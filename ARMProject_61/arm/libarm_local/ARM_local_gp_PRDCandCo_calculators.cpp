        ...
        long        objId )
{
    ...
    try
    {
        ...
        ARM_GP_Vector schedulerVector(schedulerDatas);
        ARM_GP_Vector truncatorVector(truncatorDatas);
		ARM_GP_Vector prdcCalibDatas(calibDatas);
        ...
        long					objId )
{
	...
	try
	{
		...
		ARM_GP_Vector schedulerDatas(schedulerDatasDble);
		ARM_GP_Vector truncatorDatas(truncatorDatasDble);
		ARM_StringVector productsToPrice(productsStr);
		ARM_GP_Vector calibDatas(calibDatasDble);
...
long ARM_PRDCCalculator_InitFunctor::operator()( ARM_result& result, long objId )
{
	...
	ARM_MarketData_ManagerRep*	mktDataManager = NULL;
	ARM_GP_Vector*	scheduler = NULL;
	ARM_GP_Vector*	truncator  = NULL;
	ARM_GP_Vector*	calibDatas = NULL;
