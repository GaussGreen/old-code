	...
	ARM_result& result )
{
	...
	try
	{
		...
		ARM_GP_Vector* tmpData = dateStrip->GetMemberData( dataType );
...
)
{
	...
	try
	{
		ARM_GP_Vector* FlowStartDates	= CreateARMVectorFromXLDATEVECTOR( FlowStartDatesV );
		ARM_GP_Vector* FlowEndDates		= CreateARMVectorFromXLDATEVECTOR( FlowEndDatesV );
		ARM_GP_Vector* FwdStartDates	= CreateARMVectorFromXLDATEVECTOR( FwdStartDatesV );
		ARM_GP_Vector* FwdEndDates		= CreateARMVectorFromXLDATEVECTOR( FwdEndDatesV );
		ARM_GP_Vector* ResetDates		= CreateARMVectorFromXLDATEVECTOR( ResetDatesV );
		ARM_GP_Vector* PaymentDates		= CreateARMVectorFromXLDATEVECTOR( PaymentDatesV );
		ARM_GP_Vector* InterestDays		= CreateARMGPVectorFromVECTOR( InterestDaysV );
		ARM_GP_Vector* InterestTerms	= CreateARMGPVectorFromVECTOR( InterestTermsV );
