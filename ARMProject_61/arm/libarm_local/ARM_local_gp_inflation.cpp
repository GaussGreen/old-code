	...
	long objId )
{
	...
	ARM_GP_Vector* vDim1	= NULL;
	ARM_GP_Vector* vStrikes	= NULL;
		...
		ARM_result& result )
{
	...
	CCString msg ("");
	ARM_GP_Vector* pZCVol		= NULL;	
	ARM_GP_Vector* pYtYVol		= NULL;	
	ARM_GP_Vector* pMaturity	= NULL;	
		...
		ARM_result& result )
{
	...
	try
	{
		...
		/// to avoid memory leak, delete the ARM_GP_Vector*
		delete pCor;
		delete pYtYVol;
		delete pMaturity;
		...
		ARM_result& result )
{
	...
	try
	{
		...
		pYtYVol		= CreateARMGPVectorFromVECTOR( YtYVolV );
		pMaturity	= CreateARMGPVectorFromVECTOR( MaturityV );
		ARM_GP_Vector UBound(1);
		ARM_GP_Vector LBound(1);
		...
		ARM_result& result )
{
	...
	CCString msg ("");
	ARM_GP_Vector* pDFactor	= NULL;	
	ARM_GP_Vector* pFwdCPI		= NULL;	
	ARM_GP_Vector* pVol_DF		= NULL;	
	ARM_GP_Vector* pVol_YoY	= NULL;	
	ARM_GP_Vector* pAvgCor		= NULL;	
	ARM_GP_Vector* pDates		= NULL;	
	ARM_GP_Vector* pTenors		= NULL;	
			...
			)
{
	...
	ARM_GP_Vector* vSeasonSpreadList  = NULL;
	...
	long objId )
{
	...
	ARM_GP_Vector* tenorsVec		= NULL;
	ARM_GP_Vector* expiriesVec		= NULL;
	...
	long objId )
{
	...
	ARM_GP_Vector* tenorsVec		= NULL;
	ARM_GP_Vector* expiriesVec		= NULL;
	ARM_GP_Vector* strikesVec		= NULL;
	ARM_GP_Vector* smiledTenorsVec		= NULL;
