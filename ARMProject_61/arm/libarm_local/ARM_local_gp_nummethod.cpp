	...
	try
	{
        ...
        else
        {
            ...
            treeFactoryData = new ARM_TreeFactoryData(
                ...
                ARM::ARM_SamplerBase::MeanReverting, ARM_GP_Vector(1,minStdDev),
                ARM::ARM_TruncatorBase::StandardDeviation,ARM_GP_Vector(1,stdDev),false,
	...
	long					objId )
{
	...
	try
	{
		...
		if (C_SchedulerDatas.size())
			schedulerDatas = ARM_GP_Vector(C_SchedulerDatas);
		else
		...
		ARM_GP_Vector samplerDatas(C_SamplerDatas);
		...
		{
			ARM_GP_Vector abscisses(1, 0.0);
			ARM_GP_T_Vector<ARM_GP_Vector > ordinates(1, ARM_GP_Vector(1,0.0));
         ...
         long        objId )
{
	...
	try
	{
        int nbDims = C_NbDims;
        int schedulerType = C_SchedulerType;
        ARM_GP_Vector schedulerDatas(C_SchedulerDatas);
        int samplerType = C_SamplerType;
        ARM_GP_Vector samplerDatas(C_SamplerDatas);
        int truncatorType = C_TruncatorType;
        ARM_GP_Vector truncatorDatas(C_TruncatorDatas);
         ...
         long        objId )
{
	...
	try
	{
		...
		{
			ARM_GP_Vector abscisses(1, 0.0);
			ARM_GP_T_Vector<ARM_GP_Vector > ordinates(1, ARM_GP_Vector(1,C_InitGuess));
		...
		{
			ARM_GP_Vector abscisses(1, 0.0);
			ARM_GP_T_Vector<ARM_GP_Vector > ordinates(1, ARM_GP_Vector(1,C_LowerBound));
		...
		{
			ARM_GP_Vector abscisses(1, 0.0);
			ARM_GP_T_Vector<ARM_GP_Vector > ordinates(1, ARM_GP_Vector(1,C_UpperBound));
