										...
										long				objId)
{
	...
	try
	{
		...
		for (int i = 0; i < ListOfKeys.size(); i++)
		{
			...
			ARM_GP_Vector * ResetDates		= DS->GetResetDates();
			ARM_GP_Vector * PaymentDates	= DS->GetPaymentDates();
			...
			curve = new ARM_Curve(	ARM_GP_Vector( 1, (ResetDateResearched - myDate) ),	/* abscisses */
									ARM_GP_Vector( 1, FixingResearched ),				/* ordinates */
