		...
		long objId)
{
	...
	ARM_GP_Vector smileData(sizeVector);
	try
	{ 
							...
							long objId)
{
	...
	try
	{
		...
		else
		{
			...
			leverage = new ARM_Curve ( ARM_GP_Vector(1, -1), //lag
									   ARM_GP_Vector(1, leverageValue), //value
							 ...
							 long objId)
{
	...
	try
	{
		...
		{
			// create a leverage constant to leverageValue
			vLeverage = new ARM_Curve ( ARM_GP_Vector(1, -1), //lag
									   ARM_GP_Vector(1, C_leverageValue), //value
									   new ARM_LinearInterpolatorCstExtrapol<double,double> );
		}
