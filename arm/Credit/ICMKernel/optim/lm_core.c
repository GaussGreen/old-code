...
#define LEVMAR_DER LM_ADD_PREFIX(FDP_levmar_der)
#define LEVMAR_DIF LM_ADD_PREFIX(FDP_levmar_dif)
#define FDIF_FORW_JAC_APPROX LM_ADD_PREFIX(FDP_fdif_forw_jac_approx)
#define FDIF_CENT_JAC_APPROX LM_ADD_PREFIX(FDP_fdif_cent_jac_approx)
#define TRANS_MAT_MAT_MULT LM_ADD_PREFIX(FDP_trans_mat_mat_mult)
#define LEVMAR_COVAR LM_ADD_PREFIX(FDP_levmar_covar)
...
#else
#define AX_EQ_B_LU LM_ADD_PREFIX(FDP_Ax_eq_b_LU_noLapack)
#endif /* HAVE_LAPACK */
