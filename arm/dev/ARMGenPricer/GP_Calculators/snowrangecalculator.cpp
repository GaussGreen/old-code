...
void ARM_SnowRangeCalculator::CreateAndSetModel()
{
	...
	int multiDim = 2;
	ARM_GP_Vector samplerDatas(0);

	int schedulerType = ARM_SchedulerBase::TimeStepPerYear;
	ARM_GP_Vector schedulerDatas(1);
	schedulerDatas[0] = 1;
	...
	if (itsModelName == "HK")
	{
		...
		ARM_GP_Vector breakPointTimes(size);
		ARM_GP_Vector values(size);
	...
	{
		ARM_GP_Vector breakPointTimes(1);
		ARM_GP_Vector values(1);
		ARM_GP_Vector lowerBound(1);
		ARM_GP_Vector upperBound(1);
