...
void ARM_PRDCalculator::ComputeDomesticBasis()
{
	...
	ARM_GP_Vector vdomMargin = basisConveter.ComputeDomMargin(fundingLeg);
...
void ARM_PRDCalculator::CreateUnderlying(const ARM_Date& fixDate)
{
	...
	*FxNumLeg = FxNumTmpLeg;
	...
	ARM_Vector* cancelDates = To_pARM_Vector(&ARM_GP_Vector(itsStructDateStrip->GetFlowStartDates()->begin() + itsNbNoCall,
