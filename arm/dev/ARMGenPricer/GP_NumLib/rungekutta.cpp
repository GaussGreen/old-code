			...
			const ARM_ODEFunc& function, vector<ARM_GP_Vector>& solverVars)
{
	int i;
	double xh,hh,h6;
	ARM_GP_Vector* dym = & solverVars[RK4_DYM];
	ARM_GP_Vector* dyt = & solverVars[RK4_DYT];
	ARM_GP_Vector* yt  = & solverVars[RK4_YT];
...

{
	int k;
	double x,h;
	ARM_GP_Vector* dxdy	= & solverVars[RK4_DXDY];;
...
void rkckToNextStep(ARM_GP_Vector* yIn, ARM_GP_Vector* dydx, int n, double x, double h,
			ARM_GP_Vector* yOut, ARM_GP_Vector* yerr, const ARM_ODEFunc& function, vector<ARM_GP_Vector>& solverVars)
{
	int i;
		
	ARM_GP_Vector* ak2		= & solverVars[RK5_AK2];
	ARM_GP_Vector* ak3		= & solverVars[RK5_AK3];
	ARM_GP_Vector* ak4		= & solverVars[RK5_AK4];
	ARM_GP_Vector* ak5		= & solverVars[RK5_AK5];
	ARM_GP_Vector* ak6		= & solverVars[RK5_AK6];
	ARM_GP_Vector* ytemp	= & solverVars[RK5_YTEMP];
							...
							const ARM_ODEFunc& function, vector<ARM_GP_Vector>& solverVars)
{
	...
	ARM_GP_Vector* yout  = & solverVars[RK5_YOUT];
	ARM_GP_Vector* yerr  = & solverVars[RK5_YERR];
			...
			ARM_GP_Vector* xp, ARM_GP_Vector* yp)
{
	...
	ARM_GP_Vector* yscal	= & solverVars[RK5_YSCAL];
	ARM_GP_Vector* dydx		= & solverVars[RK5_DXDY];
