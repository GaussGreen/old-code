...
public:
	...
	void SetProductsToPrice(const vector<bool>& productsToPrice){itsProductsToPrice = productsToPrice;};
...
protected:
	...
	// Pricing Data
    vector<bool>				itsProductsToPrice;
	...
	ARM_GP_Vector				itsCorridorLegPrices;
