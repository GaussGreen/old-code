...
public:
	...
	/// Vector
	inline virtual ARM_GP_Vector GetvCpnNominal() const  { return itsCpnNominal.GetOrdinates();};
	inline virtual ARM_GP_Vector GetvFundNominal() const { return itsFundNominal.GetOrdinates();};
	inline virtual ARM_GP_Vector GetvFundSpread() const { return itsFundSpread.GetOrdinates();};
