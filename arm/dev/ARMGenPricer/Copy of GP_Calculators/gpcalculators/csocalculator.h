...
*/
	...
	void ComputeEquivalentSwoptStrikes(ARM_GP_Vector& equivStrikes1, ARM_GP_Vector& equivStrikes2);
	void GenerateEquivalentDiagSwoptStrikes(ARM_GP_Vector& equivStrikes);
