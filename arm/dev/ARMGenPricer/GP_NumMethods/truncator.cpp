...
ARM_IntMatrixPtr ARM_Truncator1D::ComputeCenter(const ARM_SamplerBase* sampler, const ARM_SliceVectorPtr& slices) const
{
    ...
    model.IntegratedGlobalDrifts(*model.GetNumMethod()->GetTimeSteps(),globalDrifts);
...
void ARM_TruncatorND::Init(const ARM_SliceVectorPtr& slices, const ARM_SamplerBase* sampler, const ARM_IntMatrixPtr& center)
{
    ...
    for(i=1; i<nbSlices; ++i)
    {
		...
		const ARM_GP_Vector& globalVarVec = samplerND->GetGlobalVar(i);
...
///          nodes (ARM_SliceND)
////////////////////////////////////////////////////
void ARM_TruncatorND::UpdateNode( double sliceTime, ARM_SliceBase* tmpSlice, size_t stateIdx, ARM_SliceBase* tmpNextSlice, const ARM_GP_Vector& meanRel, const ARM_GP_Vector& varRel ) const
{
...
///          nodes (ARM_SliceND)
////////////////////////////////////////////////////
void ARM_TruncatorNDArrowDebreu::UpdateNode( double sliceTime, ARM_SliceBase* tmpSlice, size_t stateIdx, ARM_SliceBase* tmpNextSlice, const ARM_GP_Vector& meanRel, const ARM_GP_Vector& varRel ) const
{
    ARM_SliceND* slice      = tmpSlice->ToSliceND();
    ARM_SliceND* nextSlice  = tmpNextSlice->ToSliceND();
