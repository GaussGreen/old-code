...
public:
	...
	void UpdateVectorWithMatrixByProduct( const ARM_GP_VectorPtr& DiagTerm, const ARM_GP_VectorPtr& UpperTerm, const ARM_GP_VectorPtr& LowerTerm, ARM_GP_Vector& Vector );
