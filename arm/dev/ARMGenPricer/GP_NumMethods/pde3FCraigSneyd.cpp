...
////////////////////////////////////////////////////
void PermutXY(ARM_GP_Vector &U, int nx, int ny, int nz, ARM_GP_Vector &V )
{
...
////////////////////////////////////////////////////
void PermutXZ(ARM_GP_Vector &U, int nx, int ny, int nz, ARM_GP_Vector &V)
{
	int i,j,k,I,I_per,K,K_per;
	unsigned int lengthU =U.size();
...
void ARM_PDE3FCraigSneydNumericalScheme::InitABC2(int toTimeIdx)
{
	...
	ARM_GP_Vector::iterator Qxxit = itsQxx->begin();
	ARM_GP_Vector::iterator Qyyit = itsQyy->begin();
	ARM_GP_Vector::iterator Qzzit = itsQzz->begin();
	ARM_GP_Vector::iterator Pxit = itsPx->begin();
	ARM_GP_Vector::iterator Pyit = itsPy->begin();
	ARM_GP_Vector::iterator Pzit = itsPz->begin();
	ARM_GP_Vector::iterator Oit = itsO->begin();
	ARM_GP_Vector::iterator Rxxit = itsRxx->begin();
	ARM_GP_Vector::iterator Ryyit = itsRyy->begin();
	ARM_GP_Vector::iterator Rzzit = itsRzz->begin();
	ARM_GP_Vector::iterator Sxit = itsSx->begin();
	ARM_GP_Vector::iterator Syit = itsSy->begin();
	ARM_GP_Vector::iterator Szit = itsSz->begin();
	ARM_GP_Vector::iterator A1it = itsA1->begin();
	ARM_GP_Vector::iterator B1it = itsB1->begin();
	ARM_GP_Vector::iterator C1it = itsC1->begin();
	ARM_GP_Vector::iterator A2it = itsA2->begin();
	ARM_GP_Vector::iterator B2it = itsB2->begin();
	ARM_GP_Vector::iterator C2it = itsC2->begin();
	ARM_GP_Vector::iterator A3it = itsA3->begin();
	ARM_GP_Vector::iterator B3it = itsB3->begin();
	ARM_GP_Vector::iterator C3it = itsC3->begin();
...
void ARM_PDE3FCraigSneydNumericalScheme::UpdatePayoffs2(ARM_GP_Vector& U, int toTimeIdx)
{
	...
	ARM_GP_Vector::iterator PrevQxxit = itsPrevQxx->begin();
	ARM_GP_Vector::iterator PrevQyyit = itsPrevQyy->begin();
	ARM_GP_Vector::iterator PrevQzzit = itsPrevQzz->begin();
	ARM_GP_Vector::iterator PrevQxyit = itsPrevQxy->begin();
	ARM_GP_Vector::iterator PrevQyzit = itsPrevQyz->begin();
	ARM_GP_Vector::iterator PrevQzxit = itsPrevQzx->begin();
	ARM_GP_Vector::iterator PrevPxit = itsPrevPx->begin();
	ARM_GP_Vector::iterator PrevPyit = itsPrevPy->begin();
	ARM_GP_Vector::iterator PrevPzit = itsPrevPz->begin();
	ARM_GP_Vector::iterator PrevOit = itsPrevO->begin();
	ARM_GP_Vector::iterator Rxxit = itsRxx->begin();
	ARM_GP_Vector::iterator Ryyit = itsRyy->begin();
	ARM_GP_Vector::iterator Rzzit= itsRzz->begin();
	ARM_GP_Vector::iterator Rxyit = itsRxy->begin();
	...
	ARM_GP_Vector::iterator Dit= itsD->begin();


	ARM_GP_Vector::iterator UCCCit=U.begin();
	ARM_GP_Vector::iterator U_tempCCCit;
	ARM_GP_Vector::iterator UDCCit;
	ARM_GP_Vector::iterator UGCCit;
	ARM_GP_Vector::iterator UCDCit;
	ARM_GP_Vector::iterator UCGCit;
	
	ARM_GP_Vector::iterator UGDCit;
	ARM_GP_Vector::iterator UGGCit;
	ARM_GP_Vector::iterator UDDCit;
	ARM_GP_Vector::iterator UDGCit;

	ARM_GP_Vector::iterator UCCGit;
	ARM_GP_Vector::iterator UDCGit;
	ARM_GP_Vector::iterator UGCGit;
	ARM_GP_Vector::iterator UCDGit;
	ARM_GP_Vector::iterator UCGGit;

	ARM_GP_Vector::iterator UCCDit;
	ARM_GP_Vector::iterator UDCDit;
	ARM_GP_Vector::iterator UGCDit;
	ARM_GP_Vector::iterator UCDDit;
	ARM_GP_Vector::iterator UCGDit;
