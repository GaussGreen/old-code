...
void ARM_InfPayOffVisitor::Visit( const ARM_InfHybridPayOff & payOff){
		ARM_InfHybridPayOffValue* tmp = new ARM_InfHybridPayOffValue(payOff);
		itsInfPayOffValue	= ARM_InfPayOffValuePtr ( tmp );	
}; 

void ARM_InfPayOffVisitor::Visit( const ARM_InfHybridCap & payOff){
		ARM_InfHybridCapValue* tmp = new ARM_InfHybridCapValue(payOff);
		itsInfPayOffValue	= ARM_InfPayOffValuePtr ( tmp );	
};

void ARM_InfPayOffVisitor::Visit( const ARM_InfHybridDigit & payOff){
		ARM_InfHybridDigitValue* tmp = new ARM_InfHybridDigitValue(payOff);
		itsInfPayOffValue	= ARM_InfPayOffValuePtr ( tmp );	
};

void ARM_InfPayOffVisitor::Visit( const ARM_InfDoubleDigit & payOff){
		ARM_InfDoubleDigitValue* tmp = new ARM_InfDoubleDigitValue(payOff);
		itsInfPayOffValue	= ARM_InfPayOffValuePtr ( tmp );	
};

void ARM_InfPayOffVisitor::Visit( const ARM_InfCorridor & payOff){
