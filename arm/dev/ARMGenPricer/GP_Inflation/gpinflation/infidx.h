...
protected:
	...
	ARM_CountedPtr<ARM_InfCurv> itsInfFwdCurve ;
	std::string itsResetLag;
	std::string itsDCFLag;

public:
	/// constructor
	ARM_InfIdx( ARM_CountedPtr<ARM_Currency> ccy,
	...
	ARM_CountedPtr<ARM_InfCurv> GetInfFwdCurve() const {return itsInfFwdCurve ;}
