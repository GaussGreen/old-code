...
///	Action : 
////////////////////////////////////////////////////
double MultiDimFunc :: operator()(const ARM_GP_Vector& x ) const
{ ARM_THROW( ERR_INVALID_ARGUMENT, ARM_USERNAME +" : unimplemented function" ); }

void MultiDimFunc :: operator()(const ARM_GP_Vector& x, ARM_GP_Vector* fx) const
{ ARM_THROW( ERR_INVALID_ARGUMENT, ARM_USERNAME +" : unimplemented function" ); }

void MultiDimFunc :: operator()(const ARM_GP_Vector& x, double* fxVals, double* fxDeriv) const
{ ARM_THROW( ERR_INVALID_ARGUMENT, ARM_USERNAME +" : unimplemented function" ); }
...
////////////////////////////////////////////////////
void  MultiDimWeightedSquareFunc::operator()( const ARM_GP_Vector& x, ARM_GP_Vector* result) const
{
    int secIdx, nbSec = GetPortfolio()->size();
	itsOptimise->SplitVariables(x);
...
////////////////////////////////////////////////////
double WeightedSquareFunc ::operator () ( const ARM_GP_Vector& x ) const
{
    int nbSec = GetPortfolio()->size();
	ARM_GP_Vector result(nbSec ,0.0);
...
///	Action : Caloculte the quadratic sum
////////////////////////////////////////////////////
void MultiDimWithDerivativeFunc ::operator () ( const ARM_GP_Vector& x, 
											   double* f, 
											   double* fjac ) const
{
    int secIdx, nbSec = GetPortfolio()->size();
