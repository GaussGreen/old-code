...
:	itsExerDateStrip(static_cast<ARM_DateStrip*>(rhs.itsExerDateStrip->Clone())),
	...
	itsPortfolio((rhs.itsPortfolio!=ARM_StdPortfolioPtr(NULL) ?  (ARM_StdPortfolio*)rhs.itsPortfolio->Clone() : NULL)),
...
{
	double asOfDate = pMkmo->GetZeroCurve()->GetAsOfDateJul();
	...
	for(int i=0;i<itsPortfolio->GetSize();++i)
	{
		...
		ARM_GP_Vector coefs = pCastModel->GetBasketCoefs();
		if (i==0)
...
////////////////////////////////////////////////////
void ARM_BasketCalib::Compute(vector<ARM_Security*> securities, vector<ARM_Model*> models, const ARM_GP_Vector& weights)
{
	double mktprice;
...
/////////////////////////////////////////////////////////////////
bool ARM_BasketCalib::FillNotionals(ARM_Vector& fixAbs,ARM_Vector& fixNotios,const ARM_GP_Vector& endDates,const ARM_GP_Vector& payDates,double& fixNotional)
{
	int j;
