...
////////////////////////////////////////////////////
ARM_Bootstrap1D::ARM_Bootstrap1D(const ARM_Bootstrap1D& rhs)
:   
	ARM_ModelFitter(rhs),
...
////////////////////////////////////////////////////
ARM_Bootstrap1D:: ~ARM_Bootstrap1D()
{
	CleanUp();
}
...
///	Action : destroy the object
////////////////////////////////////////////////////
ARM_Bootstrap1D& ARM_Bootstrap1D::operator = (const ARM_Bootstrap1D& rhs)
{
    if( this != &rhs )
	{
		CleanUp();
...
///	in this object
////////////////////////////////////////////////////
void ARM_Bootstrap1D::CopyNoCleanUp( const ARM_Bootstrap1D& rhs )
{
...
////////////////////////////////////////////////////
ARM_Object* ARM_Bootstrap1D::Clone() const
{
	return new ARM_Bootstrap1D(*this); 
}
...
///	Action : constructor
////////////////////////////////////////////////////
ARM_Bootstrap1D::ARM_Bootstrap1D( ARM_PricingModel* model, 
	...
	itsSolver( NULL )
{
	...
	case ARM_ModelFitterSolverType::Brent:
		/// Here it is not necessary to template with ???WithDerivative but the
		/// ARM_Bootstrap1D class was previoulsy designed to only use such type of functions !
		itsSolver   = ModifiedNRSolverPtr( new T_BrentSolver<FunctionToSolveWithDerivative>(
				*itsFunction,target, fxTolerance,xTolerance, max_iter, printLevel , NULL, true));
		break;
	default:
...
////////////////////////////////////////////////////
void ARM_Bootstrap1D::Validate()
{
    // When the portfolio is empty we don't
    // need any validation
    if (GetPortfolio()->GetSize() == 0)
        return;
...
///	Action : initialise the object
////////////////////////////////////////////////////
void ARM_Bootstrap1D::Initialise()
{
...
////////////////////////////////////////////////////
double ARM_Bootstrap1D::RootFinding(
	double mktPrice, 
	ARM_Security* sec,
...
///	Action : initialise the object
////////////////////////////////////////////////////
void ARM_Bootstrap1D::Calibrate()
{
	...
	else if( ARM_SurfaceModelParam* surfaceCalibParam = dynamic_cast<ARM_SurfaceModelParam*>(GetCalibParam()) )
	{
		...
		GetPricingModel()->Re_InitialiseCalibParams(*this);
		const ARM_GP_Vector& expiries = surface->GetX1();
		const ARM_GP_Vector& tenors	= surface->GetX2();
...
///				details
////////////////////////////////////////////////////
string ARM_Bootstrap1D::detailedString( const string& indent ) const
{
...
////////////////////////////////////////////////////
string ARM_Bootstrap1D::toString( const string& indent, const string& nextIndent) const
{
    CC_Ostringstream os;
