...
public:
	...
	inline const ARM_GP_Vector& getInterestTerms() const {return itsInterestTerms;}
...
protected: 
	...
	ARM_GP_Vector itsInterestTerms;
	ARM_IntVector itsPayDatesRelIndexes; /// w.r.t start date
	ARM_IntVector itsPayDatesAbsIndexes; /// w.r.t schedule

protected:

	double	ComputeForwardRate(double startdate, double enddate, const ARM_IntVector& PayDatesAbsIndexes, const ARM_GP_Vector& InterestTerms) const;
	double	ComputeLevel(double startdate, double enddate, const ARM_IntVector& PayDatesAbsIndexes, const ARM_GP_Vector& InterestTerms) const;
	...
	virtual void AssociateCalibSchedule(ARM_DateStripPtr calibSchedule, double StartDate, double EndDate, int Frequency, int Daycount, ARM_GP_Vector& InterestTerms, 
...
private:
	...
	ARM_GP_Vector	itsInterestTerms2;
...
public:
	...
	inline const ARM_GP_Vector& getInterestTerms1() const {return itsInterestTerms;}
	...
	inline const ARM_GP_Vector& getInterestTerms2() const {return itsInterestTerms2;}
