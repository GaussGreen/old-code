...
/// vector declaration
typedef vector< ARM_GP_Vector* >                        ARM_VectorVector;
...
typedef ARM_CountedPtr< ARM_GP_Vector >					ARM_VectorPtr;
typedef ARM_CountedPtr< ARM_GP_Vector >					ARM_GP_VectorPtr;
...
typedef vector< ARM_VectorPtr >							ARM_VectorPtrVector;
