...
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::Tail_1_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
...
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::Tail_2_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																						  int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	NonParametric_LogVolatility_TailSlope_Compute(x,y,index_begin,index_end,beginflag,endflag,beginderivative,endderivative);
}
...
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption2_Formula::Tail_1_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																					int beginflag,int endflag, double* beginderivative,double* endderivative )
{
...
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption2_Formula::Tail_2_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																					int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	NonParametric_NormalVolatility_TailSlope_Compute(x,y,index_begin,index_end,beginflag,endflag,beginderivative,endderivative);
}
...
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption3_Formula::Tail_1_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																					int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	NonParametric_LogVolatility_TailSlope_Compute(x,y,index_begin,index_end,beginflag,endflag,beginderivative,endderivative);
}
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption3_Formula::Tail_2_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																					int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	NonParametric_NormalVolatility_TailSlope_Compute(x,y,index_begin,index_end,beginflag,endflag,beginderivative,endderivative);
}
...
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption4_Formula::Tail_1_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																					int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	NonParametric_NormalVolatility_TailSlope_Compute(x,y,index_begin,index_end,beginflag,endflag,beginderivative,endderivative);
}
void ARM_CF_NonParametric_Gaussian_PowerSpreadOption4_Formula::Tail_2_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
																					int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	NonParametric_LogVolatility_TailSlope_Compute(x,y,index_begin,index_end,beginflag,endflag,beginderivative,endderivative);
}
