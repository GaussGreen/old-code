 ...
 *
 *	\file spreadoption_sabr_student_formula.h
 *
 *  \brief
 *
 *	\author  O. Croissant
...
#ifndef _GP_CF_SPREADOPTION_SABR_STUDENT_FORMULA_H
#define _GP_CF_SPREADOPTION_SABR_STUDENT_FORMULA_H
...
//////////////////////////////////////////////////////////////////////
///  
///			class : ARM_CF_SABR_Student_PowerSpreadOption_Formula
...
struct ARM_CF_SABR_Student_PowerSpreadOption_Formula
{
	typedef ARM_CF_PowerSpreadOption_Formula<SABR_smile,StudentCopula> structure;
	enum ArgumentType
	{
		INDEX1,
		INDEX2,
