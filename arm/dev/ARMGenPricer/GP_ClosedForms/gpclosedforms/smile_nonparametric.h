...
{
	static double call_option(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
		double index_begin,double index_end,int beginflag,int endflag,
		double S,double T,double strike);

	static double digital_call_option(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
		double index_begin,double index_end,int beginflag,int endflag,double S,double T,double strike);

	static double inverse_distribution(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
	double index_begin,double index_end,int beginflag,int endflag,double S,double T, double proba);

	static  double gaussian_to_distribution(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
