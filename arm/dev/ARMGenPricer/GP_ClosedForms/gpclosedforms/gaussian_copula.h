...
#ifndef _GP_CF_GAUSSIANCOPULADESQCRIPTION_H
#define _GP_CF_GAUSSIANCOPULADESQCRIPTION_H
...
struct GaussianCopula : public GenericCopula
{
	...
	/// integral up to H ofthe elliptic distribution with 0 correlations with respect to S1
	...
	GaussianCopula(ArgumentList* structure0):GenericCopula(structure0) {}
