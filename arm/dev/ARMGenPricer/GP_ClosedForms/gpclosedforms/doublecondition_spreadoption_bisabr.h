...
#ifndef _GP_CF_DOUBLECOND_BISABR_SPREADOPTION_FORMULA_H
#define _GP_CF_DOUBLECOND_BISABR_SPREADOPTION_FORMULA_H
...
///////////////////////////////////////////////////////////////////////
///  
///			class : ARM_CF_DoubleCondition_BiSABR_SpreadOption_Formula
///			Purpose : Evaluation of spread option under the BiSABR model
///			
///
///////////////////////////////////////////////////////////////////////

struct ARM_CF_BiSABR_DoubleCondition_SpreadOption_Formula
{
	enum ArgumentType
	{
		INDEX1,				// i=0
