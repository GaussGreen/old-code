...
public:
	...
	inline ARM_GP_Vector get_weights() const { return weigths;}
	inline ARM_GP_Vector get_points() const{return points;}
	...
	inline void set_points(ARM_GP_Vector x){weigths=x;}
	inline void set_weigths(ARM_GP_Vector x){points=x;}

	void fill( Orthogonal_Polynomial_Coefficients coeff){ weigths.fill( coeff.get_weights() );points.fill( coeff.get_points() );}

	protected:
	ARM_GP_Vector weigths;
	ARM_GP_Vector points;
