...
struct ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula
{
	...
	static void Tail_1_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
							int beginflag,int endflag, double* beginderivative,double* endderivative );
	static void Tail_2_Slope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
							int beginflag,int endflag, double* beginderivative,double* endderivative );
...
double dummy_VC6<A>::ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula_value(const ArgumentList& a)
{
	...
	ARM_GP_Vector* x1=a.V(ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::STRIKEVECTOR1);
	ARM_GP_Vector* y1=a.V(ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::VOLVECTOR1);
	int n1size=x1->size();
	ARM_GP_Vector SecondDer1(n1size);
	...
	ARM_GP_Vector* x2=a.V(ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::STRIKEVECTOR2);
	ARM_GP_Vector* y2=a.V(ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::VOLVECTOR2);
	int n2size=x2->size();
	ARM_GP_Vector SecondDer2(n2size);
