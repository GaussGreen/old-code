...
public:
	...
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0,double x1);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0,double x1,double x2);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0,double x1,double x2,double x3);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0,double x1,double x2,double x3,double x4);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0,double x1,double x2,double x3,double x4,double x5);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,double x0,double x1,double x2,double x3,double x4,double x5,double x6);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1,double x2);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1,double x2,double x3);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1,double x2,double x3,double x4);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1,double x2,double x3,double x4,double x5);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1,double x2,double x3,double x4,double x5,double x6);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,ARM_GP_Vector*  y2,double x0,double x1,double x2,double x3,double x4,double x5,double x6,
	...
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0,double x1);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0,double x1,double x2);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0,double x1,double x2,double x3);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0,double x1,double x2,double x3,double x4);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0,double x1,double x2,double x3,double x4,double x5);
	ArgumentList(ARM_GP_Vector*  x,ARM_GP_Vector*  y,ARM_GP_Vector*  xv,double x0,double x1,double x2,double x3,double x4,double x5,double x6);
	...
	const vector<ARM_GP_Vector*>& get_itsVectorContainer() const { return itsVectorContainer; }
	vector<ARM_GP_Vector*>& get_itsVectorContainer() { return itsVectorContainer; }
	inline double operator[](int i) const { return itsContainer[i];}
	inline double& operator[](int i) { return itsContainer[i];}
	ARM_GP_Vector*  vectnth(int i) { return itsVectorContainer[i]; }
	ARM_GP_Vector*  V(int i) const { return itsVectorContainer[i]; }
	ARM_GP_Vector*& V(int i)  { return itsVectorContainer[i]; }
	inline void set_vectnth(int i,ARM_GP_Vector*  x) {itsVectorContainer[i]=x;}
	ArgumentList* sublist(int n) const;
private:
	vector<double> itsContainer;
	vector<ARM_GP_Vector*> itsVectorContainer;
