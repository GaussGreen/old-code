...
struct ARM_CF_PowerSpreadOption_NonSymmetric_Formula : public Templated_Pricing<smile1,smile2,copula>
{
...
double ARM_CF_PowerSpreadOption_NonSymmetric_Formula<smile1,smile2,copula>::PowerSpreadOption_Pricing(const ArgumentList& Underlying1,const ArgumentList& Underlying2,
				    copula copula_instance,double t,int n,double a10,double b10,double k10,double a20,double b20,double k20,int algorithm)
{
	...
	default :
		{	
			throw Exception(__LINE__, __FILE__, ERR_INVALID_ARGUMENT,"ARM_CF_PowerSpreadOption_NonSymmetric_Formula<smile,copula>::PowerSpreadOption_Pricing : ALGORITHM : bad value ");
			break;
		}
	}
...
/// used by ARM_CF_PowerSpreadOption_NonSymmetric_Formula<ShiftedLogNormal_Smile,GaussianCopula>
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
template<class smile1,class smile2, class copula>
double ARM_CF_PowerSpreadOption_NonSymmetric_Formula<smile1,smile2,copula>::PowerSpreadOption_Pricing(int i_deriv,const ArgumentList& Underlying1,const ArgumentList& Underlying2,
				   const ArgumentList& copula,double t,int n,double a10,double b10,double k10,double a20,double b20,double k20,int algorithm)
{
	switch (algorithm)
	{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
template<class smile1,class smile2, class copula>
double ARM_CF_PowerSpreadOption_NonSymmetric_Formula<smile1,smile2,copula>::PowerSpreadOption_Pricing_With_Limits (const ArgumentList& Underlying1,const ArgumentList& Underlying2,
				   const ArgumentList& copula,double t,int n,double a10,double b10,double k10,double a20,double b20,double k20,int algorithm)
{
	...
	if((b20==0)&&(a20==0))
	{
		throw Exception(__LINE__, __FILE__, ERR_INVALID_ARGUMENT,"ARM_CF_PowerSpreadOption_NonSymmetric_Formula<smile1,smile2,copula>::PowerSpreadOption_Pricing2   : bad arguments : a2 or b2");
	}
	else
	{
		if
