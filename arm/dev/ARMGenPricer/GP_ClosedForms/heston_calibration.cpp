...
GeneralizedHeston_ParameterSet*  GeneralizedHeston_CalibrateToSmile(ARM_GP_Vector* K_Vec,ARM_GP_Vector* ImpVol_Vec,double F,double tex,int nbsteps,int algorithm,
												double V0_0,double omega_0,double theta_0,double ksi_0,double rho_0,double muJ_0,double sigmaJ_0,double lambda_0)
{
	...
	public:
		...
		objectiveFuntion(ARM_GP_Vector* strike_list0,double f,double tex0,int nbsteps0):
...
GeneralizedHeston_ParameterSet*  GeneralizedHeston_CalibrateToSmile(ARM_GP_Vector* K_Vec,ARM_GP_Vector* ImpVol_Vec,double F,double tex,double muJ,double sigmaJ,double lambda,int nbsteps,int algorithm,
												double V0_0,double omega_0,double theta_0,double ksi_0,double rho_0)
{
	...
	public:
		...
		objectiveFuntion(ARM_GP_Vector* strike_list0,double f,double tex0,double muJ0,double sigmaJ0,double lambda0,int nbsteps0):
