...
double NonParametric_LogVolatility_Interpolate(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
...
void NonParametric_LogVolatility_TailSlope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
...
double NonParametric_LN_Distribution_Interpolate(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
							double index_begin,double index_end,
...
double NonParametric_LN_Quantile_Interpolate(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
							double index_begin,double index_end,
...
class DistributionToInverse : public DoubleToDoubleFunc 
	...
	public: 
		...
		int beginflag_0;
		int endflag_0;
		DistributionToInverse(ARM_GP_Vector* x_1,ARM_GP_Vector* y_1,ARM_GP_Vector* y2_1,
...
double NonParametric_NormalVolatility_Interpolate(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
							double index_begin,double index_end,
							int beginflag,int endflag, double strike)
{
	double initialstrike=*(x->begin());
...
void NonParametric_NormalVolatility_TailSlope_Compute(ARM_GP_Vector* x,ARM_GP_Vector* y,double index_begin,double index_end,
							int beginflag,int endflag, double* beginderivative,double* endderivative )
{
	double initialstrike=(*(x->begin()));
	double initialvol=(*(y->begin()));
...
double NonParametric_N_Distribution_Interpolate(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
							double index_begin,double index_end,
							int beginflag,int endflag, double S,double T, double strike)
{
	double shift=ARM_CF_NonParametric_Gaussian_PowerSpreadOption_Formula::specific_shift(
...
double NonParametric_N_Quantile_Interpolate(ARM_GP_Vector* x,ARM_GP_Vector* y,ARM_GP_Vector* y2,
							double index_begin,double index_end,
							int beginflag,int endflag,double S,double T, double proba)
{
class DistributionToInverse : public DoubleToDoubleFunc 
