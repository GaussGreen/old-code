...
void ARM_SpreadVBProxy::price()
{
	...
	ARM_GP_Vector x(4);
	ARM_GP_Vector x1(itsNbSimul), x2(itsNbSimul), z(itsNbSimul), z1(itsNbSimul), z2(itsNbSimul), zc(itsNbSimul);
	ARM_GP_Vector u1(itsNbSimul), u2(itsNbSimul);
	ARM_GP_Vector sfwd1(itsNbSimul), sfwd2(itsNbSimul), efwd1(itsNbSimul), efwd2(itsNbSimul);
	ARM_GP_Vector svol1(itsNbSimul), svol2(itsNbSimul);
	...
	ARM_GP_Vector spreadopt(itsNbSimul);
...
void ARM_SpreadVBProxy::sabrFwdRate(ARM_GP_Vector& fwdrate, const ARM_GP_Vector& u, double fwd, double t, 
