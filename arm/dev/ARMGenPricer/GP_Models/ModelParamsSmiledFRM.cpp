...
void ARM_ModelParamsSmiled::BuildVolatilityStructure()
{
	...
	ARM_GP_Vector dates(n,0.);
	ARM_GP_Vector values(n,1.);
...
double ARM_ModelParamsSmiled::StationaryConstraint(double a, double b)
{
	...
	const ARM_GP_Vector& x = pcurve->GetAbscisses();
	const ARM_GP_Vector& y = pcurve->GetOrdinates();
...
//Localization of a and b
	...
	ARM_GP_Vector xx(inter+2,0.);
	ARM_GP_Vector yy(inter+2,1.);
...
void ARM_ModelParamsSmiled::UpdateVolatilityFromHump()
{
	if( DoesModelParamExist(ARM_ModelParamType::Hump) )
	{
		...
		ARM_GP_Vector::iterator iterReset			= itsResetDates->begin();

		for (;iterVol!=itsVol.end();++iterVol,++iterVolCalib,++iterReset)
		{
			double sum1=0.,sum2=0;
			ARM_GP_Vector value	= (*iterVol)->GetOrdinates();
			ARM_GP_Vector date	= (*iterVol)->GetAbscisses();
...
///                         Scalar product(Sigma(u,T1).Sigma(u,T2))*du)
////////////////////////////////////////////////////
double ARM_ModelParamsSmiled::GetEquivalentVol(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight,const ARM_GP_Vector& coeff, CalibProxy proxy) const
{
	switch (proxy)
	{
		case ATM:
...
///	Action : 
////////////////////////////////////////////////////
double ARM_ModelParamsSmiled::GetEquivalentCov(double evalTime, double swapResetTime, const ARM_GP_Vector& weight1, const ARM_GP_Vector& weight2, const ARM_GP_Vector& coeff, CalibProxy proxy) const
{
	switch (proxy)
	{
		case ATM:
...
///	Action : 
////////////////////////////////////////////////////
double ARM_ModelParamsSmiled::GetEquivalentCov(double evalTime, double swapResetTime, const ARM_GP_Vector& weight1, const ARM_GP_Vector& weight2, const ARM_GP_Vector& coeff, const ARM_MatrixVector& mat) const
{
	if (!itsGlobalCovTimes)
...
///	Action : 
////////////////////////////////////////////////////
double ARM_ModelParamsSmiled::GetEquivalentVol(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight,const ARM_GP_Vector& coeff, const ARM_MatrixVector& mat) const
{
	if (!itsGlobalCovTimes)
		ARM_THROW( ERR_INVALID_ARGUMENT, "ARM_ModelParamsSmiled,GetEquivalentVol : covariance structure not initialized!! ");
...
///	Action : 
////////////////////////////////////////////////////
double ARM_ModelParamsSmiled::GetEquivalentVolCalib(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight,const ARM_GP_Vector& coeff) const
{
...
///	Action : 
////////////////////////////////////////////////////
double ARM_ModelParamsSmiled::GetEquivalentVolModel(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight,const ARM_GP_Vector& coeff) const
{
