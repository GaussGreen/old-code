...
ARM_CurveModelParam ARM_Heston_ModelParams::GetVolAlpha() const
{
	...
	ARM_GP_Vector abs = ((ARM_CurveModelParam&)GetModelParam(ARM_ModelParamType::Sigma)).GetCurve()->GetAbscisses();
	ARM_GP_Vector ord = ((ARM_CurveModelParam&)GetModelParam(ARM_ModelParamType::Sigma)).GetCurve()->GetOrdinates();
