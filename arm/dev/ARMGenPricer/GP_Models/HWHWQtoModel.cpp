...
void ARM_HWHWQtoModel::NumMethodStateLocalGlobalVariances( const ARM_GP_Vector& timeSteps,
...
void ARM_HWHWQtoModel::NumMethodStateGlobalVariances( const ARM_GP_Vector& timeSteps,
	ARM_MatrixVector& variances ) const
{
	ARM_MatrixVector localVariances;
...
void ARM_HWHWQtoModel::NumMethodStateLocalVariances( const ARM_GP_Vector& timeSteps,
...
void ARM_HWHWQtoModel::IntegratedLocalDrifts( const ARM_GP_Vector& timeSteps,
