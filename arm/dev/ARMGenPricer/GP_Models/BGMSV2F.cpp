...
ARM_GP_Vector* ARM_BGMSV2F::ComputeModelTimes(  const ARM_TimeInfoPtrVector& timeInfos )
{
...
void ARM_BGMSV2F::CalcNbEffectiveReset(const ARM_GP_Vector& timeSteps)
{
	if(itsProxyStatus)
	{
...
void ARM_BGMSV2F::ModelStateLocalVariancesAndStdDev( const ARM_GP_Vector& timeSteps)
{
...
void ARM_BGMSV2F::NumMethodStateLocalVariances(const ARM_GP_Vector& timeSteps, ARM_MatrixVector& localVariances ) const
{
...
void ARM_BGMSV2F::NumMethodStateGlobalVariances(const ARM_GP_Vector& timeSteps, ARM_MatrixVector& globalVariances ) const
{
...
void ARM_BGMSV2F::ModelStateLocalStdDev( const ARM_GP_Vector& timeSteps, const ARM_MatrixVector& auxLocalCov)
{
...
void ARM_BGMSV2F::NumMethodStateLocalVariancesAndStdDev( const ARM_GP_Vector& timeSteps )
{
...
void ARM_BGMSV2F::ModelStateLocalVariances(const ARM_GP_Vector& timeSteps, ARM_MatrixVector& localVariances ) const
{
	int totalFwds		= itsNbEffectiveReset;
	int timeStepsSize	= timeSteps.size();
	int modelNb			= GetModelNb();
...
void ARM_BGMSV2F::GetWeightSwaptionApprox(const string& curveName, double evalTime, const ARM_GP_Vector& floatNotional, 
...
double ARM_BGMSV2F::GetEquivSwaptionShift(int idx, const ARM_IntVector& idxs, ARM_GP_Vector& weight) const
{
	double shift = 0.;
...
double ARM_BGMSV2F::GetEquivSwaptionLevel(int idx, const ARM_IntVector& idxs, const ARM_GP_Vector& weight, const ARM_GP_Vector * optweight) const
{
	int i, j, k;
...
double ARM_BGMSV2F::GetEquivSwaptionRho(int idx, const ARM_IntVector& idxs, const ARM_GP_Vector& weight, double swlevel,
										int UnOuDeux) const
{
	int k;
