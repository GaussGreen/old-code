...
/*	(const_cast<ARM_FRMSV1F*> (this))->PrecomputeDatas( curveName,swapResetTime, floatStartTime,floatEndTime,
	...
	return ARM_VectorPtr( new ARM_GP_Vector(1,volatility_t));
}
...
void ARM_FRMSV1F::EulerLocalDrifts( const ARM_GP_Vector& timeSteps,
		ARM_GP_MatrixPtr& relativeDrifts,
		ARM_GP_MatrixPtr& absoluteDrifts) const
{
...
////////////////////////////////////////////////////
void ARM_FRMSV1F::VolatilitiesAndCorrelations( const ARM_GP_Vector& timeSteps, 
...
///	Action  :  
////////////////////////////////////////////////////
void ARM_FRMSV1F::ModelStateLocalCorrels( const ARM_GP_Vector& timeSteps,
