			...
			const ARM_PricingStatesPtr& states) const
{
	...
	double z,w;
	ARM_GP_Vector longFlowStoc(longNbFlows+1,0.0),shortFlowStoc(shortNbFlows+1,0.0);
...
void ARM_HullWhite1F::EulerLocalDrifts( const ARM_GP_Vector& timeSteps,
		ARM_GP_MatrixPtr& relativeDrifts,
		ARM_GP_MatrixPtr& absoluteDrifts) const
{
...
////////////////////////////////////////////////////
void ARM_HullWhite1F::VolatilitiesAndCorrelations( const ARM_GP_Vector& timeSteps, 
