...
ARM_PricingStatesPtr ARM_InfFwdMod::Init(const string& payModelName, const ARM_TimeInfoPtrVector& timeInfos)
{
    ...
    numMethod->SetTimeSteps( ARM_GP_Vector(timeSteps) );
...
void ARM_InfFwdMod::NumMethodStateLocalVariances( const ARM_GP_Vector& timeSteps,
	ARM_MatrixVector& localVariances ) const
{

}

void ARM_InfFwdMod::ModelStateLocalVariances( const ARM_GP_Vector& timeSteps,
	ARM_MatrixVector& localVariances ) const
{
}
...
ARM_GP_Vector* ARM_InfFwdMod::ComputeModelTimes(  const ARM_TimeInfoPtrVector& timeInfos )
{
...
{
	ARM_GP_VectorPtr returnedVector = ARM_GP_VectorPtr( new ARM_GP_Vector(1) );
...
{ 
	ARM_GP_VectorPtr result( new ARM_GP_Vector( 1 ) );
	(*result)[0] = 1;
