        ...
        const   ARM_PricingStatesPtr& states) const 
{
    ...
    {
        liborPay = ARM_VectorPtr( new ARM_GP_Vector(nbStates, couponMargin ) );
    }
...
ARM_ModelParam* ARM_Local_SLN_Model::CreateDefaultModelParam(ARM_ModelParamType::ParamNb paramType)
{
    ...
    /// Becareful : interpolator is not cloned by the constructor
 	ARM_SurfaceWithInterpol surface (ARM_GP_Vector(0),
									 ARM_GP_Vector(0), 
									 ARM_GP_Matrix(0,0),
									 type,0.0);
...
////////////////////////////////////////////////////
void ARM_Local_SLN_Model::CalibrateLocalModel(const ARM_Security& security, double targetPrice, const ARM_GP_Vector& evalTimes, size_t secIdx)
{	//
...
///           SLN compatible
////////////////////////////////////////////////////
void ARM_Local_SLN_Model::CalibrateEqFxOption(ARM_Option* option, double targetPrice, const ARM_GP_Vector& evalTimes)
{	
    ...
    ARM_GP_Vector strikesPerState(1,strike);
...
///			  cap / floor
////////////////////////////////////////////////////
void ARM_Local_SLN_Model::CalibrateCapFloor(ARM_CapFloor* capFloor, double targetPrice, const ARM_GP_Vector& evalTimes)
{	
...
///			  caplet / floorlet
////////////////////////////////////////////////////
void ARM_Local_SLN_Model::CalibrateCapFloorLet(ARM_CapFloor* capFloor, size_t periodIdx, double targetPrice, const ARM_GP_Vector& evalTimes)
{	
...
////////////////////////////////////////////////////
void ARM_Local_SLN_Model::CalibrateCorridorLet(ARM_CorridorLeg* corridor, double targetPrice, const ARM_GP_Vector& evalTimes)
{	
    // will generate an exception if numerical model is not supported for calibration
	Local_SLN_Model_Calibration_Helper helper (GetNumericalModel());
	...
	ARM_GP_Vector refIdxResettimes, refIdxStarttimes,	refIdxEndtimes,	refFwdPeriods,refIndexWeight, DownBarrier, UpBarrier;
	...
	ARM_GP_Vector ref_TargetVol_DownMinus(ref_Size,0.0);
	ARM_GP_Vector ref_TargetVol_DownPlus(ref_Size,0.0);
	ARM_GP_Vector ref_TargetVol_UpMinus(ref_Size,0.0);
	ARM_GP_Vector ref_TargetVol_UpPlus(ref_Size,0.0);

	ARM_GP_Vector ref_TargetVol_DownMinus_PayFloat(ref_Size,0.0);
	ARM_GP_Vector ref_TargetVol_DownPlus_PayFloat(ref_Size,0.0);
	ARM_GP_Vector ref_TargetVol_UpMinus_PayFloat(ref_Size,0.0);
	ARM_GP_Vector ref_TargetVol_UpPlus_PayFloat(ref_Size,0.0);

	ARM_GP_Vector ref_Shift_Vector(ref_Size);
