...
{
	itsBetaPart_1 = ARM_GP_Vector (sizeVector + 1, 0.0);
	itsBetaPart_2 = ARM_GP_Vector (sizeVector + 1, 0.0);
	itsEpsPart_1 = ARM_GP_Vector (sizeVector + 1, 0.0);
	itsEpsPart_2 = ARM_GP_Vector (sizeVector + 1, 0.0);
	itsEpsPart_3 = ARM_GP_Vector (sizeVector + 1, 0.0);
...
{
	ARM_GP_Vector Schedule = ((ARM_ModelParamsMSV*) GetModelParams())->GetSchedule();
	double startTime = 0.0;
	double endTime,weight_in,Volt_in,t_in,temp_in,volMrs ;
	
	
	ARM_GP_Vector newSched;
	int size = 0;
	...
	itsStoredData.itsBetaPart_1 = ARM_GP_Vector (sizeVector, 0.0);
	itsStoredData.itsBetaPart_2 = ARM_GP_Vector (sizeVector, 0.0);
	itsStoredData.itsEpsPart_1 = ARM_GP_Vector (sizeVector, 0.0);
	itsStoredData.itsEpsPart_2 = ARM_GP_Vector (sizeVector, 0.0);
	itsStoredData.itsEpsPart_3 = ARM_GP_Vector (sizeVector, 0.0);
...

{
	...
	ARM_GP_Vector yInOut(nvar,0.0); // start at 0
	...
	ARM_GP_Vector* xp = new ARM_GP_Vector(kmax * nvar,0.0);
...
////////////////////////////////////////////////////
ARM_GP_Vector* ARM_SVModels::ComputeModelTimes(  const ARM_TimeInfoPtrVector& timeInfos )
{
