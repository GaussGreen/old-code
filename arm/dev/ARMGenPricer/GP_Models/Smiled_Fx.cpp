	...
	if (itsCalibrationStatus){
		if (!itsIsCalibrated){
			...
			if (params->GetCorrelType() == ARM_ModelParamsSmiled::CorrelMatrix)
			{
				...
				ARM_GP_Vector totalVolatilites;
...
void ARM_SmiledModel_Fx::setNumericalModelFitter( ARM_NumericalModelFitter* numericalModelFitter ) 
{
	if (numericalModelFitter)
	{
		...
		ARM_GP_Vector settlementDates(size);
...
////////////////////////////////////////////////////
void ARM_SmiledModel_Fx::NumMethodStateLocalVariances( const ARM_GP_Vector& timeSteps,
...
////////////////////////////////////////////////////
void ARM_SmiledModel_Fx::NumMethodStateGlobalVariances( const ARM_GP_Vector& timeSteps,
...
////////////////////////////////////////////////////
void ARM_SmiledModel_Fx::ModelStateLocalVariances( const ARM_GP_Vector& timeSteps,
		ARM_MatrixVector& localVariances ) const
{
...
///	Action  : 
////////////////////////////////////////////////////
ARM_GP_Vector* ARM_SmiledModel_Fx::ComputeModelTimes(  const ARM_TimeInfoPtrVector& timeInfos )
{
...
/// Nabyl
////////////////////////////////////////////////////
void ARM_SmiledModel_Fx::VolatilitiesAndCorrelations( const ARM_GP_Vector& timeSteps, 
														...
														bool linearVol) const
{
	...
	ARM_GP_Vector times		= GetModelParams()->GetModelParam(ARM_ModelParamType::Hump).ToCurveModelParam().GetCurve()->GetAbscisses();
	ARM_GP_Vector values	= GetModelParams()->GetModelParam(ARM_ModelParamType::Hump).ToCurveModelParam().GetCurve()->GetOrdinates();
...
void ARM_SmiledModel_Fx::EulerLocalDrifts(const ARM_GP_Vector& timeSteps, ARM_GP_MatrixPtr& relativeDrifts,
										  ARM_GP_MatrixPtr& absoluteDrifts) const
{
	// Nabyl
