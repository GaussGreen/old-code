...
double ARM_QModelBaseIR::IntegratedDrift(double t,double T, const ARM_ModelParams* modelParams ) const
{
	...
	const ARM_GP_Vector& BreakPointTimes = ((ARM_CurveModelParam&) modelParams->GetModelParam( ARM_ModelParamType::QVol)).GetCurve()->GetAbscisses();
    ARM_GP_Vector MaturityTimes( BreakPointTimes );
