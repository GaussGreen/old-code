...
void ARM_BiSVMM::ModelStateLocalVariancesAndStdDev(const ARM_GP_Vector& timeSteps)
{
...
void ARM_BiSVMM::ModelStateLocalVariances(const ARM_GP_Vector& timeSteps, ARM_MatrixVector& localVariances) const
{
	int totalFwds		= itsNbEffectiveReset;
	int timeStepsSize	= timeSteps.size();
	int modelNb			= GetModelNb();
...
void ARM_BiSVMM::NumMethodStateLocalVariances(const ARM_GP_Vector& timeSteps, ARM_MatrixVector& localVariances ) const
{
	int timeStepsSize	= timeSteps.size();
	int modelNb			= GetModelNb();
...
void ARM_BiSVMM::NumMethodStateGlobalVariances(const ARM_GP_Vector& timeSteps, ARM_MatrixVector& globalVariances) const
{
	int totalFwds		= itsNbEffectiveReset;
	int timeStepsSize	= timeSteps.size();
	int modelNb			= GetModelNb();
