	...
	bool isConstantStrike) const
{
	...
	if(itsIsMCPrice)
	{
		...
		return ARM_VectorPtr( new ARM_GP_Vector(1,MCValue));
...
{	
	...
	ARM_GP_Vector S_State (nbPaths,swapRate_Zero);
	ARM_GP_Vector Z_State (nbPaths,1.0);
	double time = 0;
	...
	{
		ARM_GP_Vector* gaussian_Vector_1 = (*normRandGen)(nbPaths);
		ARM_GP_Vector* gaussian_Vector_2 = (*normRandGen)(nbPaths);
		ARM_GP_Vector* gaussian_Vector_3 = (*normRandGen)(nbPaths);
//		ARM_GP_Vector* uniform_Vector = (*pBaseRandomGen)(nbPaths);
...
/*			double gaussian_2 = (*gaussian_Vector_2)[i+ j*nbPaths];		
	...
	ARM_GP_Vector* values = new ARM_GP_Vector(nbPaths);
