...
/// gpinfra
#include "gpmodels/modelparamsvec.h"
...
///////////////////////////////////////
void ARM_ModelParamsVec::PreProcessing(ARM_ModelFitter& modelFitter)
{
#if defined(__GP_STRICT_VALIDATION)
	CheckRange( modelFitter.GetFactorNb() );
#endif
	itsParamsVector[modelFitter.GetFactorNb()]->PreProcessing( modelFitter );
}
...
///	Action : PreProcessing
///////////////////////////////////////
void ARM_ModelParamsVec::PostProcessing(const ARM_ModelFitter& modelFitter,ARM_PricingModel* model )
{
#if defined(__GP_STRICT_VALIDATION)
	CheckRange( modelFitter.GetFactorNb() );
#endif
	itsParamsVector[modelFitter.GetFactorNb()]->PostProcessing( modelFitter, model );
}
