...
void ARM_ModelParamsMSV::GenerateSchedule()
{
    ...
    const ARM_GP_Vector& schedAt  = GetModelParam( ARM_ModelParamType::InitialVol).ToCurveModelParam().GetCurve()->GetAbscisses();
    const ARM_GP_Vector& schedBt  = GetModelParam( ARM_ModelParamType::Shift).ToCurveModelParam().GetCurve()->GetAbscisses();
