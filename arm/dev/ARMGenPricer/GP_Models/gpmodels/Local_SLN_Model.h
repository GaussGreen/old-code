...
private:
	...
	virtual void CalibrateEqFxOption (ARM_Option* option, double targetPrice, const ARM_GP_Vector& evalTimes);
	virtual void CalibrateCorridorLet (ARM_CorridorLeg* corridor, double targetPrice, const ARM_GP_Vector& evalTimes);
