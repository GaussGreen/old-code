...
#ifndef _INGPMODELS_MERTON_MODEL_H
#define _INGPMODELS_MERTON_MODEL_H
...
class ARM_Merton_Model : public ARM_AnalyticIRModel
{
private:
	size_t itsIntegrationStep;

public:
	ARM_Merton_Model( const ARM_ZeroCurvePtr& zc, const ARM_Merton_ModelParams& params, size_t IntegrationStep = 30 );
	ARM_Merton_Model(const ARM_Merton_Model& rhs);
    ARM_Merton_Model& operator=(const ARM_Merton_Model& rhs);
	virtual ~ARM_Merton_Model();
