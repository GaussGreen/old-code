...
public:
	...
	void		calibre(double resetTime, double forward, double atmvol, ARM_GP_Vector * mktVols, ARM_GP_Vector * strikes,
...
private:
	...
	private:
		...
		ARM_GP_Vector *		itsMktVols;

	public:
		ObjectiveFunction(ARM_ShiftedSABR * shsabr, bool calibshift, bool calibrho, bool calibnu, double eps, ARM_GP_Vector * strikes, ARM_GP_Vector * mktvols)
		{
			_this			= shsabr;
...
protected:
	...
	void			getkthStrikesAndVols(int k, ARM_GP_Vector& strikes, ARM_GP_Vector& vols, double& atmvol);
};
...
inline int IdxFromValue(const ARM_GP_Vector& dateVector, double date, double tol)
{
