...
public:
    ...
    virtual ARM_GP_Vector* BetatT(double t,double T) const = 0;

    /// Drift from a to b of the state variable
    virtual ARM_GP_Vector* StateLocalDrift(double a,double b) const = 0;

	virtual ARM_GP_MatrixPtr StateLocalDriftVec( const ARM_GP_Vector& timeSteps ) const = 0;
    ...
    virtual double FwdZcLocalCovariance(double a,double b,double T1,double U1,double T2,double U2,ARM_GP_Vector& vars) const = 0;
	...
	static ARM_GP_Vector* BetatT(const ARM_ModelParam& mrsParam,const ARM_ModelParam& mrsSpreadParam,double t,double T);
...
{
private:
    ARM_GP_Vector* Variance(double a,double b,ARM_GP_Vector& scale) const;
...
public:
   ...
   /// Coefficient of the state variable (for Zc closed form formula)
    virtual ARM_GP_Vector* BetatT(double t,double T) const
    ...
    /// Drift from a to b of the state variable
    virtual ARM_GP_Vector* StateLocalDrift(double a,double b) const;

	virtual ARM_GP_MatrixPtr StateLocalDriftVec( const ARM_GP_Vector& timeSteps ) const;
    ...
    /// Covariance in [a,b] of Zc(.,T1)/Zc(.,U1) and Zc(.,T2)/Zc(.,U2)
    virtual double FwdZcLocalCovariance(double a,double b,double T1,double U1,double T2,double U2,ARM_GP_Vector& vars) const;
