...
public:
	...
	double	GetEquivalentVolCalib(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight, const ARM_GP_Vector& coeff) const;
	double	GetEquivalentVolModel(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight, const ARM_GP_Vector& coeff) const;
	double	GetEquivalentVol(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight, const ARM_GP_Vector& coeff, const ARM_MatrixVector& cov) const;
	double	GetEquivalentVol(double evalTime, double swapResetTime, size_t i, size_t j, const ARM_GP_Vector& weight, const ARM_GP_Vector& coeff, CalibProxy proxy) const;

	double	GetEquivalentCov(double evalTime, double swapResetTime, const ARM_GP_Vector& weight1, const ARM_GP_Vector& weight2, const ARM_GP_Vector& coeff, const ARM_MatrixVector& cov) const;
	double	GetEquivalentCov(double evalTime, double swapResetTime, const ARM_GP_Vector& weight1, const ARM_GP_Vector& weight2, const ARM_GP_Vector& coeff, CalibProxy proxy) const;
	...
	const ARM_GP_Vector*	GetGlobCovTimes() const {return itsGlobalCovTimes;};
...
private:
	...
	ARM_GP_Vector*				itsGlobalCovTimes;
	size_t						itsNbFwds;
	size_t						itsNbFactors;
	size_t						itsIndexFrom;
	size_t						itsIndexTo;
...
inline	size_t IndexOfLastLowerEqInVector(double x, const ARM_GP_Vector& v)
{
	size_t size = v.size();
...
inline	size_t IndexOfFirstHigherEqInVector_DefaultLast(double x, const ARM_GP_Vector& v)
{
	size_t size = v.size();
...
inline	size_t IndexOfFirstHigherInVector_DefaultLast(double x, const ARM_GP_Vector& v)
{
	size_t size = v.size();
...
inline	size_t IndexOfLastLowerEqInVector_DefaultFirst(double x, const ARM_GP_Vector& v)
{
	size_t size = v.size();
