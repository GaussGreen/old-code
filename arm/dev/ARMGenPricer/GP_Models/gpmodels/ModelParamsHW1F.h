...
// FIXMEFRED: mig.vc8 (22/05/2007 18:09:59):cast
	...
	static double HW1FStateCovarianceWithVec(
		...
		const ARM_GP_Vector& timesTimes2,
...
private:
    ...
    ARM_GP_Vector* VecBetatT(double t,double T) const;
    double IntegLambdaBeta(double a,double b,double T,ARM_GP_Vector& betatTs) const;
...
public:
    ...
    double SquaredIntegral(double a,double b,ARM_GP_Vector* times, 
                           ARM_GP_Vector* values) const;
