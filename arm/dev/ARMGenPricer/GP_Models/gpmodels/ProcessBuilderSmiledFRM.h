...
private:
	...
	size_t	NDaysIdxFromDate( const ARM_GP_Vector& dateVector, double date, double daysNb ) const;
	
	size_t	IdxFromDate( const ARM_GP_Vector& dateVector, double date ) const;
...
public:
	...
	const ARM_GP_Vector& GetDates() const	{ return itsDates;}
	...
	ARM_GP_Vector* RateAtResetDate (	size_t t,
										const ARM_PricingStatesPtr& states,
										size_t modelNb,
										size_t k ) const;

	ARM_GP_Vector* DxRateAtResetDate (	size_t t,
										const ARM_PricingStatesPtr& states,
										size_t modelNb,
										size_t k ) const;

	ARM_GP_Vector* RateBetweenResetDates (	double ratio, size_t a, size_t b,
											const ARM_PricingStatesPtr& states,
											size_t modelNb,
											size_t k ) const;

	ARM_GP_Vector* DxRateBetweenResetDates ( double ratio, size_t a, size_t b,
											 const ARM_PricingStatesPtr& states,
											 size_t modelNb,
											 size_t k ) const;
	...
	virtual	ARM_GP_VectorPtr DFRatioAtResetDate (	size_t t,
													const ARM_GP_Vector& states) const;
	...
	size_t GetIndex(double x, const ARM_GP_Vector& v) const;
