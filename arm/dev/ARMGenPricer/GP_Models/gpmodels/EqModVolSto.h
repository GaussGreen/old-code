...
protected:
	...
	static double				itsDilatation;

public:
	ARM_EQHWSV( ){ }
	ARM_EQHWSV( ARM_ZeroCurve*, const ARM_EQHWSV_ModelParams*, const ARM_EQHWSV_NumMethods*, const double & dilatation);
	...
	ARM_VectorPtr values(new ARM_GP_Vector(1.0));
	values->Elt(0)= zcT;
