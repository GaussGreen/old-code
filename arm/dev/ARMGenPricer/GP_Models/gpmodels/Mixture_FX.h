...
public:
	...
	const ARM_GP_Vector& GetLags() const { return itsLags; }
	const ARM_GP_Vector& GetVolATM() const { return itsVolATM; }
	const ARM_GP_Vector& GetDecVol() const { return itsDecVol; }
	const ARM_GP_Vector& GetShift() const { return itsShift; }
	const ARM_GP_Vector& GetLambda() const { return itsLambda; }
	const string& GetInterpolName() const { return itsInterpolName; }

private:
	ARM_GP_Vector itsLags;
	ARM_GP_Vector itsVolATM;
	ARM_GP_Vector itsDecVol;
	ARM_GP_Vector itsShift;
	ARM_GP_Vector itsLambda;
