...
{
    itsLowerBound	= rhs.itsLowerBound		? (ARM_GP_Vector*) rhs.itsLowerBound->Clone()	: NULL;
    itsUpperBound	= rhs.itsUpperBound		? (ARM_GP_Vector*) rhs.itsUpperBound->Clone()	: NULL;
    itsInitialCurve = rhs.itsInitialCurve	? (ARM_Curve*) rhs.itsInitialCurve->Clone()		: NULL;
	itsCurve		= rhs.itsCurve			? (ARM_Curve*) rhs.itsCurve ->Clone()			: NULL;
	itsName			= rhs.itsName;
