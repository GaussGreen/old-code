...
////////////////////////////////////////////////////
ARM_GP_Vector* ARM_PricingModel::PricingTimeSteps(const ARM_TimeInfoPtrVector& timeInfos)
{
...
////////////////////////////////////////////////////
void ARM_PricingModel::ModelStateLocalVariancesAndStdDev( const ARM_GP_Vector& timeSteps)
{
...
////////////////////////////////////////////////////
void ARM_PricingModel::NumMethodsDrifts( const ARM_GP_Vector& timeSteps)
{
...
///	Action  : computes the local variance and std dev 
////////////////////////////////////////////////////
void ARM_PricingModel::NumMethodStateLocalVariancesAndStdDev( const ARM_GP_Vector& timeSteps )
{
...
void ARM_PricingModel::NumMethodStateLocalGlobalVariances( const ARM_GP_Vector& timeSteps,
	ARM_MatrixVector& localVariances,
...
////////////////////////////////////////////////////
void ARM_PricingModel::EulerLocalDrifts(const ARM_GP_Vector& timeSteps,
...
///	Action  : Computes the relative and absolute Euler local drifts
////////////////////////////////////////////////////
void ARM_PricingModel::IntegratedLocalDrifts(const ARM_GP_Vector& timeSteps,
	ARM_GP_MatrixPtr& relativeDrifts,
	ARM_GP_MatrixPtr& absoluteDrifts) const
{
...
////////////////////////////////////////////////////
void ARM_PricingModel::VolatilitiesAndCorrelations( const ARM_GP_Vector& timeSteps, 
		...
		const ARM_PricingStatesPtr& states) const
{
    ...
    else
    {
        ...
        ARM_VectorPtr floatLegValues(new ARM_GP_Vector(nbStates,0.0));
...
ARM_VectorPtr ARM_PricingModel::DefaultNPVSwapWithComputedAnnuity(
		...
		int payRec,
		const ARM_GP_VectorPtr& floatAnnuity,
		const ARM_PricingStatesPtr& states) const
{
	/// Compute the fixed leg price
	int i, nbStates= states != ARM_PricingStatesPtr(NULL) ? states->size(): 1;
	ARM_GP_Vector* valuesNull = new ARM_GP_Vector(nbStates);
	ARM_VectorPtr values(valuesNull);

	//// Calculation of the Fixed Leg
    ARM_VectorPtr FixedLegvalues(new ARM_GP_Vector(nbStates,0.0));
