...
public:
	...
	ARM_GP_Vector* GetData( ARM_DataType type, long& rows, long& cols ) const;
...
public:
	...
	void UpdateMultiCurves( ARM_GP_Vector* breakPointTimes );
	virtual void SetFactorCount( size_t factorCount );
...
private:
	double itsTheta;
	ARM_GP_Vector* itsCorrelBreakPointTimes;
};
...
public:
    ...
    virtual void MergeModelParam( ARM_ModelParam* NewValue );
private:
	void ComputeMultiCurves( ARM_GP_Vector* values );
};
