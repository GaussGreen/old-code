...
public:
	...
	virtual ARM_GP_Vector* ComputeModelTimes( const ARM_TimeInfoPtrVector& timeInfos )=0;
	...
	void NumMethodsDrifts( const ARM_GP_Vector& timeSteps);
    ...
    virtual ARM_Currency* GetCurrency( const string& modelName  ) const { return GetZeroCurve()->GetCurrencyUnit(); }
	...
	virtual ARM_Date GetAsOfDate() const { return GetZeroCurve()->GetAsOfDate(); }
