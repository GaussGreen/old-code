...
public:
	...
	inline void SetPayoffs(const ARM_GP_Vector& payoffs) {itsPayoffs=payoffs;}
	inline const ARM_GP_Vector& GetPayoffs() { return itsPayoffs; }
    ...
    inline const ARM_VectorPtr& GetPayoffSnapshot(size_t idx) const {return itsPayoffSnapshots[idx];}
    inline void SetPayoffSnapshot(size_t idx,const ARM_VectorPtr& payoff) {itsPayoffSnapshots[idx]=payoff;}
    inline void push_backPayoffSnapshot(const ARM_VectorPtr& payoff) {itsPayoffSnapshots.push_back(payoff);}
...
// FIXMEFRED: mig.vc8 (22/05/2007 18:06:21):cast
	inline ARM_GP_VectorPtr GetProbaChangeVec(size_t probaChangeIdx) { return static_cast<ARM_GP_VectorPtr>(new ARM_GP_Vector(itsProbaChanges.GetRow(probaChangeIdx))); }
...
// FIXMEFRED: mig.vc8 (22/05/2007 18:06:18):cast
	inline ARM_VectorPtr GetPayoffVec(size_t payoffIdx) {return static_cast<ARM_VectorPtr>(new ARM_GP_Vector(itsPayoffs.GetRow(payoffIdx)));}
