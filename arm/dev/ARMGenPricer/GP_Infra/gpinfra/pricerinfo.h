...
private:
	...
	void ComputeBetas( ARM_PInfo_Map* pinfoMap, ARM_PInfo_MultipleLoop* pinfoMultiLoop, const ARM_GP_Vector& userBetas );
	void PostProcessCV( ARM_PInfo_Map* pinfoMap, ARM_PInfo_MultipleLoop* pinfoMultiLoop, const ARM_GP_Vector& userBetas );

public:
	ARM_PInfo_Cov( ARM_PInfo_Map* pinfoMap, const string& refPriceColumn, const ARM_StringVector& CVColumns, const ARM_GP_Vector& CVPrices, const ARM_GP_Vector& Betas );
