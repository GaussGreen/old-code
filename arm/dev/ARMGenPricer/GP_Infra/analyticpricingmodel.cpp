...
ARM_GP_Vector* ARM_AnalyticPricingModel::ComputeModelTimes( const ARM_TimeInfoPtrVector& timeInfos )
{   throw Exception(__LINE__, __FILE__, ERR_INVALID_ARGUMENT,
...
void ARM_AnalyticPricingModel::IntegratedLocalDrifts(const ARM_GP_Vector& timeSteps,ARM_GP_MatrixPtr& relativeDrifts,ARM_GP_MatrixPtr& absoluteDrifts) const
{   throw Exception(__LINE__, __FILE__, ERR_INVALID_ARGUMENT,
                    "IntegratedLocalDrifts : unimplemented function !"); }

void ARM_AnalyticPricingModel::ModelStateLocalVariances( const ARM_GP_Vector& timeSteps,ARM_MatrixVector& localVariances ) const
{   throw Exception(__LINE__, __FILE__, ERR_INVALID_ARGUMENT,
                    "LocalVariances : unimplemented function !"); }

void ARM_AnalyticPricingModel::NumMethodStateLocalVariances( const ARM_GP_Vector& timeSteps,ARM_MatrixVector& localVariances ) const
{   throw Exception(__LINE__, __FILE__, ERR_INVALID_ARGUMENT,
                    "LocalVariances : unimplemented function !"); }
