...
public:
	...
	void Init(const ARM_MarketData_ManagerRep& mktDataManager,
		...
		const std::vector<double>& calibDatas = std::vector<double>(0));
...
protected:
	...
	std::vector<double>   itsDomesticCpn;
	std::vector<double>   itsForeignCpn;
	std::vector<double>   itsMinCpn;
	std::vector<double>   itsMaxCpn;
	std::vector<double>   itsInitialFx;
	...
	std::vector<double>   itsvFundLeverage;
	std::vector<double>   itsvInitialFundSpread; /// to store the initial curve for hedging
	...
	std::vector<double>	itsvLeverage;
	std::vector<double>   itsvFixCpn;
	std::vector<double>	itsvLowStrikeCpn;
    std::vector<double>	itsvHighStrikeCpn;
	...
	std::vector<double>     itsFxResetTimeBefore;
