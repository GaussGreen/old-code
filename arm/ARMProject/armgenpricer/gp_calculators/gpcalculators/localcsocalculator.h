...
private:
	...
	std::vector<double>	itsvCpnFloor;
	std::vector<double>	itsvCpnCap;
	std::vector<double>	itsvCpnLeverageShort;
    std::vector<double>	itsvCpnLeverageLong;
	std::vector<double>	itsvCpnStrike;
	...
	std::vector<double>			itsCpnLongSensiForSwitch;
	std::vector<double>			itsCpnShortSensiForSwitch;
	std::vector<double>			itsCpnValueForSwitch;
};
