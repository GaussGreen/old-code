...
public:
	...
	void FilterCoupon(const std::vector<double>& coupon, const std::vector<double>& cpnIndex, double cpnMin, double cpnMax, std::vector<double>& filterCoupon, ARM_GP_Matrix& filterCpnIndex );
...
private:
	...
	std::vector<double>				itsSBRank2Pos;
	std::vector<double>				itsSBPos2Rank;
	std::vector<double>				itsExerRank2Pos;
	std::vector<double>				itsExerPos2Rank;

	/// Precomuted Vector
	std::deque<bool>			itsIsCpnFlow;
	std::vector<double>				itsResetDatesVec;
	std::vector<double>				itsStartDatesVec;
	std::vector<double>				itsEndDatesVec;
	std::vector<double>				itsPeriodsVec;
	std::vector<double>				itsPaymentDatesVec;
	std::vector<double>				itsConstVec;
	std::vector<double>				itsLevPrevVec;
	std::vector<double>				itsLevNewVec;
	ARM_GP_Matrix				itsSumOptionCoeffs;
	std::vector<double>				itsStrikeOptVec;
	std::vector<double>				itsCpnMinVec;
	std::vector<double>				itsCpnMaxVec;
	std::vector<double>				itsStrikeSum;
	std::vector<double>				itsFeesVec;
	std::vector<double>				itsvCpnNominal;

	std::vector<double>				itsvInitialFundNominal;
	...
	std::vector<double>				itsFixBetaTimes;
	std::vector<double>				itsFixBetaValues;
	...
	inline virtual std::vector<double> GetvCpnNominal() const				{ return  itsvCpnNominal;				};
	inline virtual std::vector<double> GetvFundNominal() const			{ return  itsvInitialFundNominal;		};
	...
	inline virtual ARM_ZeroCurve* GetDomesticDiscountZeroCurve() const  { return NULL;}//dynamic_cast<ARM_ZeroCurve*>(GetMktDataManager()->GetData(GetKeys()[YcBasisDomKey]));    };
	inline virtual ARM_ZeroCurve* GetForeignDiscountZeroCurve()	const	{ return NULL;}//dynamic_cast<ARM_ZeroCurve*>(GetMktDataManager()->GetData(GetKeys()[YcBasisFundKey]));     };
