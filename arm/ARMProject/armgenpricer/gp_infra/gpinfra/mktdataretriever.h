...
private:
	...
	std::vector<double>* ConvertVectorFromMatuOrDateToYearFrac( const vector<string>& vecData, 
		const ARM_Date& asOfDate,
		const string& ccy ) const;

	std::vector<double>* ConvertVectorFromMatuOrDateWRefDateToYearFrac( const vector<string>& vecData, 
		const ARM_Date& asOfDate,
