...
public:
	...
	inline void Increment( size_t& nodeIdx, std::vector<double>::iterator& fromTime, std::vector<double>::iterator& toTime ) const { nodeIdx+=itsIncrement; fromTime+=itsIncrement; toTime+=itsIncrement; }

	/// GetTimeInfos and toTime vector
	inline ARM_VectorPtr GetFromTimes() const { return itsFromTimes; }
	std::vector<double>::iterator GetFirstFromTime() const { return itsFirstFromTime; }
	std::vector<double>::iterator GetLastFromTime() const { return itsLastFromTime; }
	inline ARM_VectorPtr GetToTimes() const { return itsToTimes; }
	std::vector<double>::iterator GetFirstToTime() const { return itsFirstToTime; }
	std::vector<double>::iterator GetLastToTime() const { return itsLastToTime; }
...
private:	
	...
	std::vector<double>::iterator itsFirstFromTime;
	std::vector<double>::iterator itsLastFromTime;
	ARM_VectorPtr itsToTimes;
	std::vector<double>::iterator itsFirstToTime;
	std::vector<double>::iterator itsLastToTime;
