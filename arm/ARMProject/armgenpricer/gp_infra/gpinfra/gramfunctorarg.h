...
struct ARM_GramFctorArg
{
	...
	void SetVector( const ARM_VectorPtr& v )							{ itsVector=ARM_GP_VectorPtr(new ARM_GP_Vector(*v));  itsType=GFAT_VECTOR_TYPE;			}
	void SetVector( const ARM_GP_VectorPtr& v )							{ itsVector=v;          itsType=GFAT_VECTOR_TYPE;			}
	...
	inline ARM_GP_VectorPtr GetVector() const							{ CheckType(GFAT_VECTOR_TYPE);			return itsVector;		}
	inline ARM_GP_VectorPtr GetVector()									{ CheckType(GFAT_VECTOR_TYPE);			return itsVector;		}
	...
	ARM_GramFctorArg( const ARM_GP_VectorPtr& v );
