...
public:
    ...
    virtual ARM_GP_MatrixPtr GetSpotProbabilities(const std::vector<double>& eventTimes) const = 0;
	...
	virtual void ProcessPaidPayoffs(ARM_GP_VectorPtr& payoffs, double evalTime) const{};
	virtual void ProcessUnPaidPayoffs(ARM_GP_VectorPtr& payoffs, double evalTime) const{};
};
