    ...
    ARM_PricingContext* context) const
{
	...
	std::vector<double> strikePerState( stateSize, strike);
        ...
        ARM_PricingContext* context) const
{
	...
	std::vector<double> strikes(nbStates);

    ARM_VectorPtr callStripValues(new std::vector<double>(nbStates,0.0));
		...
		ARM_PricingContext* context) const
{
	...
	std::vector<double> strikesPerState(nbStates,strike);
...
///	Returns: ARM_VectorPtr
///	Action : Default wrapper function to scalar times
////////////////////////////////////////////////////
ARM_VectorPtr ARM_PricingFunctionEquity::CallVectorial(
		const string& modelName,
        double evalTime,
	    const std::vector<double>& expiryTime,
	    const std::vector<double>& settlementTime,
...
////////////////////////////////////////////////////
///	Class  : ARM_PricingFunctionEquity
///	Routine: GreekVectorial
///	Returns: ARM_VectorPtr
///	Action : greeks
////////////////////////////////////////////////////
ARM_VectorPtr ARM_PricingFunctionEquity::GreekVectorial(
		const string& modelName,
        double evalTime,
	    const std::vector<double>& expiryTime,
	    const std::vector<double>& settlementTime,
        ...
        ARM_PricingContext* context) const
{
	ARM_THROW( ERR_INVALID_ARGUMENT, ": unimplemented method GreekVectorial(...)" ); 
}
