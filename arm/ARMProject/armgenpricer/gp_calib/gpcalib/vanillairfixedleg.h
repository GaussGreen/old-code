...
#ifndef _INGPCALIB_VANILLAIRFIXEDLEG_H
#define _INGPCALIB_VANILLAIRFIXEDLEG_H
...
///////////////////////////////////////////////////////////////
struct ARM_VanillaIRFixedLegArg:public ARM_VanillaArg
{
    ARM_VanillaIRFixedLegArg(
	...
	{}		
    ARM_VanillaIRFixedLegArg(const ARM_VanillaIRFixedLegArg& arg);
    ARM_VanillaIRFixedLegArg& operator=(const ARM_VanillaIRFixedLegArg& rhs);
    virtual ~ARM_VanillaIRFixedLegArg();
    virtual double Price(ARM_PricingModel* model) const;
    virtual double ImpliedVol(ARM_PricingModel* model) const;
	virtual VanillaArgType GetType() const { return ARM_VanillaArg::VANILLA_IRFIXEDLEG; }
...
private:
    ...
    ///Get fixed frequency
    int itsFixFrequency;
    void CopyNoCleanUp(const ARM_VanillaIRFixedLegArg& rhs);
	void CleanUp();
};
