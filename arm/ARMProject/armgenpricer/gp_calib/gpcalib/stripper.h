...
public:
	...
	double swapRate (double startFloatTime,double endFloatTime, const std::vector<double>& FixPayTimes, const std::vector<double>& FixPayPeriods) const;
	double stdFundingLeg  (const std::vector<double>& startFlowTimes, const std::vector<double>& endFlowTimes,  
							const std::vector<double>& periods, const std::vector<double>& Notional, 
							const std::vector<double>& Margin, std::vector<double>& LiborLeverage = std::vector<double>(0))  const;
	inline double asOf() const {return itsAsofDate;};
