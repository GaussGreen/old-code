...
public:
	...
	void Compute(vector<ARM_Security*> securities, vector<ARM_Model*> models, const std::vector<double>& weights);
	...
	bool FillNotionals(ARM_Vector& fixAbs,ARM_Vector& fixNotios,const std::vector<double>& endDates,const std::vector<double>& payDates,double& fixNotional);
