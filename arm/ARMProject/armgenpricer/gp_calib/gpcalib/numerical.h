...
private:
	...
	ARM_GP_VectorPtr			itsResetDates;
	int						itsCurIndex;
...
public:
	...
	const std::vector<double>& getCalibSecInterestTerms(size_t resetIndex)	  const;// {return itsCalibSecDensities[resetIndex]->getInterestTerms();}
