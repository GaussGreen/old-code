...
private:
	std::vector<double>	itsMoney;
	std::vector<double>	itsStrike;
	std::vector<double>	itsVol;
	MoneyType		itsType;
	std::vector<double>	itsExtraStrikes;
public:
    ARM_SmileViewer(const std::vector<double>& money,MoneyType type = GAUSS,const std::vector<double>& strikes=std::vector<double>());
	...
	inline const std::vector<double>&	GetMoney()		{ return itsMoney;};
	inline const std::vector<double>&	GetStrike()		{ return itsStrike;};
	inline const std::vector<double>&	GetVol()		{ return itsVol;};
...
{
private: 
	std::vector<double>				itsVar;
	std::vector<double>				itsMoney;
	std::vector<double>				itsDer2;
	size_t						itsSize;
	ARM_SmileViewer::MoneyType  itsType;
public: 
	/// constructor/destructor
	ARM_SplineDensityFunctor( const std::vector<double>& money, const std::vector<double>& vol, ARM_SmileViewer::MoneyType type);
	...
	static double Proba(double strike, double fwd, const std::vector<double>& money, const std::vector<double>& var, const std::vector<double>& der2,size_t type);
	static double ComputeVol(double strike, double fwd, const std::vector<double>& money, const std::vector<double>& var, const std::vector<double>& der2,size_t type);
	static double ComputeVol(double eps, const std::vector<double>& money, const std::vector<double>& var, const std::vector<double>& der2);
	static double ComputeDVol(double strike, double fwd, const std::vector<double>& money, const std::vector<double>& var, const std::vector<double>& der2,size_t type);
	static double ComputeDVol(double eps, const std::vector<double>& money, const std::vector<double>& var, const std::vector<double>& der2);
