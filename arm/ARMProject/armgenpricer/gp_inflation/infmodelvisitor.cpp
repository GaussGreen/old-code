...
void ARM_InfModelVisitor::Visit(ARM_InfNumBiLog & payOff){
		ARM_InfNumBiLogValue* tmp = new ARM_InfNumBiLogValue(payOff);
		itsInfModelValue	= ARM_InfModelValuePtr ( tmp );		
}

void ARM_InfModelVisitor::Visit(ARM_InfBiLog & payOff){
		ARM_InfBiLogValue* tmp = new ARM_InfBiLogValue(payOff);
		itsInfModelValue	= ARM_InfModelValuePtr ( tmp );		
}


void ARM_InfModelVisitor::Visit(ARM_InfHK & payOff){
		ARM_InfHKValue* tmp = new ARM_InfHKValue(payOff);
		itsInfModelValue	= ARM_InfModelValuePtr ( tmp );		
} 

void ARM_InfModelVisitor::Visit(ARM_InfNoModel & payOff){
