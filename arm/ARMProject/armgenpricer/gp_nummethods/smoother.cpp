...
////////////////////////////////////////////////////
double ARM_SmootherLinear::Compute(const std::vector<double>& exerFct, int exerIdx, double coef, std::vector<double>& smooth) const
{
...
///          exerFct[exerIdx] and exerFct[exerIdx+1]
////////////////////////////////////////////////////
double ARM_SmootherQuadratic::Compute(const std::vector<double>& exerFct, int exerIdx, double coef, std::vector<double>& smooth) const
{
...
///          exerFct[exerIdx] and exerFct[exerIdx+1]
////////////////////////////////////////////////////
double ARM_SmootherCubic::Compute(const std::vector<double>& exerFct, int exerIdx, double coef, std::vector<double>& smooth) const
{
