...
struct ARM_SmootherBase : public ARM_RootObject
{
    ...
    virtual double Compute(const std::vector<double>& exerFct, int exerIdx, double coef, std::vector<double>& smooth) const = 0;
};

struct ARM_SmootherDoNothing : public ARM_SmootherBase
{
    virtual double Compute(const std::vector<double>& exerFct, int exerIdx, double coef, std::vector<double>& smooth) const { return 0.5; }
...
{
    virtual double Compute(const std::vector<double>& exerFct, int exerIdx, double coef, std::vector<double>& smooth) const;
