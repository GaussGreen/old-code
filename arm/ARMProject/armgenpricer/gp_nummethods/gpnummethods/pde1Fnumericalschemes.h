...
public:
	...
	void UpdateVectorWithMatrixByInverse( const ARM_GP_VectorPtr& DiagTerm, const ARM_GP_VectorPtr& UpperTerm, const ARM_GP_VectorPtr& LowerTerm, std::vector<double>& Vector );
