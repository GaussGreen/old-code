...
void ARM_Berm2DatesProxy::price()
{
	...
	std::vector<double> x1(itsNbSimul), x2(itsNbSimul), z(itsNbSimul);
	...
	std::vector<double> tx1(itsNbSimul), tx2(itsNbSimul);
...
void ARM_Berm2DatesProxy::sabrFwdRate(std::vector<double>* fwdrate, const std::vector<double>* u, double fwd, double t, 
