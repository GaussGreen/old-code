...
/*
void cubicspline_precompute(const std::vector<double> *x, const std::vector<double> *y, const double yp1, const double ypn,
...
double cubicspline_interpolate(const std::vector<double> &xa, const std::vector<double> &ya,const std::vector<double> &y2a, const double x)
{
	int k;
	double h,b,a;
...
double cubicspline_inter(const std::vector<double>& xa, const std::vector<double>& ya, const std::vector<double>& y2a, double x)
{
	int n = xa.size();
...
double cubicspline_interder(const std::vector<double>& xa, const std::vector<double>& ya, const std::vector<double>& y2a, double x)
{
	int n = xa.size();
