...
SABR_ParameterSet*  SABR_CalibrateToSmile_withstrikecuter(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,
									      ...
									      int nbsteps,int algorithm,double alpha0,double rho0,double nu0)
{
	...
	public:
		...
		objectiveFuntion(std::vector<double>* strike_list0,double f0,double beta0,double tex0,int flag0,
