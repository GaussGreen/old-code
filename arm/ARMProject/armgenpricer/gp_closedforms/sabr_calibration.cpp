...
SABR_ParameterSet* SABR_CalibrateToSmile(std::vector<double>* K_Vec,
	  std::vector<double>* ImpVol_Vec,std::vector<double>* Weigth_Vec,
	  double f,
	  double tex,
	  int flag,
	  int nbsteps, 
	  ...
	  double nu0)
{
	...
	public:
		...
		objectiveFuntion(std::vector<double>* strike_list0,
			double f0,
			double tex0,
			int flag0,
			int nbsteps0)
...
SABR_ParameterSet*  SABR_CalibrateToSmile(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,
										  std::vector<double>* Weigth_Vec,
												...
												double alpha0,double rho0,double nu0)
{
	...
	public:
		...
		objectiveFuntion(std::vector<double>* strike_list0,double f0,double beta0,double tex0,int flag0,int nbsteps0):
...
SABR_ParameterSet*  SABR_CalibrateToSmile(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,std::vector<double>* Weigth_Vec,
										  double f,double beta,double tex,int flag,int nbsteps,int algorithm,
												...
												double rweight_alpha1,double rweight_rho1,double rweight_nu1)
{
	...
	std::vector<double>* strikelist= new std::vector<double>(m+n);
	std::vector<double>* pricelist= new std::vector<double>(m+n);
	std::vector<double>* weightlist= new std::vector<double>(m+n);
	std::vector<double>* initialparamlist= new std::vector<double>(n);
	std::vector<double>* lowerboundaryparamlist= new std::vector<double>(n);
	std::vector<double>* upperboundaryparamlist= new std::vector<double>(n);
	for(i=0;i<m;i++)
...
SABR_ParameterSet * SABR_CalibrateToSmileBetaFixedToOne(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,
														std::vector<double>* Weight_Vec,double f,double t,double atmvol)
{
	...
	public:
		...
		ARM_SABR_CalibrationBetaOne(std::vector<double> * K_Vec, std::vector<double> * ImpVol_Vec,
					std::vector<double> * Weight_Vec, double fwd, double ttm, double atm)
		{
			KVec		= K_Vec;
	...
	std::vector<double> x(2 + (func.calibATM() == false));
	x[0] = -0.2;
	x[1] = 0.3;
	if(func.calibATM() == false) x[2] = 0.15;
	std::vector<double> fx(K_Vec->size(), 0.);
