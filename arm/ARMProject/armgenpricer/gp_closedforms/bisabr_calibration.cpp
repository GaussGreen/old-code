						...
						double converg_prec, int nbIter_max, double first_step_max,int flag)
{
	...
	std::vector<double>* F1list= new std::vector<double>(m);
	std::vector<double>* Alpha1list= new std::vector<double>(m);
	std::vector<double>* Beta1list= new std::vector<double>(m);
	std::vector<double>* Rho1list= new std::vector<double>(m);
	std::vector<double>* Nu1list= new std::vector<double>(m);
	std::vector<double>* F2list= new std::vector<double>(m);
	std::vector<double>* Alpha2list= new std::vector<double>(m);
	std::vector<double>* Beta2list= new std::vector<double>(m);
	std::vector<double>* Rho2list= new std::vector<double>(m);
	std::vector<double>* Nu2list= new std::vector<double>(m);
	std::vector<double>* Klist= new std::vector<double>(m);
	std::vector<double>* Tlist= new std::vector<double>(m);
	...
	std::vector<double>* constraintlowerboundaryparamlist= new std::vector<double>(4*m);
	std::vector<double>* constraintupperboundaryparamlist= new std::vector<double>(4*m);
	for(i=0;i<m;i++)
	{
		(*F1list)[i]=(*F1_Vec)[i];
	...
	{
	private:
		std::vector<double>* F1_list;
		std::vector<double>* Alpha1_list;
		std::vector<double>* Beta1_list;
		std::vector<double>* Rho1_list;
		std::vector<double>* Nu1_list;
		std::vector<double>* F2_list;
		std::vector<double>* Alpha2_list;
		std::vector<double>* Beta2_list;
		std::vector<double>* Rho2_list;
		std::vector<double>* Nu2_list;
	...
	public:
		...
		objectiveFuntion(
			std::vector<double>* F1_list0,std::vector<double>* Alpha1_list0,std::vector<double>* Beta1_list0,std::vector<double>* Rho1_list0,std::vector<double>* Nu1_list0,
			std::vector<double>* F2_list0,std::vector<double>* Alpha2_list0,std::vector<double>* Beta2_list0,std::vector<double>* Rho2_list0,std::vector<double>* Nu2_list0,
			std::vector<double>* K_list0,std::vector<double>* T_list0,int flag0):
...
// FIXMEFRED: mig.vc8 (22/05/2007 18:26:22):floor (Integer/Integer) doesnt mean anything
		...
		constraintFuntion(
			std::vector<double>* Rho1_list0,std::vector<double>* Rho2_list0):
						...
						double converg_prec, int nbIter_max, double first_step_max,int flag)
{
	...
	public:
		...
		objectiveFuntion(
			std::vector<double>* F1_list0,std::vector<double>* Alpha1_list0,std::vector<double>* Beta1_list0,std::vector<double>* Rho1_list0,std::vector<double>* Nu1_list0,
			std::vector<double>* F2_list0,std::vector<double>* Alpha2_list0,std::vector<double>* Beta2_list0,std::vector<double>* Rho2_list0,std::vector<double>* Nu2_list0,
			double rhos0,std::vector<double>* K_list0,std::vector<double>* T_list0,int flag0):
		F1_list(F1_list0),Alpha1_list(Alpha1_list0),Beta1_list(Beta1_list0),Rho1_list(Rho1_list0),Nu1_list(Nu1_list0),
		F2_list(F2_list0),Alpha2_list(Alpha2_list0),Beta2_list(Beta2_list0),Rho2_list(Rho2_list0),Nu2_list(Nu2_list0),
...
// FIXMEFRED: mig.vc8 (22/05/2007 18:45:57):floor(int/int)
		...
		constraintFuntion(
			std::vector<double>* Rho1_list0,std::vector<double>* Rho2_list0,double rhos0):
