...
double Export_GLambda_CompleteSpreadoption(
		std::vector<double>* l1a_Vec,
		std::vector<double>* l2a_Vec,
		std::vector<double>* l3a_Vec,
		std::vector<double>* l4a_Vec,
		std::vector<double>* l5a_Vec,
		std::vector<double>* l6a_Vec,
		std::vector<double>* l1b_Vec,
		std::vector<double>* l2b_Vec,
		std::vector<double>* l3b_Vec,
		std::vector<double>* l4b_Vec,
		std::vector<double>* l5b_Vec,
		std::vector<double>* l6b_Vec,
