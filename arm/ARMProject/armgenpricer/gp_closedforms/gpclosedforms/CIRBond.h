...
struct ARM_InvLaplace{
	...
	ARM_InvLaplace( const std::vector<double>	& schedule, 
...
public:
	...
	std::vector<double>	GenerateSchedule		(	const double & time) const;
	...
	static Complex	CptLaplace_Bond	(	const	std::vector<double>	& schedule,	
										const	mapParamType	& mapParam,
										const	Complex			& x0,
										const	Complex			& phi);
	
	static double	CptDensity_Bond	(	const	std::vector<double>	& schedule,	
										const	mapParamType	& mapParam,
										const	double			& x0,
										const	double			& x);
...
private:
	...
	static Complex	CptGlobal		(	const	std::vector<double>	& schedule,	
										const	mapParamType	& mapParam,
										const	Complex			& x0,
										const	Complex			& phi,
										const	Complex			& psi,
