...
SABR_ParameterSet*  SABR_CalibrateToSmile(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,std::vector<double>* Weigth_Vec,double f,double t,int flag,int nbsteps,int algorithm,
												double alpha0,double beta0,double rho0,double nu0);
SABR_ParameterSet*  SABR_CalibrateToSmile(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,std::vector<double>* Weigth_Vec,double t,int flag,int nbsteps,int algorithm,
												double alpha0,double beta0,double rho0,double nu0,double f0);
SABR_ParameterSet*  SABR_CalibrateToSmile(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,std::vector<double>* Weigth_Vec,double f,double beta,double t,int flag,int nbsteps,int algorithm,
...
SABR_ParameterSet*	SABR_CalibrateToSmileBetaFixedToOne(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,std::vector<double>* Weight_Vec,double f,double t,double atmvol);
