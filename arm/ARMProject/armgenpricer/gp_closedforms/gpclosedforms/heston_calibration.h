...
GeneralizedHeston_ParameterSet*  GeneralizedHeston_CalibrateToSmile(std::vector<double>* K_Vec,std::vector<double>* ImpVol_Vec,double F, double t,int nb,int algorithm,
