...
double Export_NonParametric_Distribution(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
							double index_begin,double index_end,
							int beginflag,int endflag, double S,double T, double strike);


double Export_NonParametric_Quantile(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
							double index_begin,double index_end,
							int beginflag,int endflag,double S,double T, double proba);


double Export_NonParametric_LogVolatility(std::vector<double>* x,std::vector<double>* y,
							double index_begin,double index_end,
							int beginflag,int endflag, double strike);


double Export_NonParametric_NormalVolatility(std::vector<double>* x,std::vector<double>* y,
							double index_begin,double index_end,
							int beginflag,int endflag, double strike);


double Export_NonParametric_N_Distribution(std::vector<double>* x,std::vector<double>* y,
							double index_begin,double index_end,
							int beginflag,int endflag, double S,double T, double strike);

double Export_NonParametric_LN_Distribution(std::vector<double>* x,std::vector<double>* y,
							double index_begin,double index_end,
							int beginflag,int endflag, double S,double T, double strike);

double Export_NonParametric_N_Quantile(std::vector<double>* x,std::vector<double>* y,
							double index_begin,double index_end,
							int beginflag,int endflag,double S,double T, double proba);

double Export_NonParametric_LN_Quantile(std::vector<double>* x,std::vector<double>* y,
							double index_begin,double index_end,
							int beginflag,int endflag,double S,double T, double proba);
