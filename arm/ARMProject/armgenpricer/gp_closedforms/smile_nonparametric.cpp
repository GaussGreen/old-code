...
double NonParametric_LogSmile::call_option(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
...
double NonParametric_LogSmile::digital_call_option(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
						   double index_begin,double index_end,int beginflag,int endflag,double S,double T,double strike)
{
...
double NonParametric_LogSmile::inverse_distribution(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
...
double NonParametric_LogSmile::gaussian_to_distribution(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
...
double NonParametric_NormalSmile::call_option(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
		double index_begin,double index_end,int beginflag,int endflag,double S,double T,double strike)
{
	return BlackSholes_Formula(S,
...
double NonParametric_NormalSmile::digital_call_option(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
						   double index_begin,double index_end,int beginflag,int endflag,double S,double T,double strike)
{
...
double NonParametric_NormalSmile::inverse_distribution(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
							double index_begin,double index_end,
							int beginflag,int endflag,double S,double T, double proba)
{
...
double NonParametric_NormalSmile::gaussian_to_distribution(std::vector<double>* x,std::vector<double>* y,std::vector<double>* y2,
								double index_begin,double index_end,int beginflag,int endflag,double S,double T,double k)
{
...
{
	int i;
std::vector<double>*  Vp0=new std::vector<double>((Underlying->V(0))->size());
for(i=0;i<(Underlying->V(0))->size()-1;i++) (*Vp0)[i]=(*(Underlying->V(0)))[i];

std::vector<double>*  Vp1=new std::vector<double>((Underlying->V(1))->size());
for(i=0;i<(Underlying->V(1))->size()-1;i++) (*Vp1)[i]=(*(Underlying->V(1)))[i]*positivenumber;

std::vector<double>*  Vp2=new std::vector<double>((Underlying->V(2))->size());
