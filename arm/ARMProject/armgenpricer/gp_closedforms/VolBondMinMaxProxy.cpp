...
void ARM_VBMinMaxProxy::price()
{
	...
	std::vector<double> z1(itsNbSimul), z2(itsNbSimul);
	std::vector<double> u(itsNbSimul);

	std::vector<double> smaxfwd(itsNbSimul), sminfwd(itsNbSimul), svol(itsNbSimul), emax(itsNbSimul), emin(itsNbSimul);
	std::vector<double> sfwd(itsNbSimul), efwd(itsNbSimul);
...
void ARM_VBMinMaxProxy::sabrFwdRate(std::vector<double>* fwdrate, const std::vector<double>* u, double fwd, double t, 
