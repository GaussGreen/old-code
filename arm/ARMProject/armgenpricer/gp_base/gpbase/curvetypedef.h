...
/// multi curves
typedef ARM_T_Curve<double, std::vector<double> >							ARM_MultiCurve;
typedef ARM_Interpolator<double, std::vector<double> >						ARM_MultiCurveInterpolator;
typedef ARM_LinearInterpolatorCstExtrapol<double, std::vector<double> >		ARM_LinInterpCstExtrapolVec;
typedef ARM_StepUpRightOpenCstExtrapol<double, std::vector<double> >		ARM_StepUpRightOpenCstExtrapolVec;
typedef ARM_StepUpLeftOpenCstExtrapol<double, std::vector<double> >			ARM_StepUpLeftOpenCstExtrapolVec;
