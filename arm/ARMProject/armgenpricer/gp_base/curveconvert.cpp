...
//{
//	ARM_Vector* dates =  To_pARM_Vector(const_cast<std::vector<double>*>(&(curve.GetAbscisses())));
//	ARM_Vector* values = To_pARM_Vector(const_cast<std::vector<double>*>(&(curve.GetOrdinates())));
//
//	(*dates) += asOfDate;
//	(*values) *= base;
//
...
//	}
//	else
//		gpDates = std::vector<double>(1,0.0);
//	std::vector<double> gpValues = To_ARM_GP_Vector(refVal.GetDiscreteValues());
//
//	gpValues /= base;
//
