...
/// gpclosedforms
#include "gpclosedforms/shifted_lognormal_interface.h"
...
///	Routine: Constructor
///	Returns: 
///	Action : builds the ARM_SLN_Model
////////////////////////////////////////////////////

ARM_SLN_Model::ARM_SLN_Model(const ARM_ZeroCurvePtr& zc, const ARM_SLN_ModelParams& params)
...
ARM_SLN_Model::ARM_SLN_Model(const ARM_SLN_Model& rhs)
...
////////////////////////////////////////////////////
ARM_SLN_Model& ARM_SLN_Model::operator=(const ARM_SLN_Model& rhs)
{
	if( this != &rhs )
	{
...
////////////////////////////////////////////////////
ARM_VectorPtr ARM_SLN_Model::VanillaCaplet(
	...
	const ARM_PricingStatesPtr& states) const
{
	...
	double alpha			= GetModelParams()->GetModelParam(ARM_ModelParamType::Shift).GetValue(time,tenor);

	double optionValue = payNotional * period * (*DF)[0] * Export_shifted_lognormal_VanillaOption(
		(*liborRate)[0],strikesPerState[0],volatility,time/K_YEAR_LEN,alpha ,capFloor);
...
ARM_VectorPtr ARM_SLN_Model::VanillaSwaption(
	const string& curveName,
	double evalTime,
	...
	bool isConstantStrike) const
{
	...
	double optionValue = swapNotional * (*annuity)[0] * Export_shifted_lognormal_VanillaOption(
		(*swapRate)[0],strikesPerState(0,0),volatility,time/K_YEAR_LEN,alpha, callPut);
...
////////////////////////////////////////////////////
ARM_Object* ARM_SLN_Model::Clone() const
{
	return new ARM_SLN_Model(*this);
}
...
///	Action  : Object dump
////////////////////////////////////////////////////
string ARM_SLN_Model::toString(const string& indent,const string& nextIndent) const
{
    CC_Ostringstream os;
    os << "\n\n";
    os << indent << "Shifted Lognormal Model \n";
    os << indent << "---------------------\n";
...
////////////////////////////////////////////////////
bool ARM_SLN_Model::ValidateModelParams(const ARM_ModelParams& params) const
{
	const ARM_SLN_ModelParams* SLN_ModelParams = dynamic_cast<const ARM_SLN_ModelParams*>(&params);
	if( !SLN_ModelParams )
		ARM_THROW( ERR_INVALID_ARGUMENT, "modelparams is not of type ARM_SLN_ModelParams" );
	return true;
}
