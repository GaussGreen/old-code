...
public:
	...
	ARM_GP_VectorPtr DiscountFactorInterpolate( double ResetTime, double EndTime, const std::vector<double>& states, bool dividedByTerminalDf = true ) const;
	...
	//inline double LevelOnLastDfInterpolateFromStates( const ARM_PricingStatesPtr& states, double state, size_t startSearchIdx, size_t firstEndIdx, size_t nbPeriods, const std::vector<double>& interestTerms) const;
	inline double LevelOnLastDfInterpolateFromStates( const ARM_PricingStatesPtr& states, double state, size_t startSearchIdx, size_t firstEndIdx, const ARM_IntVector& relIdx, const std::vector<double>& interestTerms) const;
	/// Accessors
...
///	Action : 
////////////////////////////////////////////////////
double ARM_DiscountFactorMap::LevelOnLastDfInterpolateFromStates( const ARM_PricingStatesPtr& states, double state, size_t startSearchIdx, size_t firstEndIdx, const ARM_IntVector& relIdx, const std::vector<double>& interestTerms) const
{
	ARM_GP_MatrixPtr NumMethodStates = states->GetNumMethodStates();
