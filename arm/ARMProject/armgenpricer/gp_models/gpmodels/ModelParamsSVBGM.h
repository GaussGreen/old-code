...
public:
	...
	void				UpdateParamValues(std::vector<double> * times, std::vector<double> * shift, std::vector<double> * alpha, std::vector<double> * rho, std::vector<double> * nu);
...
inline void ARM_ModelParamsSVBGM::UpdateParamValues(std::vector<double> * times,
													std::vector<double> * shift, std::vector<double> * alpha, std::vector<double> * rho, std::vector<double> * nu)
{
