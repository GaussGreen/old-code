...
private:
	...
	mutable std::vector<double> itsVnsFloatNotionals;
	mutable std::vector<double> itsVnsStrikes;
	mutable std::vector<double> itsVnsForwards;
	mutable std::vector<double> itsVnsAtmNormVols;
	mutable std::vector<double> itsVnsNormVols;
	mutable std::vector<double> itsVnsBasketCoefs;
...
public:
	...
	const std::vector<double>& GetBasketCoefs() const {return itsVnsBasketCoefs;}
