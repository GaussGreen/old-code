...
public:
	ccalib(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv)
	...
	virtual void initOptim(std::vector<double>& fguess){};
...
{
public:
	ccalib3eq(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv)
		:ccalib(a,b,c,d,sv){};
	virtual ~ccalib3eq(){};
	virtual void solve();
...
protected:
	...
	int m_j;
public:
	ccalib2eq(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i, int j)
...
private:
	double m_sigma;
public:
	ccalib2eqVol(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i, int j,double sigma)
...
private:
	double m_rho;
public:
	ccalib2eqRho(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i, int j,double rho)
...
private:
	double m_scale;
public:
	ccalib2eqRatio(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i, int j,double scale)
...
protected:
	int m_i;
public:
	ccalib1eq(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i)
...
{
public:
	ccalib1eqRatio(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i)
...
{
public:
	ccalib1eqRho(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i)
		: ccalib1eq(a,b,c,d,sv,i){};
...
{
public:
	ccalib1eqVol(const std::vector<double>& a, const std::vector<double>& b, const std::vector<double>& c, const std::vector<double>& d, std::vector<double>& sv, int i)
		: ccalib1eq(a,b,c,d,sv,i){};
