...
void ARM_HWSVBGMQtoModel::NumMethodStateLocalVariances(const std::vector<double>& timeSteps, ARM_MatrixVector& localVariances) const
{
...
void ARM_HWSVBGMQtoModel::NumMethodStateGlobalVariances(const std::vector<double>& timeSteps, ARM_MatrixVector& globalVariances) const
{
...
void ARM_HWSVBGMQtoModel::ModelStateLocalVariancesAndStdDev(const std::vector<double>& timeSteps)
{
	...
	DuplicateCloneablePointorVectorInPlace<std::vector<double>>(itsSVMMModel->GetEigenValues(), itsEigenValues);
}

void ARM_HWSVBGMQtoModel::NumMethodStateLocalVariancesAndStdDev( const std::vector<double>& timeSteps )
{
...
void ARM_HWSVBGMQtoModel::ModelStateLocalVariances(const std::vector<double>& timeSteps, ARM_MatrixVector& localVariances) const
{
	int totalFwds		= itsNbEffectiveReset;
	int timeStepsSize	= timeSteps.size();
