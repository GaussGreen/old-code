...
/*! \file SABR_SurfaceModelParams.cpp
 *
...
#include "gpmodels/SABR_SurfaceModelParams.h"
...
////////////////////////////////////////////////////
ARM_SABR_SurfaceModelParams::ARM_SABR_SurfaceModelParams( const ARM_ModelParamVector& params )
...
///	Action  : 
////////////////////////////////////////////////////
void ARM_SABR_SurfaceModelParams::ValidateModelParams() const
{	
...
///	Action : Constructor
////////////////////////////////////////////////////
ARM_SABR_SurfaceModelParams::ARM_SABR_SurfaceModelParams( const ARM_SABR_SurfaceModelParams& rhs )
...
////////////////////////////////////////////////////
ARM_Object* ARM_SABR_SurfaceModelParams::Clone() const
{
	return new ARM_SABR_SurfaceModelParams(*this);
}
...
////////////////////////////////////////////////////
double ARM_SABR_SurfaceModelParams::ImpliedVol(double underlying, 
       double strike, 
       double time,
       double tenor,
       int type,
       int IntegrationStep)
{
	...
	if(itsIsSigmaParam)
	{
		...
		alpha = SABR_ComputeAlphaFromSigmaATM(underlying,strike,expiry,sigma,beta,rho,nu,type);
	}
	else
	{
...
////////////////////////////////////////////////////
double ARM_SABR_SurfaceModelParams::PartialDerivative(double underlying, 
       double strike, 
       double time,
       double tenor,
       int type,
...
////////////////////////////////////////////////////
void ARM_SABR_SurfaceModelParams::PostProcessing(const ARM_ModelFitter& modelFitter,ARM_PricingModel* model ,int factorNb)
{
...
////////////////////////////////////////////////////
double ARM_SABR_SurfaceModelParams::StateLocalVariance(double a,double b) const
{
	return 0;
}
...
////////////////////////////////////////////////////
double ARM_SABR_SurfaceModelParams::StateLocalDrift(double a,double b) const
{
	return 0;
}
