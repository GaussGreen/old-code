...
///			  price
////////////////////////////////////////////////////
void ComputeDiscountFactorsFromSwapRates (	const std::vector<double>& fixPayPeriods,
		...
		bool isConstantStrike) const
{
	...
	std::vector<double> DfCoefs (size+1), Dfs(size);
	...
	return ARM_VectorPtr(new std::vector<double>(1,NPV));
}
