...
{
    itsPrecomputedFwds = rhs.itsPrecomputedFwds? (std::vector<double>&) rhs.itsPrecomputedFwds->Clone() : NULL;
}
...
void ARM_QModelBase::PostInit()
{
	...
	itsPrecomputedFwds = new std::vector<double>(timeStepSize,0.0);
