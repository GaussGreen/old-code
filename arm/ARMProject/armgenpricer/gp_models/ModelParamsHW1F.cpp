...
double ARM_ModelParamsHW1FStd::Variance(double a,double b,double scale) const
{
    ...
    std::vector<double> sigmaValues( ((ARM_CurveModelParam&) GetModelParam(GetVolatilityType())).GetCurve()->GetOrdinates() ); // Ui
...
///          and Zc(.,T2)/Zc(.,U2)
////////////////////////////////////////////////////
double ARM_ModelParamsHW1FStd::FwdZcLocalCovariance(double a,double b,double T1,double U1,double T2,double U2,std::vector<double>& vars) const
{
    double MRSValue= ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()[0];
...
double ARM_ModelParamsHW1FExt::Lambda(double a,double b) const
{
    ...
    std::vector<double> MRSTimes(( (ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetAbscisses()); // Vi
    std::vector<double> MRSValues(( (ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()); // MRS(Vi)
...
{
    std::vector<double> sigmaTimes( ( (ARM_CurveModelParam&) GetModelParam( GetVolatilityType() )).GetCurve()->GetAbscisses());  // Ui
    std::vector<double> sigmaValues(( (ARM_CurveModelParam&) GetModelParam( GetVolatilityType() )).GetCurve()->GetOrdinates()); // Sigma(Ui)
...
///
////////////////////////////////////////////////////
std::vector<double>& ARM_ModelParamsHW1FExt:: VecBetatT(double t,double T) const
{
    std::vector<double> MRSTimes(( (ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetAbscisses()); // Vi
    std::vector<double> MRSValues(( (ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()); // MRS(Vi)
    ...
    std::vector<double>& values=new std::vector<double>(nt+1);
...
///
////////////////////////////////////////////////////
double ARM_ModelParamsHW1FExt::IntegLambdaBeta(double a,double b,double T,std::vector<double>& betatTs) const
{
    if(b<=a+K_NEW_DOUBLE_TOL)
        return 0.0;
...
///          and Zc(.,T2)/Zc(.,U2)
////////////////////////////////////////////////////
double ARM_ModelParamsHW1FExt::FwdZcLocalCovariance(double a,double b,double T1,double U1,double T2,double U2,std::vector<double>& vars) const
{
...
double ARM_ModelParamsHW1FExt:: ZcVarianceSpread(double t1,double t2,double T1,double T2) const
{
    ...
    std::vector<double>& betatT1s=VecBetatT(t,T1);
    std::vector<double>& betatT2s=VecBetatT(t,T2);
...
double ARM_ModelParamsHW1FExt::StateZcCovariance(double t,double T) const
{
    ...
    std::vector<double>& betatTs=VecBetatT(t,T);
...
///          MRS is a stepwise right constant curve
////////////////////////////////////////////////////
double ARM_CalibParamsHW1FExt::ExpLambdaIntegral(double a,double b,std::vector<double>& times, 
...
void ARM_CalibParamsHW1FExt::PreProcessing(ARM_ModelFitter& modelFitter, int factorNb)
{
    ...
    std::vector<double>& timesVolatility = NULL;
    ...
    std::vector<double>& timesMeanReversion = NULL;
    ...
    std::vector<double> varvector(size);
    std::vector<double> lowerbound(size);
    std::vector<double> upperbound(size);
    size_t i;
...
double ARM_ModelParamsHW1F::HW1FStateCovariance( const ARM_ModelParamsHW1F* lhs, const ARM_ModelParamsHW1F* rhs, double a, double b, double T )
{
    ...
    std::vector<double> sigmaValues1( ((ARM_CurveModelParam&) lhs->GetModelParam(lhs->GetVolatilityType())).GetCurve()->GetOrdinates() ); // Ui
    std::vector<double> sigmaTimes1(  ((ARM_CurveModelParam&) lhs->GetModelParam(lhs->GetVolatilityType())).GetCurve()->GetAbscisses() ); // Sigma(Ui)->
    std::vector<double> sigmaValues2( ((ARM_CurveModelParam&) rhs->GetModelParam(rhs->GetVolatilityType())).GetCurve()->GetOrdinates() ); // Ui
    std::vector<double> sigmaTimes2(  ((ARM_CurveModelParam&) rhs->GetModelParam(rhs->GetVolatilityType())).GetCurve()->GetAbscisses() ); // Sigma(Ui)
...
double ARM_ModelParamsHW1F::HW1FStateCovarianceWithVec(
		...
		const std::vector<double>& sigmaTimes2,
...
double ARM_ModelParamsHW1F::HW1FEqFxZcCovariance( const ARM_CurveModelParam& eqFxVol, const ARM_ModelParamsHW1F* rhs, double a, double b, double T )
{
    ...
    std::vector<double> sigmaValues1( eqFxVol.GetCurve()->GetOrdinates() ); // Ui
    std::vector<double> sigmaTimes1(  eqFxVol.GetCurve()->GetAbscisses() ); // Sigma(Ui)->
    std::vector<double> sigmaValues2( ((ARM_CurveModelParam&) rhs->GetModelParam(rhs->GetVolatilityType())).GetCurve()->GetOrdinates() ); // Ui
    std::vector<double> sigmaTimes2(  ((ARM_CurveModelParam&) rhs->GetModelParam(rhs->GetVolatilityType())).GetCurve()->GetAbscisses() ); // Sigma(Ui)
