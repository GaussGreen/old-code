...
{
    std::vector<double> sigmaTimes(  ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Volatility)).GetCurve()->GetAbscisses() ); // Sigma(Ui)
...
////////////////////////////////////////////////////
std::vector<double>& ARM_ModelParamsHW2FStd::Variance(double a,double b,std::vector<double>& scale) const
{
    int nbScales=scale.size();

    if(b - K_NEW_DOUBLE_TOL <= a)
        return new std::vector<double>(nbScales,0.0);

    std::vector<double> sigmaValues( ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Volatility)).GetCurve()->GetOrdinates()); // Ui
    std::vector<double> sigmaTimes(  ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Volatility)).GetCurve()->GetAbscisses()); // Sigma(Ui)
    ...
    double U,lastU,sig;
    std::vector<double> timeScale(nbScales);
    std::vector<double> newExpScale(nbScales);
    std::vector<double> lastExpScale(nbScales);
    ...
    std::vector<double>& variances = new std::vector<double>(nbScales,0.0);
...
///          from a to b>=a 
////////////////////////////////////////////////////
std::vector<double>& ARM_ModelParamsHW2FStd::StateLocalDrift(double a,double b) const
{
    ...
    std::vector<double>& localDrift = new std::vector<double>(2,1.0);
...
ARM_GP_MatrixPtr ARM_ModelParamsHW2FStd::StateLocalDriftVec( const std::vector<double>& timeSteps ) const
{
...
ARM_GP_TriangularMatrix* ARM_ModelParamsHW2FStd::StateLocalVariance(double a,double b) const
{
	...
	std::vector<double>& localVariance=Variance(a,b,scale);
...
///          and Zc(.,T2)/Zc(.,U2)
////////////////////////////////////////////////////
double ARM_ModelParamsHW2FStd::FwdZcLocalCovariance(double a,double b,double T1,double U1,double T2,double U2,std::vector<double>& vars) const
{
    double MRS1Value=((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()[0];
    if(fabs(MRS1Value)<=K_NEW_DOUBLE_TOL)
        MRS1Value=(MRS1Value>0 ? K_NEW_DOUBLE_TOL : -K_NEW_DOUBLE_TOL);
...
double ARM_ModelParamsHW2FStd::ZcVarianceSpread(double t1, double t2, double T1,double T2) const
{
    ...
    // Compute weighted volatility integrals
    std::vector<double>& totalVar=Variance(0.0,t,scale);
...
///          constant sigma curve 
////////////////////////////////////////////////////
std::vector<double>& ARM_ModelParamsHW2FExt::Variance(double a,double b,std::vector<double>& scale) const
{
    int nbScales=scale.size();
	if (nbScales%3)
    ...
    std::vector<double> sigmaValues( ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Volatility)).GetCurve()->GetOrdinates()); // Ui
    std::vector<double> sigmaTimes(  ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Volatility)).GetCurve()->GetAbscisses()); // Sigma(Ui)
	std::vector<double> volRatioValues( ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::VolatilityRatio)).GetCurve()->GetOrdinates());
    std::vector<double> volRatioTimes(  ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::VolatilityRatio)).GetCurve()->GetAbscisses());
	std::vector<double> correlValues( ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Correlation)).GetCurve()->GetOrdinates());
    std::vector<double> correlTimes(  ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::Correlation)).GetCurve()->GetAbscisses());
...
///          from a to b>=a 
////////////////////////////////////////////////////
std::vector<double>& ARM_ModelParamsHW2FExt::StateLocalDrift(double a,double b) const
{
    double MRS1Value=((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()[0];
    double MRS2Value=MRS1Value + ((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversionSpread)).GetCurve()->GetOrdinates()[0];
...
ARM_GP_MatrixPtr ARM_ModelParamsHW2FExt::StateLocalDriftVec( const std::vector<double>& timeSteps ) const
{
	size_t nbSteps	= timeSteps.size();
	double step		= timeSteps[0],nextStep;
    double MRS1Value=((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()[0];
...
///          and Zc(.,T2)/Zc(.,U2)
////////////////////////////////////////////////////
double ARM_ModelParamsHW2FExt::FwdZcLocalCovariance(double a,double b,double T1,double U1,double T2,double U2,std::vector<double>& vars) const
{
    double MRS1Value=((ARM_CurveModelParam&) GetModelParam(ARM_ModelParamType::MeanReversion)).GetCurve()->GetOrdinates()[0];
    if(fabs(MRS1Value)<=K_NEW_DOUBLE_TOL)
        MRS1Value=(MRS1Value>0 ? K_NEW_DOUBLE_TOL : -K_NEW_DOUBLE_TOL);
...
////////////////////////////////////////////////////
std::vector<double>& ARM_ModelParamsHW2F::BetatT(const ARM_ModelParam& mrsParam,const ARM_ModelParam& mrsSpreadParam,double t,double T)
{
    ...
    std::vector<double>& beta=new std::vector<double>(2);
