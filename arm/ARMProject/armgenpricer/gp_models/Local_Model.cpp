...
////////////////////////////////////////////////////
void ARM_Local_Model::CalibrateLocalModel(const ARM_Portfolio& portfolio, const std::vector<double>& evalTimes)
{	
	// reset model params
	ResetModelParams();
...
void ARM_Local_Model::GetCorridorSpreadOptionData (	ARM_SpreadOption* spreadOption,
										...
										std::vector<double>&	swapsLongFloatStartTimes,
										std::vector<double>&	swapsLongFloatEndTimes,
										vector<std::vector<double>>&	swapsLongFixPayTimes,
										vector<std::vector<double>>&	swapsLongFixPayPeriods,
										std::vector<double>&	swapsShortFloatStartTimes,
										std::vector<double>&	swapsShortFloatEndTimes,
										vector<std::vector<double>>&	swapsShortFixPayTimes,
										vector<std::vector<double>>&	swapsShortFixPayPeriods,
										std::vector<double>& fixValues,
										double& spread1,
										double& spread2,
										int& payIndexType,
										std::vector<double>& payIndexLeverages,
										std::vector<double>& swapsPayFloatStartTimes,
										std::vector<double>& swapsPayFloatEndTimes,
										vector<std::vector<double>>& swapsPayFixPayTimes,
										vector<std::vector<double>>& swapsPayFixPayPeriods,
