...
void ARM_ModelParamsBGMSV2F::Calibrate(const std::vector<double>& resetTimes, const std::vector<double>& fwdRates, 
...
void ARM_ModelParamsBGMSV2F::GetCalibrationData(const std::vector<double>& resetTimes, const std::vector<double>& fwdRates,
												const ARM_VanillaSecDensityPtrVector& CalibSecDensities,
...
void ARM_ModelParamsBGMSV2F::finishCalibration(const std::vector<double>& resetTimes, const std::vector<double>& fwdRates,
