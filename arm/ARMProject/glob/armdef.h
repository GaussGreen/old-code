/*
 * $Log: armdef.h,v $
 * Revision 1.73  2004/06/03 16:43:59  mab
 * Added : #define    K_LIVRET_A  60
 *
 * Revision 1.72  2004/05/11 13:18:06  emezzine
 * Added new  interpolation method
 *
 * Revision 1.71  2004/03/11 10:48:32  jmprie
 * ajout K_DELTA, K_VEGA etc..
 *
 * Revision 1.70  2004/03/10 10:38:31  rguillemot
 * Display volatility
 *
 * Revision 1.69  2004/03/05 09:40:36  mab
 * Formatting
 *
 * Revision 1.68  2004/03/05 09:34:47  mab
 * Replaced : ARM_DISC_ACCOUNTING_MTH
 * by : ARM_DISC_ACCOUNTING_METH
 *
 * Revision 1.67  2004/03/05 09:30:48  mab
 * Added: #define ARM_DISC_PRICING_METH     0
 *        #define ARM_DISC_ACCOUNTING_MTH   1
 *
 * Revision 1.66  2004/02/11 14:37:47  jpriaudel
 * ajout d'un mode de bump de vol
 *
 * Revision 1.65  2004/01/28 15:19:27  mab
 * added : #define K_SABR_IMPLNVOL 3
...
/*---- For sorting vector ----*/
#define K_INCREASING			1
#define K_DECREASING			-1

/*--- FOR FX smile interpol ---*/

#define FXINTERP_STRIKE       0
#define FXINTERP_DELTA        1
#define FXINTERP_DELTA_SMOOTH 2


#define	PIVOT_IS_ZDS             0
#define	PIVOT_IS_ATMF            1
#define	PIVOT_IS_ATMF_ANDNOTWP   2
#define	PIVOT_IS_ZDS_NOPREM      3
#define	PIVOT_IS_ZDS_SPOT_WPREM  4
#define	PIVOT_IS_ZDS_SPOT_NOPREM 5


/*---- Discounting mode ----*/

#define ARM_DISC_PRICING_METH      0
#define ARM_DISC_ACCOUNTING_METH   1
...
#define ARM_LAG_THRESHOLD 7
#define FRMVOL_LAG_THRESHOLD 7 
#define K_FRM_TOL       1.0E-12 

/*---- Default settlement gap ----*/
#define ARM_DFLTSETTLEMENTGAP	2 
...
#define S_POWER_REVERSE_SCHEDULE  "PowerReverse Schedule"
#define K_CANCEL_DATES   0
#define K_NOTIF_DATES     1
...
#define K_VOL_FWD         16
#define K_VOL_CAP         17
#define K_RAW_FWD_RATES   18
#define K_FLOWS_PV_VALUES 19
...
#define S_LONG_SHORT_TYPES		"Long Short Types"
#define K_LONG				1
#define K_SHORT				-1

#define S_MCAP_MODE_TYPES		"MaturityCap Mode Types"
#define K_INFINE		0
#define K_TRI			1

#define S_MCAP_CALIB_MODE_TYPES	"MaturityCap Calib Mode Types"
#define K_MCAP_EX_BOUNDARY	0
#define K_MCAP_ATM			1
#define K_MCAP_FLAT			2
...
#define K_LIN_INTER_CST_EXTRA_REF           10
...
#define K_LOG				                2
#define K_2SABR                             3
#define K_GCOP                              4  /* Gaussian Copula */
#define K_SCOP                              5  /* Student Copula */
#define K_2LOG_EXTENDED						6                                            
#define K_2SABR_CALIB_DEGEN					7
#define K_2SABR_CALIB_NODEGEN				8
#define K_2SABR_NOCALIB_DEGEN				9
#define K_2SABR_NOCALIB_NODEGEN				10
#define K_GCOP_CALIB_DEGEN					11
#define K_GCOP_CALIB_NODEGEN				12
#define K_GCOP_NOCALIB_DEGEN				13
#define K_GCOP_NOCALIB_NODEGEN				14
#define K_2SABR_LOG							15
...
#define K_SPLINE            12 /* Spline Interpolation */

/*---- Correls Intrepolation ----*/

#define K_DIAG_INTERPOL           13
#define K_LIN_EXTRAPOL            14


#define S_SEASONADJ_METHOD			"Seasonality Correction Method"
#define K_SEASONADJ_ADDITIVE		0
#define K_SEASONADJ_MULTIPLICATIVE	1
...
#define    K_TAG       58
#define    K_TMP       59
#define    K_EONIA     K_TMP // because this is the index
#define    K_LIVRET_A  60
#define    K_EUR3M     61
#define    K_EUR12     62
#define    K_EUR1M     K_EURIBOR1M
...
/* Rate Compounding methods */
#define S_COMPOUNDING_SPREAD_TYPES  "Spread Compounding methods"
#define K_COMP_NONE         0
#define K_SPREAD_INC        1
#define K_SPREAD_EXC        2
#define K_FLAT				3
/* fin de categorie*/ 
...
#define K_STD           10
#define K_CMSLIBOR      11
#define K_CMSPIBOR      12
#define K_CMT           13
#define K_TEC           14
#define K_CMS			15
#define K_LIBOR			16 
...
#define K_NUMINT_GL				3
#define K_NUMINT_GB				4
#define K_SWAP_SETTLE			5

/* Replic Mode */
#define S_REPLIC_STOP_MODE_TYPES	"Replic Stop Mode"
#define K_STOP_PRICE				0
#define K_STOP_PRICE_WEIGHT			1
#define K_STRIKEMIN_REPLIC			0
#define K_STRIKEMAX_REPLIC			100.0


/*KO Type for options*/
#define KO_TYPE "KO Type"
#define K_KO					1
#define K_No_KO_No_ACC			0
#define K_No_KO_ACC				-1

/*TimeLagAdjust*/
#define K_CONV_ADJ_SUMREP  1
#define K_CONV_ADJ_EXP     0
#define K_CONV_ADJ_SUMANA  2
#define K_CONV_ADJ_SUMEXP 3
#define K_CONV_ADJ_LIBORORG 4

/*Month*/
#define K_MONTH_DEFAULT	0
#define K_JANUARY		1
#define K_FEBRUARY		2
#define K_MARCH			3
#define K_APRIL			4
...
#define K_JULY			7
#define K_AUGUST		8
#define K_SEPTEMBER		9
#define K_OCTOBER		10
#define K_NOVEMBER		11
#define K_DECEMBER		12

//Payoff Type For Inflation Digital 
#define K_SIMPLE		0
#define K_PRODUCT		1
