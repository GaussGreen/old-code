...
//------------------------------------------------------------------------------
		...
		std::vector<double> leveragesShort(size);
		...
		std::vector<double> leveragesLong(size);
		...
		std::vector<double> margins(size);
