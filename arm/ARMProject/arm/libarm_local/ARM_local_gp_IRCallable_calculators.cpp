        ...
        long        objId )
{
	...
	try
	{
        ...
        else
        {
			...
			std::vector<double> values(1,coupon);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,exercise);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,cpnSpread);
...
// for VMS END
		...
		std::vector<double> optimResetDataGP(optimResetData.size());
        ...
        long        objId )
{
	...
	{
		std::vector<double>& flags = dynamic_cast<std::vector<double>&>(LOCAL_PERSISTENT_OBJECTS->GetObject(dataId));
