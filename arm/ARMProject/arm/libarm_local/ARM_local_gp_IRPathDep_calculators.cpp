                                    ...
                                    long objId)
{
	...
	std::vector<double>& customResetDates = NULL;
	std::vector<double>& julianResetDates = new std::vector<double>(0);
	...
	try
	{
        ...
        else
        {
			...
			std::vector<double> values(1,strike);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,leverage);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,cpnMin);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,cpnMax);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,fundSpread);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,nominal);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,fees);
		...
		if (isCustomResetFlag == true)
		{
			...
			customResetDates = dynamic_cast<std::vector<double> *>(LOCAL_PERSISTENT_OBJECTS->GetObject(resetDatesId));
        ...
        tarnCalculator = new ARM_TARNCalculator(mktDataManager ? mktDataManager->GetAsOfDate(): 
			                                    ...
			                                    *nominalProfile,
			                                    *feesProfile,
			                                    std::vector<double>( nbIterations ),
			                                    modelType,
			                                    capFloorCalibMode,
			                                    digitalCalibMode,
			                                    oswCalibFlag,
        ...
        long        objId )
{
	...
	try
	{
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,levPrev);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,fundNominal);
        ...
        long        objId )
{
	...
	try
	{
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,amortizing);
        ...
        long        objId )
{
	...
	try
	{
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,notional);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,fundnotional);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,Const);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,lPrevCpn);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,lNewOpt);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,strikeOpt);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,minCpn);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,maxCpn);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,fundCoeff);
        ...
        {
			std::vector<double> times(1,0.0);
			std::vector<double> values(1,fundMargin);
        ...
        long objId)
{
	...
	try
	{
		...
		std::vector<double> RKparameters;
