...
CreditMetricsLossCalculator::~CreditMetricsLossCalculator(){}
...
CreditMetricsLossCalculator::CreditMetricsLossCalculator(
    ...
    calculatorTemplate(new CCMTrancheCalculatorLegacy(
        true, false, recoverNotional, tranche, lossUnit, cpty))
{}
...
/** Same as original lossKey method but allows the betas used to be
    ...
    Correlation */
ITrancheLossCalculator::IKey* CreditMetricsLossCalculator::lossKey(
