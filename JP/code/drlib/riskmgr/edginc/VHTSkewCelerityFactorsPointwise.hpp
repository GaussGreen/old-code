...
#ifndef EDG_VHT_SKEW_CELERITY_FACTORS_POINTWISE_HPP
#define EDG_VHT_SKEW_CELERITY_FACTORS_POINTWISE_HPP
#include "edginc/VectorShift.hpp"
#include "edginc/Additive.hpp"

DRLIB_BEGIN_NAMESPACE

class RISKMGR_DLL VHTSkewCelerityFactorsPointwise: public VectorShift,
                               public virtual Additive {
public:
    friend class VHTSkewCelerityFactorsPointwiseHelper;
    ...
    public:
        ...
        /** Returns the name of the vol - used to determine whether to tweak
            the object */
        virtual string sensName(VHTSkewCelerityFactorsPointwise* shift) const = 0;

        /** Return the array of expiries (ie maturities/benchmark dates) that
            need to be tweaked for this vol */
        virtual ExpiryArrayConstSP sensExpiries(VHTSkewCelerityFactorsPointwise* shift) const =0;

        /** Shifts the object using given shift. Return true to make the
            infrastructure keep tweaking the components within the object
            which implements this interface */
        virtual bool sensShift(VHTSkewCelerityFactorsPointwise* shift) = 0;
    };
    ...
    public:
        ...
        virtual void sensRestore(VHTSkewCelerityFactorsPointwise* shift) = 0;
    };

    /** constructor with explicit shift size */
    VHTSkewCelerityFactorsPointwise(double     shiftSize);
     ...
     * @param obj The object to shift. The object must implement the
     VHTSkewCelerityFactorsPointwise.Shift interface. The return value indicates whether
     ...
     * @param param1 The object to shift. The
     object must implement the VHTSkewCelerityFactorsPointwise.RestorableShift interface
     */
...
private:
    ...
    VHTSkewCelerityFactorsPointwise(const VHTSkewCelerityFactorsPointwise &rhs);
    VHTSkewCelerityFactorsPointwise& operator=(const VHTSkewCelerityFactorsPointwise& rhs);
};

typedef smartConstPtr<VHTSkewCelerityFactorsPointwise> VHTSkewCelerityFactorsPointwiseConstSP;
typedef smartPtr<VHTSkewCelerityFactorsPointwise> VHTSkewCelerityFactorsPointwiseSP;
