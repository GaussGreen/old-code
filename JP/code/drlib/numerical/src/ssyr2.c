...
/* Structured by FOR_STRUCT, v0.2, on 07/26/90 at 14:43:15
    Options SET: fmt=t s=n
  -----------------------------------------------------------------------
    IMSL Name:  SSYR2  (Single precision version)
    ...
    Usage:      CALL SSYR2 (UPLO, N, ALPHA, X, INCX, Y, INCY, A, LDA)
 ...
 */
#ifdef ANSI
void imsl_ssyr2(Mchar *uplo, Mint uplo_s, Mint *n, Mfloat *alpha, Mfloat *x,
                Mint *incx, Mfloat *y, Mint *incy, Mfloat *a, Mint *lda)
#else
void imsl_ssyr2(uplo, uplo_s, n, alpha, x, incx, y, incy, a, lda)
	Mchar           *uplo;
	Mint            uplo_s;
	Mint            *n;
	Mfloat          *alpha, x[];
