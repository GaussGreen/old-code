...
int	isanan(int, float*, int);

void	c1wfr(int, int, float*, int, int, int, int, int, float, int*, float*, float*, int*);

void 	c1div(float, float, float*);

void 	g1aov(float, float, float, float, float, float*);

float	ssum(int, float*, int);

int	isum(int, int*, int);
...
void 	c1iarg(int, char*, int, int, int*);
