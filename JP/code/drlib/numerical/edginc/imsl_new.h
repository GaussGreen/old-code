...
#if defined(sparc) && !defined(__GNUC__) && !defined(COMPUTER_SUN4)
...
#if defined(sparc) && defined(__GNUC__) && !defined(COMPUTER_GSUN4)
...
#if defined(IMSL_MACHINE_SUN3) || defined(IMSL_MACHINE_SUN4)
...
#if defined(COMPUTER_PMXUX) || defined(COMPUTER_MIPNT)
...
#if defined(IMSL_MACHINE_DOS) || defined(COMPUTER_NTLNT)
...
#if !defined(IMSL_MACHINE_SUN) && !defined(IMSL_MACHINE_DECOSF)
...
struct {
    ...
    0x00000000, 0x3cb00000,  0x3fd34413, 0x3fd34413,  0xFFFFFFFF, 0x7FFFFFFF,
    ...
    0x3cb00000, 0x00000000,  0x3fd34413, 0x3fd34413,  0x7FFFFFFF, 0xFFFFFFFF,
