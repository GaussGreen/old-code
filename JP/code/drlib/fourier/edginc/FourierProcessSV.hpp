...
//
//   Filename    : FourierProcessSV.hpp
//
//   Date        : 09 March 04
//
//
//----------------------------------------------------------------------------
#ifndef EDR_FOURIERPROCESSSV_HPP
#define EDR_FOURIERPROCESSSV_HPP
...
class FOURIER_DLL FourierProcessSV: public FourierProcessParametric,
						...
						virtual public FwdStFourierProcessExpQuadVar {  // implements fwd starting exp quad variance  **ARNAUD**
public:
...
typedef smartPtr<FourierProcessSV> FourierProcessSVSP;
