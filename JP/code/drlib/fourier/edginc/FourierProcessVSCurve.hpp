#ifndef EDR_FOURIERPROCESSVSCURVE_HPP
#define EDR_FOURIERPROCESSVSCURVE_HPP
...
class FOURIER_DLL FourierProcessVSCurve: public FourierProcessParametric,
                             ...
                             virtual public StFourierProcessQuadVar,        // implements started quad variation
                             virtual public FwdStFourierProcessQuadVar,      // implements fwd starting quad variation
                             virtual public FwdStFourierProcessExpQuadVar{  // implements fwd starting exp quad variance
public:
...
private:
    ...
    FrequencyRangeConstSP stFrequencyRangeQuadVar;
    FrequencyRangeConstSP fwdStFrequencyRangeQuadVar;
...
typedef smartPtr<FourierProcessVSCurve> FourierProcessVSCurveSP;
