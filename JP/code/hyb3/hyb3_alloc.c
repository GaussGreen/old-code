                 ...
                 HYB3_TREE_DATA    *tree_data)    /**< (I) Tree data structure   */
{
    ...
    dev_data->Shift1 = DR_Array(INT, 0, Size1);
    dev_data->Shift4 = DR_Array(INT, 0, Size1);
    dev_data->Shift2 = DR_Array(INT, 0, Size2);
    dev_data->Shift5 = DR_Array(INT, 0, Size2);
             ...
             (tree_data->TreeType != TTYPE_1IR2F))
    {
        ...
        dev_data->Shift3 = DR_Array(INT, 0, Size3);
