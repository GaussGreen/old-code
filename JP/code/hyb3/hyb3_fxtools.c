                           ...
                           double          *ExMidNode )
{
    ...
    smileCacheL->X       = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->K       = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->SPL     = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->SPL_Inv = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->gd      = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->gd_SPL  = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->kdX     = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);
    smileCacheL->kdX_SPL = DR_Matrix (DOUBLE, 0, smileCacheL->nbCachePts, 0 , NBSPLINE + 3);

    smileCacheL->nbPtSPL = DR_Array( INT, 0, smileCacheL->nbCachePts );
