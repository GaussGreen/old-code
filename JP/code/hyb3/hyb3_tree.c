...

{
    ...
    char  *CcyErrString[2];        /* defines the name for the tree dimensions */
    ...
    CcyErrString[0] = "Foreign";    /* important: make sure that NbIRatesOn is <= 2 */
    CcyErrString[1] = "Domestic";
                     ...
                     )
{
        ...
        else if (TreeType == TTYPE_2IR2F1D)
        {
             ...
             */
            SpotVolAsset2 = DR_Array(DOUBLE, -1, NbTP);
            Rho1          = DR_Array(DOUBLE, -1, NbTP);
            for (t = -1; t <= NbTP; t++)
            {
