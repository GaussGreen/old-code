...
public:
	...
	friend ostream &operator<<(ostream& s, const KValarray &a) //
	{
...
void KValarray<T>::print_short (ostream& s) const
{ 
	if (size() < 3) {
...
typedef KValarray<float>	FArray;
typedef KValarray<short>	SArray;
typedef KValarray<long>	LArray;
typedef KValarray<long>	MbsTDateArray;
