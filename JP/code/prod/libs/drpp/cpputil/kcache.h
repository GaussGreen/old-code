...
{
public:
	/** Unique string describing the type of input */
	KCacheInput (string type) : m_type (type) {} // String description of type
	/**@#-*/
	virtual ~KCacheInput(){} //
	/**@#+*/

	/** Return the type of input */
	string type() {return m_type;} // Returns the type

	/**@#-*/
	friend ostream& operator<< (ostream& s, const KCacheInput& a)
	{a.print(s); return s;} //
	/**@#+*/
protected:
...
public:
	...
	friend ostream& operator<< (ostream&, const KCache&); //
protected:
	friend class KCacheItemPtr;
	...
	typedef KMap (string, ElemList) TypeElemMap;
