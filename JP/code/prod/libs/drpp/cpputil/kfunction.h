...
public:
	...
	template <class InIt>
		KArgFunction(InIt first, InIt last, const Interp<Arg,Arg>& i): Function<Arg,Arg>(first, last, i) {}
#else
	/** Creates a function from a vector of points and an interpolation type */
	...
	KArgFunction (string s, const KExpression<Arg>::UnaryFunctionMap& uf, 
...
public:
...
#ifdef DR_MEMBER_TEMPLATES
	template <class InIt>
		KDoubleFunction(InIt first, InIt last, const Interp<double,double>& i): ArgFunction<double>(first, last, i) {}
#else
	/** Creates a function from a vector of points and an interpolation type */
	...
	/** Creates a function from an expression and unary/binary function pointers */
	KDoubleFunction (string s, const KDoubleExpression::UnaryFunctionMap& uf= KDoubleExpression::UnaryMathFunctions, 
...
public:
	...
	KDoubleBinaryFunction (string s, const KDoubleExpression::UnaryFunctionMap& uf= KDoubleExpression::UnaryMathFunctions, 
