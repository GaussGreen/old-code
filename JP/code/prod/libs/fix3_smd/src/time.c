...
*                tree_data->JumpPpy)
*/
int     Fix3_Time_Line (    long        ValueDate,  /* (I) Value date                */
                    ...
                    FIX3_TREE_DATA   *tree_data) /* (O) Structure of tree data    */
{
    ...
    */
    ...
    {
        DR_Error ("Fix3_Time_Line: first date falls before value date!");
        goto FREE_MEM_AND_RETURN;
    }
    ...
    */
    ...
    if ( (StepStyle == 'I') || (StepStyle == 'J') )
    {
        ...
        { 
            NbDailyPts = (int)Daysact (ValueDate, Date[NbDate - 1].CritDate) - 1;
        }
        else
        {
