...
*/
int     Fix3_Drift_1D (  MKTVOL_DATA     *mktvol_data,   /* (I) Volatility data */
...
*/
int     Fix3_Drift_2D (  MKTVOL_DATA     *mktvol_data,   /* (I) Volatility data */
                    FIX3_TREE_DATA       *tree_data)     /* (I/O) Tree data     */
{
...
*/
int     Fix3_Drift_3D (  MKTVOL_DATA     *mktvol_data,   /* (I) Volatility data */
                    FIX3_TREE_DATA       *tree_data)     /* (I/O) Tree data     */
{
