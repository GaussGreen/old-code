...
public:
	...
	virtual void payoff_new(double *underly,double *optValue, double *underVega,
							double *optVega, double asset,double stock, double integratUnderly) = 0;	//HY4.1v		

	virtual double get_defaultValue() = 0;			//HY4.1v
...
//	void	resize(){ m_ts.resize(m_tree);}
	...
	void	jump_dev();
	double	get_integratedValue(DTimeSlice ts, int ts_idx, int num);				//HY4.1v

//	double  get_spot_ts_value(){return m_ts[0];}
//	double  get_option_ts_value(){return m_ts_opt[0];}					//HY3.4v
	double  get_spot_ts_value();							//HY4.1v
	double  get_option_ts_value();							//HY4.1v
	...
	double  get_vega_value();								//HY4.1v
	double  get_option_vega_value();						//HY4.1v
...
//							double *optVega, double asset,double stock);		//HY3.4v		
	...
	void payoff_new(double *underly,double *optValue, double *underVega,
							double *optVega, double asset,double stock, double integratUnderly);	//HY4.1v
	
	double get_defaultValue();			//HY4.1v
...
//		m_underFunc = underFunc;
	...
	double get_defaultValue();				//jump version
