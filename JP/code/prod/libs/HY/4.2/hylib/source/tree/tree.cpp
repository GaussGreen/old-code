...
//	iter = _tpLine.find(valueDate);				//taken out HY4.1v
//	_tpLine.erase(_tpLine.begin(), iter);		//taken out HY4.1v
	...
	KTimeLine::iterator	iterStart;						//HY4.1v
	iterStart = _tpLine.find(valueDate);				//HY4.1v
	int yy=1;
//	for(iter = _tpLine.begin(); iter !=_tpLine.end(); iter++)
	for(iter = iterStart; iter !=_tpLine.end(); iter++)					//HY4.1v
	{	
