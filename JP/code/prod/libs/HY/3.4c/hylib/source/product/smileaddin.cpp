...
MAGNET_FUNCTION13(Array<double>*,  Gen_Pricer, double spotStockPrice,CM::SharedPointer<DDMap> dividentYield, 
				 ...
				 CM::SharedPointer<BaseFunction> assetProcess, double ppy, double beta, Date settleDate,
				 bool isCVOption)
{
...
MAGNET_FUNCTION13(Array<double>*,  Gen_Pricer2, double spotStockPrice,CM::SharedPointer<DDMap> dividentYield, 
				 CM::SharedPointer<KRateCurve> repoCurve,CM::SharedPointer<KRateCurve> irCurve,
				 CM::SharedPointer<KRateCurve> volCurve, CM::SharedPointer<KRateCurve> volCurveShift,
				 CM::SharedPointer<Instrument> instrument, 
				 CM::SharedPointer<BaseFunction> assetToStockMapping, 
