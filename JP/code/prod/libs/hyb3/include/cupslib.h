...
int     Hyb3_DomDim(HYB3_TREE_DATA *);
int     Hyb3_ForDim(HYB3_TREE_DATA *);
...
/* STATEPRICES.C */
int     Hyb3_UpdateStatePrices1D(int ,MKTVOL_DATA  *,HYB3_TREE_DATA *,HYB3_DEV_DATA *,TSLICE ,TSLICE );
int     Hyb3_UpdateStatePrices2D(int ,MKTVOL_DATA  *,HYB3_TREE_DATA *,HYB3_DEV_DATA *,TSLICE ,TSLICE );
int     Hyb3_UpdateStatePrices(int ,MKTVOL_DATA  *,HYB3_TREE_DATA *,HYB3_DEV_DATA *,TSLICE ,TSLICE );

/* STDINPUT.C */
/* General */
int     Hyb3_FindAndSkipComLineOptional (FILE *,char const *,char const *, char const *);
int     Hyb3_Param_Input (MKTVOL_DATA *,char [MAXINDEX], HYB3_TREE_DATA *,int,char[4][MAXBUFF],char const *);
...
int     Hyb3_Correl_Input_WType3(FX_DATA *,char [3][MAXBUFF],char const *);
int     Hyb3_Correl_Check_WType3(FX_DATA *);
int     Hyb3_Correl_Input_WType4(EQ_DATA *,char [MAXBUFF],char const *);
int     Hyb3_Correl_Check_WType4(EQ_DATA *);
int     Hyb3_Correl_Input_WType6(FX_DATA *,EQ_DATA *,char,char [6][MAXBUFF],char const *);
...
int     ProduceFlatMarketFiles(T_CURVE [2][3], MKTVOL_DATA *,FX_DATA *, EQ_DATA *, HYB3_TREE_DATA *);
int     PrintIRVolFile( FILE *fp_bv, MKTVOL_DATA *);
int     PrintEQVolFile( FILE *fp_eq, EQ_DATA *);
int     PrintFXVolFile( FILE *fp_fx, FILE *fp_fxsmile, FX_DATA *);
int     PrintModelParameterFile(FILE *fx_m, MKTVOL_DATA *, HYB3_TREE_DATA *);
