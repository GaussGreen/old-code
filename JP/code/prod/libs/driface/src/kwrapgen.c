    ...
    double   *corrs)        /* (I) corrleations          */
{
    ...
    case 1L:
        ...
        CHECK_IN_RANGE(betas[0], -10.0,   10.0,   "Beta #1 out of range!\n");
        break;
    ...
    case 2L:
        ...
        CHECK_IN_RANGE(betas[0], -10.0,   10.0,  "Beta #1 out of range!\n");
        CHECK_IN_RANGE(betas[1], -10.0,   10.0,  "Beta #2 out of range!\n");
    ...
    case 3L:
        ...
        CHECK_IN_RANGE(betas[0], -10.0,   10.0,  "Beta #1 out of range!\n");
        CHECK_IN_RANGE(betas[1], -10.0,   10.0,  "Beta #2 out of range!\n");
        CHECK_IN_RANGE(betas[2], -10.0,   10.0,  "Beta #3 out of range!\n");
