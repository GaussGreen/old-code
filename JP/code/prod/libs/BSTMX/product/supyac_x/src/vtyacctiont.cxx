...
#define	NOUTPUT	4
	...
	(char   *)	TestArgCacheGet( 22),
			/* ---  Cash Flows      */
	(TDate  *)	TestArgCacheGet( 23),
	(double *)	TestArgCacheGet( 24),
	(char   *)	TestArgCacheGet( 25),
			/* --- 	Option		*/
	(char   *)	TestArgCacheGet( 26),
	(TDate  *)	TestArgCacheGet( 27),
	(TDate  *)	TestArgCacheGet( 28),
	(TDate  *)	TestArgCacheGet( 29),
	(double *)	TestArgCacheGet( 30),
	(double *)	TestArgCacheGet( 31),
	(char   *)	TestArgCacheGet( 32),
			/* --- Zero curve info 	*/
	(TDate  *)	TestArgCacheGet( 33),
	(char   *)	TestArgCacheGet( 34),
	(char   *)	TestArgCacheGet( 35),

	(TDate  *)	TestArgCacheGet( 36),
	(double *)	TestArgCacheGet( 37),
	(TDate  *)	TestArgCacheGet( 38),
	(double *)	TestArgCacheGet( 39),
	(TDate  *)	TestArgCacheGet( 40),
	(double *)	TestArgCacheGet( 41),
	(TDate  *)	TestArgCacheGet( 42),
	(double *)	TestArgCacheGet( 43),

	(double *)	TestArgCacheGet( 44),
			/* ---	Vol Curve info 	*/
	(TDate  *)	TestArgCacheGet( 45),
	(TDate  *)	TestArgCacheGet( 46),
	(int    *)	TestArgCacheGet( 47),
	(double *)	TestArgCacheGet( 48),

	(TDate  *)	TestArgCacheGet( 49),
	(double *)	TestArgCacheGet( 50),
	(char   *)	TestArgCacheGet( 51),
			/* -- Model Info	*/
	(double *)	TestArgCacheGet( 52),
	(double *)	TestArgCacheGet( 53),
	(double *)	TestArgCacheGet( 54),
	(double *)	TestArgCacheGet( 55),
	(double *)	TestArgCacheGet( 56),

			/* --- Reset Bank	*/
	(char   *)	TestArgCacheGet( 57),
	(TDate  *)	TestArgCacheGet( 58),
	(double *)	TestArgCacheGet( 59),
			/* --- Other 		*/
	(int    *)	TestArgCacheGet( 60),
			/* --- Output 		*/
	outVal
	);
	...
	if (errCode == SUCCESS) {
	    ...
	    fprintf(fp,
		"PRICE: %15.6f  UNDER: %15.6f  FUGIT: %8.4f  PROB: %8.4f \n",
			outVal[1],
			outVal[2],
			outVal[3],
			outVal[4]);
...
ARG_DEF g_ArgInfoArray[]=
{
	...
	{"FORMULAS_1",		AT_ARRAY(AT_CHAR_BLOCK)},	/* ( 0) */
	...
	{"FORMULAS_2",		AT_ARRAY(AT_CHAR_BLOCK)},	/* ( 0) */
	...
	{"CASH_DATES",		AT_ARRAY(AT_DATE)},		/* ( 0) */
	{"CASH_AMOUNTS",	AT_ARRAY(AT_DOUBLE)},		/* ( 0) */
	{"DISC_CASH_CURVE",	AT_ARRAY(AT_CHAR_BLOCK)},	/* ( 0) */

	{"OPT_TYPES",		AT_ARRAY(AT_CHAR_BLOCK)},	/* ( 0) */
	{"OPT_NOTIF_DATES",	AT_ARRAY(AT_DATE)},		/* ( 0) */
	{"OPT_SETTLE_DATES",	AT_ARRAY(AT_DATE)},		/* ( 0) */
	{"OPT_STKPAY_DATES",	AT_ARRAY(AT_DATE)},		/* ( 0) */
	{"OPT_STRIKES",		AT_ARRAY(AT_DOUBLE)},		/* ( 0) */
	{"OPT_NOTIONALS",	AT_ARRAY(AT_DOUBLE)},		/* ( 0) */
	{"DISC_OPTION_CURVE",	AT_ARRAY(AT_CHAR_BLOCK)},	/* ( 0) */
