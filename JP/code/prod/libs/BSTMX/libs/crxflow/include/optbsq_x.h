 ...
 */
extern double  NormDens (double x); 

/*f----------------------------------------------------------------------------
 * Double precision cumulative normal function
 */
extern double NormCum (double x);
 ...
 */
extern double NormCumInv (double prob);
 ...
 */
extern double  BSQInt (double  a, double b, double x1, double x2);
 ...
 */
extern double ExpCErrFcn (double a, double b, double x);
