...
*/
int     Dev (   double     *Price,       /* (I/O) Prices to be discounted */
                ...
                TREE_DATA  *tree_data)   /* (I) Tree data structure       */
{
    ...
    /* Convert to numeraire quantities if necessary 
     * This is performed on lagged slices (at t+1) */
    if (dev_data->CcyToNmr)
    {
        if (MultiplyTwoSlices (Price,
                               Price,
                               dev_data->NmrInvLag[DCurve],
                               t+1,
    ...
    if (tree_data->NbFactor == 1)
    {
         ...
         */
        PriceL = Price + Node_Offset(1, 0, 0, t+1, tree_data);
    ...
    {
        PriceL = Price + Node_Offset (2, NxtBottom1, 0, t+1, tree_data);

        PFlat = PriceL[NxtTop2[NxtBottom1]];

        for (i = OutBottom1; i < NxtBottom1; i++)
        {
            PriceL = Price + Node_Offset (2, i, 0, t+1, tree_data);
        ...
        PriceL = Price + Node_Offset (2, NxtTop1, 0, t+1, tree_data);
        ...
        Shift1 = dev_data->Shift1 + Node_Offset(1, 0, 0, t, tree_data);
        ...
        for (i = Bottom1; i <= Top1; i++)
        {
            ...
            Price0 = Price + Node_Offset (2, l+1, 0, t+1, tree_data);
            Price1 = Price + Node_Offset (2, l  , 0, t+1, tree_data);
            Price2 = Price + Node_Offset (2, l-1, 0, t+1, tree_data);
    ...
    {
       PriceL = Price + Node_Offset (3, NxtBottom1, NxtTop2[NxtBottom1], t+1, tree_data);
        ...
        for (i = OutBottom1; i < NxtBottom1; i++)
            for (j = OutBottom2[i]; j <= OutTop2[i]; j++)
            {
                PriceL = Price + Node_Offset (3, i, j, t+1, tree_data);
        ...
        for (i = NxtBottom1; i <= NxtTop1; i++)
        {
            PriceL = Price + Node_Offset (3, i, NxtBottom2[i], t+1, tree_data);
            ...
            PriceL = Price + Node_Offset (3, i, NxtTop2[i], t+1, tree_data);
        ...
        PriceL = Price + Node_Offset (3, NxtTop1, NxtTop2[NxtTop1], t+1, tree_data);
        ...
        for (i = Bottom1; i <= Top1; i++)
        {
            ...
            for (j = Bottom2[i]; j <= Top2[i]; j++)
            {
                ...
                Price00 = Price + Node_Offset (3, l+1, m+1, t+1, tree_data);
                Price01 = Price + Node_Offset (3, l+1, m  , t+1, tree_data);
                Price02 = Price + Node_Offset (3, l+1, m-1, t+1, tree_data);
                Price10 = Price + Node_Offset (3, l  , m+1, t+1, tree_data);
                Price11 = Price + Node_Offset (3, l  , m  , t+1, tree_data);
                Price12 = Price + Node_Offset (3, l  , m-1, t+1, tree_data);
                Price20 = Price + Node_Offset (3, l-1, m+1, t+1, tree_data);
                Price21 = Price + Node_Offset (3, l-1, m  , t+1, tree_data);
                Price22 = Price + Node_Offset (3, l-1, m-1, t+1, tree_data);
    ...
    /* Convert to currency quantities if necessary */
    if (dev_data->NmrToCcy)
    {
        if (DivideTwoSlices (Price,
                             Price,
                             dev_data->NmrInv[DCurve],
                             t,
                             tree_data) == FAILURE) goto RETURN;
    }
...
*       Expected value function.
*/
int     Ev (    double     *Price,       /* (I/O) Prices to be discounted */
                int         t,           /* (I) Current time point        */
                int         T,           /* (I) Last time point           */
                DEV_DATA   *dev_data,    /* (I) Dev data structure        */
                TREE_DATA  *tree_data)   /* (I) Tree data structure       */
{
    ...
    {
        PriceL = Price + 
                 Node_Offset (3, NxtBottom1, NxtTop2[NxtBottom1], 
                              t+1, tree_data);
        ...
        PriceL = Price + 
                 Node_Offset (3, NxtTop1, NxtTop2[NxtTop1], t+1, tree_data);
