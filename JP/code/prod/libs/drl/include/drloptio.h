...
extern	double	DrlCumTriNorm(double x1, double x2, double x3,
...
extern	int	DrlBinary(double t, double s, double v,
				double k, char *what,
				double *retVal);

extern	int	DrlNormOption(double texp, double p,
				double vol, double k,
				char *cp, char *what,
				double *retVal);
extern	int	DrlNormOptionImplVol(double texp,
				double fp, double prem,
				double k, char *cp, char *what,
				double *retVal);


extern	int	DrlBlack(double texp, double p, double vol, double k,
				char *cp, char *what, double *retVal);
extern	int	DrlBlackImplVol(double texp, double fwdp, double prem,
...
extern	int	DrlOpMax2Sec(double t, double s1, double s2,
				double sigma1, double sigma2, double rho,
				double k, char *cp, char *what,
				double *retVal);

extern	int	DrlSpreadOption(double texp, double p1, double p2,
				double vol1, double vol2, double cor,
				double strike, char *callPut, char *what,
				double *retVal);

extern	int	DrlMargrabe(double t1, double t2,
				double s1, double s2,
...
extern	int	DrlOptionDoubleKO(double expiration,
 ...
 */
extern	double DrlCumTriNorm(
				double x1, double x2, double x3,
				double r12, double r13, double r23);

extern	int	DrlOpMax3Sec(double t, double *sVec,
