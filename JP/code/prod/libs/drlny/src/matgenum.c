/*-----------------------------------------------------------------------
  SOURCE FILE:    gennum.c
  
  CREATED BY:     Julia Chislenko  October, 1998
  
  PURPOSE:        Generic numerical procedures
...
GTO_EXPORT(double)  DrlSimpsIntegral(
    double            step,             /* (I) */
    long              numPoints,        /* (I) */
    double           *fValues)          /* (I) */ 
{
 ...
 *                  F(X) = 0 if X <  0.
 */
GTO_EXPORT(double)  DrlSmoothStepFcn(
     double  x,                         /* (I) Argument */
 ...
 */
GTO_EXPORT(double)  DrlSmoothMAX(
     double  x,                         /* (I) Argument */
     double  step)                      /* (I) 1/2 step */
{
    double smoothValue, xSquare;
