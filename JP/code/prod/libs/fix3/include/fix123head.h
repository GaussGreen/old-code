...
extern int (*Fix3_IndexVol) (double *, long, long,long,  char, char,MKTVOL_DATA*,T_CURVE const*);
...
int     Fix3_IndexVol_Classic (double *, long, long, long, char, char,MKTVOL_DATA*,T_CURVE const*);
...
int     Fix3_IndexVol_TimeDep (double *, long, long, long, char, char,MKTVOL_DATA*,T_CURVE const*);
...
int     Fix3_IndexCorr_TimeDep (double*, long, long, long, char, char, long, long, long, char, char, MKTVOL_DATA *,T_CURVE const*);        
...
int     Fix3_IndexVol_Smd (double *, long, long, long, char, char,MKTVOL_DATA*,T_CURVE const*);
...
int     Fix3_IndexVol_Tmx (double *, long, long, long, char, char,MKTVOL_DATA*,T_CURVE const*);
...
int     Fix3_IndexVol_E2Q (double *, long, long, long, char, char,MKTVOL_DATA*,T_CURVE const*);
