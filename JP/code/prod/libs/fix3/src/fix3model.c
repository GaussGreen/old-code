...
int     (*Fix3_IndexVol)         (double *, long, long, long, char, char,MKTVOL_DATA*,T_CURVE const*) = NULL;
...
int     Fix3_Model_Interface_Init (int ModelChoice)
{
    ...
    case FIX3_TIMEDEP:
        ...
        Fix3_GenIndexVol       = Fix3_GenIndexVol_TimeDep;
        Fix3_IndexLimits       = Fix3_IndexLimits_Classic;
        Fix3_Cet_Main          = Fix3_Cet_Classic;
    ...
    case FIX3_TMX:
        ...
        Fix3_GenIndexVol       = Fix3_GenIndexVol_Tmx;
        Fix3_IndexLimits       = Fix3_IndexLimits_Classic;
