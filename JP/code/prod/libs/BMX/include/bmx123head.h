...
#ifndef _bmx123head_h
#define _bmx123head_h
...
int     Drift    (MKTVOL_DATA *, TREE_DATA *);
...
/* ladder.c */
int     LadderSwap_t (double **,long,long,double *, double *, double *,double,double,double,double,char,char,int,double,double,double **,int,TREE_DATA *);
...
int     Nmr_Interp(double *,int,int,MKTVOL_DATA *,TREE_DATA *);
int     Yield_Calc (double **, double *, double [2], double *, double *, double *, double, long, long, char , char , long , long , T_CURVE *, MKTVOL_DATA *, TREE_DATA *); 
int     Covar_Slices (double *, double *, double *, double *, double *, double *, double  *, double *, double *, long , long , T_CURVE *, TREE_DATA *);
...
int     Annuity_t (double *,int,double **,long *,long,long,long,int,char,char, int,int,int,DEV_DATA *,TREE_DATA *);
...
int     SwapSmile_Input_W (MKTSMILE_DATA *,int,int,long,char *);
int     MktVol_Input_W (MKTVOL_DATA *,char *,T_CURVE *,char[MAXBUFF],char *,char *,char *,char *);
int     MktVol_Check_W (MKTVOL_DATA *);
int     MktSmile_Input_W (MKTSMILE_DATA *,char[MAXBUFF],long,char,char *);
...
double  VFAC(double, double , double); 
int     BFactor (double *,long,long,char,char,int,double *,double,double,double,int,double *,long *,long);
int     SpotVol (double[6][MAXNBDATE],long,int,long *,double *,int *,char,char,long *,long *,double,double,double,double[NBVOLPARS][MAXNBDATE],int,double *,double *,double *,int,int,int,double *,long *,long);
int     Interp_SpotVol (double  **,long,int,long *,double[6][MAXNBDATE],int,double *,double,double,double,int,double *,double *,int);
int     IndexVol (double *,long,long,char,char,int,int,long,long *,double[6][MAXNBDATE],double,double,double,int,double *,int,double *,long *,long);
double  VFAC(double, double , double );
int     TreeVol(MKTVOL_DATA *, MKTVOL_DATA *, TREE_DATA *, T_CURVE *);
int     Correl_Input_W(TREE_DATA *, MKTVOL_DATA *);
...
int     Build_Tree (T_CURVE *,MKTVOL_DATA *, MKTVOL_DATA *, TREE_DATA *);
