...
{
    if (strstr(swapdcc_str, "360") != NULL)
    {
        *crvdcc = '0';
        return SUCCESS;
    }
    else if (strstr(swapdcc_str, "ACT") != NULL)
    {
        *crvdcc = '3';
        return SUCCESS;
    }
    else if (strstr(swapdcc_str, "365") != NULL)
    {
        *crvdcc = '5';
        return SUCCESS;
    }
...
int Swap_DCC(char crvdcc, char* swapdcc_str)
{
    ...
    {
    case '0':
        strcpy(swapdcc_str, "360"); 
        status = SUCCESS;
        break;
    case '3':
        strcpy(swapdcc_str, "ACT"); 
        status = SUCCESS;
        break;
    case '5':
        strcpy(swapdcc_str, "365"); 
        status = SUCCESS;
        break;
    default:
        status = FAILURE;
                    ...
                    T_CURVE const*    t_curve)   /**< (I) t_curve data             */
{
    ...
    return Conv_Index_s(IndexMat, IndexF, IndexBase, Index, SwapF, SwapDCC, LiborDCC);
