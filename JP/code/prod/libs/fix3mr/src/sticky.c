...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/sticky.c,v 1.8 2001/08/15 10:20:09 lcooper Exp $
*/
        ...
        TREE_DATA   *tree_data)             /* (I)   Tree data structure   */
{
    ...
    {
        DR_Error("Sticky_t: nb of state variables exceeds limit (200)!");
        goto RETURN;
    }
    ...
    if (FltResetFlag)
    {
        ...
        {
            DR_Error("Sticky_t: max state smaller than min state!");
            goto RETURN;
        }
        ...
        if (State == NULL)
        {
            DR_Error("Sticky_t: could not allocate memory for State!");
            goto RETURN;
        }
 ...
 */
int  VolBond_t(double    **VolBond,        /* (O) Prices for all states   */
               ...
               TREE_DATA   *tree_data)     /* (I) Tree data structure     */
{
    ...
    if (NbStates > MAXNBSTATES)
    {
        DR_Error("VolBond_t: nb of state variables exceeds limit (200)!");
        goto RETURN;
    }
    ...
    if (ResetFlagCplx)
    {
        ...
        if (MaxState < MinState)
        {
            DR_Error("VolBond_t: max state smaller than min state!");
            goto RETURN;
        }
        ...
        if (State == NULL)
        {
            DR_Error("VolBond_t: could not allocate memory for State!");
            goto RETURN;
        }
 ...
 */
int  VolSwap_t(double    **VolBond,        /* (O) Prices for all states   */
               long        ResetFlagCplx,  /* (I) Reset at timept         */
               ...
               TREE_DATA   *tree_data)     /* (I) Tree data structure     */
{
    ...
    if (NbStates > MAXNBSTATES)
    {
        DR_Error("VolSwap_t: nb of state variables exceeds limit (200)!");
        goto RETURN;
    }
    ...
    if (ResetFlagCplx)
    {
        ...
        if (MaxState < MinState)
        {
            DR_Error("VolSwap_t: max state smaller than min state!");
            goto RETURN;
        }
        ...
        if (State == NULL)
        {
            DR_Error("VolSwap_t: could not allocate memory for State!");
            goto RETURN;
        }
