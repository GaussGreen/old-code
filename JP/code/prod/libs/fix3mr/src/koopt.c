...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/koopt.c,v 1.6 1998/03/17 13:45:27 plewicki Exp $
*/
...
*       smoothing algorithm.
*/
int     KoOption_t (double      *KoOpt,      /* (I/O) Knock-out option       */
...
*/
int     KiOption_t (double      *KiOpt,      /* (I/O) Knock-in option prices */
