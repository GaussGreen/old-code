...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/ladder.c,v 1.5 2004/06/22 12:33:57 dliu Exp $
*/
              ...
              TREE_DATA   *tree_data)     /* (I) Tree data structure     */
{
    ...
    if (ResetFlagSt)
    {
        if (PrevStates == NULL ||
            CurrStates == NULL)
        {
            DR_Error("LadderSwap_t: No previous or current states on %8d!", 
                     CurrDate);
            goto RETURN;
        }
