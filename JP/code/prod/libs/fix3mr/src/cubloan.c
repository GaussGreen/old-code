...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/cubloan.c,v 1.3 2000/06/23 07:45:32 lcooper Exp $
*/
...
*/
int  CubLoan_t (double    **Loan,         /* (I/O) Prices for all states   */
