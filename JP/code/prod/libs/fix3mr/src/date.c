...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/date.c,v 1.22 2004/08/04 17:46:36 rconstan Exp $
*/
...
unsigned 
ExpandDateSchedule(unsigned sSize, long const* sSched, unsigned tSize, long* tSched, char frequency)
{
    unsigned cnt, ret, i;
    ...
    {
        long begDate = sSched[0];
        long endDate = sSched[sSize-1];
        long curDate = begDate;
