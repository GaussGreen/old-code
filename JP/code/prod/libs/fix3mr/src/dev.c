...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/dev.c,v 1.6 1998/09/23 17:35:11 dfung Exp $
*/
                ...
                TREE_DATA  *tree_data)   /* (I) Tree data structure       */
{
    ...
    {
        DR_Error ("Dev: incorrect specification for discount curve!");
        goto RETURN;
    }
...
int     Ev (double     *Price,       /* (I/O) Values to be EV'd   */
            int         t,           /* (I)   Current time point        */
            int         T,           /* (I)   Last time point           */
            DEV_DATA   *dev_data,	 /* (I)   Dev data structure        */
            TREE_DATA  *tree_data)   /* (I)   Tree data structure       */
