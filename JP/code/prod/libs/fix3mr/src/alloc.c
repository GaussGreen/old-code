...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/alloc.c,v 1.17 2004/07/27 15:39:47 hjorge Exp $
*/
...
int     Tree_Alloc (TREE_DATA   *tree_data) /* Tree building data structure */
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        tree_data->BetaInt[i] = (double *) DR_Array (DOUBLE, 0, MAX_INST + 10);
...
int     Tree_Free ( TREE_DATA   *tree_data) /* Tree building data structure */
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        Free_DR_Array(tree_data->BetaInt[i], DOUBLE, 0, MAX_INST + 10);
    }
