...
/*
$Header: /nasdev/export2/home/drdev/cvsadmin/cvs/libs/fix3/src/lattice.c,v 1.9 1999/06/30 15:06:26 plewicki Exp $
*/
    ...
    else if (tree_data->NbFactor == 3)
    {
        ...
        {                        
            ...
            for (j = Bottom2[i]; j <= Top2[i]; j++)
            {
                ...
                if (nMin > nMax)
                {
                    DR_Error ("Lattice: problem in building the tree (nMin > nMax)!");
                    goto RETURN;
                }
