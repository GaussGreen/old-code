...
*/
int     Fix3_Cap_t ( double     *CapFloor,   /* (I/O) Cap/floor                   */
...
*       Single caplet.
*/
int     Fix3_Caplet_t (  double     *Caplet,     /* (I/O) Caplet/floorlet         */
                    double     *Index,      /* (I) Index                     */
                    double     *Zero,       /* (I) Zero to next payment date */
                    int         CoF,        /* (I) 1 for cap, -1 for floor   */
                    long        CapletFlag, /* (I) Cap/Floor reset flag      */
...
*       Single collaret.
*/
int     Fix3_Collaret_t (double     *Collaret,     /* (I/O) Collaret              */
