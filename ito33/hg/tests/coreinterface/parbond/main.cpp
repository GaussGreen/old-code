...
#include "ito33/finance/analytic_cds.h"
...
int main()
{
 ...
 {  
   ...
   // pModel->SetDebugOutputFile("hg_parbond.xml");
   ...
   parbond.SetComputationalFlags(pFlags);
   ...
   if ( pNumOutput->HasSensitivities() )
   {
     ...
     std::vector<double> 
       sensitivityByFD( hg::ComputeSensitivity(*pModel, parbond, dShift) );
