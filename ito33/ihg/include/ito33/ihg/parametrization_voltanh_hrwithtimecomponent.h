/////////////////////////////////////////////////////////////////////////////
// Name:        ito33/ihg/parametrization_voltanh_hrwithtimecomponent.h
// Purpose:     parametrization using a vol tanh and a hr with time component
// Author:      ITO 33
// Created:     2005/01/05
// RCS-ID:      $Id: parametrization_voltanh_hrwithtimecomponent.h,v 1.12 2006/08/20 09:47:41 wang Exp $
// Copyright:   (c) 2005 - 2006 Trilemma LLP
/////////////////////////////////////////////////////////////////////////////

/**
    @file ito33/ihg/parametrization_voltanh_hrwithtimecomponent.h
    @brief parametrization using a vol tanh and a hr with time component
 */

#ifndef _ITO33_IHG_PARAMETRIZATION_VOLTANH_HRWITHTIMECOMPONENT_H_
#define _ITO33_IHG_PARAMETRIZATION_VOLTANH_HRWITHTIMECOMPONENT_H_
...
/**
   An IHG parametrization for a tanh volatility and a hazard rate
   with time component.
 */
class ITO33_IHG_DLLDECL
ParametrizationVolTanhHRWithTimeComponent : public Parametrization
{
public:
  ...
  /**
     ...
     @param option1 the first option to help calibrate a tanh vol
     @param option2 the second option to help calibrate a tanh vol
...
#endif // #ifndef _ITO33_IHG_PARAMETRIZATION_VOLTANH_HRWITHTIMECOMPONENT_H_
