/////////////////////////////////////////////////////////////////////////////
// Name:        tests/testsuite/calibration/src/testparametrization_voltanhhrpower.h
// Purpose:     header file for testing parametrizationVolTanhHRPower
// Author:      ITO33
// Created:     2005/07/29
// RCS-ID:      $Id: testparametrization_voltanhhrpower.h,v 1.4 2006/08/20 09:49:27 wang Exp $
...
class Parametrization_VolTanhHRPowerTest : public CppUnit::TestCase
{
public:
  Parametrization_VolTanhHRPowerTest() { }

  virtual void tearDown() { }

private:
  CPPUNIT_TEST_SUITE( Parametrization_VolTanhHRPowerTest );
  ...
  ito33::shared_ptr<ito33::ihg::ParametrizationVolTanhHRPower> 
    m_pParametrization;

  NO_COPY_CLASS(Parametrization_VolTanhHRPowerTest);
};
