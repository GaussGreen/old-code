/////////////////////////////////////////////////////////////////////////////
// Name:        tests/testsuite/calibration/src/testparametrization_voltanhhrwithspotcomponentpower.h
// Purpose:     header file for testing parametrizationVolTanhHRWithSpotComponentPower
// Author:      ITO33
// Created:     2006/01/27
// RCS-ID:      $Id: testparametrization_voltanhhrwithspotcomponentpower.h,v 1.3 2006/08/20 09:49:27 wang Exp $
...
class Parametrization_VolTanhHRWithSpotComponentPowerTest : public CppUnit::TestCase
{
public:
  Parametrization_VolTanhHRWithSpotComponentPowerTest() { }

  virtual void tearDown() { }

private:
  CPPUNIT_TEST_SUITE( Parametrization_VolTanhHRWithSpotComponentPowerTest );
  ...
  ito33::shared_ptr<ito33::ihg::ParametrizationVolTanhHRWithSpotComponentPower> 
    m_pParametrization;

  NO_COPY_CLASS(Parametrization_VolTanhHRWithSpotComponentPowerTest);
};
