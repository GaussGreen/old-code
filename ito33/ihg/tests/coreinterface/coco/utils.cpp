...
InitCB(const shared_ptr<SessionData>& pSessionData, const Date issueDate,
       const Date maturityDate,
       const shared_ptr<ito33::finance::ConversionSchedule>& pConversionSchedule)
{
  double
    dIssuePrice = 1,
    dParValue = 110,
       ...
       const Date maturityDate)
{
  ...
  pConvSchedule->AddConversionPeriod( 
    shared_ptr<ConversionPeriod>( new ConversionPeriod(issueDate, maturityDate, 1.e-10) ) );
