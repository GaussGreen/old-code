/////////////////////////////////////////////////////////////////////////////
// Name:        ihg/src/calibration/parametrization_voltanh_hrpower.cpp
// Purpose:     implement ParametrizationVolTanhHRower class
// Author:      ITO 33
// Created:     2005/07/29
// RCS-ID:      $Id: parametrization_voltanh_hrpower.cpp,v 1.15 2006/08/20 09:31:04 wang Exp $
...
void ParametrizationVolTanhHRPower::CalibrateWithDerivatives
     (const finance::Derivatives& derivatives) 
{
  ...
  shared_ptr<ihg::Translator> pTranslator(new ihg::Translator(VolType_tanh, 
  ...
  catch(ito33::numeric::Exception)
  {
    ...
    m_pVolatility = static_pointer_cast<VolatilityTanh>
...
void ParametrizationVolTanhHRPower::Calibrate
     (const finance::BasketGoodType& basket)
{
  CalibrateWithDerivatives(*basket.GetDerivatives());
}

void ParametrizationVolTanhHRPower::Dump
    (ito33::XML::Tag& tagParent) const
{
  // create the root tag
  ito33::XML::Tag tagParametrization
    (XML_TAG_PARAMETRIZATION_VOLTANHHRPOWER_ROOT, tagParent);
}

void ParametrizationVolTanhHRPower::Visit
    (ParametrizationVisitor& visitor) const
{
  visitor.OnParametrizationVolTanhHRPower(*this);
}

shared_ptr<finance::TheoreticalModel> 
   ParametrizationVolTanhHRPower::GetTheoreticalModel()
{
