    ...
    SrtBasisCode  eBasis)
{
    ...
    _ASSERTE((dDF_Front - dDF_Back + dLevel_Mult_Spread + dLevel_Mult_Spread) > 0.);

    return dFltPV / (dDF_Front - dDF_Back + dLevel_Mult_Margin + dLevel_Mult_Spread);
}
