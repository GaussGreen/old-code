...
set  , and also node->drift_sam and node->var_at_sam. If the mid_son_index hits
the top (bottom)  , it is decremented (incremented). Probabilities are bounded
to be between PROBUPB and PROBLUB MODIFIES		  :node->p CALL :
...
/* --------------------------------------------------------------------------------
   ...
   each step maxtreeinf will contain the biggest maxr and maxphi  , and the
   smallest minr and minphi
   --------------------------------------------------------------------------------
 */
