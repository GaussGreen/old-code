...
/*---------------------------------------------------------------------------------------------------
  ...
  This function returns the location of the node of the PsiFunction (Arrow-Debreau function) at the right
  of the last found onde that has to be input as  "NodeLeft"
