    ...
    CRIF_OUTPUTS        sOutputs)
{
    ...
    {
        /* Allocation */
        sSimulArg = (crif_simularg*)calloc(1, sizeof(crif_simularg));
...
Err crif_allocate_outputs(CRIF_OUTPUTS sOutputs)
{
    ...
    sOutputs->sFwdIVInfos      = (crif_fwdiv*)calloc(1, sizeof(crif_fwdiv));
...
Err crif_allocate_fwdiv(CRIF_FWDIV sFwdIVInfos, long lNbCall)
{
    ...
    sFwdIVInfos->dExeProba      = (double*)calloc(sFwdIVInfos->lNbCall, sizeof(double));
    ...
    sFwdIVInfos->dOTCallPartial = (double*)(sFwdIVInfos->lNbCall, sizeof(double));
