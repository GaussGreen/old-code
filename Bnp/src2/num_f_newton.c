/* ==========================================================
   ...
   DESCRIPTION:
                ...
                if niter<= 2  , then we only use first derivatives
                                ...
                                at the end x1 is assigned x2  , x2 is assigned
   x3 and x3 is assigned x3+dx2  , y1 is assigned y2 and y2 is assigned y3 if
   nstop=1  , we do not proceed as x3-x2 is small
