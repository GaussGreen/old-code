/* ===================================================================================
   FILENAME:      swp_f_fwd_swaption.cxx

   PURPOSE:       Computes price of a fwd swaption        , with maturity T , to
   enter into a Fwd swap between T-1 > T and T_2 > T. To model the fwd vol , the
   function uses a method based on CMS replication and Copula simulation in a
   Swap market model context
   ===================================================================================
 */
...

{
  ...
  //   swp_f_ForwardRate(lPayDatesLong[0]        ,lPayDatesLong[1]        ,cFreq
  //   ,cBasis
...

{
  ...
  //      computes the Fwd swap rate
                  ...
                  swp_f_ForwardRate(lPayDatesShort[0]        ,lPayDatesShort[i]
  ,cFreq ,cBasis        ,cYCname        ,cRefRname        ,&dFwd); err =
  GetDensity_Lvl_Measure(nClass ,dMat        ,dFwd        ,SigmaHestonShort[i-1]
  ,AlphaHestonShort[i-1]        ,1.0 ,LambdaHestonShort[i-1]        ,
  ShiftHestonShort[i-1]        ,RhoHestonShort[i-1]        ,dDisc ,dUpBound
  ,iNPts        ,i-1        ,dCov        ,dPPD_Shortx        ,dPPD_Shorty
  ,dCPD_Shorty);
          }
