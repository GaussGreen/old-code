...
#define MY_DBL_EPSILON \
    (10.0 * DBL_EPSILON) /* a little above the smallest such that 1.0+DBL_EPSILON != 1.0 */
    ...
    int n0)
{
...

    {
        ...
        number_of_extra_points = LOCAL_DTOL(proportional_lenght * total_number_of_extra_points);
