...
Err GrfnQuantoAutocalCaller(
  ...
  *prod_val = NULL;
  ...
  if (mth == 0) {
    ...
    /*	PDE */
    err = SrtGrfnQuantoPDE(fx_und_name, num_ex_dates, ex_date, tableauRows,
                           tableauCols, tableauStrings, tableauMask, auxWidth,
                           auxLen, aux, pricing_param->num_stp,
                           pricing_param->num_paths, num_prod, prod_val);
