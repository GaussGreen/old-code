                             ...
                             // minimization loop
{
  ...
  // to calculate the correlation of the data series)  , the historical rank
  // correlation and the the maximum likelihood for the first 10 degrees.
...
// For a given value of the `linear correlation' parameter  , calculate the
// value of m between 0 (Gaussian) and Max_Stud_Degree that maximizes the
...
//
// Inputs: x1		value at which the probability density is to be evaluated
// (can be any real number)
//		   x2		value at which the probability density is to be
//evaluated (can be any real number) 		   m		degree of the distribution (0 is
//Gaussian  , otherwise can be any positive integer)
