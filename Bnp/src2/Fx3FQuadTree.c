...
/* ==========================================================================
   ...
   PURPOSE:		Modelling of a 3 Facors Quadratic Model:
				...
				- Third one is BS with a quadratic volatility function for the Spot Fx.
...
Err			err							= NULL;
			...
			for (i=0; i<n0; i++)
			{
				...
				{				
					...
					{	
						...
						fwd =	svijk[2]
									+ e * Z2 * (svijk[0] - svijk[1]) / model_func -> vol_func(step, Z2, model_param)
									+ f * model_func -> vol_func_deriv(step, Z2, model_param);
	...
	expect_node[2] = sv[0][0][0][2]					
					+ f * model_func -> vol_func_deriv(0, Z2, model_param);
