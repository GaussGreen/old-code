...
Err			err							= NULL;
	...
	if (!transf_matrix || !transf_matrix_next || !transf_matrix_inv || !transf_matrix_inv_next		
		...
		|| !correl || !glob_correl || !covar_matrix
...
Err			err							= NULL;
	...
	{	
		...
		prod_matrix (transf_matrix_inv_next, transf_matrix, temp_mat2, i, j, k, gsum);
		...
		for (l=0; l<3; l++)
		{
			...
			for (j=0; j<3; j++)
			{
				temp_mat2[l][j] += transf_matrix_inv_next[l][1] * b * transf_matrix[2][j];
			}
		}		
