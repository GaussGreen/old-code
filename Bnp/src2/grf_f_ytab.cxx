...
/* Skeleton output parser for bison        ,
   Copyright (C) 1984        , 1989        , 1990 Free Software Foundation ,
   Inc.
...
/* In all cases        , when you get here        , the value and location
   stacks have just been pushed. so pushing a state here evens the stacks.  */
yynewstate:
...
#line 34 "GrfnLang.y"
  {
    COMLL_PTR c;
    c = comll_gotobot(yyvsp[-2].cxxval);
    c = comll_insert_after(c);
    c->type = COMLL_POP;
    yyval.cxxval = comll_join(yyvsp[-2].cxxval, yyvsp[0].cxxval);
    ;
    break;
  }
  case 3:
#line 41 "GrfnLang.y"
  {
    COMLL_PTR c;
    if (comll_atom(yyvsp[-2].cxxval, COMLL_REAL) &&
        comll_atom(yyvsp[0].cxxval, COMLL_REAL)) {
      yyvsp[-2].cxxval->dval =
          (double)(DTOL(yyvsp[-2].cxxval->dval) == DTOL(yyvsp[0].cxxval->dval));
      comll_free_list(yyvsp[0].cxxval);
      yyval.cxxval = yyvsp[-2].cxxval;
    } else {
      c = comll_gotobot(yyvsp[-2].cxxval);
      yyval.cxxval = comll_join(yyvsp[0].cxxval, yyvsp[-2].cxxval);
      c = comll_insert_after(c);
      c->type = COMLL_B_EQ;
    };
    break;
...
#line 83 "GrfnLang.y"
  {
    ...
    if (comll_atom(yyvsp[-2].cxxval, COMLL_REAL) &&
        comll_atom(yyvsp[0].cxxval, COMLL_REAL)) {
      yyvsp[-2].cxxval->dval =
          (double)(yyvsp[-2].cxxval->dval <= yyvsp[0].cxxval->dval);
      comll_free_list(yyvsp[0].cxxval);
      yyval.cxxval = yyvsp[-2].cxxval;
    } else {
      c = comll_gotobot(yyvsp[-2].cxxval);
...
#line 195 "GrfnLang.y"
  {
    ...
    if (comll_atom(yyvsp[-2].cxxval, COMLL_REAL) &&
        comll_atom(yyvsp[0].cxxval, COMLL_REAL)) {
      yyvsp[-2].cxxval->dval =
          pow(yyvsp[-2].cxxval->dval, yyvsp[0].cxxval->dval);
      comll_free_list(yyvsp[0].cxxval);
      yyval.cxxval = yyvsp[-2].cxxval;
    } else {
      c = comll_gotobot(yyvsp[-2].cxxval);
...
#line 209 "GrfnLang.y"
  {
    if (!comll_atom(yyvsp[-2].cxxval, COMLL_VAR))
      yyerror(GRERR_BAD_ASSIGNMENT);
    yyvsp[-2].cxxval->type = COMLL_ASSIGN;
    yyval.cxxval = comll_join(yyvsp[0].cxxval, yyvsp[-2].cxxval);
...
#line 216 "GrfnLang.y"
  {
    COMLL_PTR c;
    if (comll_atom(yyvsp[0].cxxval, COMLL_REAL)) {
      yyvsp[0].cxxval->dval *= -1.0;
    } else {
      c = comll_gotobot(yyvsp[0].cxxval);
      c = comll_insert_after(c);
      c->type = COMLL_REAL;
      c->dval = -1.0;
      c = comll_insert_after(c);
...
#line 231 "GrfnLang.y"
  {
    Err err;
    if (err = grfn_interp_func(yyvsp[-3].sval, yyvsp[-1].cxxval, grfndeal)) {
      yyerror(err);
    }
    yyval.cxxval = yyvsp[-1].cxxval;
    ;
...
#line 238 "GrfnLang.y"
  {
    Err err;
    if (err =
            grfn_interp_cell_func(yyvsp[-3].sval, yyvsp[-1].cxxval, grfndeal)) {
      yyerror(err);
    }
    yyval.cxxval = yyvsp[-1].cxxval;
    ;
...
#line 245 "GrfnLang.y"
  {
    COMLL_PTR c, d;
    c = comll_gotobot(yyvsp[-5].cxxval);
    c = comll_insert_after(c);
    d = comll_gotobot(yyvsp[-3].cxxval);
    d = comll_insert_after(d);
    c->type = COMLL_BRANCH;
    c->next = yyvsp[-3].cxxval;
    yyvsp[-3].cxxval->prev = c;
    d->type = COMLL_JUMP;
    d->next = yyvsp[-1].cxxval;
    yyvsp[-1].cxxval->prev = d;
    c->jmp = d;
    c = comll_gotobot(yyvsp[-1].cxxval);
    d->jmp = c;
    yyval.cxxval = yyvsp[-5].cxxval;
    ;
    break;
  }
  case 21:
#line 262 "GrfnLang.y"
  {
    ...
    if (comll_atom(yyvsp[-3].cxxval, COMLL_REAL))
      yyerror(
          "first argument of IFFIX should be real val") if (grfndeal
                                                                ->is_history) {
        yyval.cxxval = yyvsp[-3].cxxval;
        comll_free_list(yyvsp[-1].cxxval);
      }
    else {
      yyval.cxxval = yyvsp[-1].cxxval;
      comll_free_list(yyvsp[-3].cxxval);
    };
    break;
  }
  case 22:
...
#line 305 "GrfnLang.y"
  {
    yyval.cxxval = comll_join(yyvsp[0].cxxval, yyvsp[-2].cxxval);
    yyval.cxxval->nargs = yyvsp[-2].cxxval->nargs + 1;
    ;
    break;
  }
  }
