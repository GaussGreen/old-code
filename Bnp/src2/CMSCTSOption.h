...
Err cmscts_calibrate_model(CMSCTS_MARKET sMarket, CMSCTS_DEAL sDeal,
                           CMSCTS_SIMULARG sSimulArg, CMSCTS_CALIB sCalibration,
                           CMSCTS_OUTPUTS sOutputs);

Err cmscts_calculate_option(CMSCTS_MARKET sMarket, CMSCTS_DEAL sDeal,
                            CMSCTS_SIMULARG sSimulArg,
                            CMSCTS_PRICING_PARAMS sPricingParams,
                            CMSCTS_OUTPUTS sOutputs);

Err cmscts_calculate_switch_adjust(CMSCTS_MARKET sMarket, CMSCTS_DEAL sDeal,
                                   CMSCTS_SIMULARG sSimulArg,
