...
{ /* BEGIN srt_f_optextrema */
    ...
    **/
    ...
    { /* DELTA FWD UP */
        ...
        answer =
            (srt_f_optextrema(
                 fwd_price + shift, spot, strike, hist_extr, vol, mat, disc, call_put, PREMIUM) -
             premium) /
            shift;
    }
    else if (greek == DELTA)
    ...
    */
    ...
    { /*   VEGA    */
        ...
        answer =
            (srt_f_optextrema(
                 fwd_price, spot, strike, hist_extr, vol + shift, mat, disc, call_put, PREMIUM) -
             premium) /
            shift;
    }
    else if (greek == THETA)
