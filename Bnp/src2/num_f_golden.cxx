...
double golden_section(double ax, double bx, double cx,
                      double (*function)(double), double tol, double *xmin) {
...
/*<startcom>*/
double golden_section_va_list(double ax, double bx, double cx,
                              double (*function)(double, va_list), double tol,
                              double *xmin, ...)
/*<endcom>*/
{
  va_list argptr;
