...
//
///************** proba max *********************/
//double proba_max_fct(
//    double spot, double barrier, double vol, double mat, double r_d, double r_f, int flag)
//{
...
//        yn   = exp(vn * mat) - 1;
//        term = pow(-1, i + 1) * (SRT_PI * vol * vol / (a + b) / (a + b)) * i * yn / vn *
//               sin(SRT_PI * a / (a + b));
