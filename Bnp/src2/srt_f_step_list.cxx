/* ============================================================================
   FILENAME:       srt_f_step_list.cxx
   PURPOSE:        A step contains the information for events at that time and
                   for the time slice that follows.  It is used for discretizing
  a stochastic differential equation in time.

                   Basically        , a SrtStrpPtr is a linked list of time
  steps
  ============================================================================
*/
...
/* is gone */
/* We terminate tminf[i] with 0 in the allocation process        , see
   srtstptminfalloc() */
...
/* Allocates space for tminf (time info) = market information at each step of
 * stp structure */
/* We need to allocate one extra tminf and terminate it with 0        ,
 * otherwise free_node would not work */
/* Size corrsponds to the number of underlyings used: it will allocates space
 * for the **tminf vector */
