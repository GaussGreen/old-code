...
/* -----------------------------------------------------------------------------
  ...
  dates)  , generates a list of EFFECTIVE payment (or start of accrual period)
                        dates  , that are business days adjusted according to
  SrtBusDayConv for a swap with periodicity compd

  AMENDMENT: E.Auld 5 Jan 94 --- added bus_day_start.
                        previously  , swap->start was used  , which caused an
  error when swap->start was not a business day.
  -----------------------------------------------------------------------------
*/
