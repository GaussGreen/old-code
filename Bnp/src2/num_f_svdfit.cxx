/* ====================================================================
  ...
  w[1..ma] provide workspace on input; on output they define the singular value
   ...
   INPUT:	The user supplies a routine funcs(x        ,afunc        ,ma) that
  returns the ma basis functions evaluated at x in the array afunc[1..ma]
