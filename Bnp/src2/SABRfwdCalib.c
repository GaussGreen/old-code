...
Err SABR_fwd_GetSecondGuess_RR(
    void*   Model_,
    void*   Params_,
    int     index_param,
    double  param1,
...
Err SABR_fwd_GetLimitAndLastParam_RR(
    void*           Model_,
...
Err SABR_fwd_BumpParam_RR(void* Model_, void* Params_, int index_param, double param1)
{
    SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_UpdateConstsAfterParam_RR(
...
Err SABR_fwd_GetSecondGuess_BT(
    void*   Model_,
    void*   Params_,
    int     index_param,
    double  param1,
...
Err SABR_fwd_GetLimitAndLastParam_BT(
    void*           Model_,
    CALIBGEN_PARAMS CalibConsts,
    void*           Params_,
    int             index_param,
...
Err SABR_fwd_BumpParam_BT(void* Model_, void* Params_, int index_param, double param1)
{
    SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_UpdateConstsAfterParam_BT(
    void* Inst_, void* InstConst_, void* Params_, void* Model_, CALIBGEN_PARAMS CalibConsts)
{
    SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
    Err             err    = NULL;
...
Err SABR_fwd_GetFirstGuess_VOL(
    void* Model_, void* Params_, int index_param, double target, double* param1)
{
    SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
    double         logVol;
...
Err SABR_fwd_GetSecondGuess_VOL(
    void*   Model_,
    void*   Params_,
    int     index_param,
    double  param1,
...
Err SABR_fwd_GetLimitAndLastParam_VOL(
    void*           Model_,
    CALIBGEN_PARAMS CalibConsts,
    void*           Params_,
    int             index_param,
...
Err SABR_fwd_BumpParam_VOL(void* Model_, void* Params_, int index_param, double param1)
{
    SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_UpdateConstsAfterParam_VOL(
    void* Inst_, void* InstConst_, void* Params_, void* Model_, CALIBGEN_PARAMS CalibConsts)
{
    return NULL;
}

Err SABR_fwd_PriceInst_VOL(
    void* Inst_, void* InstConst_, void* Params_, void* Model_, double* InstPrice)
{
    SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
    SABR_FWD_INST   Inst   = (SABR_FWD_INST)Inst_;
    ...
    double* Results)
{
    ...
    /* For the calibration */
    double strike_down, strike_up, vol_down, vol_atm, vol_up, price_down, price_atm, price_up;
    ...
    price_atm = srt_f_optblksch(
        forward, forward, vol_atm, valTime, discount, outputVol ? SRT_CALL : SRT_PUT, PREMIUM);

    price_down = srt_f_optblksch(
        forward, strike_down, vol_down, valTime, discount, outputVol ? SRT_CALL : SRT_PUT, PREMIUM);

    price_up = srt_f_optblksch(
        forward, strike_up, vol_up, valTime, discount, outputVol ? SRT_CALL : SRT_PUT, PREMIUM);
    ...
    double*  calib_err)
{
    ...
    if (!CalibParamsVol || !CalibParamsAlpha || !CalibParamsRho || !AllFunctionsVol ||
        !AllFunctionsAlpha || !AllFunctionsRho || !Inst || !Model || !Params)
    {
    ...
    err = Initialise_CalibParams(1, precision, nb_iter_max, 1, 1, 1, 0, 0.0, CalibParamsVol);

    if (err)
        goto FREE_RETURN;

    err = Initialise_CalibParams(1, precision, nb_iter_max, 1, 1, 1, 0, 0.0, CalibParamsAlpha);

    if (err)
        goto FREE_RETURN;

    err = Initialise_CalibParams(1, precision, nb_iter_max, 1, 1, 1, 0, 0.0, CalibParamsRho);
    ...
    /* Solve !!! */
    err = CalibrateParamTS(0, 0, &Inst, &Params, Params, Model, CalibParamsRho, AllFunctionsRho);
