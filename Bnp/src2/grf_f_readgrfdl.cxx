...
Err grf_f_readcells(FILE *in, Date **eventdates, GrfnCell ***m, long *nr,
                    long *nc) {
...
Err grf_f_readauxrng(FILE *in, long *auxwidthptr, long **auxlenptr,
                     double ***auxptr) {
...
Err grf_f_readgrfdl(FILE *in, GrfnDeal *gd) {
  ...
  grfn_copy_to_GrfnDeal(gd, nrow, ncol, sprdsht, eventdates, numgrng, grng,
                        auxwidth, auxlen, aux);
