    ...
    int            nterms)
{
    ...
    premium -= strikey *
               prob_tri_scud(l_k, l_yd, l_yu, l_x, mux, muy, sigx, sigy, rho, mat, du, cp, nterms);
...

{
    ...
    for (n = -nterms; n <= nterms; n++)
    {
        ...
        term1 =
            (bivar(
                 du * (-A + rho * sigx * bn / sigy + mux * mat) / sigxrt,
