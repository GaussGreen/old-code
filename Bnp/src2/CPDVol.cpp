...
Err cpd_alloc_smile_vol_market(int num_vols, SMILE_VOL_MARKET smile_mkt)
{
    ...
    smile_mkt->forward = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->sigma   = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->alpha   = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->beta    = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->rho     = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->pi      = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->times   = (double*)calloc(num_vols, sizeof(double));
    smile_mkt->dates   = (long*)calloc(num_vols, sizeof(long));
    ...
    SMILE_PARAMETERS smile_params)
{
    ...
    {
        dates = (double*)calloc(smile_mkt->num_vols, sizeof(double));
