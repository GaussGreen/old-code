...
static Err IMM_fut(
    int nm, int spot, int sy, int sm, Date* fut_last_trading, Date* fut_start, Date* fut_end);
...
Err ccy_string_get_param(SrtCcyParam* ccy_param, String param_name, String* param_val)
{
    Err     err;
    Message val;
...
Err ccy_string_set_param(SrtCcyParam* ccy_param, String param_name, String param_val)
{
    Err     err;
    Message val;
    ...
    int nm, int spot, int sy, int sm, Date* fut_last_trading, Date* fut_start, Date* fut_end)
{
    ...
    *fut_end =
        eleventh_thursday((sm + 1 < 13 ? sm + 1 : 1), (sm + 1 < 13 ? sy : sy + 1)) - 2 + spot;
