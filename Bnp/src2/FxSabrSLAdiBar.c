...
double				logx, logmax, logmin, save1, save3, coef;
	...
	if (is_cvx)
	{
		disc_SL_strike(x, nstepx, spot_fx, bar_ex_down, bar_ex_up, a, b, std1, NSTD_FX, 1.0 / strike2, 0, &index_x);
	}
	else
	{
		disc_SL_strike(x, nstepx, spot_fx, bar_ex_down, bar_ex_up, a, b, std1, NSTD_FX, strike2, 0, &index_x);
	}
