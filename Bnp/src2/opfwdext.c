...
{ /* BEGIN srt_f_optfwdext() */
    ...
    premium = srt_f_optfwdext_price(
        fwd1, fwd2, strike, barrier, vol1, vol2, mat1, mat2, disc, call_put, down_up);
...
{ /* BEGIN srt_f_optfwdext_price */
    ...
    if (mat1 >= mat2)
    {
        if (flag == -1) /* Call Up or Put Down */
        {
            ...
            premium = srt_f_optblksch(fwd1, strike, vol1, mat1, disc, call_put, PREMIUM);

            premium -= srt_f_optblksch(fwd1, barrier, vol1, mat1, disc, call_put, PREMIUM);
