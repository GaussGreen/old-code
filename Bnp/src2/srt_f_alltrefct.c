...
#define bound(X,LUB,UPB){X = DMAX(X,LUB);X = DMIN(X,UPB);}
...
<%%END---------------------------------------------------------------------*/
void find_closest(double target, double *val_array, 
...
/* Returns the index that correspond to the closest smaller value */
  ...
  find_closest(sam_get(node->drift_sam,0,STATEVAR),prev_x,trinf->min_x_index,
    trinf->max_x_index,&node->mid_son_index);  
...
/*<%%ENDDEC>*/
{
  ...
  if(x_i==trinf->min_x_index)x_i++;
  if(x_i==trinf->max_x_index)x_i--;
...
/*<%%ENDDEC>*/
{
  ...
  {
    node->p[2] = second_moment - center_x * center_x - 
      eta * ( center_x+down_x); 
...
void srt_f_nonotreprob (SrtTwoFacTreInf *trinf, SrtNonoTreeNodeInfo *node, double **next_x)
{
	...
	e_x1x1x2 = e_x1 * e_x1 * e_x2 
					+ 2 * e_x1 * (e_x1x2 - e_x1 * e_x2) 
					+ e_x2 * (e_x1x1 - e_x1 * e_x1);
	e_x1x2x2 = e_x2 * e_x2 * e_x1 
					+ 2 * e_x2 * (e_x1x2 - e_x1 * e_x2) 
	...
	node->p[0][0] = e_x1x2/mn + (-(e_x1x2x2*mn) - e_x1x2*mn2)/(2*mn*mn2) +		/* Pdd */
		...
		2*mn*m2n*(-2*mn*(-(e_x1x2x2*mn) - e_x1x2*mn2)*m2n2 - 
		2*mn*mn2*(-(e_x1x1x2x2*mn) + e_x1x2*m2n2)))/
		(16*mn*mn*mn*mn2*m2n*m2n2);
	node->p[0][1] = -(e_x1x2/mn) - (-(e_x1x2x2*mn) - e_x1x2*mn2)/				/* Pd0 */
		(mn*mn2) + e_x1x1/m2 + (-(e_x1x1*m) - e_x1*m2)/(2*m*m2) - 
		(-(e_x1x1x2*mn) - e_x1x2*m2n)/(2*mn*m2n) + 
		(4*mn*mn*mn2*(-(e_x1x1x2*mn) - e_x1x2*m2n)*m2n2 - 
		2*mn*m2n*(-2*mn*(-(e_x1x2x2*mn) - e_x1x2*mn2)*m2n2 - 
		2*mn*mn2*(-(e_x1x1x2x2*mn) + e_x1x2*m2n2)))/
	...
	node->p[1][0] = -(e_x1x2/mn) - (-(e_x1x2x2*mn) - e_x1x2*mn2)/(2*mn*mn2) -	/* P0d */
		...
		2*mn*m2n*(-2*mn*(-(e_x1x2x2*mn) - e_x1x2*mn2)*m2n2 - 
		2*mn*mn2*(-(e_x1x1x2x2*mn) + e_x1x2*m2n2)))/
		(8*mn*mn*mn*mn2*m2n*m2n2) + e_x2x2/n2 + 
	...
	node->p[1][1] = 1 + e_x1x2/mn + (-(e_x1x2x2*mn) - e_x1x2*mn2)/(mn*mn2) -	/* P00 */
		...
		2*mn*m2n*(-2*mn*(-(e_x1x2x2*mn) - e_x1x2*mn2)*m2n2 - 
		2*mn*mn2*(-(e_x1x1x2x2*mn) + e_x1x2*m2n2))) / 
		(4*mn*mn*mn*mn2*m2n*m2n2) - e_x2x2/n2;
	node->p[1][2] = -(-(e_x1x2x2*mn) - e_x1x2*mn2)/(2*mn*mn2) +					/* P0u */
		(4*mn*mn*mn2*(-(e_x1x1x2*mn) - e_x1x2*m2n)*m2n2 - 
		2*mn*m2n*(-2*mn*(-(e_x1x2x2*mn) - e_x1x2*mn2)*m2n2 - 
		2*mn*mn2*(-(e_x1x1x2x2*mn) + e_x1x2*m2n2)))/(8*mn*mn*mn*mn2*m2n*m2n2) - 
		(-(e_x2x2*n) - e_x2*n2)/(2*n*n2);
	...
	node->p[2][2] = -(4*mn*mn*mn2*(-(e_x1x1x2*mn) - e_x1x2*m2n)*m2n2 -			/* Puu */
		2*mn*m2n*(-2*mn*(-(e_x1x2x2*mn) - e_x1x2*mn2)*m2n2 - 
		2*mn*mn2*(-(e_x1x1x2x2*mn) + e_x1x2*m2n2)))/(16*mn*mn*mn*mn2*m2n*m2n2);
}
...
void srt_f_nonotredcntvec (SrtStpPtr stp, 
						   double *cur, 
						   SrtNonoTreeNodeInfo *node, 
						   double ***assets, 
						   long dim)
