...
CMT_Param_Struct *init_CMT_Param(
    String yc_name, String vc_name, String mkt_name,
    Err (*GetVol)(long, long, double,
...
Err CMT_string_set_param(CMT_Param_Struct *cmt_param, String param_name,
                         String param_val) {
  Err err;
  Message val;
  ...
  if ((!strcmp(param_name, "CMTFREQUENCY")) ||
      (!strcmp(param_name, "TECFREQUENCY"))) {
...
Err interp_cmt_string(String cmt_index_string, CMTCode *cmt_code) {
  ...
  if (!strcmp(cmt_index_string, "CMT1") || !strcmp(cmt_index_string, "CMT_1")) {
    *cmt_code = CMT1;
  } else if (!strcmp(cmt_index_string, "CMT2") ||
             !strcmp(cmt_index_string, "CMT_2")) {
    *cmt_code = CMT2;
  } else if (!strcmp(cmt_index_string, "CMT3") ||
             !strcmp(cmt_index_string, "CMT_3")) {
    *cmt_code = CMT3;
  } else if (!strcmp(cmt_index_string, "CMT5") ||
             !strcmp(cmt_index_string, "CMT_5")) {
    *cmt_code = CMT5;
  } else if (!strcmp(cmt_index_string, "CMT7") ||
             !strcmp(cmt_index_string, "CMT_7")) {
    *cmt_code = CMT7;
  } else if (!strcmp(cmt_index_string, "CMT10") ||
             !strcmp(cmt_index_string, "CMT_10")) {
    *cmt_code = CMT10;
  } else if (!strcmp(cmt_index_string, "CMT20") ||
             !strcmp(cmt_index_string, "CMT_20")) {
    *cmt_code = CMT20;
  } else if (!strcmp(cmt_index_string, "CMT30") ||
             !strcmp(cmt_index_string, "CMT_30")) {
    *cmt_code = CMT30;
  } else if (!strcmp(cmt_index_string, "TEC10") ||
