  ...
  */
  ...
  if (total->do_for) {
    for (k = 0; k < total->num_for_df; k++) {
      ...
      (float)total->for_dff[k]); smessage (" total->for_gam1[%d]=%f\n"        ,
      k        , (float)total->for_gam1[k]); smessage ("
      total->for_gam2[%d]=%f\n"        , k        , (float)total->for_gam2[k]);
      smessage (" total->for_gam1_2[%d]=%f\n"        , k        ,
      (float)total->for_gam1_2[k]); smessage (" total->for_gam2_2[%d]=%f\n" , k
            , (float)total->for_gam2_2[k]); smessage ("
      total->for_gam12[%d]=%f\n"        , k        ,
      (float)total->for_gam12[k]); smessage (" DF[%d]=%f\n"        , k        ,
