...

{
  ...
  err = FxLocal_log_approx(today, maturity, nbMat, sig_curve_dom, sig_curve_for,
                           mat_fx, nb_mat_fx, sig_curve_fx, vol_ln_func, params,
                           lda_dom, lda_for, corr_dom_for, corr_dom_fx,
...
Err Fx3DLocalImpliedVol(char *fx_underlying,
  ...
  err = Fx3DLocaltsImpliedVol(
      ...
      vol_ln_func, params, spot_fx, correl_dom_for, correl_dom_fx,
...

{
  ...
  for (i = 0; i < nbrOpt; i++) {
    ...
    err = Fx3DLocaltsImpliedVol(
        ...
        sig_curve_for, lda_for, exercise_opt, nbrOpt, (*fx_vol_curve),
        vol_ln_func, params, spot_fx, correl_dom_for, correl_dom_fx,
        correl_for_fx, dom_yc, for_yc, &vol_imp1, disc_dt, fx_dt);
    if (err) {
      goto FREE_RETURN;
    }
    ...
    while (nIter <= nbIterMax && error > MAX_ERROR) {
      ...
      err = Fx3DLocaltsImpliedVol(
          ...
          sig_curve_for, lda_for, exercise_opt, nbrOpt, (*fx_vol_curve),
          vol_ln_func, params, spot_fx, correl_dom_for, correl_dom_fx,
          correl_for_fx, dom_yc, for_yc, &vol_imp2, disc_dt, fx_dt);
...

{
  ...
  err = Fx3DLocaltsCalibration(
      ...
      nb_merge_dates, sigma_dom, lda_dom, sigma_for, lda_for, vol_ln_func,
      params, spot_fx, correl_dom_for, correl_dom_fx, correl_for_fx, dom_yc,
