/* =================================================================================
  ...
  should be strung together in this way.
  ================================================================================
*/
...
/* BOOLEAN */
static SrtTrnLstEle boolean_SrtTrnLst[] = {{(long)SRT_NO, 0, {"NO", 0}},
                                           {(long)SRT_YES, 0, {"YES", 0}},
                                           {(long)0, 0, {""}}};
...
static SrtTrnLstEle curve_SrtTrnLst[] = {
    ...
    {(long)REPO_CURVE, 0, {"REPO_CURVE", "REPO", "REPO_CRV", 0}},
    {(long)BOND_CURVE, 0, {"BOND_CURVE", "BONDCURVE", "BC", "BNDCRV", 0}},
    {(long)UNKNOWN_CURVE, 0, {"UNKNOWN_CURVE", "UNKNOWN", 0}},
    {(long)0, 0, {""}}};

/* ----------------------- Underlying Type ------------------------------- */
static SrtTrnLstEle underlying_SrtTrnLst[] = {
    {(long)INTEREST_RATE_UND,
     0,
     {"IR_UND", "INTEREST_RATE_UND", "INTEREST_RATE",
      "INTEREST_RATE_UNDERLYING", 0}},
    {(long)FOREX_UND,
     0,
    ...
    {(long)UNKNOWN_UND, 0, {"UNKNOWN_UND", "UNKNOWN", 0}},
    {(long)0, 0, {""}}};
...
static SrtTrnLstEle yieldcurve_SrtTrnLst[] = {
    {(long)SRT_YC,
     0,
     {"SRT_YC", "SORT_YC", "SRT_CURVE", "SRT_YIELD_CURVE", "ZC_OBJ_CURVE",
      "ZC_OBJ", 0}},
    {(long)MAP_YC,
     0,
     {"MAP_YC", "SPG_YC", "SPG_CURVE", "SPG_YIELD_CURVE", "MAPINT_CURVE",
      "MAP_CURVE", 0}},
    {(long)WES_YC,
     0,
     {"WES_YC", "WESTMINSTER_YC", "WES_CURVE", "WETMINSTER_CURVE", 0}},
    {(long)BND_YC, 0, {"BND_YC", "BOND_YC", "BND_CURVE", "BOND_CURVE", 0}},
    {(long)0, 0, {""}}};
...
static SrtTrnLstEle model_SrtTrnLst[] = {
    {(long)CHEY,
     (long)ONE_FAC,
     {"CHEY1F", "CHEY", "LOGNORMAL", "CHE", "CHEY2D_R_TRUNCATE", "CHEYETTE",
      "CHEYETTE1F", 0}},
    {(long)CHEY_BETA,
     (long)ONE_FAC,
     {"CHEYBETA", "CHEYBETA1F", "CHEY_BETA", "CHEY_BETA1F", "CHEY_BETA_1F",
      "CHEYETTEBETA", "CHEYETTE_BETA", 0}},
    {(long)LGM,
     (long)ONE_FAC,
     {"LGM1F", "LGM", "NORMAL", "GAUSS_MARKOV", "LINEAR_GAUSS_MARKOV", "LGM_1F",
      0}},
    {(long)NEWLGM,
     (long)ONE_FAC,
    ...
    {(long)CHEY1D, (long)ONE_FAC, {"CHEY1D", "CHEY_1D", "CHE1D", "CHE_1D", 0}},
    {(long)ETABETA,
     (long)ONE_FAC,
     {"BETAETA", "BE", "BETA_ETA", "SMILE", "EB", "ETA_BETA", "ETABETA", "PAT",
      "LE_MODEL", "THE_ONE", 0}},
    {(long)BDT,
     (long)ONE_FAC,
     {"BDT", "BLACK_DERMAN_TOY", "BLACK_KARASINSKI", "BK", "B_K", 0}},
    {(long)LGM, (long)TWO_FAC, {"LGM2FAC", "LGM_2FAC", "LGM_2F", "LGM2F", 0}},
    {(long)CHEY,
     (long)TWO_FAC,
     {"CHE2FAC", "CHE_2FAC", "CHEY2FAC", "CHEY_2FAC", "CHEY2F", "CHE2F",
      "CHEY_2F", 0}},
    {(long)CHEY_BETA,
     (long)TWO_FAC,
     {"CHEYBETA2F", "CHEY_BETA2F", "CHEY_BETA_2F", "CHEYETTEBETA2F",
      "CHEYETTE_BETA2F", 0}},
    {(long)MIXED_BETA,
     (long)TWO_FAC,
     {"MIXEDBETA2F", "MIXED_BETA2F", "MIXBETA2F", "MIXED_BETA_2F",
      "MIX_BETA_2F", 0}},
    {(long)CHEY_STOCH_VOL,
     (long)ONE_FAC,
     {"CHEY_STOCH_VOL", "CHEY_STOCHVOL1F", "CHEYSTOCHVOL1F", "CHEYSTOCHVOL",
      "CHE_STOCHASTIC_VOL", "STOCH_VOL_CHE", "CSV", 0}},
    {(long)LGM_STOCH_VOL,
     (long)ONE_FAC,
     {"LGM_STOCH_VOL", "LGM_STOCHASTIC_VOL", "STOCH_VOL_LGM", "LGMSV", 0}},
    {(long)CHEY_BETA_STOCH_VOL,
     (long)ONE_FAC,
     {"CHEY_BETA_STOCH_VOL", "CHEYBETA_STOCHVOL1F", "CHEYBETASTOCHVOL",
      "CHEYBETA_STOCH_VOL", "CBSV", 0}},
    {(long)BDT,
     (long)TWO_FAC,
     {"BDT2FAC", "BDT_2FAC", "BDT_2F", "BDT2F", "BK2F", "BK_2F", "BK_2FAC", 0}},
    {(long)VASICEK, (long)ONE_FAC, {"VASICEK", 0}},
    {(long)BLACK_SCHOLES,
     (long)ONE_FAC,
     {"BLACK_SCHOLES", "BLACKSCHOLES", "BS", "BLACK_SCHOLES", "EQD_BS", "B_S",
      0}},
    {(long)FX_STOCH_RATES,
     (long)ONE_FAC,
     {"BS_STOCH_RATES", "STOCH_RATES_FX", "FX_STOCH_RATES", "STOCH_RATES",
      "STOCHRATES", "FX_STOCHRATES", 0}},
    {(long)EQ_STOCH_RATES,
     (long)ONE_FAC,
     {"BS_STOCH_RATES", "STOCH_RATES_EQ", "EQ_STOCH_RATES", "STOCH_RATES",
      "STOCHRATES", "EQ_STOCHRATES", 0}},
    {(long)EQ_STOCH_RATES_SRVGS, (long)ONE_FAC, {"EQ_STOCH_RATES_SRVGS", 0}},
    {(long)NORMAL_BS,
     (long)ONE_FAC,
     {"NORMAL_BLACK_SCHOLES", "NORMAL_BLACK_SCHOLES", "NBS", "NORMAL_BS",
      "NORMALBS", 0}},
    {(long)DRIFTED_NORMAL,
     (long)ONE_FAC,
     {"DRIFT", "DRIFTED_NORMAL", "DN", "DRIFT_NORMAL", "DNORMAL", 0}},
    {(long)CLEAN_TRIN, (long)ONE_FAC, {"CLEAN_TRIN", "CLEAN", "BOND_TRIN", 0}},
    {(long)NONE, (long)NO_FAC, {"NONE", "DETERMINISTIC", 0}},
    {(long)0, 0, {""}}};

/* ---------------- Monte Carlo Discretisation Method ----------------------- */
static SrtTrnLstEle diffscheme_SrtTrnLst[] = {
    {(long)EULER, 0, {"EULER", "EUL", 0}},
    {(long)MILSHTEIN, 0, {"MILSHTEIN", "MIL", 0}},
    {(long)0, 0, {""}}};

/* ----------------------- Random Number Generation Method ---------------------
 */
static SrtTrnLstEle mcsample_SrtTrnLst[] = {
    {(long)RANDOM_GAUSS, 0, {"RG", "RANDOM_GAUSS", 0}},
    {(long)ANTITHETIC, 0, {"ANTI", "ANTITHETIC", 0}},
    {(long)RANDOM_GAUSS_DYNAMIC,
     0,
     {"RANDSAM", "RANDOM_GAUSS_DYNAMIC", "RGD", 0}},
    {(long)ANTITHETIC_DYNAMIC, 0, {"ANTISAM", "ANTITHETIC_DYNAMIC", "AD", 0}},
    {(long)BAL_SAMPLING, 0, {"BALSAM", "BALANCED", 0}},
    {(long)BAL_ANTI,
     0,
     {"BALANTISAM", "BALANCED_ANTITHETIC", "ANTIBAL", "BALANTI", 0}},
    {(long)SOBOL, 0, {"SOBOL", "SOB", 0}},
    {(long)UWAN, 0, {"UWAN", "U1", 0}},
    {(long)ABS, 0, {"ABS", 0}},
    {(long)SPECTRUNC,
     0,
     {"SPECTRUNC", "SPEC_TRUNC", "SPECTRAL_TRUNCATION", "SPECTRAL", 0}},
    {(long)0, 0, {""}}
...
static SrtTrnLstEle algorithm_SrtTrnLst[] = {
    {(long)LEVENBERG_MARQUARDT,
     0,
     {"LM", "LEVENBERG", "LEVENBERG_MARQUARDT", 0}},
    {(long)SIMPLEX, 0, {"SIMPLEX", "SIMP", 0}},
    {(long)SIMULATED_ANNEALING,
     0,
     {"SA", "SIMULATED_ANNEALING", "S_A", "ANNEALING", 0}},
    {(long)SOBENBERG, 0, {"SG", "SOBENBERG", "SOBNBG", "SOBOL_LEVENBERG", 0}},
    {(long)FIXED_POINT,
     0,
     {"FP", "FIXEDPOINT", "FIXED_POINT", "FIXPOINT", "FIX_POINT", "QUICK", 0}},
    {(long)BOOTSTRAP, 0, {"BOOTSTRAP", "BOOT_STRAP", "CALBOOT", "BOOT", 0}},
    {(long)BROYDN, 0, {"BROYDN", "BROY", 0}},
    {(long)0, 0, {""}}
...
static SrtTrnLstEle calibration_SrtTrnLst[] = {
    {(long)GLOBAL_CALIB,
     0,
     {"DEFAULT", "GLOBAL", "GLOB", "CORRELATION", "CALIBRATE", "OPTIMIZE",
      "OPTIMISE", "FIT", 0}},
    {(long)FIXED_CALIB,
     0,
     {"FIXED", "FIXED_CORR", "FIXED_CORRELATION", "FIXEDCORR", "FIX_CORR",
      "FIXED", "FREEZE", 0}},
    {(long)0, 0, {""}}
...
static SrtTrnLstEle measure_SrtTrnLst[] = {
    {(long)SPOT_MEAS,
     0,
     {"DEFAULT", "SPOT", "SPOT_MEASURE", "SPOTMEAS", "SPOT_MEAS", "SPOTMEASURE",
      0}},
    {(long)FINAL_MEAS,
     0,
...
Err srt_f_interp_curve(String curve_str, SrtCurveType *val) {
  ...
  if (err)
    return err;
  if ((tmpLng <= FIRSTSRTCURVETYPE) || (tmpLng >= LASTSRTCURVETYPE)) {
...
Err srt_f_interp_under(String und_str, SrtUnderlyingType *val) {
  ...
  if (err)
    return err;
  if ((tmpLng <= FIRSTSRTUNDERLYINGTYPE) || (tmpLng >= LASTSRTUNDERLYINGTYPE)) {
...
Err srt_f_interp_yc(String crv_str, SrtYieldCurveType *val) {
  ...
  if (err)
    return err;
  if ((tmpLng <= FIRSTSRTYIELDCURVETYPE) || (tmpLng >= LASTSRTYIELDCURVETYPE)) {
