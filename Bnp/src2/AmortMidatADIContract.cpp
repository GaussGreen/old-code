...
////-------------------------------------------------------------------------------------------------------
// double __stdcall _SIGMA1_Sqrd_(const double *pdX1,const double *pdX3,const double *pdT, void*
// pArg)
//{
//	// cast
...
////	Returns : as indicated
////-------------------------------------------------------------------------------------------------------
// double __stdcall _SIGMA3_Sqrd_(const double *pdX1,const double *pdX3,const double *pdT, void*
// pArg)
//{
...
////	Returns : as indicated
////-------------------------------------------------------------------------------------------------------
// double __stdcall _MU1_BACKWARD_(const double *pdX1,const double *pdX3,const double *pdT,void*
// pArg)
//{
//	const _Model *pModel = (const _Model *)pArg;
//	const int n = pdT-pModel->m_pdLocalT_Begin;
...
////	Returns : as indicated
////-------------------------------------------------------------------------------------------------------
// double __stdcall _MU1_FORWARD_(const double *pdX1,const double *pdX3,const double *pdT, void*
// pArg)
//{
...
////	Returns : as indicated
////-------------------------------------------------------------------------------------------------------
// double __stdcall _MU3_BACKWARD_(const double * pdX3,const double * pdX1,const double * pdT, void
// *pArg)
//{
//	// cast
...
////	Returns : as indicated
////-------------------------------------------------------------------------------------------------------
// double __stdcall _MU3_FORWARD_(const double *pdX3,const double *pdX1,const double *pdT, void
// *pArg)
//{
...
//	*(const double**)(&pComm->m_pdLocalLam_Begin)=pdLocalLam_Begin;//_alloca(nNumT *
//sizeof(double));
//	*(const double**)(&pComm->m_pdLocalSig_Begin)=pdLocalSig_Begin;//_alloca(nNumT *
//sizeof(double));
//
//	_bmatch_ex(
...
////						U solves
///U(t,x1,x3)=E[Integrand(T,X(T))|X1(t)=x,X3(t)=x3]
////
////						NB: U traverses from *pdT_Begin to *(pdT_End-1)
////						To solve for the backward equation, pdT should be decreasing and
///for the forward equation, increasing.
////
////
////	Returns : U(0,0)
////-------------------------------------------------------------------------------------------------------
...
//			(pGrid->m_pdX3_Begin-pGrid->m_pdX3_Begin_+
//(pGrid->m_pdX3_End-pGrid->m_pdX3_Begin)/2)); 		_ASSERTE( pGrid->m_nX1_Zero ==
//			(pGrid->m_pdX1_Begin-pGrid->m_pdX1_Begin_+
