...
*                                                                           
*******************************************************************************/
static double optvalstrike(double fwd,double strike,double vol,double mat,double disc_fact,
...
double 	deriv;
	...
	for (i = 0; i <= MAX_ITER; i++)
	{
		...
		prem_new = optvalstrike(fwd_price,
								strike_guess,
								vol,
								mat, 
								disc, 
