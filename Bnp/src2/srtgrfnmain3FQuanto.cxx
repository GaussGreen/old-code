...
char *SrtGrfn3FQuantoTree(char *und3Fquanto, double *correl_dates,
  ...
  if (xStr.num_und > 3) {
    err = "Fx3FQuantoGrfn can only accept 3 underlyings        , please check "
          "the "
  ...
  // Create an array containing all dates of r1_sigma        , r3_sigma and
  // fx_sigma which are <= the last event date
