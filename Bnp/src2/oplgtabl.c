    ...
    SrtGreekType   greek)
{
    ...
    premium =
        srt_f_optblksch(fwd, strike, vol, mat, disc, call_put, PREMIUM) -
        srt_f_optexting(fwd, spot, strike, barrier, vol, mat, disc, call_put, down_up, PREMIUM);
