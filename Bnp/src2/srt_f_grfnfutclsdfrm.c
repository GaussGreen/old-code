/* -------------------------------------------------------------------------
   ...
   without the Grfn interface as of a date in the FUTURE  , taking todays
   forward curve as input. THese functions take simplified descriptions of the
   products to be priced  , and construct arrays of Grfn cells to feed to the
   Grfn function If LGM can be used  , then switch to closed form
   ------------------------------------------------------------------------- */
