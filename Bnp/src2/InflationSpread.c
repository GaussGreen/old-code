...
Err setInflationStructure(char *csUndName, Date dtExpiry, Date *dtvMaturity,
  ...
  sArg->dRateMean =
      0.0; /* swp_f_zr( dtExpiry-7.0  , dtExpiry+7.0  , csYCName ); */
...
Err srt_InflationSpread(char *csUndName, Date dtExpiry, Date *dtvMaturity,
  ...
  /* Set the upper and lower limits  , the number of points and the desired
   * accuracy (or use default values) */
  iDim = 2;
...
Err srt_CalibrateInflationSpread(char *csYCname, double dSpotSpread,
  ...
  /* Loop over the dates  , calculating the times and the difference of the
   * exponentials */
