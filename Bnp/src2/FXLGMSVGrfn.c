...
static Err		err	= NULL;
	...
	if (total->do_dom)
	{
		...
		{
			local->evt->df[total->dom_idx][k] = exp (total->dom_dff[k]
										- total->dom_gam1[k] * domft1 
										- total->dom_gam2[k] * domft2
										- total->dom_gam1_2[k] * dompsi1
										- total->dom_gam2_2[k] * dompsi2
	...
	if (total->do_fx)
	{
		...
		{
			local->evt->df[total->fx_idx][k] = exp (total->fx_dff[k]
										- total->fx_gam1[k] * domft1 
										- total->fx_gam2[k] * domft2
										- total->fx_gam1_2[k] * dompsi1
										- total->fx_gam2_2[k] * dompsi2
	...
	if (total->do_for)
	{
		...
		{
			local->evt->df[total->for_idx][k] = exp (total->for_dff[k]
										- total->for_gam1[k] * forft1 
										- total->for_gam2[k] * forft2
										- total->for_gam1_2[k] * forpsi1
										- total->for_gam2_2[k] * forpsi2
