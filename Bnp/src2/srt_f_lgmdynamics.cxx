/* =================================================================================
   ...
   FILENAME: srt_f_lgmdynamics.cxx
   ...
   PURPOSE:  Give all the Equations required to descretise the LGM model:
                                ...
                                - variance of r at t+1 knowing t (and same for
   phi)
   =================================================================================
 */
...
void srt_f_lgmdrfatsam(SrtStpPtr stp, SrtSample *cur_sam, SrtSample *drift_sam,
                       int index) {
  double mu;
  SrtIRMTmInf *tminf;
  ...
  /* cur_sam and drift_sam are all fwd_sam's when this function is called ,
     therefore they all should have index 0 in sam_get and samptr_get macros
     K L Chau 6/6/95 */

  mu = -tminf->ev.onef.lambda * samptr_get(cur_sam, 0, STATEVAR) * stp->delta_t;
