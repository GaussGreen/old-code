...
Free_SABRfwd_Model(SABR_FWD_MODEL Model) {
  if (Model) {
    if (Model->matrix)
      free_dmatrix(Model->matrix, 0, Model->nSimul - 1, 0, 2);
    Model->matrix = NULL;

    if (Model->mergeTimes)
      free(Model->mergeTimes);
...
Err SABR_fwd_GetTarget_RR(void *Inst_, void *Params_, void *Model_,
...
Err SABR_fwd_GetFirstGuess_RR(void *Model_, void *Params_, int index_param,
...
Err SABR_fwd_GetSecondGuess_RR(void *Model_, void *Params_, int index_param,
...
Err SABR_fwd_GetLimitAndLastParam_RR(void *Model_, CALIBGEN_PARAMS CalibConsts,
...
Err SABR_fwd_BumpParam_RR(void *Model_, void *Params_, int index_param,
                          double param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_SetParam_RR(void *Model_, CALIBGEN_PARAMS CalibConsts,
...
Err SABR_fwd_ExtrapolParam_RR(void *Model_, void *Params_, int index_param) {
  return NULL;
}

Err SABR_fwd_UpdateConstsAfterParam_RR(void *Inst_, void *InstConst_,
...
Err SABR_fwd_PriceInst_RR(void *Inst_, void *InstConst_, void *Params_,
...
Err SABR_fwd_GetTarget_BT(void *Inst_, void *Params_, void *Model_,
                          CALIBGEN_PARAMS CalibConsts, double *target) {
  SABR_FWD_INST Inst = (SABR_FWD_INST)Inst_;
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
  SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
  ...
  if (Params->solve_on_vol)
    *target = Inst->target_vol_up + Inst->target_vol_down -
              2.0 * Inst->target_vol_atm;
  else
    *target = Inst->target_price_up + Inst->target_price_down -
              2.0 * Inst->target_price_atm;

  return NULL;
}

Err SABR_fwd_GetFirstGuess_BT(void *Model_, void *Params_, int index_param,
                              double target, double *param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_GetSecondGuess_BT(void *Model_, void *Params_, int index_param,
                               double param1, double price1, double target,
                               double *param2) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
  SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
...
Err SABR_fwd_GetLimitAndLastParam_BT(void *Model_, CALIBGEN_PARAMS CalibConsts,
                                     void *Params_, int index_param,
                                     double *last_param, double *limit_down,
                                     double *limit_up) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_BumpParam_BT(void *Model_, void *Params_, int index_param,
                          double param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_SetParam_BT(void *Model_, CALIBGEN_PARAMS CalibConsts,
                         void *Params_, int index_param, double param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_ExtrapolParam_BT(void *Model_, void *Params_, int index_param) {
  return NULL;
}

Err SABR_fwd_UpdateConstsAfterParam_BT(void *Inst_, void *InstConst_,
                                       void *Params_, void *Model_,
                                       CALIBGEN_PARAMS CalibConsts) {
  SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
  Err err = NULL;
  ...
  err =
      CalibrateParamTS(0, 0, &Inst_, &Params_, Params_, Model_,
                       Params->CalibParams_ForVol, Params->AllFunctions_ForVol);

  return err;
}

Err SABR_fwd_PriceInst_BT(void *Inst_, void *InstConst_, void *Params_,
                          void *Model_, double *InstPrice) {
  SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
  SABR_FWD_INST Inst = (SABR_FWD_INST)Inst_;
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
  ...
  if (!Model->SVfudge) {
    err = fwdSABRpayoff(
        Model->today, Model->forwardFixDate, Model->forwardFixTime,
        Model->valDate, Model->fixTime, Model->valTime, Model->fwd,
        Model->SigmaFwd, Model->AlphaFwd, Model->BetaFwd, Model->RhoFwd,
        Model->matrix, Model->nSimul, Model->tstarTime, Model->tstarDate,
        Model->dom_yc, Model->for_yc, Model->mergeTimes, Model->mergeNtimes,
        Model->sigDom, Model->lda_dom, Model->sigFor, Model->lda_for,
        Model->mergeTimes, Model->sigFx, Model->mergeNtimes, Model->mergeTimes,
        Model->corDF, Model->corDFx, Model->corFFx, Model->mergeNtimes, 2,
        strikes, Params->solve_on_vol, Params->solve_on_vol, vols);
    ...
    err = fwdSABRpayoffAlphaFudge(
        ...
        Model->mergeTimes, Model->sigFx, Model->mergeNtimes, Model->mergeTimes,
        Model->corDF, Model->corDFx, Model->corFFx, Model->mergeNtimes, 2,
        strikes, Params->solve_on_vol, Params->solve_on_vol,
        Model->SVfudgeSwitchLevel, Model->SVfudgeProba, Model->SVfudgeAlpha,
        vols);
...
Err SABR_fwd_GetTarget_VOL(void *Inst_, void *Params_, void *Model_,
                           CALIBGEN_PARAMS CalibConsts, double *target) {
  SABR_FWD_INST Inst = (SABR_FWD_INST)Inst_;
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
  SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
...
Err SABR_fwd_GetFirstGuess_VOL(void *Model_, void *Params_, int index_param,
                               double target, double *param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
  double logVol;
  ...
  err = Fx3DtsImpliedVol_corr(
      Model->valTime, Model->forwardFixTime, Model->fixTime, Model->mergeTimes,
      (long)Model->mergeNtimes, Model->sigDom, Model->lda_dom, Model->sigFor,
      Model->lda_for, Model->mergeTimes, Model->sigFx, (long)Model->mergeNtimes,
      Model->mergeTimes, Model->corDF, Model->corDFx, Model->corFFx,
      (long)Model->mergeNtimes, &logVol);

  err = srt_f_optsarbvol(Model->fwd, Model->fwd, Model->valTime, logVol,
                         Model->AlphaFwd, Model->BetaFwd, Model->RhoFwd,
                         SRT_LOGNORMAL, SRT_BETAVOL, param1);

  return NULL;
}

Err SABR_fwd_GetSecondGuess_VOL(void *Model_, void *Params_, int index_param,
                                double param1, double price1, double target,
                                double *param2) {
  if (price1 > target) {
    *param2 = param1 * 0.98;
...
Err SABR_fwd_GetLimitAndLastParam_VOL(void *Model_, CALIBGEN_PARAMS CalibConsts,
                                      void *Params_, int index_param,
                                      double *last_param, double *limit_down,
                                      double *limit_up) {
  *limit_down = 1e-5;
...
Err SABR_fwd_BumpParam_VOL(void *Model_, void *Params_, int index_param,
                           double param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_SetParam_VOL(void *Model_, CALIBGEN_PARAMS CalibConsts,
                          void *Params_, int index_param, double param1) {
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
...
Err SABR_fwd_ExtrapolParam_VOL(void *Model_, void *Params_, int index_param) {
  return NULL;
}

Err SABR_fwd_UpdateConstsAfterParam_VOL(void *Inst_, void *InstConst_,
                                        void *Params_, void *Model_,
                                        CALIBGEN_PARAMS CalibConsts) {
  return NULL;
}

Err SABR_fwd_PriceInst_VOL(void *Inst_, void *InstConst_, void *Params_,
                           void *Model_, double *InstPrice) {
  SABR_FWD_PARAMS Params = (SABR_FWD_PARAMS)Params_;
  SABR_FWD_INST Inst = (SABR_FWD_INST)Inst_;
  SABR_FWD_MODEL Model = (SABR_FWD_MODEL)Model_;
  ...
  if (!Model->SVfudge) {
    err = fwdSABRpayoff(
        ...
        Model->sigDom, Model->lda_dom, Model->sigFor, Model->lda_for,
        Model->mergeTimes, Model->sigFx, Model->mergeNtimes, Model->mergeTimes,
        Model->corDF, Model->corDFx, Model->corFFx, Model->mergeNtimes, 1,
        strikes, Params->solve_on_vol, Params->solve_on_vol, vols);
...
PRECALCULATIONS
=====================================*/
Err calib_sabr_fwd_rr_bt_given_beta_precalc(
    ...
    double *correl_for_fx, int corr_n_times, double SABRvol, double SABRalpha,
    double SABRbeta, double SABRrho, double SABRvol2, double SABRalpha2,
    double SABRbeta2, double SABRrho2, double FirstGuessSABRvol,
    double FirstGuessSABRalpha, double FirstGuessSABRbeta,
    double FirstGuessSABRrho, int nSimul, int nPoints, int nIter, int nStd,
    double std, int smileModel, int outputVol, int SVfudge,
    double SVfudgeSwitchLevel, double SVfudgeProba, double SVfudgeAlpha,
    double *Results) {
  ...
  /* For the calibration */
  double strike_down, strike_up, vol_down, vol_atm, vol_up, price_down,
      price_atm, price_up;
  ...
  err =
      OTCgetCopula(forward, forwardFixTime, tstarTime, mergeTimes, mergeNtimes,
                   ...
                   corFFx, SABRvol, SABRalpha, SABRbeta, SABRrho, nSimul,
                   nPoints, nIter, nStd, std, smileModel, matrix);
  ...
  err = srt_f_optsarbvol(forward, strike_down, valTime, SABRvol2, SABRalpha2,
                         SABRbeta2, SABRrho2, SRT_LOGNORMAL, SRT_LOGNORMAL,
                         &vol_down);

  if (err)
    goto FREE_RETURN;

  err = srt_f_optsarbvol(forward, strike_up, valTime, SABRvol2, SABRalpha2,
                         SABRbeta2, SABRrho2, SRT_LOGNORMAL, SRT_LOGNORMAL,
                         &vol_up);
  ...
  price_atm = srt_f_optblksch(forward, forward, vol_atm, valTime, discount,
                              outputVol ? SRT_CALL : SRT_PUT, PREMIUM);

  price_down =
      srt_f_optblksch(forward, strike_down, vol_down, valTime, discount,
                      outputVol ? SRT_CALL : SRT_PUT, PREMIUM);

  price_up = srt_f_optblksch(forward, strike_up, vol_up, valTime, discount,
                             outputVol ? SRT_CALL : SRT_PUT, PREMIUM);

  err = calib_sabr_fwd_rr_bt_given_beta(
      forward, today, forwardFixDate, valDate, tstarDate, forwardFixTime,
      fixTime, valTime, tstarTime, matrix, nSimul, outputVol, dom_yc, for_yc,
      mergeTimes, mergeNtimes, sigDom, lda_dom, sigFor, lda_for, sigFx, corDF,
      corDFx, corFFx, vol_atm, price_atm, strike_down, vol_down, price_down,
      strike_up, vol_up, price_up, SVfudge, SVfudgeSwitchLevel, SVfudgeProba,
      SVfudgeAlpha, &(Results[0]), &(Results[1]), Results[2], &(Results[3]),
      precision, nb_iter_max, &(Results[4]));
...
=====================================*/
Err calib_sabr_fwd_rr_bt_given_beta(
    double fwd, long today, long forwardFixDate, long valDate, long tstarDate,
    double forwardFixTime, double fixTime, double valTime, double tstarTime,
    double **matrix, int nSimul, int outputVol, char *dom_yc, char *for_yc,
    double *mergeTimes, int mergeNtimes, double *sigDom, double lda_dom,
    double *sigFor, double lda_for, double *sigFx, double *corDF,
    double *corDFx, double *corFFx, double vol_atm, double price_atm,
    double strike_down, double vol_down, double price_down, double strike_up,
    double vol_up, double price_up, int SVfudge, double SVfudgeSwitchLevel,
    double SVfudgeProba, double SVfudgeAlpha, double *sigma, double *alpha,
    double fixed_beta, double *rho, double precision, int nb_iter_max,
    double *calib_err) {
  ...
  if (!CalibParamsVol || !CalibParamsAlpha || !CalibParamsRho ||
      !AllFunctionsVol || !AllFunctionsAlpha || !AllFunctionsRho || !Inst ||
      !Model || !Params) {
  ...
  AllFunctionsAlpha->UpdateConstsAfterParam =
      SABR_fwd_UpdateConstsAfterParam_BT;
