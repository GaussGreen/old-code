...
doublereal alngam_(doublereal* x)
{
    ...
    static doublereal scoefn[9] = {
        62.003838007127258804,
        36.036772530024836321,
        20.782472531792126786,
        6.338067999387272343,
        2.15994312846059073,
        .3980671310203570498,
        .1093115956710439502,
        .0092381945590275995,
        .0029737866448101651};
    static doublereal scoefd[4] = {
        62.003838007126989331, 9.822521104713994894, -8.906016659497461257, 1.};
    static doublereal coef[5] = {
        .083333333333333023564,
        -.0027777777768818808,
        7.9365006754279e-4,
        -5.94997310889e-4,
        8.065880899e-4};
...
doublereal gam1_(doublereal* a)
{
    ...
    static doublereal p[7] = {
        ...
        -.00514889771323592,
        5.89597428611429e-4};
    static doublereal q[5] = {
        1., .427569613095214, .158451672430138, .0261132021441447, .00423244297896961};
...
L40:
    top = (((((((r__[8] * t + r__[7]) * t + r__[6]) * t + r__[5]) * t + r__[4]) * t + r__[3]) * t +
            r__[2]) *
               t +
           r__[1]) *
              t +
...
doublereal erf_(doublereal* x)
{
    ...
    static doublereal a[5] = {
        7.7105849500132e-5,
        -.00133733772997339,
        .0323076579225834,
        .0479137145607681,
        .128379167095513};
    static doublereal b[3] = {.00301048631703895, .0538971687740286, .375795757275549};
    static doublereal p[8] = {
        -1.36864857382717e-7,
        .564195517478974,
        7.21175825088309,
        43.1622272220567,
    ...
    static doublereal q[8] = {
        ...
        790.950925327898,
        300.459260956983};
    static doublereal r__[5] = {
        2.10144126479064, 26.2370141675169, 21.3688200555087, 4.6580782871847, .282094791773523};
    static doublereal s[4] = {94.153775055546, 187.11481179959, 99.0191814623914, 18.0124575948747};
...
L10:
    ...
    top = ((((((p[0] * ax + p[1]) * ax + p[2]) * ax + p[3]) * ax + p[4]) * ax + p[5]) * ax + p[6]) *
              ax +
          p[7];
    bot = ((((((q[0] * ax + q[1]) * ax + q[2]) * ax + q[3]) * ax + q[4]) * ax + q[5]) * ax + q[6]) *
              ax +
          q[7];
...
/* Subroutine */ int gratio_(
    doublereal* a, doublereal* x, doublereal* ans, doublereal* qans, integer* ind)
{
    /* Initialized data */
    ...
    static doublereal d5[4] = {
        -6.97281375836586e-5, 2.77275324495939e-4, -1.99325705161888e-4, 6.79778047793721e-5};
    ...
    static doublereal c0, c1, c2, c3, c4, c5, c6, e0, t1, x0, an, wk[20], am0, an0, a2n, b2n;
...
L280:
    ...
    c0 = ((((((((((((d0[12] * z__ + d0[11]) * z__ + d0[10]) * z__ + d0[9]) * z__ + d0[8]) * z__ +
                 d0[7]) *
                    z__ +
                d0[6]) *
                   z__ +
          ...
          d0[0]) *
             z__ -
         third;
    c1 = (((((((((((d1[11] * z__ + d1[10]) * z__ + d1[9]) * z__ + d1[8]) * z__ + d1[7]) * z__ +
                d1[6]) *
                   z__ +
               d1[5]) *
                  z__ +
          ...
          d1[0]) *
             z__ +
         d10;
    c2 = (((((((((d2[9] * z__ + d2[8]) * z__ + d2[7]) * z__ + d2[6]) * z__ + d2[5]) * z__ + d2[4]) *
                 z__ +
             d2[3]) *
                z__ +
            d2[2]) *
          ...
          d2[0]) *
             z__ +
         d20;
    c3 = (((((((d3[7] * z__ + d3[6]) * z__ + d3[5]) * z__ + d3[4]) * z__ + d3[3]) * z__ + d3[2]) *
               z__ +
           d3[1]) *
              z__ +
          d3[0]) *
             z__ +
         d30;
    c4 = (((((d4[5] * z__ + d4[4]) * z__ + d4[3]) * z__ + d4[2]) * z__ + d4[1]) * z__ + d4[0]) *
             z__ +
         d40;
...
L290:
    c0 = (((((d0[5] * z__ + d0[4]) * z__ + d0[3]) * z__ + d0[2]) * z__ + d0[1]) * z__ + d0[0]) *
             z__ -
         third;
...
L340:
    c0 = ((((((d0[6] * z__ + d0[5]) * z__ + d0[4]) * z__ + d0[3]) * z__ + d0[2]) * z__ + d0[1]) *
              z__ +
          d0[0]) *
             z__ -
         third;
    c1 = (((((d1[5] * z__ + d1[4]) * z__ + d1[3]) * z__ + d1[2]) * z__ + d1[1]) * z__ + d1[0]) *
             z__ +
         d10;
    c2 = ((((d2[4] * z__ + d2[3]) * z__ + d2[2]) * z__ + d2[1]) * z__ + d2[0]) * z__ + d20;
...
/* Subroutine */ int cumgam_(doublereal* x, doublereal* a, doublereal* cum, doublereal* ccum)
{
    extern /* Subroutine */ int gratio_(
...
{
    static doublereal           a;
    extern /* Subroutine */ int cumgam_(doublereal*, doublereal*, doublereal*, doublereal*);
...
/* Subroutine */ int cumchn_(
    doublereal* x, doublereal* df, doublereal* pnonc, doublereal* cum, doublereal* ccum)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int cumchi_(doublereal*, doublereal*, doublereal*, doublereal*);
