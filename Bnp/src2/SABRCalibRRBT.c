...
Err	SABR_RRBT_GetTarget_RR(	void				*Inst_,
							void				*Params_,
							void				*Model_,
...
Err	SABR_RRBT_GetFirstGuess_RR(	void				*Model_,
								void				*Params_,
								int					index_param,
								double				target,
								double				*param1)
...
Err	SABR_RRBT_GetSecondGuess_RR(void				*Model_,
								void				*Params_,
								int					index_param,
								double				param1,
								double				price1,
...
Err	SABR_RRBT_GetLimitAndLastParam_RR(	void				*Model_,
										CALIBGEN_PARAMS	CalibConsts,
										void				*Params_,
										int					index_param,
										double				*last_param,
...
Err	SABR_RRBT_BumpParam_RR(	void				*Model_,
							void				*Params_,
							int					index_param,
							double				param1)
{
...
Err	SABR_RRBT_SetParam_RR(	void				*Model_,
							CALIBGEN_PARAMS	CalibConsts,
							void				*Params_,
							int					index_param,
							double				param1)
...
Err	SABR_RRBT_ExtrapolParam_RR(	void				*Model_,
								void				*Params_,
								int					index_param)
{
	return NULL;
...
Err	SABR_RRBT_UpdateConstsAfterParam_RR(void				*Inst_,
										void				*InstConst_,
										void				*Params_,
										void				*Model_,
										CALIBGEN_PARAMS	CalibConsts)
...
Err	SABR_RRBT_PriceInst_RR(	void				*Inst_,
							void				*InstConst_,
							void				*Params_,
							void				*Model_,
							double				*InstPrice)
...
Err	SABR_RRBT_GetTarget_BT(	void				*Inst_,
							void				*Params_,
							void				*Model_,
							CALIBGEN_PARAMS	CalibConsts,
							double				*target)
...
Err	SABR_RRBT_GetFirstGuess_BT(	void				*Model_,
								void				*Params_,
								int					index_param,
								double				target,
								double				*param1)
...
Err	SABR_RRBT_GetSecondGuess_BT(void				*Model_,
								void				*Params_,
								int					index_param,
								double				param1,
								double				price1,
...
Err	SABR_RRBT_GetLimitAndLastParam_BT(	void				*Model_,
										CALIBGEN_PARAMS	CalibConsts,
										void				*Params_,
										int					index_param,
										double				*last_param,
...
Err	SABR_RRBT_BumpParam_BT(	void				*Model_,
							void				*Params_,
							int					index_param,
							double				param1)
{
...
Err	SABR_RRBT_SetParam_BT(	void				*Model_,
							CALIBGEN_PARAMS	CalibConsts,
							void				*Params_,
							int					index_param,
							double				param1)
...
Err	SABR_RRBT_ExtrapolParam_BT(void				*Model_,
								void				*Params_,
								int					index_param)
{
	return NULL;
...
Err	SABR_RRBT_UpdateConstsAfterParam_BT(void				*Inst_,
										void				*InstConst_,
										void				*Params_,
										void				*Model_,
										CALIBGEN_PARAMS	CalibConsts)
...
Err	SABR_RRBT_PriceInst_BT(	void				*Inst_,
							void				*InstConst_,
							void				*Params_,
							void				*Model_,
							double				*InstPrice)
...
Err	err = NULL;
	...
	if (!CalibParamsRho || !CalibParamsAlpha || !AllFunctionsAlpha || !AllFunctionsRho
		|| !Inst || !Model || !Params)
	{
...
Err		err = NULL;
	...
	*new_rho = init_rho + (init_beta - new_beta) * vol_atm / init_alpha;
	...
	err = calib_sabr_rr_bt_given_beta(fwd,
									mat,
									vol_atm,
									strike_down,
									vol_down,
