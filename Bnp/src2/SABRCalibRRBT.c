...
Err SABR_RRBT_GetFirstGuess_RR(
...
Err SABR_RRBT_GetSecondGuess_RR(
    void*   Model_,
    void*   Params_,
    int     index_param,
    double  param1,
...
Err SABR_RRBT_GetLimitAndLastParam_RR(
    void*           Model_,
...
Err SABR_RRBT_BumpParam_RR(void* Model_, void* Params_, int index_param, double param1)
{
    SABR_RRBT_MODEL Model = (SABR_RRBT_MODEL)Model_;
...
Err SABR_RRBT_UpdateConstsAfterParam_RR(
    ...
    void* Inst_, void* Params_, void* Model_, CALIBGEN_PARAMS CalibConsts, double* target)
{
    ...
    {
        *target = Inst->target_price_up - Inst->target_price_down - 2.0 * Inst->price_atm;
    }

    return NULL;
}

Err SABR_RRBT_GetFirstGuess_BT(
    void* Model_, void* Params_, int index_param, double target, double* param1)
{
    SABR_RRBT_MODEL Model = (SABR_RRBT_MODEL)Model_;
...
Err SABR_RRBT_GetSecondGuess_BT(
    void*   Model_,
    void*   Params_,
    int     index_param,
    double  param1,
...
Err SABR_RRBT_GetLimitAndLastParam_BT(
    void*           Model_,
    CALIBGEN_PARAMS CalibConsts,
    void*           Params_,
    int             index_param,
...
Err SABR_RRBT_BumpParam_BT(void* Model_, void* Params_, int index_param, double param1)
{
    SABR_RRBT_MODEL Model = (SABR_RRBT_MODEL)Model_;
...
Err SABR_RRBT_UpdateConstsAfterParam_BT(
    void* Inst_, void* InstConst_, void* Params_, void* Model_, CALIBGEN_PARAMS CalibConsts)
{
    SABR_RRBT_PARAMS Params = (SABR_RRBT_PARAMS)Params_;
    SABR_RRBT_MODEL  Model  = (SABR_RRBT_MODEL)Model_;
    ...
    double*          calib_err)
{
    ...
    if (!CalibParamsRho || !CalibParamsAlpha || !AllFunctionsAlpha || !AllFunctionsRho || !Inst ||
        !Model || !Params)
    {
    ...
    AllFunctionsAlpha->UpdateConstsAfterParam = SABR_RRBT_UpdateConstsAfterParam_BT;
