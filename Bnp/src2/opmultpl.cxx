 ...
 *
 * DESCRIPTION  	: At maturity        , the holder receives the price
 *difference between some asset S1 and a strike K1        , times the price
 *difference between a 2nd asset S2 and another strike K2        , times a
 *gearing.
 *
