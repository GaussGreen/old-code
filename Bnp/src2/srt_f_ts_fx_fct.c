...
/*O_fd def: int(s = 0  , s = t) [pfd(s)*s_dom(s)*s_for(s)/(F_dom(s)*F_for(s))]
 * ds */
...
/* int ( s = 0  , s = t) [pfd(s)*s_ifr_dom(s  ,t)*s_ifr_for(s  ,t)] ds =
 * F_dom(t)*F_for(t)*O_fd(t) */
...
/* W_fd def: int(s=0  , s = t) [ p_fd(s)*s_dom(s)*s_for(s)*Psi_dom(s)/F_dom(s)]
 * ds */
