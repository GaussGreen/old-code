...
Message val;
	...
	{
		if(err = (interp_vol_calc_method(param_val,&val))) return err;
		cmt_param->use_prop_vol_flg = val;
		return NULL;
	}
	if(!strcmp(param_name,"INTERPONSPREAD"))
	{
		if(err = (interp_interp_on_spread(param_val,&val))) return err;
...
Err err=NULL;
	...
	if ( !strcmp(cmt_index_string, "CMT1") 
		|| !strcmp(cmt_index_string,"CMT_1"))
	{ 	*cmt_code = CMT1;}
	else
	if ( !strcmp(cmt_index_string, "CMT2") 
		|| !strcmp(cmt_index_string,"CMT_2"))
	{ 	*cmt_code = CMT2;}
	else
	if ( !strcmp(cmt_index_string, "CMT3") 
		|| !strcmp(cmt_index_string,"CMT_3"))
	{ 	*cmt_code = CMT3;}
	else
	if ( !strcmp(cmt_index_string, "CMT5") 
		|| !strcmp(cmt_index_string,"CMT_5"))
	{ 	*cmt_code = CMT5;}
	else
	if ( !strcmp(cmt_index_string, "CMT7") 
		|| !strcmp(cmt_index_string,"CMT_7"))
	{ 	*cmt_code = CMT7;}
	else
	if ( !strcmp(cmt_index_string, "CMT10") 
		|| !strcmp(cmt_index_string,"CMT_10"))
	{ 	*cmt_code = CMT10;}
	else
	if ( !strcmp(cmt_index_string, "CMT20") 
		|| !strcmp(cmt_index_string,"CMT_20"))
	{ 	*cmt_code = CMT20;}
	else
	if ( !strcmp(cmt_index_string, "CMT30") 
		|| !strcmp(cmt_index_string,"CMT_30"))
	{ 	*cmt_code = CMT30;}
	else
	if ( !strcmp(cmt_index_string, "TEC10") 
		|| !strcmp(cmt_index_string,"TEC_10"))
	{ 	*cmt_code = TEC10;}
	else
