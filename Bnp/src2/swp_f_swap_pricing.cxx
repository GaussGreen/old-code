/* =============================================================================
   ...
   FILENAME:    swp_f_swap_pricing.cxx
...
/* ------------------------------------------------------------------------------
 */
/* Computes a forward Swap rate        , taking spreads into account with a
 * SwapDP */
...
Err swp_f_ForwardRate_SwapDP(SwapDP *swapdp, String ycName, String refRateCode,
  ...
  /* Construct the floating leg        , keeping the same end date as the fixed
   * leg */
