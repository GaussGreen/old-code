...
double srt_f_optamedig(double fwd, double spot, double barrier, double vol,
  ...
  case DELTA_FWD: /*** DELTA FWD ***/
    shift = fwd / 10000;
    answer = (srt_f_optamedig(fwd + shift, spot, barrier, vol, mat, disc,
  ...
  case DELTA: /*** DELTA SPOT + FWD ***/
    shift = spot / 10000;
    answer = (srt_f_optamedig(fwd * (1 + shift / spot), spot + shift, barrier,
                              vol, mat, disc, below_above, min_max, PREMIUM) -
              premium) /
             shift;
    break;
  ...
  case VEGA: /*** VEGA ***/
    shift = GVOPT.vol_add;
    answer = (srt_f_optamedig(fwd, spot, barrier, vol + shift, mat, disc,
                              below_above, min_max, PREMIUM) -
              premium) /
             shift;
    break;
  ...
  case THETA: /*** THETA  ***/
    shift = YEARS_IN_DAY;
    answer = srt_f_optamedig(fwd, spot, barrier, vol, mat - shift,
                             disc * exp(-shift * log(disc) / mat), below_above,
                             min_max, PREMIUM) -
             premium;
    break;
