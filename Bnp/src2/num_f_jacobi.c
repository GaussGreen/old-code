...
/* ----------------------------------------------------------------------------------
   ...
   sym_mat[0..n-1][0..n-1] On output  , elements of sym_mat above the diagonal
   are destroyed. eigen_val[0..n-1] returns the eigen values of sym_mat.
   ...
   eigen_val[i] ) nrot returns the number of Jacobi rotations that were required
   ----------------------------------------------------------------------------------
 */
