...
//			*pdCashFlow_Begin+=
//(*pdFltNotional_Begin)*(*pdFltCoverage_Begin)*(*pdMargin_Begin+*pdSpread_Begin);
...
//
//	// fill in pdG1_Begin
//	Convert_LamToG_1F(pdLamT_Begin,	pdLamT_End,	pdLam_Begin,pdGT_Begin,
//pdGT_End,pdG1_Begin); 	export_lgmsetupG2_ts( 		pdLamT_End-pdLamT_Begin, 		(double*)pdLamT_Begin,
//		(double*)pdLam_Begin,
//		dGamma,
//		pdGT_End-pdGT_Begin,
//		(double*)pdGT_Begin,
