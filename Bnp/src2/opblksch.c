    ...
    SrtGreekType   greek)
{
    ...
    {
        answer = srt_f_optblksch(fwd_price, strike, vol, mat, disc, SRT_CALL, greek) +
    ...
    else
    {
        ...
        case THETA: /*** THETA ***/
            answer = -(1 / 365.00) * (0.5 * fwd_price * disc * vol / sqrt(mat) * gauss(d1) -
    ...
    double* result)
{
    ...
    *result = srt_f_optblksch(fwd_price, strike, vol, mat, disc, call_put_type, greek_type);
    ...
    SrtGreekType   greek)
{
    ...
    if (call_put == SRT_STRADDLE)
    {
        answer = srt_f_optblksch_accurate(fwd_price, strike, vol, mat, disc, SRT_CALL, greek) +
                 srt_f_optblksch(fwd_price, strike, vol, mat, disc, SRT_PUT, greek);
        return answer;
    }
    ...
    double* result)
{
    ...
    /* Compute the requested greek */
    *result =
        srt_f_optblksch_accurate(fwd_price, strike, vol, mat, disc, call_put_type, greek_type);
