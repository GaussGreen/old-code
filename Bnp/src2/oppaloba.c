...
**/                                                             
	...
	if (mat2 == mat1)
	{
		...
		{
			premium = srt_f_optlokbak(	fwd_price1,
										spot,
										hist_extr,
		       							vol1,
										mat1,
	...
	{                        
		...
		if (mat1==0.0)
		{
			premium = srt_f_optblksch(	fwd_price2,
										hist_extr,
										vol2,
										mat2,
										disc,
		...
		{ 
			...
			premium1 -= hist_extr *	bivar(	d_ext01-sqrt(var01),
						d_ext02-sqrt(var02),
						corr12);
			...
			{          
				...
				premium3 = 	bivar( d_ext01-sqrt(var01)+2*l_ext/sqrt(var01),
			...
			else 
			{
				...
				premium5 = sqrt(var01) *  gauss( -d_ext01 )
					       * norm( d_12-sqrt(var12) );
				premium5 += sqrt(var02)
							*gauss( ( -d_ext01*sqrt(var01)
					  		+(d_12-sqrt(var12))*sqrt(var12) ) 
							/ sqrt(var02) )
							*norm( ( (-d_12+sqrt(var12))*sqrt(var01)
					 		-d_ext01*sqrt(var12) )
							/ sqrt(var02) );
				premium5 *= fwd_price1;	
       		}
