 ...
 *				  analytically with approx price = disc * proba * (fwd
 *+ mrg) * cvg
 *
 * DESCRIPTION  	: XX
 *
 ...
 *				: CMSfixing		- forward fixing rate CMS
 *adjusted for pay date : CMSpay		- forward pay rate CMS adjusted
 ...
 *				: K1			- lower bound strike
 *				: K2			- upper bound strike
 *				: CMSfvol		- vol of Ffixing between today
 *and fixing : CMSpvol		- vol of Fpay between today and fixing : rhofp
