    ...
    double* DoubleTriggerSwapQuantoLeg)
{
    ...
    while (i < n_exo_coupons)
    {
        ...
        put2 = srt_f_optblksch(
            cms2, K2, cms2_K2_log_vol, cms2_fixing_time, 1.0, SRT_PUT, (SrtGreekType)SRT_PREMIUM);

        put1 = srt_f_optblksch(
            cms2, K1, cms2_K1_log_vol, cms2_fixing_time, 1.0, SRT_PUT, (SrtGreekType)SRT_PREMIUM);
        ...
        put2 = srt_f_optblksch(
            cms1, B2, cms1_B2_log_vol, cms1_fixing_time, 1.0, SRT_PUT, (SrtGreekType)SRT_PREMIUM);

        put1 = srt_f_optblksch(
            cms1, B1, cms1_B1_log_vol, cms1_fixing_time, 1.0, SRT_PUT, (SrtGreekType)SRT_PREMIUM);
