    ...
    double** prod_val)
{
    ...
    {
        err =
            "Fx3DGrn can only accept 3 underlyings, please check the GRFN tableau or use the "
            "MultiGRFN functions";
        goto FREE_RETURN;
    }
    ...
    if (!dom_ifr || !dom_fwd || !dom_var || !for_ifr || !for_fwd || !for_var || !fx_fwd || !fx_var)
    {
    ...
    double*** prod_val)
{
    ...
    double *dom_ifr = NULL, *dom_fwd = NULL, *dom_std = NULL, *dom_phi = NULL, *dom_beta = NULL,
           *dom_bond_pay = NULL, *dom_beta_pay = NULL,

           *for_ifr = NULL, *for_fwd = NULL, *for_std = NULL, *for_phi = NULL, *for_beta = NULL,
    ...
    double *sigma_date_dom = NULL, *sigma_dom = NULL, *tau_date_dom = NULL, *tau_dom = NULL,
           ...
           *sigma_date_fx = NULL, *sigma_fx = NULL, *corr_date = NULL, *correl_dom_for = NULL,
           *correl_dom_fx = NULL, *correl_for_fx = NULL, *dom_for_cov = NULL, *dom_fx_cov = NULL,
           *for_fx_cov = NULL;
    ...
    if (!dom_ifr || !dom_fwd || !dom_std || !dom_phi || !dom_beta || !dom_bond_pay ||
        !dom_beta_pay || !for_ifr || !for_fwd || !for_std || !for_phi || !for_beta || !fx_fwd ||
        !fx_std)
    {
