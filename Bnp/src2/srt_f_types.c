...
static SrtTrnLstEle boolean_SrtTrnLst[] = {
    {(long)SRT_NO, 0, {"NO", 0}}, {(long)SRT_YES, 0, {"YES", 0}}, {(long)0, 0, {""}}};

/* ----------------------- Curve Type ------------------------------------ */
static SrtTrnLstEle curve_SrtTrnLst[] = {
    {(long)YIELD_CURVE, 0, {"YC", "YIELD", "YIELD_CURVE", "YIELDCURVE", "YLDCRV", 0}},
    {(long)CMT_CURVE, 0, {"CMT_CURVE", "CMT", "TREASURY_CURVE", "TREASURYCURVE", 0}},
    {(long)DVD_CURVE, 0, {"DVD_CURVE", "DVD", "DIVIDEND_CURVE", "DIVIDEND", "DVD_CRV", 0}},
...
static SrtTrnLstEle underlying_SrtTrnLst[] = {
    ...
    {(long)FOREX_UND, 0, {"FX_UND", "FOREX", "FOREX_UND", "FOREX_UNDERLYING", 0}},
    {(long)EQUITY_UND, 0, {"EQ_UND", "EQUITY", "EQUITY_UND", "EQD_UND", "EQUITY_UNDERLYING", 0}},
...
static SrtTrnLstEle yieldcurve_SrtTrnLst[] = {
    ...
    {(long)WES_YC, 0, {"WES_YC", "WESTMINSTER_YC", "WES_CURVE", "WETMINSTER_CURVE", 0}},
...
static SrtTrnLstEle model_SrtTrnLst[] = {
    ...
    {(long)NEWLGM, (long)ONE_FAC, {"NEWLGM1F", "NEWLGM", "NEWNORMAL", "NEW_LGM_1F", 0}},
    {(long)NEWCHEYBETA,
     (long)ONE_FAC,
    ...
    {(long)ETABETA,
     ...
     {"BETAETA",
      ...
      "THE_ONE",
      0}},
    {(long)BDT, (long)ONE_FAC, {"BDT", "BLACK_DERMAN_TOY", "BLACK_KARASINSKI", "BK", "B_K", 0}},
...
static SrtTrnLstEle mcsample_SrtTrnLst[] = {
    ...
    {(long)RANDOM_GAUSS_DYNAMIC, 0, {"RANDSAM", "RANDOM_GAUSS_DYNAMIC", "RGD", 0}},
    {(long)ANTITHETIC_DYNAMIC, 0, {"ANTISAM", "ANTITHETIC_DYNAMIC", "AD", 0}},
    {(long)BAL_SAMPLING, 0, {"BALSAM", "BALANCED", 0}},
    {(long)BAL_ANTI, 0, {"BALANTISAM", "BALANCED_ANTITHETIC", "ANTIBAL", "BALANTI", 0}},
    {(long)SOBOL, 0, {"SOBOL", "SOB", 0}},
    {(long)UWAN, 0, {"UWAN", "U1", 0}},
    {(long)ABS, 0, {"ABS", 0}},
    {(long)SPECTRUNC, 0, {"SPECTRUNC", "SPEC_TRUNC", "SPECTRAL_TRUNCATION", "SPECTRAL", 0}},
    {(long)0, 0, {""}}
...
static SrtTrnLstEle algorithm_SrtTrnLst[] = {
    {(long)LEVENBERG_MARQUARDT, 0, {"LM", "LEVENBERG", "LEVENBERG_MARQUARDT", 0}},
    {(long)SIMPLEX, 0, {"SIMPLEX", "SIMP", 0}},
    {(long)SIMULATED_ANNEALING, 0, {"SA", "SIMULATED_ANNEALING", "S_A", "ANNEALING", 0}},
...
static SrtTrnLstEle measure_SrtTrnLst[] = {
    ...
    {(long)FINAL_MEAS, 0, {"FINAL", "FINAL_MEASURE", "FINAL_MEAS", "FINALMEASURE", "FINALMEAS", 0}},
    {(long)0, 0, {""}}
