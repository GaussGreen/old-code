...
SrtStpPtr srt_f_copystp(SrtStpPtr input_dest, SrtStpPtr input_source)
{
    ...
    else
    {
        ...
        srt_f_tminfdup((SrtIRMTmInf*)(input_source->tminf[0]), (SrtIRMTmInf**)&(new_stp->tminf[0]));
        srt_f_trinfdup((SrtCheTreInf*)(input_source->trinf), (SrtCheTreInf**)&(new_stp->trinf));
...
%d\n", trinf->rmin, trinf->u, trinf->max_r_index, trinf->min_r_index	); else fprintf(f,"\t\t
trinf = NULL \n");
