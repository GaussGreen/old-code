...
/*additional parameters may be : SwapDP p        ,SwapDP pf        ,double
   coupon        , double clean_price        ,double volatility        , double
   myu        , int T        , double redemption , double first_coupon*/
{
  va_list argptr;
  int j;
