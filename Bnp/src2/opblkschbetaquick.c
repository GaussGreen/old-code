...
/*shift = forward / 10000; */
	...
	case VEGA:
		/* this does a multiplicative shift and multiplies the result by 10 (as aksed for by traders) */
...
/* The premium is computed using the BS formula */
	...
	{
		premium = srt_f_optblksch(forward, strike, volequ, maturity, disc, 
								  call_put, PREMIUM);
	}
	/* Normal diffusion */
	else
	{
		premium = srt_f_optblknrm(forward, strike, volequ, maturity, disc, 
								  call_put, PREMIUM);
	}
