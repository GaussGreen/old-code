...
*                       da = v a dZ
*                       <dZ,dW> = rho dt
* DESCRIPTION  	: Transforms the Beta vol in the equivalent BS vol, then compute
                  the required greeks accordingly
*
    ...
    SrtGreekType   greek)
{
    ...
    premium = srt_f_optblksch(forward, strike, bsvol, mat, disc, call_put, PREMIUM);
    switch (greek)
    {
    case PREMIUM:
        ans = premium;
    ...
    case DELTA:
        ...
        /*	shift = forward / 10000; */
        ans = (srt_f_optblkschbetaquick(
                   forward + shift, strike, betavol, mat, beta, disc, call_put, PREMIUM) -
               premium) /
              shift;
        break;
    ...
    case VEGA:
        /* this does a multiplicative shift and multiplies the result by 10 (as aksed for by
         * traders) */
        shift = GVOPT.sabrvol_shift;
        /*  shift = betavol / 100; */
        ans = (srt_f_optblkschbetaquick(
                   forward, strike, betavol * shift, mat, beta, disc, call_put, PREMIUM) -
               premium) *
              10;
        break;
    ...
    SrtGreekType     greek)
{
    ...
    err = srt_f_optsarbvol(
        forward, strike, maturity, betavol, alpha, beta, rho, typeinput, log_norm, &volequ);
    if (err)
        return -1;
    ...
    {
        premium = srt_f_optblksch(forward, strike, volequ, maturity, disc, call_put, PREMIUM);
    }
    /* Normal diffusion */
    else
    {
        premium = srt_f_optblknrm(forward, strike, volequ, maturity, disc, call_put, PREMIUM);
    }
    ...
    case THETA:
        ...
        ans = (srt_f_optblkschbetastochquick(
                   ...
                   beta,
                   rho,
                   disc * exp(-shift * log(disc) / maturity),
                   typeinput,
                   log_norm,
                   call_put,
                   PREMIUM) -
