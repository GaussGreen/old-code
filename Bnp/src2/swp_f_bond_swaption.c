...
/* We return the swaption maturity  , strike and volatility  , as well as vega
ratio and hedge ratio. If there is a problem to compute the volatility or the
hedge ratio or the vega ratio  , we return just the swaption maturity and strike
and put -1 for the volatility and 1 for the hedge ratio and vega ratio */
