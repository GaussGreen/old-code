//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//	Sort Static level function to calibrate an LGM 2 factor model and then price a Grfn tableau
//using	// 	either PDE, MC or MC with optimal ex boundary.
////
//																										//
//						Author:  Paul McCallum				Date:  29th Sept
//2003						//
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
...
Err GrfnLGM2FAutocalCaller(
    char* YieldCurveName,
    char* VolCubeName,
    Err (*GetCashVol)(char*, double, double, double, int, char*, double*, double*),
    char*   DefaultRefRate,
    char*   PrimSwapFreq,
    char*   PrimSwapBasis,
    char*   PrimRefRate,
    ...
    double** SecCalibratedModelPrices)
{
    ...
    //  //
    //	with a Lambda term structure (12th Nov 2003) (case when NumLambdas != 1). To be sure, we
    //still  // 	call old routine when there is only one value of Tau/Lambda. Also modified so that
    //we call two  // 	different pde tau routines depending on status of the stability parameter
    //which is now part		// 	of the pricing parameter structure (13th Nov 2003),
    ////
    //
