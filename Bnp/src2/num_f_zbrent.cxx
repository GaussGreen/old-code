...
/*	Given a function func and an initial guessed range x1 to x2        , the
   ...
   returned values x1 and x2 or until the range becomes unacceptably large. The
   static_data parameter is passed as the last func's argument. */
{
  Err err = NULL;
  int j;
  if (*x1 == *x2)
...
Err num_f_zbrent(Err (*func)(double, double *, void *), double x1, double x2,
                 double f1, double f2, double tol, void *static_data,
                 double *answer)
