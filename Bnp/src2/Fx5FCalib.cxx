/* ==========================================================================
   FILE_NAME:	Fx5FCalib.cxx

   PURPOSE:		Modelling of the spot FX vol by taking in consideration
   a LGM 2 factor on the domestic and foreign market and a lognormal model on
   the Spot Fx
...
Err calibrate_correl5D_from_histo(
    ...
    int calib_rho_for,   /* if one we calibrate rho_for
                          */
    double **corr_histo, /* input of the historical correl SD        , LD , SF
                            , LF , Fx	*/
