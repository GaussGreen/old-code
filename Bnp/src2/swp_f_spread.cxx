...
/* ---------------------------------------------------------------------------
        Calculate spreads         , using the SpreadFunc that has been attached
  to the library (see srt_f_external_fct.cxx)
  --------------------------------------------------------------------------- */
...
/* When dealing with spreads in swaps or fra's        , it is useful to get
   floating compd and basis for the reference rate */
...
/* This function returns the short forward rate        , adjusted by the cash
 * spread
 */

double swp_f_fra(Ddate start, Ddate end, BasisCode b, char *crvname,
                 String ref_rate) {
  double fwd_cash;
  double spread;
  double fra;
