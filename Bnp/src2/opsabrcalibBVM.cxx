...
Err SABRGenHardLimitDichoGen(
    ...
    double (*vol_local)(double x, double a, double b, double c, int type),
    SrtDiffusionType input,
    int HardLimType, // 0:Alpha        , 1:a        ,2:b        , 3:c        ,
                     // 4:Rho
    double *HardLimit) {
  Err err = NULL;
  int compt;
  ...
  //		Params1[HardLimType] = vol_local(0.01        ,Alpha        ,a ,b
  //,c        ,Rho
  //      ,10+HardLimType); 		Params2[HardLimType] = vol_local(0.01
  //      ,Alpha        ,a        ,b        ,c ,Rho        ,20+HardLimType);
