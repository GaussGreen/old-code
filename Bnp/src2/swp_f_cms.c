...
/*
double ProbaIntegrand(double s  , double S0  , double mat  ,double sigb  ,
double a  , double b  , double r  , double m  , double d)
{
double SIGMA;
double RV;
double integ;
...
double CMSIntegrand(double s  , double S0  , double mat  ,double sigb  , double
a  , double b  , double r  , double m  , double d)
{
double SIGMA;
double RV;
double integ;
