...
static double dens_gauss_n_explo(double var, double x1_n, double x2_n,
                                 double mu, double mu2, double vol,
                                 double mat) {
 ...
 *
 * DESCRIPTION  	: Returns the probability to get 1 unit of domestic
 *currency (if dom/for=0) or 1 unit of foreign currency(if dom/for=1) as soon as
