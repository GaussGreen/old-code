...
/*	Function:		srt_f_locvol_init_trinf
    Object:			initialise the tree information in step ( geomtry and
   limits ) allocate and populate
*/
                                                     ...
                                                     (for allocation) */
{
  ...
  /* Set the r spacing delta_r to sqrt of minimum of (average_stdev  , min_stdev
   * * 2) */
