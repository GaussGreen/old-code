    ...
    FxBetaDLM_OptNumerParams* NumParams)
{
    ...
    err = Get_LGM_TermStructure2(
        undname_dom, &(str->time_dom), &(str->sig_dom), (long*)&(str->nb_dom), &(str->tau_dom));
    ...
    str->yc_dom = (char*)calloc(strlen(temp) + 1, sizeof(char));
    ...
    err = Get_LGM_TermStructure2(
        undname_for, &(str->time_for), &(str->sig_for), (long*)&(str->nb_for), &(str->tau_for));
    ...
    str->yc_for = (char*)calloc(strlen(temp) + 1, sizeof(char));
    ...
    str->time_fx = (double*)calloc(nb_fx, sizeof(double));
    str->sig_fx  = (double*)calloc(nb_fx, sizeof(double));
    ...
    if (!compute_3F_corr)
    {
        if (nb_3F_corr == 0)
        {
            ...
            str->time_3F_corr    = (double*)calloc(nb_3F_corr, sizeof(double));
            str->dom_for_3F_corr = (double*)calloc(nb_3F_corr, sizeof(double));
            str->dom_fx_3F_corr  = (double*)calloc(nb_3F_corr, sizeof(double));
            str->for_fx_3F_corr  = (double*)calloc(nb_3F_corr, sizeof(double));
    ...
    if (!compute_DLM_corr)
    {
        if (nb_DLM_corr > 0)
        {
            ...
            str->time_DLM_corr        = (double*)calloc(nb_DLM_corr, sizeof(double));
            str->dom_for_DLM_corr     = (double*)calloc(nb_DLM_corr, sizeof(double));
            str->dom_fx_DLM_corr      = (double*)calloc(nb_DLM_corr, sizeof(double));
            str->for_fx_DLM_corr      = (double*)calloc(nb_DLM_corr, sizeof(double));
            str->dom_fx_DLM_corr_down = (double*)calloc(nb_DLM_corr, sizeof(double));
            str->for_fx_DLM_corr_down = (double*)calloc(nb_DLM_corr, sizeof(double));
...
Err FxBetaDLM_free_und(SrtUndPtr pUndDesc)
{
    ...
    if (pSrtFxPtr->spec)
    {
        FxBetaDLM_free_str((FXBETADLM_STR)pSrtFxPtr->spec);
        free(pSrtFxPtr->spec);
    }
...
Err FxBetaDLM_free_und_v(void* pUndDesc)
{
    return FxBetaDLM_free_und((SrtUndPtr)pUndDesc);
}
    ...
    FxBetaDLM_OptNumerParams* NumParams)
{
    ...
    und_fx   = (SrtFxDesc*)calloc(1, sizeof(SrtFxDesc));
    ...
    double*  equi_beta)
{
    ...
    *tstar     = str->tstar;
    ...
    /* Memory allocations */
    *time_dom             = (double*)calloc(*nb_dom, sizeof(double));
    *sig_dom              = (double*)calloc(*nb_dom, sizeof(double));
    *time_for             = (double*)calloc(*nb_for, sizeof(double));
    *sig_for              = (double*)calloc(*nb_for, sizeof(double));
    *time_fx              = (double*)calloc(*nb_fx, sizeof(double));
    *sig_fx               = (double*)calloc(*nb_fx, sizeof(double));
    *time_3F_corr         = (double*)calloc(*nb_3F_corr, sizeof(double));
    *dom_for_3F_corr      = (double*)calloc(*nb_3F_corr, sizeof(double));
    *dom_fx_3F_corr       = (double*)calloc(*nb_3F_corr, sizeof(double));
    *for_fx_3F_corr       = (double*)calloc(*nb_3F_corr, sizeof(double));
    *time_DLM_corr        = (double*)calloc(*nb_DLM_corr, sizeof(double));
    *dom_for_DLM_corr     = (double*)calloc(*nb_DLM_corr, sizeof(double));
    *dom_fx_DLM_corr      = (double*)calloc(*nb_DLM_corr, sizeof(double));
    *for_fx_DLM_corr      = (double*)calloc(*nb_DLM_corr, sizeof(double));
    *dom_fx_DLM_corr_down = (double*)calloc(*nb_DLM_corr, sizeof(double));
    *for_fx_DLM_corr_down = (double*)calloc(*nb_DLM_corr, sizeof(double));
    ...
    FxBetaDLM_model* model)
{
    ...
    model->dPWTime   = (double*)calloc(nb_fx, sizeof(double));
    ...
    /* Allocate memory */
    model->dSigmaDom       = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFor       = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFx3F      = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFx        = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFxUp      = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFxDown    = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrDomFor     = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrDomFx      = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrForFx      = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrDomFxDown  = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrForFxDown  = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrDomFxInput = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dCorrForFxInput = (double*)calloc(model->iNbPWTime, sizeof(double));
...
Err initialise_FxBetaDLM_Hermite(FxBetaDLM_OptNumerParams* NumParams, FxBetaDLM_Hermite* hermite)
{
    ...
    hermite->W         = (double*)calloc(hermite->iNbPoints + 1, sizeof(double));
    hermite->X         = (double*)calloc(hermite->iNbPoints + 1, sizeof(double));
...
Err FxBetaDLM_Allocation_Precalculations(int iNbPWTime, FxBetaDLM_ModelPrecalc* Precalc)
{
    ...
    Precalc->dVarRatesDom      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarRatesFor      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarRatesFor3D    = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRates       = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRates3D     = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarFFx           = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxDom      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxFor      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxFor3D    = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarX             = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dExpectFor        = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dIntegral         = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dIntegral2        = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRatesAdjust = (double*)calloc(iNbPWTime, sizeof(double));

    Precalc->dVarRatesFor_down      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarRatesFor3D_down    = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRates_down       = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRates3D_down     = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarFFx_down           = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxDom_down      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxFor_down      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxFor3D_down    = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarX_down             = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dExpectFor_down        = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dIntegral_down         = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dIntegral2_down        = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRatesAdjust_down = (double*)calloc(iNbPWTime, sizeof(double));

    Precalc->dVarRatesFor_mid      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarRatesFor3D_mid    = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRates_mid       = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRates3D_mid     = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarFFx_mid           = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxDom_mid      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxFor_mid      = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarFFxFor3D_mid    = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dVarX_mid             = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dExpectFor_mid        = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dIntegral_mid         = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dIntegral2_mid        = (double*)calloc(iNbPWTime, sizeof(double));
    Precalc->dCovarRatesAdjust_mid = (double*)calloc(iNbPWTime, sizeof(double));
...
Err FxBetaDLM_GetModelFromStr(FXBETADLM_STR str, FxBetaDLM_model* model)
{
    ...
    /* Allocate memory */
    model->dPWTime         = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    model->dSigmaDom       = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFor       = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFx        = (double*)calloc(model->iNbPWTime, sizeof(double));
    model->dSigmaFxUp      = (double*)calloc(model->iNbPWTime, sizeof(double));
...
Err FxBetaDLM_get3FCorrelFromDLM(FXBETADLM_STR str)
{
    ...
    str->dom_for_3F_corr = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->time_3F_corr    = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->dom_fx_3F_corr  = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->for_fx_3F_corr  = (double*)calloc(str->nb_DLM_corr, sizeof(double));
...
Err FxBetaDLM_getDLMCorrelFrom3F(FXBETADLM_STR str, FxBetaDLM_OptNumerParams* NumParams)
{
    ...
    str->time_DLM_corr = (double*)calloc(str->nb_fx, sizeof(double));
    ...
    str->dom_for_DLM_corr     = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->dom_fx_DLM_corr      = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->for_fx_DLM_corr      = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->dom_fx_DLM_corr_down = (double*)calloc(str->nb_DLM_corr, sizeof(double));
    str->for_fx_DLM_corr_down = (double*)calloc(str->nb_DLM_corr, sizeof(double));
...
Err copy_FxBetaDLM_model(FxBetaDLM_model* model_source, FxBetaDLM_model* model_dest)
{
    ...
    /* Allocate memory */
    model_dest->dPWTime         = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dSigmaDom       = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dSigmaFor       = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dSigmaFx3F      = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dSigmaFx        = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dSigmaFxUp      = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dSigmaFxDown    = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrDomFor     = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrDomFx      = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrForFx      = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrDomFxDown  = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrForFxDown  = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrDomFxInput = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
    model_dest->dCorrForFxInput = (double*)calloc(model_dest->iNbPWTime, sizeof(double));
