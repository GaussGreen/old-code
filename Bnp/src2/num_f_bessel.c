...
Err bessik(double x, double xnu, double* ri, double* rk, double* rip, double* rkp)
{
    Err    beschb(double x, double* gam1, double* gam2, double* gampl, double* gammi);
    int    i, l, nl;
    double a, a1, b, c, d, del, del1, delh, dels, e, f, fact, fact2, ff, gam1, gam2, gammi, gampl,
        h, p, pimu, q, q1, q2, qnew, ril, ril1, rimu, rip1, ripl, ritemp, rk1, rkmu, rkmup, rktemp,
