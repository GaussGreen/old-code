/* ========================================================================
        ...
        FILE NAME:  srt_f_calibpsCalibParamss.cxx
...
static Err srt_f_set_default_calib_params(SrtMdlType eModelType,
                                          SrtCalibParam *psCalibParams) {
  Err err = NULL;

  if (!psCalibParams)
    return serror(
        "Null psCalibParams pointer passed in default_CalibpsCalibParamss");
  ...
  /* The way the Tau        , Omega and psCalibParamseters are optimised or kept
   * frozen */
...
Err srt_f_set_CalibParams(String *pszParamNames, String *pszParamValues,
                          int iNumCalibParamss, SrtCalibParam *psCalibParams,
  ...
  for (i = 0; i < iNumCalibParamss; i++) {
    /* Algorithm */
    if ((!strcmp(pszParamNames[i], "ALGO")) ||
        (!strcmp(pszParamNames[i], "ALGORITHM")) ||
      ...
      if (err) {
        ...
        /* Type */
        if ((!strcmp(pszParamNames[i], "TYPE")) ||
            (!strcmp(pszParamNames[i], "CALIBTYPE")) ||
      ...
      if (err) {
        ...
        if ((!strcmp(pszParamNames[i], "NITER")) ||
            (!strcmp(pszParamNames[i], "ITERNUMBER")) ||
      ...
      if (sscanf(pszParamValues[i], "%ld", &tmpLng) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "NPTS")) ||
            (!strcmp(pszParamNames[i], "PTS")) ||
      ...
      if (sscanf(pszParamValues[i], "%ld", &tmpLng) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "NBPTS")) ||
            (!strcmp(pszParamNames[i], "BESTPTS")) ||
      ...
      if (sscanf(pszParamValues[i], "%ld", &tmpLng) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "NCLUST")) ||
            (!strcmp(pszParamNames[i], "CLUSTERS")) ||
      ...
      if (sscanf(pszParamValues[i], "%ld", &tmpLng) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "RSCMTH")) ||
            (!strcmp(pszParamNames[i], "RESEARCH"))) {
      ...
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "FTOL")) ||
            (!strcmp(pszParamNames[i], "TOLERANCE")) ||
      ...
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Initial temperature */
        if ((!strcmp(pszParamNames[i], "MAXTEMP")) ||
            (!strcmp(pszParamNames[i], "INITTEMP"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if (tmpDbl > 0) {
        ...
        /* Final temperature */
        if ((!strcmp(pszParamNames[i], "MINTEMP")) ||
            (!strcmp(pszParamNames[i], "FINALTEMP"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if (tmpDbl > 0) {
      ...
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "ONETAU")) ||
            (!strcmp(pszParamNames[i], "SINGLETAU")) ||
      ...
      if (!strcmp(pszParamValues[i], "YES")) {
        ...
        if ((!strcmp(pszParamNames[i], "SOBOL")) ||
            (!strcmp(pszParamNames[i], "SOBOLPATH"))) {
      if (sscanf(pszParamValues[i], "%ld", &tmpLng) == 1) {
        if (tmpLng >= 0) {
      ...
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Sigma Minimum*/
        if ((!strcmp(pszParamNames[i], "SIGMAMIN")) ||
            (!strcmp(pszParamNames[i], "SIGMA_MIN"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if (tmpDbl >= 0) {
        ...
        /* Sigma Maximum*/
        if ((!strcmp(pszParamNames[i], "SIGMAMAX")) ||
            (!strcmp(pszParamNames[i], "SIGMA_MAX"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if (tmpDbl >= 0) {
      ...
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Beta Minimum*/
        if ((!strcmp(pszParamNames[i], "BETAMIN")) ||
            (!strcmp(pszParamNames[i], "BETA_MIN"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Beta Maximum*/
        if ((!strcmp(pszParamNames[i], "BETAMAX")) ||
            (!strcmp(pszParamNames[i], "BETA_MAX"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Alpha Minimum*/
        if ((!strcmp(pszParamNames[i], "ALPHAMIN")) ||
            (!strcmp(pszParamNames[i], "ALPHA_MIN"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if (tmpDbl >= 0.0) {
        ...
        /* Alpha Maximum*/
        if ((!strcmp(pszParamNames[i], "ALPHAMAX")) ||
            (!strcmp(pszParamNames[i], "ALPHA_MAX"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if (tmpDbl >= 0.0) {
        ...
        /* Gamma Minimum*/
        if ((!strcmp(pszParamNames[i], "GAMMAMIN")) ||
            (!strcmp(pszParamNames[i], "GAMMA_MIN"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        psCalibParams->dBetaMin = tmpDbl;
      } else {
        ...
        /* Beta Maximum*/
        if ((!strcmp(pszParamNames[i], "GAMMAMAX")) ||
            (!strcmp(pszParamNames[i], "GAMMAMAX"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Rho Minimum*/
        if ((!strcmp(pszParamNames[i], "RHOMIN")) ||
            (!strcmp(pszParamNames[i], "RHO_MIN"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        /* Rho Maximum*/
        if ((!strcmp(pszParamNames[i], "RHOMAX")) ||
            (!strcmp(pszParamNames[i], "RHO_MAX"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if ((tmpDbl >= -1.0) && (tmpDbl <= 1.0)) {
        ...
        /* Omega Minimum*/
        if ((!strcmp(pszParamNames[i], "OMEGAMIN")) ||
            (!strcmp(pszParamNames[i], "OMEGA_MIN"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if ((tmpDbl >= -1.0) && (tmpDbl <= 1.0)) {
        ...
        /* Omega Maximum*/
        if ((!strcmp(pszParamNames[i], "OMEGAMAX")) ||
            (!strcmp(pszParamNames[i], "OMEGAMAX"))) {
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        if ((tmpDbl >= -1.0) && (tmpDbl <= 1.0)) {
      ...
      if (!strcmp(pszParamValues[i], "YES")) {
        ...
        if ((!strcmp(pszParamNames[i], "LGMITER")) ||
            ...
            (!strcmp(pszParamNames[i], "LGMNITER")) ||
            (!strcmp(pszParamNames[i], "LGM_ITER"))) {
      if (sscanf(pszParamValues[i], "%ld", &tmpLng) == 1) {
        if (tmpLng > 0) {
      ...
      if (sscanf(pszParamValues[i], "%lf", &tmpDbl) == 1) {
        ...
        if ((!strcmp(pszParamNames[i], "AGGREGATE")) ||
            ...
            (!strcmp(pszParamNames[i], "ALL_IN_ONE")) ||
            (!strcmp(pszParamNames[i], "ALLIN1"))) {
      if (!strcmp(pszParamValues[i], "YES")) {
    ...
    /* Error */
      ...
      return serror("Model psCalibParamseter not recognised: %s",
                    pszParamNames[i]);
    }
  ...
  if (psCalibParams->dSigmaMin > psCalibParams->dSigmaMax) {
    return serror("Sigma_min(%f) is bigger than sigma_max(%f)",
                  psCalibParams->dSigmaMin, psCalibParams->dSigmaMax);
  }
  if (psCalibParams->dLambdaMin > psCalibParams->dLambdaMax) {
    return serror("Lambda_min(%f) is bigger than Lambda_max(%f)",
                  psCalibParams->dLambdaMin, psCalibParams->dLambdaMax);
  }
  if (psCalibParams->dBetaMin > psCalibParams->dBetaMax) {
    return serror("Beta_min(%f) is bigger than Beta_max(%f)",
                  psCalibParams->dBetaMin, psCalibParams->dBetaMax);
  }
  if (psCalibParams->dAlphaMin > psCalibParams->dAlphaMax) {
    return serror("Alpha_min(%f) is bigger than Alpha_max(%f)",
                  psCalibParams->dAlphaMin, psCalibParams->dAlphaMax);
  }
  if (psCalibParams->dGammaMin > psCalibParams->dGammaMax) {
    return serror("Gamma_min(%f) is bigger than Gamma_max(%f)",
                  psCalibParams->dGammaMin, psCalibParams->dGammaMax);
  }
  if (psCalibParams->dRhoMin > psCalibParams->dRhoMax) {
    return serror("rho_min(%f) is bigger than rho_max(%f)",
                  psCalibParams->dRhoMin, psCalibParams->dRhoMax);
  }
  if (psCalibParams->dOmegaMin > psCalibParams->dOmegaMax) {
    return serror("Omega_min(%f) is bigger than Omega_max(%f)",
                  psCalibParams->dOmegaMin, psCalibParams->dOmegaMax);
  }
...
static Err srt_f_set_default_FXCalibParams(SrtFXCalibParam *psFXCalibParams) {
  ...
  if (!psFXCalibParams)
    return serror("Null psFXCalibParams pointer passed in "
                  "srt_f_set_default_FXCalibParams");
...
Err srt_f_set_FXCalibParams(String *pszFXCalibStrings, String *pszFXCalibValues,
...

{
  ...
  for (i = 0; i < iNumCalibParamss; i++) {
    ...
    if ((!strcmp(pszFXCalibStrings[i], "ALGO")) ||
      ...
      return serror(
          "FXCalib params must be CALIBCORREL        , CALIBALGO or NITER");
    }
  }
  return NULL;
}
