...
static double dens_gauss_n(double var, double x1_n, double x2_n, double mu, double vol, double mat)
{
 ...
 *                 if the spot stays under barrier_up and above barrier_do during mat.
 *
