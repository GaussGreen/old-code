/* ==============================================================================
   ...
   FILE NAME:      srt_f_cheybeta_mdl_def.cxx
...
void chey_beta_mdl_param(
  ...
  /*	Search relevant sigma index (such that sigma_times[i-1] < t1 <=
   * sigma_times[i] */
  i = 0;
  ...
  /*	Search relevant lambda index (such that lambda_times[i-1] < t1 <=
   * lambda_times[i] */
  i = 0;
