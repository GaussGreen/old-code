...
/* ------------------------------------------------------------------------
        ...
        the high point        , tries it        , and replaces the high point if
   new point is better.
   ------------------------------------------------------------------------ */

static double amotsa(double **p, /* Simplex points */
                     double y[], /* Value of funk at the simplex points */
                     double psum[], int ndim, double pb[], double *yb,
...
void amebsa(double **p,  /* Starting points of the simplex */
