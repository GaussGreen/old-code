    ...
    if (p > 0.0 && p < 1.0)
    {
        ...
        if (fabs(x) > 0.3)
        {
            ...
            if (fabs(x) > 0.42)
            {
                ...
                y = t3t1 +
                    x * (t3t2 + x * (t3t3 + x * (t3t4 + x * (t3t5 + x * (t3t6 + x * t3t7)))));
                yd = t3b1 +
                     x * (t3b2 + x * (t3b3 + x * (t3b4 + x * (t3b5 + x * (t3b6 + x * t3b7)))));
                y = y / yd + x;
                return s * y;
            }
        }
...
double bivar(double x, double y, double rho)
{
    ...
    double c1, c2, cos1, cos2, p, power1, power2, r, r1, root, rpower, rs2, rthalf, s1, s1c1, s2,
        s2c2, sine1, sine2, theta1, theta2, twopi;
    double tni[16];
    double result;
...
{
    return bp * norm_accurate(a / b) * gauss(ap / bp) + (bp * bp) * srt_f_intnrm_l(-a, b, ap, bp) +
...

{
    ...
    switch (n)
    {
    case 0:  // this is the gaussian case (i.e. it corresponds effectively to Student degree ->
             // Infinity)
        Value = norm(x);
        break;
    ...
    case 6:
        Value = 0.5 +
                x * (135. + 30. * x * x + 2. * x * x * x * x) / 4. /
                    sqrt((6. + x * x) * (6. + x * x) * (6. + x * x) * (6. + x * x) * (6. + x * x));
        break;
    ...
    case 9:
        alfa =
            3 * x * (67797. + 13797. * x * x + 1155 * x * x * x * x + 35 * x * x * x * x * x * x);
...
double Student_Dis_Inv(const double xacc, const double tVal, const unsigned int degree)

{
    ...
    case 1:
        ...
        break;
    case 2:
        return THETA(tVal, 0.5) *
                   sqrt((4 * tVal - 4 * tVal * tVal - 1) / (2 * tVal * tVal - 2 * tVal)) -
               THETA(0.5, tVal) *
                   sqrt((4 * tVal - 4 * tVal * tVal - 1) / (2 * tVal * tVal - 2 * tVal));
        break;
...
void TryStudent_Dis_Inv(
    const double x, const double tVal, const unsigned int degree, double* fVal, double* f1Val)

{
    ...
    case 6:
        alfa  = (6. + x * x);
        *fVal = (tVal - 0.5) * (tVal - 0.5) - x * x * (135. + 30 * x * x + 2. * x * x * x * x) *
                                                  (135. + 30 * x * x + 2. * x * x * x * x) / 16. /
    ...
    case 8:
        alfa  = (8. + x * x);
        *fVal = (tVal - 0.5) * alfa * alfa * alfa * alfa -
                x * sqrt(2. + x * x / 4.) *
                    (1120 + 280. * x * x + 28. * x * x * x * x + x * x * x * x * x * x);
    ...
    case 10:
        ...
        *fVal = (tVal - 0.5) * 16. *
                ...
                x * (196875. + 52500. * x * x + 6300. * x * x * x * x +
                     360. * x * x * x * x * x * x + 8. * x * x * x * x * x * x * x * x);
        *f1Val = 984375. / 8 /
                 sqrt(alfa * alfa * alfa * alfa * alfa * alfa * alfa * alfa * alfa * alfa * alfa);
        break;
