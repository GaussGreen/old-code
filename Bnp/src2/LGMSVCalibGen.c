...
Err GetFirstGuessVol_LGMSV(
    void* Model, void* GlobalParam, int vol_index, double target, double* vol1)
{
    LGMSV_MODEL     model     = (LGMSV_MODEL)(Model);
    LGMSV_ALLPARAMS AllParams = (LGMSV_ALLPARAMS)(GlobalParam);
    ...
    void* Model, CALIBGEN_PARAMS CalibConsts, void* GlobalParam, int vol_index, double var)
{
    ...
    fact_exp = sqrt(
        (AllParams->EquiLGM->exp_fact[new_index + 1] -
    ...
    double* limit_up)
{
    ...
    sig_limit_down_lgm =
        sqrt(AllParams->EquiLGM->cum_var_lgm[last_index] * AllParams->MinFact / t1);
...
Err ExtrapolVol_LGMSV(void* Model, void* GlobalParam, int last_vol_index)
{
    ...
    for (i = last_index + 1; i < model->iNbPWTime; i++)
    {
        ...
        fact_exp = sqrt(
            (AllParams->EquiLGM->exp_fact[i + 1] - AllParams->EquiLGM->exp_fact[i]) /
            (2.0 * model->dLambdaX) / dt);
...
Err UpdateParamsAfterVol_LGMSV(
...
Err GetFirstGuessRho_LGMSV(
    void* Model, void* GlobalConst, int index_smile, double target, double* rho1)
{
    LGMSV_MODEL     model     = (LGMSV_MODEL)(Model);
    LGMSV_ALLPARAMS AllParams = (LGMSV_ALLPARAMS)(GlobalConst);
...
Err SetRho_LGMSV(
    void* Model, CALIBGEN_PARAMS CalibConsts, void* GlobalParam, int smile_param, double rho)
{
    Err err = NULL;
...
Err UpdateParamsAfterRho_LGMSV(
    void* Inst_, void* InstParam, void* GlobalParam, void* Model, CALIBGEN_PARAMS CalibConsts)
{
    Err    err = NULL;
    ...
    if (AllParams->calib_params->calib_alpha)
    {
        ...
        err = AllParams->CalibFunctionsForAlpha.SetParam(
            Model, AllParams->CalibParamsAlpha, AllParams, AllParams->index_vol, alpha);
...
Err GetFirstGuessAlpha_LGMSV(
    void* Model, void* GlobalConst, int index_smile, double target, double* alpha1)
{
    LGMSV_MODEL     model     = (LGMSV_MODEL)(Model);
    LGMSV_ALLPARAMS AllParams = (LGMSV_ALLPARAMS)(GlobalConst);
...
Err UpdateParamsAfterAlpha_LGMSV(
    void* Inst_, void* InstParam, void* GlobalParam, void* Model, CALIBGEN_PARAMS CalibConsts)
{
    Err    err = NULL;
...
Err GetLimitAndLastAlpha_LGMSV(
    void*           Model,
    CALIBGEN_PARAMS CalibConsts,
    void*           GlobalParam,
    int             index_smile,
...
Err BumpAlpha_LGMSV(void* Model, void* GlobalParam, int smile_param, double alpha)
{
    Err err = NULL;
...
Err SetAlpha_LGMSV(
    void* Model, CALIBGEN_PARAMS CalibConsts, void* GlobalParam, int smile_param, double alpha)
{
    Err err = NULL;
...
Err GetSecondGuessLambda_LGMSV(
    void*   Model,
    void*   GlobalParam,
    int     index_lambda,
    double  lambda1,
...
Err GetLimitAndLastLambda_LGMSV(
    void*           Model,
    CALIBGEN_PARAMS CalibConsts,
    void*           GlobalParam,
    int             index_lambda,
...
Err BumpLambda_LGMSV(void* Model, void* GlobalParam, int index_lambda, double lambda)
{
    Err err = NULL;
...
Err UpdateParamsAfterLambda_LGMSV(
    void* Inst_, void* InstParam, void* GlobalParam, void* Model, CALIBGEN_PARAMS CalibConsts)
{
    Err    err = NULL;
    ...
    if (CalibConsts->do_calib)
    {
        ...
        {
            err = Calculate_HestonEquivalent_LGMSV_FromLGM_struct(
                NextInst, AllParams->CalibCpnShortSchedule, model, NextHestonParam->HestonInst);
    ...
    {
        err = Calculate_ShiftAndVol_LGMSV_FromLGM_struct(
            NextInst, NextHestonParam->sCalibCpnSchedule, model, NextHestonParam->HestonInst);
...
Err GetFirstGuessRho2_LGMSV(
    void* Model, void* GlobalConst, int index_rho2, double target, double* rho21)
{
    LGMSV_MODEL     model     = (LGMSV_MODEL)(Model);
    LGMSV_ALLPARAMS AllParams = (LGMSV_ALLPARAMS)(GlobalConst);
...
Err SetRho2_LGMSV(
    void* Model, CALIBGEN_PARAMS CalibConsts, void* GlobalParam, int index_rho2, double rho2)
{
    Err err = NULL;
...
Err UpdateParamsAfterRho2_LGMSV(
    void* Inst_, void* InstParam, void* GlobalParam, void* Model, CALIBGEN_PARAMS CalibConsts)
{
    Err err = NULL;
...
Err GetFirstGuessFlatAlpha_LGMSV(
    void* Model, void* GlobalConst, int index_flat_alpha, double target, double* flat_alpha1)
{
    LGMSV_MODEL     model     = (LGMSV_MODEL)(Model);
    LGMSV_ALLPARAMS AllParams = (LGMSV_ALLPARAMS)(GlobalConst);
...
Err GetSecondGuessFlatAlpha_LGMSV(
    void*   Model,
    void*   GlobalParam,
...
Err GetLimitAndLastFlatAlpha_LGMSV(
    void*           Model,
    CALIBGEN_PARAMS CalibConsts,
    void*           GlobalParam,
    int             index_flat_alpha,
...
Err BumpFlatAlpha_LGMSV(void* Model, void* GlobalParam, int index_flat_alpha, double flat_alpha)
{
    Err err = NULL;
...
Err ExtrapolFlatAlpha_LGMSV(void* Model, void* GlobalParam, int last_smile_index)
{
    return NULL;
}

Err UpdateParamsAfterFlatAlpha_LGMSV(
    void* Inst_, void* InstParam, void* GlobalParam, void* Model, CALIBGEN_PARAMS CalibConsts)
{
    Err err = NULL;
...
Err GetFirstGuessFlatRho_LGMSV(
    void* Model, void* GlobalConst, int index_flat_rho, double target, double* flat_rho1)
{
    LGMSV_MODEL     model     = (LGMSV_MODEL)(Model);
    LGMSV_ALLPARAMS AllParams = (LGMSV_ALLPARAMS)(GlobalConst);
...
Err GetSecondGuessFlatRho_LGMSV(
    void*   Model,
    void*   GlobalParam,
    int     index_flat_rho,
    double  flat_rho1,
...
Err GetLimitAndLastFlatRho_LGMSV(
    void*           Model,
    CALIBGEN_PARAMS CalibConsts,
    void*           GlobalParam,
    int             index_flat_rho,
...
Err BumpFlatRho_LGMSV(void* Model, void* GlobalParam, int index_flat_rho, double flat_rho)
{
    Err err = NULL;
...
Err UpdateParamsAfterFlatRho_LGMSV(
    void* Inst_, void* InstParam, void* GlobalParam, void* Model, CALIBGEN_PARAMS CalibConsts)
{
    Err err = NULL;
