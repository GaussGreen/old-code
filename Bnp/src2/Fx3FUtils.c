    ...
    double*  eigen_val)
{
    ...
    prod_diago_matrix(eigen_vector_transp, eigen_val, transf_matrix_inv, gi, gj, gsum);
...
Err compute_vol_times(char* und3dfx, int* num_vol_times, double** vol_times, double last_time)
{
    int sig_n_dom, tau_n_dom, sig_n_for, tau_n_for, sig_n_fx, nb_corr;

    double *sig_date_dom = NULL, *sig_dom = NULL, *tau_date_dom = NULL, *tau_dom = NULL,
           *sig_date_for = NULL, *sig_for = NULL, *tau_date_for = NULL, *tau_for = NULL,
           *sig_date_fx = NULL, *sig_fx = NULL, *mat_c = NULL, *c1 = NULL, *c2 = NULL, *c3 = NULL;
...
Err find_phi(double* date, double* phi, int nstp, double theDate, double* phi_at_t)
{
    int i;
