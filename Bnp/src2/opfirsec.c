    ...
    SrtGreekType greek)
{
    ...
    case DELTA_FWD: /*** DELTA FWD ***/
        shift = fwd / 10000;
        answer =
            (srt_f_optfirsec(fwd + shift, spot, fir_bar, sec_bar, vol, mat, disc, nterms, PREMIUM) -
             premium) /
            shift;
        break;
    ...
    case VEGA: /*** VEGA ***/
        shift = GVOPT.vol_add;
        answer =
            (srt_f_optfirsec(fwd, spot, fir_bar, sec_bar, vol + shift, mat, disc, nterms, PREMIUM) -
             premium) /
            shift;
        break;
