...
void crif_free_exotic(CRIF_EXOTIC sExotic) {
  ...
  /*	if (sExotic->cPaidBasis) free_svector_size(sExotic->cPaidBasis        ,
     0        , 1-1        , 5); if (sExotic->cPaidFreq)
     free_svector_size(sExotic->cPaidFreq        , 0        , 1-1        , 5);
          if (sExotic->cPaidRef) free_svector_size(sExotic->cPaidRef        , 0
     , 1-1 , 10);	*/
