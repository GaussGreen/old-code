...
//			ppdDensity[nX1][nX3]  =
//_NormDensity(dC,dX1,0.,dVarX1)*_NormDensity(dC,dX3,0.,dVarX3); 			dSumDensity +=
//ppdDensity[nX1][nX3];
//		}
//	}
//
...
//dDeltaArea*_Sum_dMatrix(ppdDensity,nX1_Begin,nX1_End,nX3_Begin,nX3_End);
...
//
//	const int nEx_I = 	(const
//double*)bsearch(pdEx,pdEx_Begin,nNumEx,sizeof(*pdEx),_dcompare) - pdEx_Begin; 	const double
//**ppdExIndicator = pppdExIndicator[nEx_I];
//
//	const int nX3_End = nX3_Begin + pdX3_End-pdX3_Begin;
//	const int nX1_End = nX1_Begin + pdX1_End-pdX1_Begin;
//	int nX1,nX3;
...
//				ppdU[nX1][nX3] = 	pComm->m_nCompute_ExProb ? ppdExIndicator[nX1][nX3]
...
//	const double dT = *pdT;
//	const int nI = 	(const double*)bsearch(&dT,pComm->m_pdT_Begin,nSize,sizeof(dT),_dcompare) -
//pComm->m_pdT_Begin;
//
...
//	double
//*pdTKnot_Begin=memcpy(_alloca((nSize+1)*sizeof(double)),pdT_Begin,nSize*sizeof(double)); 	int
//*pnSizeX1_Begin_=memcpy(_alloca((nSize+1)*sizeof(int)),pnSizeX1_Begin,nSize*sizeof(int)); 	int
//*pnSizeX3_Begin_=memcpy(_alloca((nSize+1)*sizeof(int)),pnSizeX3_Begin,nSize*sizeof(int)); 	double
//*pdTotalProb = _alloca(nSize*sizeof(double)), *pdExProb=pdExProb_Begin; 	const char *szErr=0;
//
