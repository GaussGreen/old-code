...
Err err = NULL;
	...
	*forward_x1 =	samptr_get(cur_sample,und_index,X1) 
		+ (samptr_get(cur_sample,und_index,PHI1) 
		   +	samptr_get(cur_sample,und_index,CROSSPHI)
		   -	tminf->ev.twof[0].lambda * samptr_get(cur_sample,und_index,X1) ) * delta_t;
	
	*forward_x2 =	samptr_get(cur_sample,und_index,X2) 
		+ (samptr_get(cur_sample,und_index,PHI2) 
		   +	samptr_get(cur_sample,und_index,CROSSPHI)
		   -	tminf->ev.twof[1].lambda * samptr_get(cur_sample,und_index,X2) ) * delta_t;
