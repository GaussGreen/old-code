/* =========================================================================
   ...
   FILENAME: swp_f_swapdp.cxx

   FUNCTION: swp_f_initSwapDP

   PURPOSE:  to initialise a SwapDP from start        , end_nfp        ,
   compString        , basisStr
   ========================================================================= */
...
Err swp_f_setSwapDP(long start, long end_nfp, SrtCompounding comp,
                    BasisCode basis, SwapDP *sdp) {
  Err err = NULL;
...
Err swp_f_initSwapDP(long start, long end_nfp, String compStr, String basisStr,
                     SwapDP *sdp) {
  Err err = NULL;
