...
LinearInterpTS(Date tNow, long nEx, Date *tEx,
               double *zeta11, /* [0  , 1  , ...  , nEx-1]  , values of zeta11
                                  at the exercise dates */
               double *zeta12, /* [0  , 1  , ...  , nEx-1]  , values of zeta12
                                  at the exercise dates */
               double *zeta22, /* [0  , 1  , ...  , nEx-1]  , values of zeta22
                                  at the exercise dates */
               long j, Date *tDeal,
               double **zeta11Deal, /* [0  , 1  , ...  , j]  , values of zeta_kl
                                       the deal dates */
    ...
    double **xExBdry) /* array of exercise points (in x) */
{
  ...
  for (j = 1; j <= NumTimeStep; j++) {
    ...
    /* DUAL BASIS : COORDINATES OF EIGENVECTORS IN TERMS OF X1  , X2 MULTIPLIED
       BY EIGENVALUES DUAL BASIS  = SQRT(D)*P IN THE DECOMPOSITION PD(tP) */
  ...
  /** (vX0  ,vX1)' IS A TWO DIM. GUAUSSIAN VECT.- P*SQRT(D)*(vX0  ,vX1)' HAS A
   * VAR EQUAL TO  */
