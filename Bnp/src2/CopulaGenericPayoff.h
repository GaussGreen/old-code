...
typedef struct {
  ...
  double call_spread; /* Call Spread width used for  	PAYOFF_DIGUP_CS and
                         PAYOFF_DIGDOWN_CS*/
...
Err initGenericModel(/* Input */
                     int iNbUnderlying, ModelType iModelType,

                     /* For BMM type */
                     double dNStdBMMCalib,

                     /* OutPut */
                     Generic_Model **GenericModel, void **SpecificModel);
...
Err Copula_SABRCalib_GenericPayOff_Price(
    ...
    /* For generating Marginales Distributions */
    double dMaturity, double *dForward, Generic_Model *UnderlyingModelParam,

    /* Sabr Parameters */
    double *dSigma, double *dAlpha, double *dBeta, double *dRho,
...
double TrapIntegration(/* limite */
                       ...
                       int iNbPoints, int iNumIntegration,

                       /* Function parameters */
                       int iNbX, double *X, IntGaussParam *Param,

                       double (*f)(int iNbX, double *X, IntGaussParam *Param));

double PayOffGaussianDensity(int iNbX, double *X, IntGaussParam *Param);
