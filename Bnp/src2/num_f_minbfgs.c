...
Err dfpmin(
    DFPMinCriteriumType returnCriterium,
    double              p[],
    int                 n,
    double              func_gtol,
    double              dfunc_tol,
...
Err frprmn(
    ...
    Err (*dfunc)(double[], double[]))
{
    void    linmin(double p[], double xi[], int n, double* fret, Err (*func)(double[], double*));
    int     j, its;
...
static void mnbrak(
    double* ax, double* bx, double* cx, double* fa, double* fb, double* fc, double (*func)(double))
{
