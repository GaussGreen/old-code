/* ---------------------------------------------------------------------------
   ...
   DiscFunc passed to the SrtExternalFunctions static ( see srt_f_external_fct.c
...
/*-----------------------------------------------------------------------------------
This is a proper cash rate taking into account the fixing date  , the start and
end dates
 ----------------------------------------------------------------------- */
