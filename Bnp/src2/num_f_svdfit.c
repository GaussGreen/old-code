/* ====================================================================
   ...
   PURPOSE		: Singular Value Decomposition
                  Find a linear combination of predefined functions
                                  that best matches a set ( x  , y=F(x) ) of
  points
   ...
   DESCRIPTION:	Given a set of data points x[1..ndata]  , y[1..ndata] with
                ...
                Arrays u[1..ndata][1..ma]   , v[1..ma][1..ma]  , w[1..ma]
  provide workspace on input; on output they define the singular value
   ...
   INPUT:	The user supplies a routine funcs(x  ,afunc  ,ma) that returns
  the ma basis functions evaluated at x in the array afunc[1..ma]
