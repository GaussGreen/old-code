    ...
    double**  prod_val)
{
    ...
    double *r1_sigma_dates = NULL, *r1_sigma = NULL, *r3_sigma_dates = NULL, *r3_sigma = NULL,
           *merge_dates = NULL, *r1_merge_sigma = NULL, *r2_merge_sigma = NULL,
           *r3_merge_sigma = NULL, *fx_merge_sigma = NULL, *corr_merge_r1_r2 = NULL,
           *corr_merge_r1_r3 = NULL, *corr_merge_r1_fx = NULL, *corr_merge_r2_r3 = NULL,
           *corr_merge_r2_fx = NULL, *corr_merge_r3_fx = NULL;

    double *lgm2F_ifr = NULL, *r1_fwd = NULL, *r1_var = NULL, *r2_fwd = NULL, *r2_var = NULL,
           *r1_r2_covar = NULL, *lgm1F_ifr = NULL, *r3_fwd = NULL, *r3_var = NULL;
    ...
    {
        err =
            "Fx3FQuantoGrfn can only accept 3 underlyings, please check the GRFN tableau or use "
            "the MultiGRFN functions";
        goto FREE_RETURN;
    }
    ...
    err = fill_time_vector(&time, &nstp, 0, (double*)NULL, num_vol_times, vol_times, num_stp);
    if (err)
        goto FREE_RETURN;
    ...
    // the "time" schedule but we do not care since increasing the number of steps will lead to
    // convergence.
    ...
    fx_merge_sigma[nstp - 1] =
        fx_sigma_values[Get_Index(time[nstp - 1], fx_sigma_dates, n_fx_sigma_dates)];
    ...
    if (!lgm2F_ifr || !r1_fwd || !r1_var || !r2_fwd || !r2_var || !r1_r2_covar || !lgm1F_ifr ||
        !r3_fwd || !r3_var)
    {
