...
/*	Low level lognormal */
static double
inflation_multiput_ll(double T, int nidx, double *ai, double *fyi, double *ki,
...
/*	Low level shifted */
static double
cmt_stellar_sl_ll(double T, int nidx, double *ai, double *fyi, double *ki,
                  double *shifti, double *voli, double ax, double fx, double kx,
                  double sx,
                  double **rho, /*	index 0..nidx-1: xi  , index nidx: x */
                  int npth, double ***g) /*	Sobol cube */
{
