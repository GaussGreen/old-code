...
/* -----------------------------------------------------------------------
   ...
   data taken from spreadsheet...
                ...
                correl is a full matrix [0..ndates-1][0..ncorr-1]  , which is
   supposed to store a full term structure of correlation matrixes
   ----------------------------------------------------------------------- */
...
/* -----------------------------------------------------------------------
   ...
   from tdy)  , according to the initialisation of the SrtCorrLstPtr correlation
   list There is no interpolation: the correlation is supposed to be constant
   between two dates
   ----------------------------------------------------------------------- */
