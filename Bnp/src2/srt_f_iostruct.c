...
/* Inserts the object (with its name) in the IO list */
	srt_f_lstins(l, name,ioval->shift_value,OBJ_PTR_IO,
		(void*)     ioval, &srt_f_IOvalfree, &ticker);
			...
			SrtIOVal	** ioval_pp)
{
	...
	SrtObject	*obj;
 	...
 	else *ioval_pp = (SrtIOVal*)(obj->val.pval);
 	return err;
}
...
Err srt_f_IOstructsetpremium(	SrtIOStruct *l,
				SRT_Boolean done,
				double result,
				char comp_origin[32]	)
{
...
Err srt_f_IOstructsetstdev(	SrtIOStruct *l,
				SRT_Boolean done,
				double result,
				char comp_origin[32]	)
{
...
Err srt_f_IOstructgetrshift(	SrtIOStruct l,
				char id_name[32],
				double shift_value,
				int shift_type,
				SrtIOVal** ioval_pp	)
...
Err srt_f_IOstructgetrshiftval(	SrtIOStruct l,
				char id_name[32],
				double shift_value,
				int shift_type,
				double* value		)
{
	...
	SrtIOVal	*ioval_p;
 	...
 	if (err = srt_f_IOstructgetrshift(	
				l,
				id_name,
				shift_value,
				shift_type,
...
Err srt_f_IOstructsetrshift(	SrtIOStruct* l,
				char id_name[32],
				double shift_value,
				int shift_type,
				SRT_Boolean done,
...
Err srt_f_IOstructgetsigmashift(	SrtIOStruct l,
					int bucket_no,
					double shift_value,
					int shift_type,
					SrtIOVal** ioval_pp	)
...
Err srt_f_IOstructgetsigmashiftval(	SrtIOStruct l,
					int bucket_no,
					double shift_value,
					int shift_type,
					double* value		)
{
	...
	SrtIOVal	*ioval_p;
 	...
 	if (err = srt_f_IOstructgetsigmashift(	l,
					bucket_no,
					shift_value,
					shift_type,
					&ioval_p	))
...
Err srt_f_IOstructsetsigmashift(	SrtIOStruct* l,
					int  bucket_no,
					Date bucket_start,
					Date bucket_end,
					double shift_value,
...
Err srt_f_IOstructgettaushift(	SrtIOStruct l,
				int bucket_no,
				double shift_value,
				int shift_type,
				SrtIOVal** ioval_pp	)
...
Err srt_f_IOstructgettaushiftval(	SrtIOStruct l,
					int bucket_no,
					double shift_value,
					int shift_type,
					double* value		)
...
SrtIOVal* ioval_p;
	...
	err = srt_f_IOstructgettaushift(	l,
					bucket_no,
					shift_value,
					shift_type,
					&ioval_p	);
...
Err srt_f_IOstructsettaushift(	SrtIOStruct* l,
				int bucket_no,
				Date bucket_start,
				Date bucket_end,
				double shift_value,
