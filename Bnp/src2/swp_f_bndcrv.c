...
static void reset_zcpn_yld_coefs(SrtBndCrv *crv) {
  ...
  /**********/
    ...
    */
    /*
     * between knot points  , -log(df(0  ,t)) is a second order polynomial;
     * coefs are here we say crv->zcpn_yld_coef[i][0..3] is the third order
     * polynomial (index 3 is the highest order coefficient) between knot point
     * i and knot point i+1.  Here we consider the zeroth knot point to always
     * have value zero.
     */
