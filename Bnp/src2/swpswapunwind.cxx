...
char *SwpSwapUnwind(long value_date, long start, long nfp_or_end, long today,
                    char *cpdStr, char *basisStr, double strike,
                    char *first_short_full, double initial_not,
                    double final_not, char *liborCpdStr, char *liborBasStr,
                    double libor_fix, char *dcntName, double *pv) {
  Err err;
