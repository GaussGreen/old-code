...
that found in the tableau  , except domestic that is stored as _grfn_und_list[0]
...
/*******************************************************************************
    ...
    DESCRIPTION     :   This function (indirectly) creates a (static) list of
                        ...
                        or not a list needs to be created  , i.e. if gd->pass =
1 then we are just parsing and extracting information from the tableau and NOT
creating events.
