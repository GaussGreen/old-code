    ...
    double* power)
{
    ...
    err = swp_f_ForwardRate(
        (long)(start), (long)(end), freq_std, basis_std, yc_id, refRateCode, &R_std);
...
Err swp_f_IsSmileVol(
    char* vol_id, double* yesno)  // return 1 if Model is SABR or SABRAFor any smile model.
{
    double dontcare;
