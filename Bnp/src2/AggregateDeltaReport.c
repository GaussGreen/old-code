...
//	{
//		j=0;
//		while((j<NumGlobalHedgeUndFra)&&(GlobalHedgeUndFraEndDates[j]!=LocalHedgeUndFraEndDates[k]))
//j++;
...
//		(*LocalHedgeUndFraPEQ) =
//realloc((*LocalHedgeUndFraPEQ),(*NumLocalHedgeUndFra)*sizeof(double));
//		(*LocalHedgeUndFraEndDates) =
//realloc((*LocalHedgeUndFraEndDates),(*NumLocalHedgeUndFra)*sizeof(Date));
//		(*LocalHedgeUndFraTypes) =
//realloc((*LocalHedgeUndFraTypes),(*NumLocalHedgeUndFra)*sizeof(SrtUndFRAType));
//
...
//							Date
//*SwpUndFraHedgeEndDates, 							Date			*FutUndFraHedgeEndDates, 							SrtCompounding	FloatFreq,
//							SrtBasisCode	FloatBasis,
//							String			FloatRefRate,
//							String			YieldCurveName,
//
//							/*OUTPUTS */
//							long *NumLocalHedgeUndFra, 							double
//**LocalHedgeUndFraPEQ, 							Date			**LocalHedgeUndFraEndDates, 							SrtUndFRAType
//**LocalHedgeUndFraTypes)
//
//{
// Err			err=NULL;
...
// Err		srt_f_SwapConvexity(Date				SwapStartDate,  /*SwapStartDate =
// SpotDate */ 							Date				SwapEndDate, 							SrtCompounding		FixedFreq,
...
//								   /*SOME SWAP DETAILS */
//								   SrtCompounding
//SwpFixedFreq, 								   SrtBasisCode			SwpFixedBasis, 								   SrtCompounding SwpFloatFreq,
//								   SrtBasisCode
//SwpFloatBasis, 								   String				SwpFloatRefRate,
...
//								   /*OUTPUT	*/
//								   long
//*NumFraUndSwap, 								   double				**FraUndSwapPEq, 								   long
//**FraUndSWAPEndDates)
//
//
//{
...
//						  FraEndDate, /*THE LAST SWAP MATURES AT THE FRA
//MATURITY*/ 						  SwpFloatFreq, 						  SwpFloatBasis, 						  SwpFloatLegDP); 	if(err) 		return err;
//
//	CrvPtr = lookup_curve(YieldCurveName);
//	today = get_clcndate_from_yldcrv(CrvPtr);
//
...
//												   today,
//												   &PayDates,/* THE SWAPS
//MATURITIES  (PayDates)*/ 												   &NumPayDates,/* THE NUMBER OF SWAPS */ 												   &FixingDates, 												   &StartDates,
//												   &EndDates,
//												   &Coverage,
//												   NumFraUndSwap);
//
