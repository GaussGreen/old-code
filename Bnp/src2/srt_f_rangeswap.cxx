...
/********************************************************************************
FraDBspread computes        , for a given index        , the price of the double
barrier digital (in fact the difference of two callspreads with strikes located
at the lower and upper barriers of the Range Swap). The Cms adjustment is made.
*********************************************************************************/
...

{
  ...
  ************************************************/
  ...
  /* computation of the weighted (or not        , depending on WeekendRule)
   * average of the digitals*/
...
Err srt_f_FlooredTimeSwap(
    ...
    char *TimeSwap,  /* flag: yes if it's a timeswap        , no if it's a range
                  swap  with min coupon*/
...

{
  ...
  double *isfriday = NULL;   /* for each day        , isfriday will be 1 if that
                                day is   a friday and 0 otherwise*/
