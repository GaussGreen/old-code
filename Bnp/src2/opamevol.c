...
static Err rtsafe_opamevol(double guess_vol, 
							double * diff_prem, 
							double * deriv)
{

	*diff_prem = srt_f_optameopt(RTSAFE_SPOT, 
								RTSAFE_FORWARD, 
								RTSAFE_STRIKE,					
								RTSAFE_DISCFACT,				
								guess_vol, 				
	...
	*deriv = srt_f_optameopt(RTSAFE_SPOT, 
								RTSAFE_FORWARD, 
								RTSAFE_STRIKE,					
								RTSAFE_DISCFACT,				
								guess_vol, 				
...
SrtErr err = NULL;
	...
	intrinsic = srt_f_optameopt(spot, 
								forward, 
								strike,					
								disc_fact,				
								NULL_VOL, 				
