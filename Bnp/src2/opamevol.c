 ...
 *
 * PURPOSE      	: calculates volatility of american option implied by
 *premium
 *
...
static Err rtsafe_opamevol(double guess_vol, double *diff_prem, double *deriv) {
  ...
  *diff_prem = srt_f_optameopt(RTSAFE_SPOT, RTSAFE_FORWARD, RTSAFE_STRIKE,
                               RTSAFE_DISCFACT, guess_vol, RTSAFE_OPTMAT,
                               RTSAFE_CALLPUT, RTSAFE_STEPNUM, PREMIUM) -
               RTSAFE_PREMIUM;

  *deriv = srt_f_optameopt(RTSAFE_SPOT, RTSAFE_FORWARD, RTSAFE_STRIKE,
                           RTSAFE_DISCFACT, guess_vol, RTSAFE_OPTMAT,
                           RTSAFE_CALLPUT, RTSAFE_STEPNUM, VEGA);
  return NULL;
}
...
Err srt_f_optamevol(double premium, double spot, double forward, double strike,
  ...
  intrinsic = srt_f_optameopt(spot, forward, strike, disc_fact, NULL_VOL,
                              opt_mat, call_put, step_num, PREMIUM);
  ...
  err = rtsafe(rtsafe_opamevol, 1e-11, /* inf of the solution */
