...
/* ---------------------------------------------------------------------------------
   ...
   Mind you        , the integration function is exp(-x*x) and not the real
   Gaussian density
   ---------------------------------------------------------------------------------
 */
...
/* ---------------------------------------------------------------------------------
   ...
   the abscissas and weights of the n-point Gauss-Hermite quadrature formula.
   The largest abscissa is returned in x[1]        , the most negative in x[n].
   If the polynomials roots have already been computed        , it does not
   recalculate them Mind you        , the integration function is exp(-x*x) and
   not the real Gaussian density
   ---------------------------------------------------------------------------------
 */
