                       ...
                       theta        , vega        , volga and vanna */
{
  ...
  if (is_cvx) {
    /*
    disc_SL_strike(x        , nstepx        , spot_fx        , bar_ex_down ,
    bar_ex_up        , 0.9999 , 0.00001        , stdln        , NSTD_FX , 1.0 /
    strike2        , 0        , &index_x);
    */
    ...
    /*
    disc_linleft_logright_center_strike(x        , nstepx        , spot_fx ,
    bar_ex_down        , bar_ex_up        , stdln        , NSTD_FX        ,
    strike2        , &index_x);
    */
  }
