...
Err Probas_Poissons(
    ...
    int p, double *n_sauts, double *proba, /* Conditional proba of the following
...
Err optmertonpremiumtimedependent(
    double dFwd, double Strike, int n_periods, /* The 6 following variables are
                                                  vectors of length nperiods */
    double *sigma, double *U1, double *lambda1, double *U2, double *lambda2,
    double *mat, char *Logornorm, double *answer) {
