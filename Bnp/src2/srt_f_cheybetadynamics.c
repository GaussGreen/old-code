...
Err srt_f_CheyBeta_drift_at_sam(
    SrtMdlType mdl_type, SrtStpPtr stp, SrtSample* cur_sam, SrtSample* drift_sam, int und_index)
...
Err srt_f_CheyBeta_var_at_sam(
    SrtMdlType mdl_type, SrtStpPtr stp, SrtSample* cur_sam, double* var_at_sam, int und_index)
{
    double       vol;
    SrtIRMTmInf* tminf;
    Err          err = NULL;
