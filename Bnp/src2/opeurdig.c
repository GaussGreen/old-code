...
double srt_f_opteurdig(double fwd, double barrier, double vol, double mat,
  ...
  case DELTA_FWD: /*** DELTA FWD ***/
    shift = fwd / 10000;
    answer = (srt_f_opteurdig(fwd + shift, barrier, vol, mat, disc, below_above,
                              PREMIUM) -
              premium) /
             shift;
    break;
  ...
  case VEGA: /*** VEGA ***/
    shift = GVOPT.vol_add;
    answer = (srt_f_opteurdig(fwd, barrier, vol + shift, mat, disc, below_above,
                              PREMIUM) -
              premium) /
             shift;
    break;
  ...
  case THETA: /*** THETA  ***/
    shift = YEARS_IN_DAY;
    answer = srt_f_opteurdig(fwd, barrier, vol, mat - shift,
