    ...
    SrtGreekType   greek)
{
    ...
    else
    {
        ...
        price_s = part_dbar_fn(
            k, bound_up, bound_dwn, mu1 + sig1_2, mu2 + sig2_2, sig1, sig2, mat1, mat2, nb_term);

        price_k = part_dbar_fn(k, bound_up, bound_dwn, mu1, mu2, sig1, sig2, mat1, mat2, nb_term);
