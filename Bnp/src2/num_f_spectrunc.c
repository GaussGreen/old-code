/* ======================================================================
  ...
  , the same covar matrix is used  , and the generation is made in the following
  order for the Sobol dimensions :
                                        - Eigen Vector 1:
                                                - Brownian 1
                                                - Brownian 2
                                                - ...
...
/* Make the Brownian motion covariance matrix as inf(s  ,t) (allocation done
 * outside) */
