...
double srt_f_optlifopt(	double fwd, 
			double spot, 
			double barrier, 
			double vol, 
			double mat, 
...
double	shift;
	...
	else
	{
		...
		premium = sm_qsimp_list(fct_life,
								0.000001,
								mat,
								m,
								vol,
	...
	switch (greek)
	{
		...
		case DELTA_FWD:
			shift = fwd/ 10000;
			answer = ( srt_f_optlifopt(	fwd+shift,
										spot,
										barrier,
										vol,
										mat,
		...
		case DELTA:
			shift = spot/ 10000;
			answer = ( srt_f_optlifopt(	fwd * (1 + shift/spot),
										spot + shift,
										barrier,
										vol,
							      		mat,
		...
		case GAMMA:
			...
			answer = ( srt_f_optlifopt(	fwd * ( 1 + shift/spot),
										...
										down_up,
										PREMIUM)
					 + srt_f_optlifopt(	fwd * ( 1 - shift/spot),
										spot-shift,
										barrier,
										vol,
										mat,
