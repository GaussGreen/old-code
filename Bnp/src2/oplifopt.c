    ...
    SrtGreekType   greek)
{
    ...
    case DELTA_FWD:
        shift  = fwd / 10000;
        answer = (srt_f_optlifopt(fwd + shift, spot, barrier, vol, mat, disc, down_up, PREMIUM) -
                  premium) /
                 shift;
        break;
    ...
    case VEGA:
        shift  = GVOPT.vol_add;
        answer = (srt_f_optlifopt(fwd, spot, barrier, vol + shift, mat, disc, down_up, PREMIUM) -
                  premium) /
                 shift;
        break;
