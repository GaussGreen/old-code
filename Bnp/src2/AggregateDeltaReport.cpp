...
//    }
//
// void srt_f_UpdateGlobalHedgeUndFraTermStr(
//    Date*    GlobalHedgeUndFraEndDates,
...
//        (*LocalHedgeUndFraPEQ) =
//            (double*)realloc((*LocalHedgeUndFraPEQ), (*NumLocalHedgeUndFra) * sizeof(double));
//        (*LocalHedgeUndFraEndDates) =
//            (Date*)realloc((*LocalHedgeUndFraEndDates), (*NumLocalHedgeUndFra) * sizeof(Date));
//        (*LocalHedgeUndFraTypes) = (SrtUndFRAType*)realloc(
//            (*LocalHedgeUndFraTypes), (*NumLocalHedgeUndFra) * sizeof(SrtUndFRAType));
//
...
//        (*SetOfRefUndFRATypes) =
//            (SrtUndFRAType*)realloc((*SetOfRefUndFRATypes), (*NumUndFra) * sizeof(SrtUndFRAType));
//
...
//                    // FIXEME SWAP((*SetOfRefUndFRATypes)[i],(*SetOfRefUndFRATypes)[j]);
//                }
//            }
//        }
//    }
...
//}
//
// SRT_Boolean ExitsHedgeTenors(
//    Date  MarketTenorDate, /*THE SWAP TO HEDGE */
//    long  NumHedgeTenors,
//    Date* HedgeTenorDates)
//
//{
...
//
//    if ((NumHedgeSwpUndFra == 0) || ((NumHedgeSwpUndFra > 0) && (NumHedgeFutUndFra > 0) &&
//                                     (FraEndDate <= FutUndFraHedgeEndDates[NumHedgeFutUndFra -
//                                     1])))
...
//    }
//    else if (
//        (NumHedgeFutUndFra == 0) || (NumHedgeFutUndFra > 0) && (NumHedgeSwpUndFra > 0) &&
...
//
// Err srt_f_GetHedgePEQ(
//    Date           MKTTenorDate, /*SWAP MAT OR FRA THEO DATE */
...
//
//        FraStartDate =
//            add_unit(MKTTenorDate, -12 / (int)FloatFreq, SRT_MONTH, NO_BUSDAY_CONVENTION);
//
//        err = swp_f_LevelPayment(
//            FraStartDate,
//            MKTTenorDate,
...
//        if (PrevTenorIndex != NextTenorIndex)
//        {
//            err = srt_f_FRAConvexity(
//                FraStartDate, MKTTenorDate, FloatBasis, YieldCurveName, &MKTConvexity);
//            if (err)
//                return err;
//        }
//
...
//
//        FraStartDate = add_unit(
//            HedgeTenorDates[PrevTenorIndex], -12 / (int)FloatFreq, SRT_MONTH,
...
//            MarketPEQ *
//            (NextHedgeTenorConvexity * MKTSensitivity - NextHedgeTenorSensitivity * MKTConvexity)
...
//            MarketPEQ *
//            (PrevHedgeTenorSensitivity * MKTConvexity - MKTSensitivity * PrevHedgeTenorConvexity)
//            / (PrevHedgeTenorSensitivity * NextHedgeTenorConvexity -
//             PrevHedgeTenorConvexity * NextHedgeTenorSensitivity);
//    }
//
...
//        (*SwapUndFraEndDates)[i] = add_unit(
//            DTOL(SwapStartDate), (i + 1) * (12 / (int)FloatFreq), SRT_MONTH,
//            NO_BUSDAY_CONVENTION);
//    }
//
//    if (FloatLegDP)
...
// Err srt_f_SwapConvexity(
//    Date           SwapStartDate, /*SwapStartDate = SpotDate */
//    Date           SwapEndDate,
//    SrtCompounding FixedFreq,
//    SrtBasisCode   FixedBasis,
//    SrtCompounding FloatFreq,
...
//
//    err = swp_f_setSwapDP(
//        SpotDate,   /* ALL THE SWAP START AT SPOT DATE */
...
//            add_unit(DTOL(SpotDate), i * 12 / (int)SwpFloatFreq, SRT_MONTH, NO_BUSDAY_CONVENTION);
//    }
//
