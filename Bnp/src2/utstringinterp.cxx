...
Err interp_rec_pay(const char *constStr, SrtReceiverType *val) {
  ...
  return "Enter REC (FLOOR) or PAY (CAP) or RATE or STRADDLE for swaption "
         "(capfloor).";
}
...
Err interp_SABRVolComponent(const char *constStr, SABRVolComponent *val) {
  ...
  return "enter ALPHA        , BETA        , RHO        , ATMLOG        , "
         "ATMNORM        , BETAVOL        , LOGVOL "
         "       , NORMVOL";
}
