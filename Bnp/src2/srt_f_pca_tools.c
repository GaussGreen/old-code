/************************************************************************/
/* MODULE NAME : 	SRT_F_PCA_TOOLS.C 				*/
/* Version 		1.00						*/
/* Author		Olivier VAN EYSEREN				*/
/************************************************************************/

#include "srt_h_all.h"
#include "srt_h_pca_tools.h"
...
//Err principal_component_analysis(double** covar, int n, double eigen_val[], double** vol_func)
//{
//    int    i, j, nrot;
//    Err    err = NULL;
...
//                                   sqrt(
//                                       (1 + mkt_fit_func[i] * mkt_fit_func[i]) *
