    ...
    SrtCallPutType call_put)
{
    ...
    */
    ...
    if ((fabs(prem_new - premium) < premium * PREM_TOL_PCT) || (premium < PREM_TOL_PCT / 10.0))
    {
        vol_guess = NULL_VOL;
    }
    else
...

    {
        ...
        for (i = 0; i <= MAX_ITER; i++)
        {
            ...
            prem_new = optvalbeta(fwd_price, strike, vol_guess, mat, beta, disc, call_put, PREMIUM);
            ...
            prem_shift = optvalbeta(
                fwd_price, strike, vol_guess + vol_shift, mat, beta, disc, call_put, PREMIUM);
