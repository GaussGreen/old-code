...
Err	cms_init_cms_struct(long			lFixingDate,
						long			lStartDate,
						long			lTheoEndDate,
						long			lPayDate,
						char			*cFreq,
...
Err	calc_cms_struct(CMS_STRUCT				cCmsStruct,
					CMS_SPREAD_MODEL_PARAMS	sModelParams,
					CMS_SPREAD_MKT			cCmsMkt);

/* Pricing of (gf * CMSf + mf) times an option or a digital on g1 * CMS1 + g2 * CMS2 */
Err	cms_spread_option_digital(
						...
						long	lFloatFixingDate,
						long	lFloatStartDate,
						long	lFloatTheoEndDate,
						char	*cFloatFreq,
						char	*cFloatBasis,
						char	*cFloatRefRate,
						int		iFloatIsQuanto,
						...
						/* Market Informations */
						CMS_SPREAD_MKT			sDomMarket,
						CMS_SPREAD_MKT			sQuantoMarket,

						/* Outputs */
						double					*dValue,
						CMS_SPREAD_INFOS		sInfos);
...
Err	cms_spread_copula_mixed_sl(	double	dFwd1,
								double	dShift1,
								double	dProba1,
								double	dStd11,
								double	dStd12,
...
Err cms_adjust_correl_atm(	CMS_STRUCT				sCms1,
							CMS_STRUCT				sCms2,						
							double					dGear1,
							double					dGear2,
							int						iMinMax,
