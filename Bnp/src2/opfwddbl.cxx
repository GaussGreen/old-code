...
/*
double probafunc(double T1        , double T2        , double sigma01 ,double
sigma12 ,double mu01        ,double mu12         , double d         , double u
, double k         , int nbterms)
...
2*u)/(2*sigma01*Sqrt(T1))        , (2*k + 4*d*p1 - 2*mu01t1 + 2*mu12*T1 +
powsig01_2t1
...
2*mu12*p1*u/Power(sigma12        ,2))* CBND((-2*d + 2*mu01*T1 - Power(sigma01
      ,2)*T1)/(2*sigma01*Sqrt(T1))        , (2*k + 4*d*p1 - 2*mu01*T1 +
2*mu12*T1 + Power(sigma01        ,2)*T1 - Power(sigma12        ,2)*T1 -
2*mu12*T2 + Power(sigma12       ,2)*T2
- 4*p1*u)/ (2*Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12        ,2)*T1 +
Power(sigma12 ,2)*T2))        ,
    -(sigma01*Sqrt(T1)/Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12 ,2)*T1 +
Power(sigma12        ,2)*T2)))) + Power(E        ,d*p1 -
2*d*mu12*p1/Power(sigma12        ,2) - p1*u + 2*mu12*p1*u/Power(sigma12 ,2))*
CBND((-2*d + 2*mu01*T1 - Power(sigma01 ,2)*T1)/(2*sigma01*Sqrt(T1))        ,
(4*d*p1 - 2*mu01*T1 + 2*mu12*T1 + Power(sigma01 ,2)*T1 - Power(sigma12 ,2)*T1 -
2*mu12*T2 + Power(sigma12        ,2)*T2 + 2*u - 4*p1*u)/ (2*Sqrt(Power(sigma01
,2)*T1 - Power(sigma12        ,2)*T1 + Power(sigma12 ,2)*T2))        ,
    -(sigma01*Sqrt(T1)/Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12 ,2)*T1 +
Power(sigma12        ,2)*T2))) - Power(E        ,-(d*p1) +
2*d*mu12*p1/Power(sigma12        ,2) + mu01*T1 + 2*Power(mu12 ,2)*Power(sigma01
,2)*T1/Power(sigma12        ,4) - 2*mu01*mu12*T1/Power(sigma12        ,2) -
mu12*Power(sigma01        ,2)*T1/Power(sigma12 ,2) - u + p1*u +
2*mu12*u/Power(sigma12        ,2) - 2*mu12*p1*u/Power(sigma12
...
(2*k*Power(sigma12        ,2) - 4*d*p1*Power(sigma12        ,2) -
4*mu12*Power(sigma01        ,2)*T1 + 2*mu01*Power(sigma12 ,2)*T1 +
2*mu12*Power(sigma12        ,2)*T1 + Power(sigma01        ,2)*Power(sigma12
,2)*T1
- Power(sigma12        ,4)*T1 - 2*mu12*Power(sigma12        ,2)*T2 +
Power(sigma12        ,4)*T2 - 4*Power(sigma12        ,2)*u + 4*p1*Power(sigma12
,2)*u)/ (2*Power(sigma12 ,2)*Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12
,2)*T1 + Power(sigma12        ,2)*T2))
      ,
    -(sigma01*Sqrt(T1)/Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12 ,2)*T1 +
Power(sigma12        ,2)*T2))) + Power(E        ,-(d*p1) +
2*d*mu12*p1/Power(sigma12        ,2) + mu01*T1 + 2*Power(mu12 ,2)*Power(sigma01
...
2*mu01*Power(sigma12        ,2)*T1 + 2*mu12*Power(sigma12        ,2)*T1 +
Power(sigma01 ,2)*Power(sigma12        ,2)*T1 - Power(sigma12        ,4)*T1 -
2*mu12*Power(sigma12        ,2)*T2
+ Power(sigma12        ,4)*T2 - 2*Power(sigma12        ,2)*u +
4*p1*Power(sigma12        ,2)*u)/ (2*Power(sigma12        ,2)*Sqrt(Power(sigma01
,2)*T1 - Power(sigma12        ,2)*T1 + Power(sigma12        ,2)*T2))        ,
    -(sigma01*Sqrt(T1)/Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12 ,2)*T1 +
Power(sigma12        ,2)*T2))) + Power(E        ,d*p1 -
2*d*mu12*p1/Power(sigma12        ,2) - p1*u + 2*mu12*p1*u/Power(sigma12 ,2))*
CBND((2*mu01*T1 - Power(sigma01        ,2)*T1
- 2*u)/(2*sigma01*Sqrt(T1))        , (2*k + 4*d*p1 - 2*mu01*T1 + 2*mu12*T1 +
Power(sigma01        ,2)*T1 - Power(sigma12        ,2)*T1 - 2*mu12*T2 +
Power(sigma12       ,2)*T2
- 4*p1*u)/ (2*Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12        ,2)*T1 +
Power(sigma12 ,2)*T2))        ,
    -(sigma01*Sqrt(T1)/Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12 ,2)*T1 +
...
2*d*mu12*p1/Power(sigma12        ,2) - p1*u + 2*mu12*p1*u/Power(sigma12 ,2))*
CBND((2*mu01*T1 - Power(sigma01        ,2)*T1
- 2*u)/(2*sigma01*Sqrt(T1))        , (4*d*p1 - 2*mu01*T1 + 2*mu12*T1 +
Power(sigma01 ,2)*T1 - Power(sigma12        ,2)*T1 - 2*mu12*T2 + Power(sigma12
,2)*T2 + 2*u - 4*p1*u)/ (2*Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12
,2)*T1 + Power(sigma12 ,2)*T2))        ,
    -(sigma01*Sqrt(T1)/Sqrt(Power(sigma01        ,2)*T1 - Power(sigma12 ,2)*T1 +
Power(sigma12        ,2)*T2))) + Power(E        ,-(d*p1) +
2*d*mu12*p1/Power(sigma12        ,2) + mu01*T1 + 2*Power(mu12 ,2)*Power(sigma01
...
mu12*Power(sigma01        ,2)*T1/Power(sigma12 ,2) - u + p1*u +
2*mu12*u/Power(sigma12        ,2) - 2*mu12*p1*u/Power(sigma12
      ,2))*CBND((4*mu12*Power(sigma01        ,2)*T1 - 2*mu01*Power(sigma12
,2)*T1 - Power(sigma01        ,2)*Power(sigma12        ,2)*T1 + 2*Power(sigma12
