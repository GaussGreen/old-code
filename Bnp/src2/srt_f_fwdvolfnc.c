...

{
  ...
  sprintf(
      ...
      start_act, end_theo, compStr, basisStr, cmsvol, start_act, bs_vol_type,
      ir_und_name, ref_rate);
  sprdsht[0][0].type = GRFNSCELL;
