...
symmetric matrix previously reduced by tred2 §11.2. On input  , d[1..n] contains
...
that has been reduced by tred2 are required  , then z is input as the matrix
output by tred2. In either case  , the kth column of z returns the normalized
