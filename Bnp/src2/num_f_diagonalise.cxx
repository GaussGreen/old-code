...
based on Householder tridiagonalisation method        , followed by a
tridiagonal QL implicit method In input        , sym_mat[0..n-1][0..n-1] is a
real symmetric matrix On output        , eigen_val[0..n-1] returns the eigen
values of sym_mat. eigen_vec[0..n-1][0..n-1] is a matrix that stores all the
corresponding renormalised eigen vectors of sym_mat ( eigen_vec[...][i]
corresponds to eigen_val[i] )
