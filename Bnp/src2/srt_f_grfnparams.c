...
Err srt_f_set_GrfnParams(	int numParams, 
							String *paramStrings, 
							String *valueStrings,
                     		SrtGrfnParam *param)
{
...
/*1*/  
		if ((!strcmp(paramStrings[i],"NUMPATH")) ||
			(!strcmp(paramStrings[i],"PATHNUM")) )
		{
...
/*3*/  
	   else if ( (!strcmp(paramStrings[i],"MINNODE")) ||
				(!strcmp(paramStrings[i],"MINSTEP")) )
	   {
	      if (sscanf(valueStrings[i],"%ld",&tmpLng)==1)
		  {
		     if (tmpLng > 0)
...
/*10*/  
	   else if ( (!strcmp(paramStrings[i],"WIDTHPHI")) ||
		   (!strcmp(paramStrings[i],"NUMPHI")) || (!strcmp(paramStrings[i],"NUMPHIS")) )
	   {
...
/*11*/  
	   else if ( (!strcmp(paramStrings[i],"DEBUG"))
				|| (!strcmp(paramStrings[i],"DBG")) )
	   {
 	      if (!strcmp(valueStrings[i],"YES"))
		  {
		     param->dbg = SRT_YES;
...
/*12*/  
	   else if ( (!strcmp(paramStrings[i],"PRINOK")) ||
				 (!strcmp(paramStrings[i],"PRINDEAL")) )
...
/*14*/  
  	   else if ( (!strcmp(paramStrings[i],"MAXNODE")) ||
				(!strcmp(paramStrings[i],"MAXSTEPS")) )
	   {
	      if (sscanf(valueStrings[i],"%ld",&tmpLng)==1)
		  {
		     if (tmpLng > 0)
...
/*16: for compatibility with old grfn only */  
	   else if ( (!strcmp(paramStrings[i],"MODEL")) ||
				(!strcmp(paramStrings[i],"MDL")) )
	   {
...
/*17: to skip the grfn evaluation */  
	   else if ( (!strcmp(paramStrings[i],"SKIPEVAL"))
...
/*18: for an imminent exit */  
	   else if ( (!strcmp(paramStrings[i],"IMMEXIT"))
				|| (!strcmp(paramStrings[i],"EXIT")) )
	   {
 	      if (!strcmp(valueStrings[i],"YES"))
		  {
...
/* 19 : end of day flag */  
	   else if ( (!strcmp(paramStrings[i],"ENDOFDAY"))
				|| (!strcmp(paramStrings[i],"END_OF_DAY")) 
...
/* 20 : end of day fixings ( if yes: will have to get them from database */  
	   else if ( (!strcmp(paramStrings[i],"FIXINGS"))
...
/* 21 : initial seed for random number generation */  
	   else	if ((!strcmp(paramStrings[i],"SEED")) ||
			(!strcmp(paramStrings[i],"RANDSEED")) ||
	   ...
	   else if ( (!strcmp(paramStrings[i],"CLOSEDFORM"))
				|| (!strcmp(paramStrings[i],"CLSDFRM"))
	   ...
	   else if ( (!strcmp(paramStrings[i],"JUMPING"))
				|| (!strcmp(paramStrings[i],"JUMPING_NUMERAIRE"))
				|| (!strcmp(paramStrings[i],"JUMPINGNUMERAIRE"))
				|| (!strcmp(paramStrings[i],"JUMPNUM"))
				|| (!strcmp(paramStrings[i],"JUMP_NUM")) )
	   {
		   if (!strcmp(valueStrings[i],"YES"))
		   {
	   ...
	   else if ((!strcmp(paramStrings[i],"MEASURE"))
				|| (!strcmp(paramStrings[i],"MEAS"))
	   ...
	   else if ( (!strcmp(paramStrings[i],"MINIM")))
	   {
		...
		/* 27 : colmininf */  
	   else	if ( (!strcmp(paramStrings[i],"COLMININF"))
				|| (!strcmp(paramStrings[i],"COLLSMINF")) )
		{
	      if (sscanf(valueStrings[i],"%ld",&tmpLng)==1)
		  {
		     if (tmpLng >= 0)
		...
		/* 28 : colminsup */  
	   else	if ( (!strcmp(paramStrings[i],"COLMINSUP"))
				|| (!strcmp(paramStrings[i],"COLLSMSUP")) )
	   {
	      if (sscanf(valueStrings[i],"%ld",&tmpLng)==1)
		  {
		     if (tmpLng >= 0)
	   ...
	   /* 31 : colmincible */  
	   else	if ( (!strcmp(paramStrings[i],"COLMINFREEDOM"))
				|| (!strcmp(paramStrings[i],"COLLSMDOM")) )
	   {
	      if (sscanf(valueStrings[i],"%ld",&tmpLng)==1)
		  {
		     if (tmpLng >= 0)
	   ...
	   else if ( (!strcmp(paramStrings[i],"PAY"))
		   || (!strcmp(paramStrings[i],"ENDOFDAYPAY")) 
