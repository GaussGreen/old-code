...
Err get_param_first_leg(double Fradate, double* resetdates, double** paramatrix, double* paramfra)
{
    Err    err = NULL;
    double datespread;
    ...
    paramfra[1] = (paramatrix[2][1] - paramatrix[1][1]) * (Fradate - resetdates[1]) / datespread +
                  paramatrix[1][1];

    paramfra[2] = (paramatrix[2][2] - paramatrix[1][2]) * (Fradate - resetdates[1]) / datespread +
                  paramatrix[1][2];

    paramfra[3] = paramatrix[1][3];

    paramfra[4] = (paramatrix[2][4] - paramatrix[1][4]) * (Fradate - resetdates[1]) / datespread +
                  paramatrix[1][4];
    ...
    double* pv)
{
    ...
    for (perindex = 1; perindex < n_resetdates; perindex++)
    {
        ...
        prix = PrixTimeSwap(
            eps, DRSts, (int)nfixdays, maturities, isfriday, paramperiod, width, callspread);
