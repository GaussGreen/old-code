...
static double optval_accurate(double fwd,double strike,double vol,double mat,double disc_fact,
					SrtCallPutType call_put, SrtGreekType greek, SrtDiffusionType log_or_norm)
{
double premium;
...
double    intrinsic;
	...
	*implied_vol = 0.0;
	...
	/* Compute option intrinsic value */   
	intrinsic  = optval_accurate(	fwd_price,
					strike,
					NULL_VOL,
					mat, 
					disc, 
	...
	prem_up =  optval_accurate(fwd_price,
						strike,
						vol_up,
						mat, 
						disc, 
	...
	prem_down = optval_accurate(fwd_price,
						strike,
						vol_down,
						mat, 
						disc, 
	...
	prem_new = optval_accurate(fwd_price,
						strike,
						vol_middle,
						mat, 
						disc, 
	...
	deriv = (optval_accurate(fwd_price,
						strike,
						vol_middle + vol_shift,
						mat, 
						disc, 
