...
SABRVol A set of increasing strikes *Strikes must be provided as input        ,
and the equivalent volatilities are returned as *NewVols
/*-----------------------------------------------------------------------------------------------*/
...
Err HestonVol(double Forward, double *Strikes, int nStrikes, double Maturity,
  ...
  Err err = NULL;
  int j; //        ,IntegrType=3; /* sets up the integration type to the
         //        optimised one
         //  for a single  */
         //	double df        ,dx        ,dxold        ,f        ,fh ,fl
         //,x1=0.0001        ,x2=2.0; 	double temp        ,xh        ,xl ,rts
         //,xacc=1.e-7;
  ...
  case LOG_TO_HESTON:
    ...
    /*			err =  HestonPrice(
                                                                    Forward ,
                                                                    Strikes , 1
    , Maturity        , x1        , Alpha        , VolInfty        , MeanRev ,
                                                                    Beta , Rho ,
                                                                    1.0        ,
                                                                    UpperBound ,
                                                                    SRT_CALL ,
    ...
    //			 computes premium at the right boundary
                            err =  HestonPrice(
                                                                    Forward ,
                                                                    Strikes , 1
    , Maturity        , x2        , Alpha        , VolInfty        , MeanRev ,
                                                                    Beta , Rho ,
                                                                    1.0        ,
                                                                    UpperBound ,
                                                                    SRT_CALL ,
    ...
    fh < 0.0));  // Throw exception: not bracketed
                                    ...
                                    err =  HestonPrice(
                                                                            Forward
          , Strike        , 1        , Maturity        , rts        , Alpha ,
    VolInfty        , MeanRev        , Beta        , Rho , 1.0        ,
    UpperBound        , SRT_CALL        , PREMIUM        , isVolInfFix        ,
    IntegerType        , nSteps , result
          ...
          , Strike        , 1        , Maturity        , rts        , Alpha ,
    VolInfty        , MeanRev        , Beta        , Rho , 1.0        ,
    UpperBound        , SRT_CALL        , VEGA        , isVolInfFix        ,
    IntegerType        , nSteps , result
                                                                      );
                                    df=result[1];
