    ...
    double*** prod_val)
{
    ...
    if (total->num_dom_df > 0 && total->dom_idx != -1)
    {
        ...
        {
            err = "Memory allocation error (1) in payoff_doublelgm1fquanto_pde_c";
            goto FREE_RETURN;
        }
    ...
    if (total->num_fx_df > 0 && total->fx_idx != -1)
    {
        ...
        {
            err = "Memory allocation error (2) in payoff_doublelgm1fquanto_pde_c";
            goto FREE_RETURN;
        }
    ...
    if (total->num_for_df > 0 && total->for_idx != -1)
    {
        ...
        {
            err = "Memory allocation error (3) in payoff_doublelgm1fquanto_pde_c";
            goto FREE_RETURN;
        }
