...
char *SrtGrfnMain(char *domestic, int numParams, char **paramStrings,
  ...
  if (((SrtIrDesc *)(und->spec_desc))->mdl_type == DETERMINISTIC) {
    err = FirstValueDealInDeterministicIrModel(
        numeventdates, eventdates, tableauRows, tableauCols, tableauStrings,
        tableauMask, auxWidth, auxLen, aux, domestic, &grfnparam, price);
    *stdev = 0.0;
  ...
  if (((SrtIrDesc *)(und->spec_desc))->mdl_type == BGM) {
    err = FirstValueDealInBGMModel(
        numeventdates, eventdates, tableauRows, tableauCols, tableauStrings,
        tableauMask, auxWidth, auxLen, aux, domestic, &grfnparam, price, stdev);
    return err;
  }
  ...
  err = srt_f_grfn(und, &grfnparam, numeventdates, &evdates, &tableauRows,
                   &tableauCols, &tableau, 0, NULL, auxWidth, auxLen, aux,
                   iolist, grfn_cells, pay_report);
...
/* ============================================================= */
/*SrtGrfnMainExFrontier is the function called when the exercise frontier is
 * optimized*/
/* ============================================================= */
...
char *SrtGrfnMainExFrontier(char *domestic, int numParams, char **paramStrings,
  ...
  /* Call to the Main grfn pricing function */
  err = srt_f_grfn_ex_frontier(und, &grfnparam, numeventdates, &evdates,
                               &tableauRows, &tableauCols, &tableau, 0, NULL,
                               auxWidth, auxLen, aux, iolist, grfn_cells,
                               pay_report, exfrontier);
