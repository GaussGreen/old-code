...
/*	Tau-TS enabled version */
static void
static_lgmcalczeta1_tauts(int nsig,          /*	Number of Sigmas */
    ...
    int use_jumps)   /*	Use Jumps */
{
  return lgmcalibzeta1F_tauts2_new(
      ...
      nlam, lam_time, lam,
      skip_last, /*	If 1  , the last option is disregarded and the forward
                    volatility is flat from option n-1 */
...
void init_static_lgmprcapgiventauts(
    ...
    DIAG_CALIB_LM_PARAMS
        ln_params) /*	If 1  , the last option is disregarded
                                                           and the forward
                      volatility is flat from option n-1 */
{
  NCPN_LM = ncpn;
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
//	All three routines below  , initialisation  , copying and freeing
//modified	// 	to allow the handling of long and short market prices. PMc
//17Nov03		//
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~//
