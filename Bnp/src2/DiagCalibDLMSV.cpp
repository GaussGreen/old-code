...
static int NB_MOM_LM, INDEX_MOM[MAX_INST], BREAK_INST, FREQ_SHORT_LM, SHIFT_FREQ_LM, NEXS_LM,
    MAX_ITER_NEWTON;
...
static Err (*CALIBRATION_FUNCTION)(void* AllPrimaryInst, void* Model, void* Params),

    (*PRICING_FUNCTION)(
        void* AllSecondaryInst, void* Model, void* Params, int iIndex, double* dPrice),
...
Err static_pricer_momentum_dlm(
