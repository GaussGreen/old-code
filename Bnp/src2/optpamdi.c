...
{ /* BEGIN srt_f_opttpamdi() */
    ...
    premium = srt_f_opttpamdi_price(
        fwd1, fwd2, barrier, vol1, vol2, mat1, mat2, disc1, disc2, below_above);
...
{ /* BEGIN srt_f_opttpamdi_price */
    double premium = 0;
    double measure = 0;
    double mu12, mu12_p, r, b, sig1, sig1_sqrt, sig2, sig2_sqrt, alpha, a0, b0, a1, b1;
    int    du;
