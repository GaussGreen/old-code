...
double srt_f_optamesla(double fwd1, double fwd2, double barrier, double vol1,
  ...
  if ((mat1 <= 0) || (vol1 == 0)) {
    if (below_above == SRT_DOWN) {
      ...
      if (fwd1 >= barrier)
        premium = srt_f_optamedig(fwd2, fwd1, barrier, vol2, mat2, disc,
  ...
  case DELTA_FWD1: /*** DELTA FWD ***/
    shift = fwd1 / 10000;
    answer = (srt_f_optamesla(fwd1 + shift, fwd2, barrier, vol1, vol2, mat1,
  ...
  case DELTA_FWD2: /*** DELTA FWD 2 ***/
    shift = fwd2 / 10000;
    answer = (srt_f_optamesla(fwd1, fwd2 + shift, barrier, vol1, vol2, mat1,
                              mat2, disc, below_above, PREMIUM) -
              premium) /
             shift;
    break;
  ...
  case VEGA1: /*** VEGA ***/
    shift = GVOPT.vol_add;
    answer = (srt_f_optamesla(fwd1, fwd2, barrier, vol1 + shift, vol2, mat1,
                              mat2, disc, below_above, PREMIUM) -
              premium) /
             shift;
    break;
  ...
  case VEGA2: /*** VEGA ***/
    shift = GVOPT.vol_add;
    answer = (srt_f_optamesla(fwd1, fwd2, barrier, vol1, vol2 + shift, mat1,
                              mat2, disc, below_above, PREMIUM) -
              premium) /
             shift;
    break;
