...
Err grfn_copy_to_GrfnDeal(GrfnDeal *gd,
						  long nrows, 
						  long ncols, 
						  GrfnCell **sprdsht, Date *eventdates,
						  long numgrng, GrfnRng *grng, 
...
Err attach_params_to_GrfnEvent(	GrfnDeal     *gd, 
							SrtStpPtr     sptr, 
							SrtUndPtr     und, 
							int           und_index);
...
/* grf_f_evlcllfct.c */
void grf_f_evlcllfct    (   double      **cells,
                            int         c1,
                            int         r1,
                            int         r2,
							int         ind,
