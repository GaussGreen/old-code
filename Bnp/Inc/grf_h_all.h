...
Err attach_params_to_GrfnEvent(GrfnDeal *gd, SrtStpPtr sptr, SrtUndPtr und,
                               int und_index);
...
/* grf_f_evlcllfct.c */
void grf_f_evlcllfct(double **cells, int c1, int r1, int r2, int ind,
                     COMLLType type, double *answer);

void grf_f_evlcllfct_interp(double *x_values, double **cells, int c1, int r1,
                            int r2, double x, COMLLType type, double *answer);
...
/* grf_f_get_event.c */
Err grfn_create_future_event(GrfnDeal *gd, GrfnEvent **event, double step_date,
...
Err grf_f_prgrdl(String filename, int numeventdates, Date *eventdates,
                 long nrows, long ncols, GrfnCell **sprdsht, long numgrng,
                 GrfnRng *grng, long auxwidth, long *auxlen, double **aux);
