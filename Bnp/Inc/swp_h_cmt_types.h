...
#define FwdT_Dateset(zcptr,FIELDNAME,val){ (fwdTptr->FIELDNAME) = (double)val; }
...
#define FwdT_Dset(fwdTptr,FIELDNAME,val){ (fwdTptr->FIELDNAME) = (val); }

#define FwdT_Iset(fwdTptr,FIELDNAME,val){ (fwdTptr->FIELDNAME) = (val); }
...
#define CMT_Dateset(cmtptr,FIELDNAME,val){ (cmtptr->FIELDNAME) = (double)val; }
...
#define CMT_Dset(cmtptr,FIELDNAME,val){ (cmtptr->FIELDNAME) = (val); }
#define CMT_Iset(cmtptr,FIELDNAME,val){ (cmtptr->FIELDNAME) = (val); }
