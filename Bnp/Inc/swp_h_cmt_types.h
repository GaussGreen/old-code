...
#define FwdT_field_Dget(fwdTptr, FIELDNAME, index) field_Dget(fwdTptr->data, FIELDNAME, index)

#define FwdT_field_Iget(fwdTptr, FIELDNAME, index) field_Iget(fwdTptr->data, FIELDNAME, index)
...
#define CMT_field_Dget(cmtptr, FIELDNAME, index) field_Dget(cmtptr->data, FIELDNAME, index)
#define CMT_field_Iget(cmtptr, FIELDNAME, index) field_Iget(cmtptr->data, FIELDNAME, index)
...
#define CMT_field_Dateget(cmtptr, FIELDNAME, index) DTOL(field_Dget(cmtptr->data, FIELDNAME, index))
...
#define CMT_field_Dlength(cmtptr, FIELDNAME) field_Dlength(cmtptr->data, FIELDNAME)
#define CMT_field_Ilength(cmtptr, FIELDNAME) field_Ilength(cmtptr->data, FIELDNAME)
...
#define CMT_field_set_Dlength(cmtptr, len) Field_List_set_Dlength(cmtptr->data, len)
#define CMT_field_set_Ilength(cmtptr, len) Field_List_set_Ilength(cmtptr->data, len)
