...
typedef struct _RangeAccrualStruct
{
    ...
    RangeAccrualObservStep** obs_steps; /* pointers to first observation steps in periods */
...
Err RA_RequestDfDates(
    RangeAccrualStruct* RA, long date, int* pn_unds, int** pn_dfs, long*** pdates);
