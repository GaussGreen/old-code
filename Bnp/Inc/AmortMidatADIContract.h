...
typedef void (*PFN_INTEGRAND)(
	 ...
	 double **, // Grid - Row index [nX1_Begin,...), Grid-Col index [nX3_Begin,...)
	 int,//nX1_Begin,
	 int,//nX3_Begin,
	 void*
	 );
...
//	Returns : as indicated
//-------------------------------------------------------------------------------------------------------
double __stdcall _MU3_BACKWARD_(const double *pdX1,const double *pdX3,const double *pdT,void* pArg);
//-------------------------------------------------------------------------------------------------------
...
//	Returns : as indicated
//-------------------------------------------------------------------------------------------------------
double __stdcall _MU3_FORWARD_(const double *pdX1,const double *pdX3,const double *pdT,void* pArg);
