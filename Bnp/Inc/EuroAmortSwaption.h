...
Err EuropeanAmortizingSwaption2(long AsOfDate,  // today or calculation date
...
/*								LGMErr  (*GetVol)( Date, Date, double, SRT_Boolean, double *),
								SrtDiffusionType srt_vol_type,*/
								// Output
								double *dvPayDates, // caller must pass in a vector(0,NumPeriods-1); returned zero bond values to pay dates 
								double *dvReplicatingStrikes, // caller must pass in a vector(0,NumPeriods-1);returned strikes of replicating swaptions
								double *dvReplicatingNotionals, // caller must pass in a vector(0,NumPeriods-1); returned notionals of replicating swaptions
								...
								double *dvReplicatingSwaptions, // caller must pass in a vector(0,NumPeriods-1); returned values of underlying replicating european swaptions
