...
Err EuropeanAmortizingSwaption(
    ...
    SrtDiffusionType srt_vol_type, double *dvPayDates,
    double *dvEquivalentStrikes, double *dvEquivalentNotionals, double *dPrice,
    double *dFixedLeg, double *dFloatLeg, double *dSwapRate,
    SigKapTS **lgmSigKapTSptr, double *dLGMVol, double *dvReplicatingSwaptions,
    double dMargin);
