...
double interp_linear(
    double x, double x_lower, double prem_lower, double x_upper, double prem_upper);
...
void find_closest(double key, double* val_array, long min_index, long max_index, long* guess);
