...
/* SABR lognormal Vol */
double SabrLognormalVol(double vol, double alpha, double beta, double rho,
                        double forward, double strike, double maturity,
                        SABR_VOL_TYPE cst_vol);

/* Derivative with respect to the vovol alpha */
double SabrDsigmaDalpha(double vol, double alpha, double beta, double rho,
                        double forward, double strike, double maturity,
                        SABR_VOL_TYPE cst_vol);

/* Derivative with respect to the power parameter beta */
double SabrDsigmaDbeta(double vol, double alpha, double beta, double rho,
                       double forward, double strike, double maturity,
                       SABR_VOL_TYPE cst_vol);

/* Derivative with respect to the correlation parameter rho */
double SabrDsigmaDrho(double vol, double alpha, double beta, double rho,
                      double forward, double strike, double maturity,
                      SABR_VOL_TYPE cst_vol);

/* Derivative with respect to the ATM lognormal volatility */
double SabrDsigmaDvolatm(double vol, double alpha, double beta, double rho,
                         double forward, double strike, double maturity);
...
Err compute_weights(double *strikes, int nbr_strikes, double forward,
                    double ATMVol, double maturity, double *weights_of_strikes);
