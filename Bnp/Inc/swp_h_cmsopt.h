...
/* 1. flat log vol case	: myVol.method = 0  , myVol.vol = 10%  , myVol.voltype
= SRT_LOGNORMAL */
/* 2. approx smile log	: myVol.method = 1  , myVol.voltype = SRT_LOGNORMAL , +
fill myVol.start  , myVol.end  , myVol.szVolCurveName  , myVol.numstrikes  ,
myVol.strikes
/* 3. full sabr			: myVol.method = 2  , myVol.szVolCurveName =
vol_name(mkt)  , myVol.start  , myVol.end   , myVol.voltype = Inputtype atm vols
(norm  , log  , beta);
