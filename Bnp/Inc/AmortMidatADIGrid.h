...
void __stdcall _Shift_X1(int nSize_After,_Grid* pGrid,int *pnR_Begin,int *pnR_End);
void __stdcall _Shift_X3(int nSize_After,_Grid* pGrid,int *pnR_Begin,int *pnR_End);
