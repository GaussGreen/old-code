...
Err srt_get_lgm_int_zc_bond(double		bond_mat,
							double		time,
							TermStruct	*ts,
							double		*int_zc_bond);
...
Err srt_f_lgm_phi_func(Date		date,
					   char		*und_name,
					   double	*phi_val);
...
double find_meanvol(	double time,
			TermStruct* l		);
...
double **find_M_eta_beta(   double time, 
				  TermStruct* l);
...
double find_beta(	double time,
			TermStruct* l		);
/* -> return from TermStruct 'power' the power value corresponding to the state var */

/* -------------------------------------------------------------------------- */

double find_eta(	double time,
			TermStruct* l		);
/* -> return from TermStruct 'power' the power value corresponding to the state var */

/* -------------------------------------------------------------------------- */

double find_vasicek_init_cond(	double time,
							 TermStruct* l		);
/* -> return from TermStruct 'power' the power value corresponding to the state var */

/* -------------------------------------------------------------------------- */

double find_mean_rev_level(	double time,
						  TermStruct* l		);
/* -> return from TermStruct 'power' the power value corresponding to the state var */
...
double Psi_func( 	double time,
				TermStruct* l		);
/* -> return ? */

/* -------------------------------------------------------------------------- */

double Kappa_func( 	double time,
				TermStruct* l		);
/* -> return ? */

/* -------------------------------------------------------------------------- */

double J_func( 	double time,
				TermStruct* l		);
/* -> calculates the exact value of the J function at date using J_vector */

/* -------------------------------------------------------------------------- */

double Zeta_func(   double      time, 
				TermStruct *l);
