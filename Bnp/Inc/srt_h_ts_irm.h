...
Err srt_get_lgm_int_zc_bond(double bond_mat, double time, TermStruct* ts, double* int_zc_bond);
...
Err srt_f_vasicek_fut(double start_date, double pay_date, char* und_name, double* fut_pr);
...
Err srt_f_vasicek_money_market_account_vol(
    Date date, char* und_name, double* money_market_account_vol);
...
double srt_f_lgm_cum_vol(TermStruct* ts, double t, double t1, double t2, double* answer);
