...
typedef void (*EvalEventDfsFct)(GrfnEvent *, SrtSample *, SrtUndInfo *);

typedef Err (*EvalEventFct)(GrfnEvent *, SrtSample *, SrtDealDesc, double *,
                            EvalEventDfsFct, SrtUndInfo *, double *);
...
Err SrtSetGrfnCell(int tabRows, int tabCols, char ***tabStrings, int **tabMask,
                   GrfnCell ***tableau);
...
/* ------------------------- For GRFN evaluation --------------------------- */
Err srt_f_grfn_val_GrfnDeal(GrfnDeal *gd, SrtStpPtr sptr, SrtUndPtr und,
                            SrtGrfnParam *grfnparam, void *answer,
                            SrtUndInfo *und_info);
...
Err srt_f_grfn_from_flat_file(String filename, SrtGrfnParam *grfnparam,
                              SrtUndPtr und, double *answer);

/*---------------------------- The srt_f_grfn function used when optimizing an
                                                                exercise
   frontier for Bermudans-------------- */
