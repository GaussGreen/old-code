...
typedef Err (*EvalEventFct)(
    GrfnEvent*, SrtSample*, SrtDealDesc, double*, EvalEventDfsFct, SrtUndInfo*, double*);
...
Err srt_f_grfn_from_flat_file(
    String filename, SrtGrfnParam* grfnparam, SrtUndPtr und, double* answer);

/*---------------------------- The srt_f_grfn function used when optimizing an
                                                                exercise frontier for
   Bermudans-------------- */
