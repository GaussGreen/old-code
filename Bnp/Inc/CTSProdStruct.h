...
typedef struct
{
	...
	/*	For DRS adjustment, strikes in the market volatility matrix for replication */
...
typedef struct
{
	...
	double			cpn_plus_ex_partial;	/*  Coupon including notional repay/increase for partial */
...
typedef struct
{
	int				pay_rec;		/*	0: rec exo leg upon exercise, 1: pay exo leg upon exercise */
	/*	Specs */
...
Err cts_calc_equivalent_strikes(
CTS					cts_iv,
CTS					cts_call,
CTS_MKT				mkt);
