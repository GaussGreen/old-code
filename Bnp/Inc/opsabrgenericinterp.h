...
Err BetaPrice3(
    double Forward, double Strike, double Sigma, double Maturity, double Beta, double* Price);
...
double op_BMM2_calib(
    double F, double K, double T, double sigma, double alpha, double beta, double rho, double zeta);
