...
/* A Generic type for the functions that compute the coefficients of the
...
/* A Generic type for the function that compute all sorts of thing for
   the change of variables and the localization of the Differential Linear
   Operator	 */
...
/* --------------------------------------------------------------------------------------------------------------------------------------------
        TYPE                :   SrtPdeObject
        DESCRIPTION   :   A structure to discretise and solve the PDE at a given
   time step
   --------------------------------------------------------------------------------------------------------------------------------------------*/
typedef struct {
