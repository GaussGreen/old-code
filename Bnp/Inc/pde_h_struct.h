...
/* A Generic type for the functions that compute the coefficients of the Differential Linear Operator*/
...
/* --------------------------------------------------------------------------------------------------------------------------------------------
	...
	DESCRIPTION   :   A structure that represents the PDE grid and the operator at a given time step
...
/* When computing differential of the solution wrt parameters,  a source member comes along: same L, new PDE */
...
/* Functions to compute the coeffficients of the linear differential operator at a givent point (x,y,z) */
