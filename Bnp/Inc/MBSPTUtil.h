...
// to be used in conjunction with the reurn value of interp_search, if the return value is j,
// x0=xs[j-1]
#define LogInterp(x, x0, x1, y0, y1) (y0) * pow(((y1) / (y0)), (((x) - (x0)) / ((x1) - (x0))));
