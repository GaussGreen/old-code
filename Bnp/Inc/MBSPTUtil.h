...
#pragma warning (1 : 4100 4101) // NB: force warnings for unused arguments and local parameters
...
//if we want to check that memory allocation/de-alloc's input limits are sensible
...
//to be used in conjunction with the reurn value of interp_search, if the return value is j, x0=xs[j-1]
...
double linear_interp(int n, double * xs, double * ys, double x, int linear_extrapolate); // interpolate or do flat extrapolation
...
double loglinear_interp(int n, double * xs, double * ys, double x, int loglinear_extrapolate); // interpolate or do flat extrapolation

double loglinterpFlat(int n, double * xs, double * ys, double x); // interpolate or do flat extrapolation
