...
char *MBSPT_AddCashFlowPV(double *io, double *po, // in an dout
                          int start, int end, double coupon,
                          double sch_amort_rate, double *smm, int nb_zeros,
                          double **zeros, int NbZerosToSkip);
