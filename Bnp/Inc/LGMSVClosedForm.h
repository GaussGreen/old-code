...
void LGMSV_prod_comp(double re1, double im1, double re2, double im2, double* re3, double* im3);

void LGMSV_div_comp(double re1, double im1, double re2, double im2, double* re3, double* im3);
