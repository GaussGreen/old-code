...
Err payoff_doublelgm1fquanto_pde(double evt_date, double evt_time,
                                 void *func_parm,
                                 ...
                                 /* Grid data	*/
                                 int l1, int u1, int l2, int u2, double *r1,
                                 double **r2,
  ...
  FIRSTMktAtT *local;
  double *dom_dff = NULL, *dom_gam = NULL, *fx_dff = NULL, *fx_gam = NULL,
         *fx_gam2 = NULL, *dom_gam2 = NULL, *for_dff = NULL, *for_gam = NULL,
         *for_gam2 = NULL;
  int i, j, l;
  double temp;
