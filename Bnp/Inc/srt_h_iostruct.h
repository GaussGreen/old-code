...
Err srt_f_IOencodename(	char id_name[32],
			int type,
			int bucket_no,
			double shift_value,
			int shift_type,
...
Err srt_f_IOstructset(	SrtIOStruct *l,
			char    id_name[32],
			int     type,
			int     bucket_no,
			Date    bucket_start,
...
Err srt_f_IOstructget(	SrtIOStruct l,
			char id_name[32],
			int type,
			int bucket_no,
			double shift_value,
...
Err srt_f_IOstructsetexfrontier(	
				SrtIOStruct *l,
				SRT_Boolean      done,
				double      *exboundary,
...
Err srt_f_IOstructgetexfrontier(SrtIOStruct l, double **exboundary, long *exfrontierlength);
