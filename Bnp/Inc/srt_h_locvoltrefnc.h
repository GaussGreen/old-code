...
Err		srt_f_locvol_init_tminf
		...
		SrtStpPtr	stp,			/*	Step pointer:
										the step list is supposed to have been init */
...
Err	srt_f_locvol_make_phi_grid 
	(SrtLocTreInf		*trinf, 
	double				*cur_phi_grid);
...
Err	srt_f_locvol_recombine_in_r 
	(SrtLocTreNdInf			*node, 
	double					*r_grid, 
	SrtLocTreInf			*trinf,
