...
Err irm_sv_get_term_struct_date(char *und, int *one2F, int *num_sigma,
                                long **sigma_dates, double **sigma,
                                int *num_tau, long **tau_dates, double **tau,
                                double *alpha, double *gamma, double *rho,
                                int *num_smile, long **smile_dates,
                                double **alphaSV, double **lamSV,
                                double **rhoSV, double **rho2SV, double *tstar);
