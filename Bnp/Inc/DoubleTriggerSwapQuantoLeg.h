...
Err   digital_quanto_float_leg_cms_rate_quanto(double fwd,
                                                                                           double
cms_fixing_time, double cms_start_time, double cms_nfp,

                                                                                           SrtCompounding
cms_compounding, double cms_delay, double cms_dRateConv,

                                                                                           SrtDiffusionType
cms_vol_type, int cms_flat_vol_or_smile_approx, long cms_start_date, long cms_theo_end_date, int
cms_cash_vol, double fwd_spread, char* cms_vc_name, int n_cms_strikes_in_vol, double*
cms_strikes_in_vol,
...
cms_dom_for,
                                                                                           ...
                                                                                           double*
cms_quanto_corr_times, double* cms_quanto_corr_values, int n_cms_quanto_corr,

                                                                                           double*
fwd_fx_vols_times, double* fwd_fx_vols_values, int n_fwd_fx_vols,

                                                                                           double*
result_cms_rate_quanto);
