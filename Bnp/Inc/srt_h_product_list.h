...
struct _SrtProduct {
	...
	Parameter 3: number of underlyings involved in payoff calculation is stored here
	Parameter 4: number of DFs per underlying is stored here
	Parameter 5: DFs maturities are stored here
