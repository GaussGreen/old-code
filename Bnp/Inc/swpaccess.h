...
char *SwpInitExternalFct(
    ...
    SpreadFuncType spread_func, RateInfoFuncType rate_info_func,
    VolFuncType vol_func, SABRVolFuncType sabrvol_func,
...
char *SwpSwapUnwind(long value_date, long start, long end, long today,
                    ...
                    char *LiborBasis, double liborFix, char *undName,
                    double *pv);
...
char *SwpSwapPV(long start, long nfp_or_end, char *cpdStr, char *basisStr,
                double strike, char *dnctName, char *refRateCode, double *pv);
