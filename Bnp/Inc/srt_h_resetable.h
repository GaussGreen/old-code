...
Err NewtonJumps(int nmat, /* = 1+nbre de digitales dans la periode de reset */
				double *DRS, /* term structure des DRS a la date de reset: [1..nmat] */
				double *maturites, /* [1..nmat] */
				double *isFriday,  /* [1..nmat] flag qui indique si chaque	maturite est un Friday */
				double **param, /*parametres de la dynamique de chaque DRS [1..nmat][1..5] */
...
/* =============================================================================
 ...
 Err srt_f_FlooredTimeSwap(
					...
					char    *WeekendRule,
					char	*RecPay,
					String  sYieldCurveName,
					String  sVolCurveName,
