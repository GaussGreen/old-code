...
Err srt_f_fwd_resetcaplet(SrtUndPtr und, SrtGrfnParam *grfnparam, String yc_id,
                          Date today, String ref_rate, SrtMdlType mdl_type,
                          SrtReceiverType rec_pay, Ddate str_fix,
                          Ddate spot_fix, Ddate start_act, Ddate end_th,
                          String compdStr, String basisStr, double *premium);
