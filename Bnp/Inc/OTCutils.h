...
typedef struct
{
	...
	int		OTCsmileAndFlat;
	int		OTCpayoff;
	double	OTCfwdSmileVisuStd; /* Gets the used smile at the call dates for three strikes calculated with OTCfwdSmileStd */
	int		OTCsmile;
	int		OTCsmileFee;
	int		OTC;
	...
	double	**KO_Barrier; //First row is the barrier and the second row is the adjustment
