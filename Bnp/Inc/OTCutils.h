...
typedef struct
{
    ...
    int    OTCsmileAndFlat;
    int    OTCpayoff;
    double OTCfwdSmileVisuStd; /* Gets the used smile at the call dates for three strikes calculated
                                  with OTCfwdSmileStd */
    int OTCsmile;
    int OTCsmileFee;
    int OTC;
...
void cpd_free_otc_precalc(
    otcpd_precalc* otc_precalc, int nCall, int nCoupons_pd, int nCoupons_fund);

Err cpd_alloc_otc_precalc(
    otcpd_precalc* otc_precalc, int nCall, int nCoupon_pd, int nCoupon_fund, int nMktDates);
