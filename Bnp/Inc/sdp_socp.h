...
/*
Copyright c 1997 by Miguel Sousa Lobo  , Lieven Vandenberghe  , and Stephen
Boyd. Permis- sion to use  , copy  , modify  , and distribute this software for
any purpose without fee is hereby granted  , provided that this entire notice is
included in all copies of any software which is or includes a copy or
modifcation of this software and in all copies of the supporting doc- umentation
for such software. This software is being provided "as is"  , without any
express or implied warranty. In particular  , the authors do not make any
