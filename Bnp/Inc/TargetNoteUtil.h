...
copy_TARN_Market_Struct( TARN_Market_Struct* in_market_struct, TARN_Market_Struct* out_market_struct  );
...
copy_TARN_Calibration_Struct( TARN_Calibration_Struct* in_calibration_struct, TARN_Calibration_Struct* out_calibration_struct  );
...
copy_TARN_Pricing_Struct( TARN_Pricing_Struct* in_pricing_struct, TARN_Pricing_Struct* out_pricing_struct  );
...
copy_TARN_Output_Struct( TARN_Output_Struct* in_output_struct, TARN_Output_Struct* out_output_struct  );
