...
void twound_calcdeltax(SrtStpPtr top, double* delta_x, SrtMdlType mdl_type1, SrtMdlType mdl_type2);
...
Err twound_trelim(
    SrtStpPtr stp, SrtTwoFacTreInf* maxtrinf, SrtMdlType mdl_type1, SrtMdlType mdl_type2);
