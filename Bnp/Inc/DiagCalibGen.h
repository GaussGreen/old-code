...
typedef struct {
  ...
  Err (*GetTarget)(void *Inst, void *GlobalConst, void *Model,

                   CALIBGEN_PARAMS CalibConsts, double *target);

  /* For Newton first iterations */
  Err (*GetFirstGuess)(void *Model, void *GlobalConst, int index_param,
                       double target, double *param1);

  Err (*GetSecondGuess)(void *Model, void *GlobalConst, int index_param,
                        double param1, double price1, double target,
                        double *param2);

  /* Set the bounds and the default values */
  Err (*GetLimitAndLastParam)(void *Model, CALIBGEN_PARAMS CalibConsts,
                              void *GlobalConst, int index_param,
                              double *last_param, double *limit_down,
                              double *limit_up);

  /* Bump the parameter */
  Err (*BumpParam)(void *Model, void *GlobalConst, int index_param,
                   double param);
  ...
  Err (*UpdateConstsAfterParam)(void *Inst, void *InstConst, void *GlobalConst,
                                void *Model, CALIBGEN_PARAMS CalibConsts);

  /* Pricing of the instrument */
  Err (*PriceInst)(void *Inst, void *InstConst, void *GlobalConst, void *Model,
                   double *InstPrice);
...
Err CalibrateSmileAndParam(
    ALLCALININSTRUMENTSDLM AllInst, int *DoSmileCalib, void *InstConst,
    void *GlobalConst, void *Model,

    CALIBGEN_PARAMS CalibConsts,

    Err (*GetLimitLastParam)(void *Model, CALIBGEN_PARAMS CalibConsts,
                             void *GlobalConst,

                             int index_param, double *last_param,
    ...
    Err (*UpdateConstsAfterParam)(void *Inst, void *InstConst,
                                  void *GlobalConst, void *Model),

    Err (*PriceInst)(void *Inst, void *InstConst, void *GlobalConst,
                     void *Model,
                     Err (*UpdateConstsAfterParam)(void *Inst, void *InstConst,
                                                   void *GlobalConst,
                                                   void *Model),
    ...
    Err (*SetParam)(void *Model, void *GlobalConst, int index_param,
                    double param),
