...
char *SrtGrfnLGMSVpde(char *underlying, int numeventdates, long *eventdates,
                      ...
                      LGMSVParam Params, int nstept, int nstepx, int nstepeps,
                      int nstepphi,
...
char *SrtGrfnLGMSVMCCV(char *underlying, int numeventdates, long *eventdates,
                       long tableauRows, long tableauCols,
                       char ***tableauStrings, int **tableauMask, long auxWidth,
                       long *auxLen, double **aux,
...
char *SrtGrfn3DFXQuadTree(char *und3dfx, double beta, double gamma, double sig0,
                          int numeventdates, long *eventdates, long tableauRows,
                          long tableauCols, char ***tableauStrings,
                          int **tableauMask, long auxWidth, long *auxLen,
                          double **aux, double *barrier, int *bar_col,
                          long num_stp, int *num_prod, int discount,
                          double *vols, double *vols_time, int nbVols,
                          double **prod_val);

char *SrtGrfn3DFXQuadMc(char *und3dfx, double beta, double gamma, double sig0,
                        int numeventdates, long *eventdates, long tableauRows,
                        long *tableauCols, char ***tableauStrings,
                        int **tableauMask, long auxWidth, long *auxLen,
                        double **aux, long num_paths, long num_stp, int do_pecs,
                        double ***prod_val);

char *SrtMultiGrfn3DFXMc(char *underlying, int numeventdates, long *eventdates,
                         long tableauRows, long *tableauCols,
                         char ***tableauStrings, int **tableauMask,
                         long auxWidth, long *auxLen, double **aux,
                         long num_paths, int do_pecs, double ***prod_val);

char *SrtMultiGrfn3DFXMcEB(char *underlying, int numeventdates,
                           long *eventdates, int *optimise, MCEBPARAMS params,
                           long *resRows, long tableauRows, long *tableauCols,
                           char ***tableauStrings, int **tableauMask,
                           long auxWidth, long *auxLen, double **aux,
                           long num_paths, int do_pecs, double ***prod_val);
