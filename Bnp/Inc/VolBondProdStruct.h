...
void MY_LGM2F_Compute_Df_From_Factors_Value(double fact1, double fact2, MYLGM2F mylgm2f);

// void MY_LGM2F_Compute_Df_From_Factors_Value(long today, long eventDate,
//										   double fact1,
//double
// fact2, 										   MYLGM2F mylgm2f, TermStruct* l,
// char *yc);
...
double SWAP_FOR_LGM2F_SwapRate_From_Factors_Value(
    double fact1, double fact2, swap_for_lgm2f* swapForLgm2f);
