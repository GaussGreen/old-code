...
typedef Err (*GET_CASH_VOL_FUNC)(char *vol_curve_name, double start_date,
                                 double end_date, double cash_strike, int zero,
                                 char *ref_rate_name, double *vol,
                                 double *power);

typedef Err (*GET_CASH_VOL_CONVERT_FUNC)(
    GET_CASH_VOL_FUNC get_cash_vol, char *vol_curve_name, double start_date,
    double end_date, double mat, double cash_fwd, double cash_strike,
    char *ref_rate_name, SrtDiffusionType vol_type, double *vol);
