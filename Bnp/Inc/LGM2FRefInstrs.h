...
double H2_Func(Date tRef,Date *tStart,Date tNow,long nEx,double *H1,double gamma);
double H1_Func(Date tRef,Date *tStart,Date tNow,long nEx,double *H1);
double XLH1_Func(Date tRef, Date *tStart, Date tNow, Date tLast, long nEx,double *H1);
double XLH2_Func(Date tRef,Date *tStart,Date tNow,Date tLast,long nEx,double *H1,double gamma);
...
double XL_New_Zeta2_Func(Date tRef,Date *tEx,long nEx, Date tNow,double *Zeta1,
				  double alpha, double gamma,double rho);

double XL_New_Zeta12_Func(Date tRef,Date *tEx,long nEx, Date tNow,double *Zeta1,
				  double alpha, double gamma,double rho);

double New_Zeta2_Func(Date tRef, Date *tEx, long nEx, Date tNow, 
						  double *Zeta1,double *Zeta2,
						  double alpha, double gamma, double rho);
double New_Zeta12_Func(Date tRef, Date *tEx, long nEx, Date tNow, 
