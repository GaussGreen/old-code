...
/*	Main function. Diffusion can be made either under QTfinal or under Jumping Numeraire */
/*	------------------------------------------------------------------------------------ */
Err	 mc_main_lgm2f(	
					/*	Time data */
					long		npaths,
...
// Calculates the fwds, variances, phis etc. for a LGM2F with lambda term structure
