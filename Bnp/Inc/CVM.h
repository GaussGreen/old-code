...
typedef struct
{
	...
	int				interpollation_mode;		// 0 : piecewise constant, 1 : continuous piecewise linear
	int				nbOfDates;
	...
	double			***pillars_correls;			// pillars_correlations[DateIndex][PillarIndex1][PillarIndex2]
	double			***pillars_chol;			// pillars_chol[DateIndex][PillarIndex1][PillarIndex2]
	double			***pillars_angles;			// pillars_angles[DateIndex][PillarIndex1][PillarIndex2]
...
Err cvm_convert_correls_to_angles(int nbOfPillars,
					int nbOfDates, 
					double ***pillars_correls,
					double ***pillars_angles, 
					cvm_str *cvm);
...
Err cvm_compute_sensitivities(double date, double maturity, 
