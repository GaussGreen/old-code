...
Err cpd_fill_eval_const_dlm(CPD_UND und, CPD_STR cpd,
                            /*	Index of the current call/KO */
                            int call_idx, int is_mc, CPD_EVAL_CONST eval_const);
...
/*	Structures and functions for the SMILEd underlying and its term
 * structures */
...
Err cpd_launch_smile_tree(CPD_STR cpd, CPD_SMILE_UND und,
                          /*	Number of steps */
                          int num_stp,
                          /*	GRFN tableau structures */
                          int *num_evt_dtes, int *num_cols, int *aux_rows,
                          int *aux_cols, long *evt_dtes, char ***evt,
                          int **mask, double **aux,
                          /*	Results */
                          double *fund_leg, double *pd_leg, double *call);
