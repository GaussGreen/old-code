...
//**MACROS***
#define transformIncentive( incent, gwac, refi, CMS10Y ) (incent * gwac - refi + CMS10Y)
//**********
...
void adjust_density( MBSDENSITY * density, double M, double gwac, double refiRate, double Rate10Y, long Nbweights );//potentially also refiRate and Rate10Y
void adjust_history( HISTORY * history, int term, double refiRate, double Rate10Y ); // potentially also refiRate and Rate10Y
...
//1st payment <-> payment_nb=1; wam = oterm, calc the scheduled principal paydown during the payment_nb-th payment, per $1 principal remaining before the payment
