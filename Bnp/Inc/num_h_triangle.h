...
typedef double *
    *TriTriangle; /* doublely:  typedef TriTriangle *TriTriangle   */
...
#define decode(ptr, TriOrientedTriangle)                                       \
  (TriOrientedTriangle).orient =                                               \
      (int)((unsigned long)(ptr) & (unsigned long)3l);                         \
  (TriOrientedTriangle).tri =                                                  \
      (TriTriangle *)((unsigned long)(ptr) ^                                   \
...
#define org(TriOrientedTriangle, pointptr)                                     \
  pointptr = (TriPoint)(TriOrientedTriangle)                                   \
                 .tri[plus1mod3[(TriOrientedTriangle).orient] + 3]

#define dest(TriOrientedTriangle, pointptr)                                    \
  pointptr = (TriPoint)(TriOrientedTriangle)                                   \
                 .tri[minus1mod3[(TriOrientedTriangle).orient] + 3]

#define apex(TriOrientedTriangle, pointptr)                                    \
  pointptr =                                                                   \
      (TriPoint)(TriOrientedTriangle).tri[(TriOrientedTriangle).orient + 3]
