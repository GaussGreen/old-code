...
Err twound_trelim(SrtStpPtr stp, SrtDiagTwoFacTreeInfo *maxtrinf,  SrtMdlType  mdl_type1, SrtMdlType  mdl_type2);
...
/* ------------------------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------------------------ */
void twound_tree_expectation(SrtPentoTreeNodeInfo	 *node,			      /* Node info */
