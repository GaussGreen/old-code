...
Err srt_f_vegashiftirministp(SrtStpPtr stp, SrtUndPtr und,
                             ...
                             double sigma_bucket_start, double sigma_bucket_end,
                             double sigma_shift, int sigma_shift_type,
                             double tau_bucket_start, double tau_bucket_end,
...
Err srt_f_vegashifttrelgm1d(SrtUndPtr und, SrtGrfnParam *grfparam,
