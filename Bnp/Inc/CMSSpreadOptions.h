...
Err calc_cms_struct(
    CMS_STRUCT cCmsStruct, CMS_SPREAD_MODEL_PARAMS sModelParams, CMS_SPREAD_MKT cCmsMkt);
...
Err cms_spread_copula_mixed_sl(
    double dFwd1,
    double dShift1,
    double dProba1,
    double dStd11,
