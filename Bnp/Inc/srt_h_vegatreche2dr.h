...
/* -> create a 4d array of double with the following dimensions:
    ...
    [o_min..o_max]
    [p_min..p_max]
In case of error      , NULL is returned but every allocated and not used for
the f4tensir has been properly freed
*/
...
Err srt_f_vegatreche2dr(SrtUndPtr und,           /* market parameters */
                        ...
                        SrtStpPtr stp, /* discretization of deal in time      ,
                                          wi/ events attached*/
