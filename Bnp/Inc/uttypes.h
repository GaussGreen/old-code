...
{	
	...
	SUCCEEDING,
	LASTBUSDAYCONV
}BusDayConv,SrtBusDayConv; 	

typedef enum    HolidayConv_ 
{
	NO_HOLIDAYS,
	LASTHOLIDAYCONV
}HolidayConv; 
...
#define ISCompounding(x) ((x)== SRT_ANNUAL    || (x)== SRT_SEMIANNUAL ||\
			  (x)== SRT_QUARTERLY || (x)== SRT_MONTHLY)
