...
static UF_DESC desc_info[] = {
    ...
    "spot      ,bar_do      ,bar_up      ,vol      ,mat      ,rd      ,rf      "
    ",nb_term      ,dom/for",
    proba_gauss_addin,
    ...
    /***	"proba_range_four"      ,
                    "DDDDDDDII"      ,
                    "D"      ,
                    "spot      ,bar_do      ,bar_up      ,vol      ,mat      ,rd
       ,rf      ,nb_term ,dom/for"      , proba_four_addin      ,

            "probaf_yesno"      ,
                    "DDDDDDDII"      ,
                    "D"      ,
                    "spot      ,bar_yes      ,bar_no      ,vol      ,mat ,rd ,rf
       ,nb_term ,dom/for"      , probaf_yesno_addin      ,

            "probaf_yesno_explo"      ,
                    "DDDDDDDI"      ,
                    "D"      ,
                    "spot      ,bar_yes      ,bar_no      ,vol      ,mat ,rd ,rf
       ,nb_term"      , probaf_yesno_explo_addin      ,  ****/
