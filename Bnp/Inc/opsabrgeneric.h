...
double op_sabrgen(double F, double K, double T, double sigma, double alpha,
                  double a, double b, double c, double rho,
                  double (*vol_local)(double x, double a, double b, double c,
                                      int type));

double op_sabrgen_calib(double F, double K, double T, double sigma,
...
double op_sabr_find_limit(double dist_tgt, double F, double T, double sigma,
                          double alpha, double a, double b, double c,
                          double rho, double perc,
                          double (*vol_local)(double x, double a, double b,
                                              double c, int type));
