...
#define get_ts_from_irund(undptr)\
	( ((SrtIrDesc*)(undptr->spec_desc))->ts)
...
#define get_ts_from_eqund(undptr)\
	(((SrtEqDesc*) (undptr->spec_desc))->ts)
...
#define get_spot_from_eqund(undptr)\
	(((SrtEqDesc*) (undptr->spec_desc))->spot)
...
#define get_ts_from_fxund(undptr)\
	(((SrtFxDesc*) (undptr->spec_desc))->ts)
...
#define get_spot_from_fxund(undptr)\
	(((SrtFxDesc*) (undptr->spec_desc))->spot)


/* -------------------------- Bond Underlyings ---------------------------------- */

#define get_ts_from_bndund(undptr)\
	(((SrtBndDesc*) (undptr->spec_desc))->ts)
