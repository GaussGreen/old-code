...
/* GET */
#define get_ycname_from_irund(undptr) (((SrtIrDesc*)(undptr->spec_desc))->yc_name)

#define get_mdltype_from_irund(undptr) (((SrtIrDesc*)(undptr->spec_desc))->mdl_type)

#define get_mdldim_from_irund(undptr) (((SrtIrDesc*)(undptr->spec_desc))->mdl_dim)

#define get_ts_from_irund(undptr) (((SrtIrDesc*)(undptr->spec_desc))->ts)

/* SET */
#define set_irund_mdltype(undptr, mdltype) (((SrtIrDesc*)(undptr->spec_desc))->mdl_type = mdltype)

#define set_irund_ts(undptr, termstruct) (((SrtIrDesc*)(undptr->spec_desc))->ts = termstruct)

/* ------------------------- Equity Underlyings ---------------------------------- */

#define get_ts_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->ts)

#define get_discname_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->disc_name)

#define get_dvdname_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->dvd_name)

#define get_reponame_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->repo_name)

#define get_mdltype_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->mdl_type)

#define get_mdldim_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->mdl_dim)

#define get_spot_from_eqund(undptr) (((SrtEqDesc*)(undptr->spec_desc))->spot)

/* --------------------- Foreign Exchange Underlyings ---------------------------- */

extern char* get_discname_from_fxund(SrtUndPtr undptr);

#define get_ts_from_fxund(undptr) (((SrtFxDesc*)(undptr->spec_desc))->ts)

#define get_domname_from_fxund(undptr) (((SrtFxDesc*)(undptr->spec_desc))->dom_name)

#define get_forname_from_fxund(undptr) (((SrtFxDesc*)(undptr->spec_desc))->for_name)

#define get_mdltype_from_fxund(undptr) (((SrtFxDesc*)(undptr->spec_desc))->mdl_type)

#define get_mdldim_from_fxund(undptr) (((SrtFxDesc*)(undptr->spec_desc))->mdl_dim)
...
#define get_discname_from_bndund(undptr) (((SrtBndDesc*)(undptr->spec_desc))->disc_name)

#define get_reponame_from_bndund(undptr) (((SrtBndDesc*)(undptr->spec_desc))->repo_name)

#define get_mdltype_from_bndund(undptr) (((SrtBndDesc*)(undptr->spec_desc))->mdl_type)

#define get_mdldim_from_bndund(undptr) (((SrtBndDesc*)(undptr->spec_desc))->mdl_dim)

#define get_yield_from_bndund(undptr) (((SrtBndDesc*)(undptr->spec_desc))->spot_yield)

#define get_cleanprice_from_bndund(undptr) (((SrtBndDesc*)(undptr->spec_desc))->clean_price)
...
/* --------------------------------------------------------------------------------
   Specifically for an FX underlying: gets the currencies through the growth curves
   --------------------------------------------------------------------------------- */

Err get_fx_underlying_currencies(SrtUndPtr fxund, String* dom_ccy, String* for_ccy);
