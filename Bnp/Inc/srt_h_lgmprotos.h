...
SrtSimMidAtPtr LGMCreateMidAtFromAmer(Date tfirst, double rfltCur, String ycName, LGMMarkConv *conv,
...
LGMErr LGMMakeRefDeals(
	...
	LGMErr				(*GetBeta)(Date, Date, double*),			/* EXPONENT BETA TO INTERPRET VOLto interpret vols */
...
LGMErr LGMGetRfixFromX(Date tEx, Date tEnd, double x,
					   Date tNow, 	String	ycname,
...
double LGMRecVal(double *ystar, long n, double *a, double DStart,
				double sqzeta, double *Gpay, double Gst);
...
double LGMNormalVolFromCEV(double fwd, double strike,
						double mat, double CEVvol, double beta);

/* Returns the price of a European option for a normal model */
double LGMNormOptPrice(double fwd, double strike, double NormVol,
					double mat, double dftoStart, SrtCallPutType callput);
