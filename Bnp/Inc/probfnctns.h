...
/* =============================================================================
 ...
 ============================================================================ */
double proba_max_fct(double spot, double barrier, double vol, double mat, double disc);

/* =============================================================================
  FUNCTION     : proba_max_explo_fct(...)
 ============================================================================ */
double proba_max_explo_fct(double spot, double barrier, double vol, double mat, double disc);
...
/* =============================================================================
 ...
 ============================================================================ */
double probag_yes_no_fct(
    double spot, double b_yes, double b_no, double vol, double mat, double disc, int nb_term);

/* =============================================================================
  FUNCTION     : proba_yes_no_explo_fct(...)
 ============================================================================ */
double probag_yes_no_explo_fct(
    double spot, double b_yes, double b_no, double vol, double mat, double disc, int nb_term);
