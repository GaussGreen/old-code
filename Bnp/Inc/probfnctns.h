...
/* =============================================================================
 ...
 ============================================================================ */
double proba_min_fct(double spot,
					 double barrier,
					 double vol, 
					 double mat,
					 double disc);
...
/* =============================================================================
 ...
 ============================================================================ */
double proba_min_explo_fct(double spot,							
						   double barrier,					 
						   double vol, 					 
						   double mat,					 
						   double disc);
...
/* =============================================================================
 ...
 ============================================================================ */
double proba_gauss_fct(double spot,
					   double b_up,
					   double b_do, 
					   double vol,
					   double mat,
...
/* =============================================================================
 ...
 ============================================================================ */
double proba_gauss_explo_fct(double spot,					   
							 double b_up,					   
							 double b_do, 					   
							 double vol,					   
							 double mat,					   
...
/* =============================================================================
 ...
 ============================================================================ */
double probag_yes_no_fct(double spot,					   						
						 double b_yes,					   	 
						 double b_no, 					   						
						 double vol,					   						
						 double mat,					   						
...
/* =============================================================================
 ...
 ============================================================================ */
double probag_yes_no_explo_fct(double spot,					   												 							  
							   double b_yes,					   	 						 
							   double b_no, 					   												 
							   double vol,					   												 
							   double mat,					   												 
