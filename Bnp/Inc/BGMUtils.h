...
Err srt_BGMFillLiborTS(
		...
		SMILE_MOVE_TYPE ModelSmileMove,
		double			**ppdLiborTS);
...
Err srt_f_BGMAdjustVolandGetShifts(long MaxNumPeriod,
...
Err srt_bgm_FudgeForDecreasingCorrelation(double **Correl,int NbrMaturities,double **DecreasingCorrel);

Err srt_bgm_SymmetricToPositive(double **OldCorrel,double **NewCorrel,int NewNbrMaturities);

Err srt_bgm_InterpolExtrapolCorrel(double **OldCorrel,double **NewCorrel,double *OldMaturities,double *NewMaturities,int NbrOldMaturities,int NewNbrMaturities);

Err srt_bgm_InterpolCorrelation(int OldNbrMaturities, int NewNbrMaturities, double *OldMaturities, double *NewMaturities, double **OldCorrel, double **NewCorrel);

Err srt_bgm_GetShiftedLogModelFrom2Strikes(double forward,
								   double maturity,
								   double *strikes,
								   double *marketvols,
								   double *shift,
