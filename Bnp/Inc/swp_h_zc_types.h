...
enum ZC_DFields { ZC_DATE, ZC_TIME, ZC_ZERO_RATE, ZC_DF, ZC_DWIDTH };
enum ZC_IFields { ZC_IWIDTH };
...
#define ZC_field_set_Dlength(zcptr, len)                                       \
  Field_List_set_Dlength(zcptr->data, len)
...
#define YC_field_set_Dlength(ycptr, len)                                       \
  Field_List_set_Dlength(ycptr->data, len)
#define YC_field_set_Ilength(ycptr, len)                                       \
  Field_List_set_Ilength(ycptr->data, len)
...
#define Arg_field_get(aptr, mess, index)                                       \
  (*(aptr->mess))(aptr->ARG_TARGET, index)
