...
#define ZC_field_Dget(zcptr,FIELDNAME,index)  \
	field_Dget(zcptr->data,FIELDNAME,index)

#define ZC_field_Iget(zcptr,FIELDNAME,index)  \
	field_Iget(zcptr->data,FIELDNAME,index)

#define ZC_field_Dateget(zcptr,FIELDNAME,index)\
...
#define ZC_Dateset(zcptr,FIELDNAME,val){ (zcptr->FIELDNAME) = (double)val; }
...
#define ZC_Dset(zcptr,FIELDNAME,val){ (zcptr->FIELDNAME) = (val); }

#define ZC_Iset(zcptr,FIELDNAME,val){ (zcptr->FIELDNAME) = (val); }
...
enum 	YC_DFields {	YC_SWAPEND_DATE, 
			YC_SWAP_RATE,
...
#define YC_field_Dget(ycptr,FIELDNAME,index) \
	 field_Dget(ycptr->data,FIELDNAME,index)
#define YC_field_Iget(ycptr,FIELDNAME,index) \
	 field_Iget(ycptr->data,FIELDNAME,index)
...
#define YC_field_Dateget(ycptr,FIELDNAME,index)\
	 DTOL(field_Dget(ycptr->data,FIELDNAME,index))
...
#define YC_Dateset(ycptr,FIELDNAME,val){ (ycptr->FIELDNAME) = (double)val; }
...
#define YC_Dset(ycptr,FIELDNAME,val){ (ycptr->FIELDNAME) = (val); }
#define YC_Iset(ycptr,FIELDNAME,val){ (ycptr->FIELDNAME) = (val); }
...
#define Leg_field_get(legptr,FIELDNAME,index)\
	Leg_field_Dget(legptr,FIELDNAME,index) 

#define Leg_field_set(legptr,FIELDNAME,index,val)\
	Leg_field_Dset(legptr,FIELDNAME,index,val)

#define Leg_field_Dget(legptr,FIELDNAME,index) \
	 field_Dget(legptr->data,FIELDNAME,index)
#define Leg_field_Iget(legptr,FIELDNAME,index) \
	 field_Iget(legptr->data,FIELDNAME,index)
...
#define Leg_field_Dlength(legptr,FIELDNAME)\
	 field_Dlength(legptr->data,FIELDNAME)
#define Leg_field_Ilength(legptr,FIELDNAME)\
	 field_Ilength(legptr->data,FIELDNAME)
...
#define Leg_set(legptr,FIELDNAME,val) { (legptr->FIELDNAME) = (val) ; }
#define Leg_Dset(legptr,FIELDNAME,val){ (legptr->FIELDNAME) = (val) ; }
#define Leg_Iset(legptr,FIELDNAME,val){ (legptr->FIELDNAME) = (val) ; }

#define Leg_field_set_Dlength(legptr,len)\
	 Field_List_set_Dlength(legptr->data,len)
#define Leg_field_set_Ilength(legptr,len)\
	 Field_List_set_Ilength(legptr->data,len)

#define Leg_field_Dateget(legptr,FIELDNAME,index)\
	 DTOL(field_Dget(legptr->data,FIELDNAME,index))
...
#define Leg_Dateset(legptr,FIELDNAME,val){ (legptr->FIELDNAME) = (double)val; }
...
#define Arg_field_set(aptr,mess,index,val){\
		if(aptr->mess)(*(aptr->mess))(aptr->ARG_TARGET,index,val);}
