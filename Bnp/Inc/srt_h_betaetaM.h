...
/*Err calc_bigM(double **M, double beta2, double eta2, double lambda2, double deltau2, double x_k2, 
			   int i, int j);
*/ 
double print_M(double beta2, double eta2, double lambda2, double deltau2, double x_k2);
