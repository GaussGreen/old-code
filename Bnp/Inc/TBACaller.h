...
char * mbsdf ( char * data_dir, long* valuation, long* sptdays, double *refisprd, double* tsycurve, double* swpcurve, double* volcurve, long* volexp, double *meanrev,
