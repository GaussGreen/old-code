...
typedef struct SrtCallTimeSwap_
{
    ...
    double* gear;    /* in general, 0 (fixed coupon) or 1 (floating digital) - [0,1,...,nCpn-1]
                        margins accrued*/
    ...
    Date*** observationdays; /* [0,..,nCpn-1]*[0..observation_freq-1][0..1], 0 for the Start, 1 for
                                the End  */
    double** ratiodays_for_subperiod; /* [0,..,nCpn-1]*[0..observation_freq-1] */
                                      /* Index details */
    long   undIndex;
    long   undAccrued;
    double CorrelStart;  /* for floating digital, correlation between the cash libor and the first
                            fixing of the period; */
    double CorrelEnd;    /* for floating digital, correlation between the cash libor and the last
                            exercise of the period */
    ...
    double dMatStd; /* 0 if no max, otherwise vol is retrieved for strikes bounded by Fe^{+/-dMaxStd
                       Vol sqrt{t}} */
