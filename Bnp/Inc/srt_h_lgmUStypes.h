...
typedef struct SrtCallTimeSwap_ {
  ...
  double *gear; /* in general  , 0 (fixed coupon) or 1 (floating digital) - [0
                   ,1  ,...  ,nCpn-1]  margins accrued*/
  ...
  double *
      *ratiodays_for_subperiod; /* [0  ,..  ,nCpn-1]*[0..observation_freq-1] */
                                /* Index details */
  long undIndex;
  long undAccrued;
  double CorrelStart;    /* for floating digital  , correlation between the cash
                            libor and the first fixing of the period; */
