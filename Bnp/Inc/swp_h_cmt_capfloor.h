...
Err swp_f_CMT_capfloor(long start, long end_or_nfp, String cap_freq_str,
                       ...
                       String greek_str, SrtCurvePtr crvptr, double *result);
...
Err swp_f_CMCapFloor(long TheoEnd, long numperiodcap, double Underlying,
                     char *CMTFrequency, char *CMTBasis, char *CMTRefRateCode,
                     double Strike, char *CapFrequency, char *CapBasis,
                     char *szCMTVolName, char *szSwaptionVolName,
                     char *szYieldCurveName, char *cRefRateCode,
                     char *cCapFloor, char *method, SRT_Boolean AdjForSpread,
                     int NumStrikesInVol, double *Strikes, double **result);
...
Err swp_f_GetCMVols(char *szYieldCurveName, char *szSwaptionVolName,
                    ...
                    double *beta, double *rho, char *Method, double *chi,
                    double dLambda, double dSpreadLocVol, double dCorrel,
                    double **CMTVols, double **SabrComp);
