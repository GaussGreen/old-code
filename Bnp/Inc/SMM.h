...
typedef struct _smm_params
{
    ...
    double       smile_nstd;  // number of standard deviations to get strikes for smile calibration
    ...
    int          vol_hyp;     // bit0 : converging / sliding on sigma-beta, bit1: c/s on sabr params
