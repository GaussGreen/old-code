...
Err future_HJM(long index, double *dPeriod, double *dParams,
               double *futuresRate);
...
/*---------------------------------------------------------*/
char *eFutFunc_Rut(double dIndex, double *dParams, double *dConvexity,
                   double *dDerivative, int nParams);

char *eFutFunc_HJM(double dIndex, double *dParams, double *dConvexity,
                   double *dDerivative, int nParams);

char *eFutFunc_Bloom(double dIndex, double *dParams, double *dConvexity,
                     double *dDerivative, int nParams);
/*---------------------------------------------------------*/
