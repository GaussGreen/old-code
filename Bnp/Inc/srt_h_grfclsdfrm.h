...
Err grfn_midat_clsdfrm(
    ...
    Date* exercise_start_dates,        /* dates when bonds start,>= correponding exercise
                                       dates. */
    double*         exercise_premiums, /* amounts that must be payed to exercise_ options */
    long            num_prod_dates,
    Date*           prod_dates,
    double*         prod_cfs,
    SrtReceiverType rec_pay,
    SrtUndPtr       und,       /* name of und to use */
