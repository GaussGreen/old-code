...
Err BMA_Option(
    ...
    double dStartDate1, /* The start date of the first Libor fixing (in number
                           format) */
    double dEndDate1,   /* The end date of the first Libor fixing (in number
                           format) */
    double dStartDate2, /* The start date of the last Libor fixing (in number
                           format) */
    double dEndDate2,   /* The end date of the last Libor fixing (in number
                           format) */
    ...
    int bUseNormalModel, /* 1 for combining normal vols  , 0 for using lognormal
                            vols */
    char *szVolCurveName, /* VolCurve name passed to GetVol function */
    char *szRefRate,      /* RefRate passed to GetVol function */
    Err (*GetVol)(char *, double, double, double, int, char *, double *,
                  double *),            /* Function to get vol */
    double *dPrice, double *out_dVega); /* Return value of the option price */
