...
Err srt_sdp(double ***const_mat, double *const_val, double **cmat, int dim, int num_const, double **xmat, double *obj_val, double *error, int *return_error, double toler, int printlevel, int max_iter);
