...
/* Creates a SrtdvdObject with only one  element containing today labelled "_TODAY" */
...
Err srt_f_dvdobj_drift(SrtDvdObj* dvdobj, double start_date, double end_date, double* drift);

/* Computes the implied df (inverse of forward ratio) from start_date to end_date */
Err srt_f_dvdobj_df(SrtDvdObj* dvdobj, double start_end, double end_date, double* df);
