...
/* zero rate */
SrtErr srt_f_dencrv_zr(DenStrpCrv* crv, Ddate start, Ddate end, SrtBasisCode basis, double* answer);

/* instantaneous forward rate */
SrtErr srt_f_dencrv_fwdr(DenStrpCrv* crv, Ddate start, double* answer);

/* To price a swap */
double srt_f_den_swappr(
    Ddate start, Ddate end, SrtCompounding freq, SrtBasisCode basis, DenStrpCrv* crv);

/* To price a deposit */
double srt_f_den_depositpr(Ddate start, Ddate end, SrtBasisCode basis, DenStrpCrv* crv);
