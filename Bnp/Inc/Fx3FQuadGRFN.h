...
typedef struct
{
    ...
    double (*Z_to_S)(long i, double Z, double Fwd, LOCAL_MODEL_PARAM* model_param);

    double (*S_to_Z)(long i, double S, double Fwd, LOCAL_MODEL_PARAM* model_param);
...
Err allocate_local_model_cust(
    long nbPoints, long nbSteps, LOCAL_MODEL_FUNC** model_func, LOCAL_MODEL_PARAM** model_param);
Err fill_local_model_cust(
    LOCAL_MODEL_FUNC*  model_func,
    LOCAL_MODEL_PARAM* model_param,
    long               nbPoints,
    double*            time,
...
void free_local_model_param_cust(LOCAL_MODEL_FUNC* model_func, LOCAL_MODEL_PARAM* model_param);
...
double Z_to_S_Quad_Tanh(long i, double Z, double Fwd, LOCAL_MODEL_PARAM* model_param);
double S_to_Z_Quad_Tanh(long i, double S, double Fwd, LOCAL_MODEL_PARAM* model_param);

double vol_func_Quad_Tanh(long i, double Z, LOCAL_MODEL_PARAM* model_param);
//double vol_func_deriv_Quad_Tanh(long i, double Z, LOCAL_MODEL_PARAM* model_param);
double vol_func_deriv_t_Quad_Tanh(long i, double Z, LOCAL_MODEL_PARAM* model_param);
