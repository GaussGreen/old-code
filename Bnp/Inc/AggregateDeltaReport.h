...
Err	srt_f_AggregateFraTenor(Date			FraTenorDate,
							double			FraPEQ,
							long			NumSwpUndFraHedgeTenor,
							long			NumFutUndFraHedgeTenor,
							Date			*SwpUndFraHedgeTenorDates,
							Date			*FutUndFraHedgeTenorDates,
							SrtCompounding	FloatFreq,
							SrtBasisCode	FloatBasis,
							String			FloatRefRate,
							String			YieldCurveName,
							long			*NumHedgeUndFra,
							double			**HedgeUndFraPEQ,
							Date			**HedgeUndFraTenorDates,
