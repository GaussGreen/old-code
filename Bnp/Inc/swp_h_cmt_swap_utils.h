...
Dlist treas_vol_list(Dlist swap_vol, Dlist swap_rate, Dlist treas_rate, SrtCurvePtr cmt_crv);

Dlist conv_fwd_list(
    long today, DateList dl, Dlist fwd_rate, Dlist vol, SrtCurvePtr cmt_crv, CMRateType rate_type);
