...
/*	If end_date != 0 tenors are ignored      , calibrating to diagonal
   swaptions using freq and basis. If end_date = 0 there are two cases: if
   tenors are present calibrate to corresponding swaptions using freq and basis
   , otherwise use refrate defaults and calibrate to corresponding caplets */
