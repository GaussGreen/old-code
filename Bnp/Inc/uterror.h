/* ======================================================
   ...
   ====================================================== */
/*
        serror(fmt,...) works like printf; it prints to a file, (Default NULL)
	and also to a string, which it returns.
	
	To change default string, error("SETSTRING",String new_default_string);
	To change default FILE, error("SETFILE",FILE *new_default_file);
