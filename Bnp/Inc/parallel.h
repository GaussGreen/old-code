...
void SendCalibData(const double *x,
					  int ndata,const double *a, int ma);
Err CheckRcvCalibData(int ma, int *pnb_local_data, int **prcvd, double **y,
						 double ***derivs,int **local_indexes,
						 double* pmax_time,int reset);
