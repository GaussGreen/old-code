...
_MBS_EXTERN_C
double MBS_GetVolTermTenor(
    void*   VC,  // VolatilityCurve
    long    today,
    int     TermNumUnits,
    SrtUnit TermUnitType,
    int     TenorNumUnits,
    SrtUnit TenorUnitType,
    double  Strike);
...
//	* usage:
//		+ SwapRate_Create: create handle for swap rate corresponding to given {yield curve,
//ref rate, basis, frequency}
...
_MBS_EXTERN_C
unsigned MBS_SwapRate_CreateFromYC(void* YC  // IYieldCurve
);

_MBS_EXTERN_C
void MBS_SwapRate_Delete(unsigned hSwapRate  // handle to swaprate functor
);
...
//	* functor represention by unique opaque handles
//	* usage:
//		+ ForwardRate_Create: create handle for swap rate corresponding to given {yield curve,
//ref rate, basis, frequency}
...
_MBS_EXTERN_C
void MBS_ForwardRate_Delete(unsigned hForwardRate  // handle to swaprate functor
);
...
double MBS_SwapRateEvaluate_TermTenor(
    ...
    int           TermNumUnits,
    SORT::SrtUnit TermUnitType,
    int           TenorNumUnits,
    SORT::SrtUnit TenorUnitType);
