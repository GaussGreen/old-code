...
//  (2) exp( - integration of lambda term structure(u)) from u = 0 to u = pdLamT_Begin[i] in  pdEIL_Begin
//-------------------------------------------------------------------------------------------------------
void _LAMBDA_Zero(
...
void _fill_PHI(
		const double *pdT_Begin, // exercise time
		const double *pdT_End,
		const double *pdEIL1_Begin,
		const double *pdEIL2_Begin,
		const double *pdLamT_Begin,
		const double *pdLamT_End,
		const double *pdLam_Begin,
