...
Err get_bgm_TenorDatesFromUnd(SrtUndPtr und_ptr, int numtenors, long *Tenordates);

Err get_bgm_VolMatrixFromUnd(SrtUndPtr und_ptr, int numtenors, int numfactors, double **VolMatrix);

Err get_bgm_HistCorrelFromUnd(SrtUndPtr und_ptr,int numtenors,double **histcorrel);
...
double BermudaNewton(	double epsmin,
						double epsmax,
						double tol,
						int init_num_evt_dts,
						long* init_evt_dts,
...
SrtReceiverType			PayRec,
SrtBasisCode			Basis,
double					***SwapLevelCube);

Err OptimizeFrontierBGMMidat(double epsmin,double epsmax,int num_evt, long numpaths, double *exfrontier, double *dfs, double ***SwapLevelCube,int n1,int n2);

double ComputeBGMMidat(int num_evt, long numpaths, double *exfrontier, double *dfs, double ***SwapLevelCube);
