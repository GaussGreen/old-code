...
Err swp_f_get_ref_rate_details(
    String ref_rate_name, SrtBasisCode* float_basis, SrtCompounding* float_compounding);

Err srt_f_get_spot_lag_from_refrate(String ref_rate_name, int* spot_lag);

double swp_f_fra(Ddate start, Ddate end, BasisCode basis, String yc_name, String ref_rate);
#endif