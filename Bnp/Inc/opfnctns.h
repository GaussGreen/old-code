...
Err srt_f_optblkvoltobetavol(
    double forward, double strike, double bsvol, double mat, double beta, double* betavol);
...
void srt_f_optblkd12(
    double fwd_price, double strike, double vol, double mat, double* d1, double* d2);
...
/* =====================================================================================================
  FUNCTION PAYOFF	:  MAX(w1+S1, w2+S2, ..., wN+SN) + MarginFix if  MAX(w1+S1, w2+S2, ...,
 wN+SN) > strike CouponFix						 if  MAX(w1+S1, w2+S2, ...,
...
/* =====================================================================================================
  FUNCTION PAYOFF	:	S1^w1*S2^w2* ...*Sn^wn + MarginFix		if  S1^w1*S2^w2*
 ...*Sn^wn > strike
                                        CouponFix
...
double hit_one_barrier_fct(
    double spot, double fwd, double b_yes, double b_no, double mat, double vol, int n, int ff);
...
double dens_gauss_n(double var, double x1_n, double x2_n, double mu, double vol, double mat);
