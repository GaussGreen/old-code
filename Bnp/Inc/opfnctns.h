...
/*******************************************************************************
 *
 * PURPOSE      	: iniatializes the shift parameters for greek
 *computation
 *
 *******************************************************************************/
...
/* =============================================================================
  FUNCTION     : optmerton(...)
 ============================================================================ */
Err optmerton(double Fwd, double Strike, double sigma, double U1,
              double lambda1, double U2, double lambda2, double maturity,
              char *Logornorm, SrtGreekType Greek, double *answer);
/* =============================================================================
  FUNCTION     : optmertonpremium(...)
 ============================================================================ */
double optmertonpremium(double dFwd, double Strike, double sigma, double U1,
                        double lambda1, double U2, double lambda2, double T,
                        char *Logornorm);

/* =============================================================================
  FUNCTION     : optcalibmerton(...)
 ============================================================================ */
Err optcalibmerton(double dFwd_loc, int n_strikes_loc, double *strikes_loc,
                   double *market_vols, double *param, double maturity,
                   char *Logornorm, double *chisq, long *ia, double *calibvols);

/* =============================================================================
 FUNCTION     : optmertonsmile(...)
============================================================================ */

Err optmertonsmile(double dFwd, int n_strikes, double *strikes,
                   double *parameters, double maturity, char *Logornorm,
                   double *impvols);
...
double srt_f_optblksch(double fwd_price, double k, double vol, double mat,
...
Err srt_f_optchkblksch(double fwd_price, double strike, double vol, double mat);
...
Err OptBlkSch(double fwd_price, double strike, double vol, double mat,
              double disc, char *call_put_str, char *greek_str, double *result);
...
/* =============================================================================
 ...
 ============================================================================ */
double srt_f_optblkschbeta(double fwd_price, double strike, double betavol,
...
/* =============================================================================
 ...
 ============================================================================ */
double srt_f_optimpvolbeta(double premium, double fwd_price, double strike,
                           double mat, double beta, double disc,
                           SrtCallPutType call_put);
...
/* =============================================================================
 ...
 ============================================================================ */
Err srt_f_optblkvoltobetavol(double forward, double strike, double bsvol,
                             double mat, double beta, double *betavol);

/* =============================================================================
  FUNCTION     : srt_f_optblkvoltobetavol(...)
 ============================================================================ */
Err srt_f_optbetavoltoblkvol(double forward, double strike, double betavol,
                             double mat, double beta, double *bsvol);

/* =============================================================================
  FUNCTION     : srt_f_optbetastochvoltoblkvol(...)
 ============================================================================ */
Err srt_f_optbetastochvoltoblkvol(double forward, double strike, double betavol,
                                  double vovol, double rho, double mat,
                                  double beta, double *bsvol);
/* =============================================================================
  FUNCTION     : srt_f_optbetastochvoltoblkvolmeanreversion(...)
 ============================================================================ */
Err srt_f_optbetastochvoltoblkvolmeanreversion(double forward, double strike,
                                               double betavol, double vovol,
                                               double rho, double tau,
                                               double mr, double mat,
                                               double beta, double *bsvol);
/* =============================================================================
  FUNCTION     : srt_f_optbetastochvoltoblkvoldrift(...)
 ============================================================================ */
Err srt_f_optbetastochvoltoblkvoldrift(double forward, double strike,
                                       double betavol, double vovol, double rho,
                                       double mat, double beta, double *bsvol);
/* =============================================================================
  FUNCTION     : srt_f_optbetastochvoltoblkvolpremium(...)
 ============================================================================ */

Err srt_f_optnewbetastochvoltoblkpremium(double F, double K, double sigma,
                                         double beta, double vovol, double rho,
                                         double mat, double *premium);
/* =============================================================================
...
Err srt_f_optsabrvolq(double forward, double strike, double maturity,
                      double volFwd, double alpha, double beta,
                      double corrFwdVol, double volFx, double corrFwdFx,
                      double corrVolFx, SrtDiffusionType output,
                      double *forward_adj, double *vol_adj, double *alpha_adj,
                      double *rho_adj);
...
Err srt_f_optblkvolATMtobetavolStochVol(double forward, double strike,
                                        double bsvol, double mat, double alpha,
...
double srt_f_optblknrm(double fwd_price, double strike, double vol, double mat,
                       double df, SrtCallPutType call_put, SrtGreekType greek);

double srt_f_optblknrm_accurate(double fwd_price, double strike, double vol,
                                double mat, double df, SrtCallPutType call_put,
                                SrtGreekType greek);

/* A function that checks the Normal Black-Scholes inputs */
Err srt_f_optchkblknrm(double vol, double mat);

/* A Higher level interface function to call Normal Black Scholes with checks*/
Err OptBlkNrm(double fwd_price, double strike, double vol, double mat,
              double disc, char *call_put_str, char *greek_str, double *result);
...
double srt_f_optameopt(double spot, double forward, double strike,
                       double disc_fact, double vol, double opt_mat,
                       SrtCallPutType call_put, int step_num,
                       SrtGreekType greek);
...
Err srt_f_optamevol(double premium, double spot, double forward, double strike,
                    double disc_fact, double opt_mat, SrtCallPutType call_put,
                    int step_num, double *implied_vol);
...
double srt_f_optexting(double fwd_price, double spot, double strike,
...
double srt_f_optprtext(double fwd2, double fwd1, double spot, double strike,
                       double barrier, double vol1, double vol2, double mat1,
                       double mat2, double disc, SrtCallPutType call_put,
                       SrtBarrierType down_up, SrtGreekType greek);

/* =============================================================================
  FUNCTION     : srt_f_optfwdext(...)
 ============================================================================ */

double srt_f_optfwdext(double fwd1, double fwd2, double strike, double barrier,
...
double srt_f_optlgtabl(double fwd_price, double spot, double strike,
                       double barrier, double vol, double mat, double disc,
                       SrtCallPutType call_put, SrtBarrierType down_up,
                       SrtGreekType greek);
...
double srt_f_optprtlgt(double fwd1, double fwd2, double spot, double strike,
                       double barrier, double vol1, double vol2, double mat1,
                       double mat2, double disc, SrtCallPutType call_put,
                       SrtBarrierType down_up, SrtGreekType greek);
...
double srt_f_optfwdlgt(double fwd1, double fwd2, double strike, double barrier,
                       double vol1, double vol2, double mat1, double mat2,
                       double disc, SrtCallPutType call_put,
                       SrtBarrierType down_up, SrtGreekType greek);
...
double srt_f_optdblbar(double spot, double forward, double strike, double b_do,
                       double b_up, double vol, double opt_mat, double disc,
...
double srt_f_optsprnum(double fwdy, double fwdx, double sigy, double sigx,
                       double rho, double disc, double a, double b,
                       double strike, double mat, SrtCallPutType call_put,
                       SrtGreekType greek);

/* =============================================================================
  FUNCTION     : srt_f_optworstbest(...)
 ============================================================================ */
double srt_f_optworstbest(double FirstForward, double SecondForward,
                          double FirstStrike, double SecondStrike,
                          double Gearing, double FirstBSVol, double SecondBSVol,
                          double Rho, double Df, double Maturity,
                          SrtCallPutType Call_PutOne,
                          SrtCallPutType Call_PutTwo,
                          SrtBestWorstType Best_Worst, SrtGreekType Greek);

/* =============================================================================
  FUNCTION     : srt_f_optextspr(...)
 ============================================================================ */

double srt_f_optextspr(double fwdy, double fwdx, double sigy, double sigx,
                       double rho, double disc, double a, double ap, double b,
                       double bp, double k, double t, SrtMinmaxType min_max,
                       SrtCallPutType call_put, SrtGreekType greek);
...
double srt_f_nono_bar(double spot1, double spot2, double fwd1, double fwd2,
                      double strike, double mat, double vol1, double vol2,
                      double rho, double barrier[4], double disc_fac,
                      long n_steps, SrtCallPutType call_put,
                      SrtGreekType greek);
...
double srt_f_opteurscdout(double fwdx, double fwdy, double strike,
                          double barrier, double sigx, double sigy, double rho,
                          double matx, double maty, double disc,
                          SrtCallPutType call_put, SrtBarrierType down_up,
                          SrtGreekType greek);
...
double srt_f_optscdinn(double fwdx, double fwdy, double spoty, double strike,
                       double barrier, double sigx, double sigy, double rho,
                       double mat1, double mat2, double disc,
                       SrtCallPutType call_put, SrtBarrierType down_up,
                       SrtGreekType greek);
...
double srt_f_opttriscud(double fwdy, double fwdx, double spoty, double spotx,
                        double strikey, double barriery_up, double barriery_dwn,
                        double barrierx, double sigy, double sigx, double rho,
                        double mat, double disc,
                        SrtCallPutType call_put, /* ca_pu in y */
                        int scud_type,           /* up_do in x */
                        int nterms, SrtGreekType greek);
...
double srt_f_optscdspr(double fwdx, double fwdy, double fwdz, double spoty,
                       ...
                       SrtCallPutType call_put, int scud_type, /* DOWN or UP*/
...
double srt_f_optmltspd(double fwdx, double fwdy, double fwdz, double sigx,
                       ...
                       SrtCallPutType call_put, long paths, SrtGreekType greek);

/* =============================================================================
  FUNCTION     	: srt_f_EuroBasketSmile(...)
 ============================================================================ */

Err srt_f_EuroBasketSmile(int nFwds, double *Fwds, int nWeights,
                          double *Weights, double strike, int nVols,
                          double *Vols, int nBeta, double *Beta, int nAlpha,
                          double *Alpha, int nRho, double *Rho,
                          double **Correlation, double mat, double disc,
                          SrtCallPutType call_put, long paths, long points,
                          SrtGreekType greek, double *premium,
                          double **ppdSpreadVol);
...
Err srt_f_EuroBasketSmileCpl(
    int nFwds, double *Fwds, int nWeights, double *Weights, double strike,
    int nVols, double *Vols, int nBeta, double *Beta, int nAlpha, double *Alpha,
    int nRho, double *Rho, double **Correlation, double mat, double disc,
    SrtCallPutType call_put, long nPaths, long points,
    int StudDegree, // this is the only difference: input the degree of the
                    // Student t Copula. 0 Corresponds to the gaussian copula
    SrtGreekType greek, double *premium, double **ppdSpreadVol, int n_conv,
...
Err srt_f_Basket_MixedSL_Copula(
    ...
    int iNbFwd, double *dShiftedFwdDown, double *dShiftedFwdUp, double *dProba,
    double *dShift, double *dVolDown, double *dVolUp,

    double **dCorrelation,

    double *dWeights, int iNbStrike, double *dStrike,

    SrtCallPutType eCallPut, long lNbPaths, long lNbPoints, double dNbStd,
...
Err srt_f_BestOfDigitalSmileCpl(
    ...
    int StudDegree, // this is the only difference: input the degree of the
                    // Student t Copula. 0 Corresponds to the gaussian copula
    SrtGreekType greek, double *premium, double **ppdSpreadVol, double dCoupon,
    double dMargin, int n_conv, SrtDiffusionType TypeInput,
    SrtMCSamType MCType);
...
/* ====================================================================================
  FUNCTION     	: srt_f_CompundBasketCpl(...)  Compound option on a basket with
 copulas
 ===================================================================================
 */

Err srt_f_CompoundBasketCpl(
    int nFwds, double *Fwds, int nWeights, double *Weights,

    int nStrikes, double *Strikes,
    ...
    int StudDegree, // this is the only difference: input the degree of the
                    // Student t Copula. 0 Corresponds to the gaussian copula
    SrtGreekType greek, double *premium, int n_conv, SrtDiffusionType TypeInput,
    SrtDiffusionType log_norm);

/* ====================================================================================
  FUNCTION     	: srt_f_CompundBasketCpl(...)  Callable option on a basket with
 copulas
 ===================================================================================
 */

Err srt_f_CallableBasketCpl(
    double **InFwds, double *InWeights, double *InStrikes, double **InVols,
    double *InBeta, double *InAlpha, double *InRho, double *InLvl,
    double **InCorr, double mat, double disc,

    SrtCallPutType call_put,

    long paths, long points,
    int StudDegree, // this is the only difference: input the degree of the
                    // Student t Copula. 0 Corresponds to the gaussian copula
    SrtGreekType greek, double *premium, int n_conv, const long nFwdsRows,
    const long nFwdsCols, SrtDiffusionType TypeInput,
    SrtDiffusionType log_norm);
...
double srt_f_optikosmo(double fwd_price1, double fwd_price2, double spot_price,
                       ...
                       double rungs[MAX_RUNG], double strikes[MAX_RUNG],
...
double srt_f_optratcht(double fwd1, double fwd2, double spot, double hist_ext,
                       double vol1, double vol2, double mat1, double mat2,
                       double disc, SrtCallPutType call_put, SrtGreekType greek,
                       double rungs[MAX_RUNG], double strikes[MAX_RUNG]);
...
double srt_f_optrebate(double fwd_price, double spot, double barrier,
                       double rebate, double vol, double mat, double disc,
                       SrtCallPutType call_put, SrtGreekType greek);
...
double srt_f_optladder(double fwd_price, double spot, double strike,
                       double hist_extr, double rungs[MAX_RUNG], double vol,
                       double mat, double disc, SrtCallPutType call_put,
...
double srt_f_optlokbak(double fwd_price, double spot, double hist_extr,
...
double srt_f_optpaloba(double fwd_price1, double fwd_price2, double spot,
                       double hist_extr, double vol1, double vol2, double mat1,
                       double mat2, double disc, SrtCallPutType call_put,
                       SrtGreekType greek);
...
double srt_f_opteurdig(double fwd, double barrier, double vol, double mat,
                       double disc, SrtBarrierType below_above,
                       SrtGreekType greek);
...
double srt_f_optamedig(double fwd, double spot, double barrier, double vol,
                       double mat, double disc, SrtBarrierType below_above,
                       SrtMinmaxType min_max, SrtGreekType greek);

/* ==========================================================================
   srt_f_optfwdamdig(...)
   ========================================================================== */

double srt_f_optfwdamdig(double fwd_price1, double fwd_price2, double strike,
                         double vol1, double vol2, double mat1, double mat2,
                         double disc, SrtBarrierType below_above,
                         SrtMinmaxType min_max, SrtGreekType greek);
...
double srt_f_opttpamdi(double fwd1, double fwd2, double barrier, double vol1,
                       double vol2, double mat1, double mat2, double disc1,
                       double disc2, SrtBarrierType below_above,
                       SrtGreekType greek);
...
double srt_f_opteursla(double fwd_price1, double fwd_price2, double barrier,
                       double vol1, double vol2, double mat1, double mat2,
                       double disc, SrtBarrierType below_above,
                       SrtGreekType greek);
...
double srt_f_optamesla(double fwd_price1, double fwd_price2, double strike,
                       double vol1, double vol2, double mat1, double mat2,
                       double disc, SrtBarrierType below_above,
                       SrtGreekType greek);
...
double srt_f_optslalom(double forward, double spot, double barrier, double vol,
...
double srt_f_optrainbow(double T,  /* maturity			*/
                        ...
                        double K, double nX, double X0, double sigX, double nY,
                        double Y0, double sigY, double rho);
...
double srt_f_optnrmdis(double value);

/* =============================================================================
  FUNCTION     : srt_f_optbivdis(...)
 ============================================================================ */

double srt_f_optbivdis(double variable_x, double variable_y, double rho);
...
/* ==========================================================================
   ...
   b_up ] Prob[ X(T) < k; min X(t) > b_do ; max X(t) < b_up ]
   ========================================================================== */
...
double hit_one_barrier_fct(double spot, double fwd, double b_yes, double b_no,
                           double mat, double vol, int n, int ff);

/* ==========================================================================
   fct_gold_hit_one_barrier(...)
   ========================================================================== */

double fct_gold_hit_one_barrier(double x, va_list argptr);

/* ==========================================================================
   dens_four_n(...)
   ========================================================================== */

double dens_four_n(int n, double x, double a, double b, double coeff1,
                   double coeff2);
...
double dens_gauss_n(double var, double x1_n, double x2_n, double mu, double vol,
                    double mat);
...
/* ==========================================================================
prob_ExpectedDays:  calculates the expected occupation time (in days) for a
corridor
   ========================================================================== */
