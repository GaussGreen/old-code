...
#define SENSIT_UFDESC                                                          \
  {"princ_calc", "CGGVGVI", "D",                                               \
   "@princ_calc(yc      , dates range      , flow range      , [aggregation "  \
   "dates      , "                                                             \
   "method(1/0)])",                                                            \
   princ_calc},                                                                \
      ...
      {"sy_clean", "IIDD", "D",                                                \
       "@sy_clean(start      ,end      ,coupon      ,sy)", sy_clean},          \
      {"clean_sy", "IIDD", "D",                                                \
       "@clean_sy(start      ,end      ,coupon      ,clean)", clean_sy},       \
      {"sy_yield", "IIWWDDZD", "D",                                            \
       "@sy_yield(start      ,end      ,compd      ,basis      ,cp      ,sy  " \
       "    ,rdmptn  "                                                         \
       "    ,first_coupon)",                                                   \
       sy_yield},                                                              \
  {                                                                            \
    "yield_sy", "IIWWDDZD", "D",                                               \
        "@yield_sy(start      ,end      ,compd      ,basis      ,cp      "     \
        ",yld      ,rdmptn  "                                                  \
        "    ,first_coupon)",                                                  \
        yield_sy                                                               \
  }
