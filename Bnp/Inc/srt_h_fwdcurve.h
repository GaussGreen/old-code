 ...
 */
double srt_f_drift_from_fwdcrv(double start_time, double end_time,
                               SrtCurvePtr crv);

/* Computes the implied disc (inverse of forward ratio) from start_time till
 * end_time */
double srt_f_disc_from_fwdcrv(double start_time, double end_time,
                              SrtCurvePtr crv);
...
Err srt_f_init_DividendCurve(Date today, char *ccy, double **forward_curve,
                             int ncols, int nrows, String fwd_name);
